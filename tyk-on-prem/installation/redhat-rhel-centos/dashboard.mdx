...
*   Follow the steps provided in this link [Getting started on Red Hat (RHEL / CentOS)](/tyk-on-premises/redhat-rhel-centos) to install and configure Tyk dependencies.
