...
**Tyk Operator** offers an [Ingress Controller](/api-management/automations#control-kubernetes-ingress-resources), which dynamically manages Tyk ApiDefinition resources as per the ingress spec. 
