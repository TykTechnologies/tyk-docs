...
* **Are you building and hosting your own AI applications, chat interfaces, or LLM-backed tools?** Start with **AI Studio**. It governs your own LLM traffic: connecting to LLM vendors, running a Chat interface, managing budgets, and controlling which Users and Teams can use which LLMs, Tools, and Data Sources.
* **Do you need to let AI agents call existing remote MCP servers, such as GitHub Copilot, Slack, or an internal team's MCP server, under your organization's access controls?** Use **MCP Gateway**. It sits in front of MCP servers you do not run yourself, adding authentication, per-tool access control, and observability to agent traffic that would otherwise bypass your governance.
