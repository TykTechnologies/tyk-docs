...
Tyk AI Studio is available in two editions to suit different organizational needs: **Community Edition** (open source) and **Enterprise Edition** (advanced features).

### Community Edition
The Community Edition is free and open source. It is perfect for development, testing, small teams, and learning AI management. It provides cost visibility without enforcement.
...
**How to get it:**
A valid license key is required. Contact support@tyk.io or your account manager to request an AI Studio Enterprise license. Once you have a license, you can run it via Docker Compose:
```bash
git clone https://github.com/TykTechnologies/ai-studio.git
cd ai-studio/quickstart
