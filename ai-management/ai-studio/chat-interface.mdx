...
*   **Tool Integration:** Seamlessly uses configured [Tools](/ai-management/ai-studio/tools) when the LLM determines they are necessary to fulfill a user's request. The available tools depend on the Chat Experience configuration and the user's team permissions.
...
*   **Export to PDF:** From [v2.1.0](/developer-support/release-notes/ai-studio), users can export a chat conversation to PDF using the print button, available in both the standard chat view and agent chats.
...
*   **Access Control:** Users only see and can interact with Chat Experiences assigned to their [Teams](/ai-management/ai-studio/user-management).
...
*   **Selecting Call Settings:** Choosing an existing [Call Setting](/ai-management/ai-studio/call-settings) for the assigned LLM.
...
*   **Assigning Teams:** Determining which [Teams](/ai-management/ai-studio/user-management) can access this Chat Experience.
