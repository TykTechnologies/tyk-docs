...
Once deployed and you've registered your first user, proceed to the [Initial Configuration](/ai-management/ai-studio/configuration) guide to configure Tyk AI Studio.
