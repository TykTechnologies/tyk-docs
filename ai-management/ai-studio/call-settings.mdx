...
AI Studio seeds the list only when no call settings exist yet, such as on a new installation. It never overwrites a setting you already created, edited, or deleted.
