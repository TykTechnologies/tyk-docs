...
## Details About LLM Call Settings
...
It is important to note that these settings are not utilized in the AI Gateway proxy since applications are expected to define their own model configurations. While the settings are not used in the proxy, they are crucial for managing system-level and chat-specific interactions, ensuring consistent performance and efficiency. This section enables streamlined configuration for application-level integration of LLMs.
...
> **TODO:** Add product screenshots of the LLM Call Settings creation form.

## External References

For more details on standard LLM configuration fields, refer to the official documentation of the respective providers:

- [OpenAI API Reference (Chat Completions)](https://platform.openai.com/docs/api-reference/chat/create)
- [Anthropic Claude API Reference (Messages)](https://docs.anthropic.com/en/api/messages)
- [Cohere API Reference](https://docs.cohere.com/reference/generate)
