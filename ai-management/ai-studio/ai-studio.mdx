...
> **Important:** Analytics must be **explicitly enabled** in the Edge Gateway configuration for data to appear in Studio dashboards. This is a common stumbling block — see the [Analytics](/ai-management/ai-studio/analytics) docs for configuration details.
...
This provides **eventually-accurate** budget control across a multi-gateway environment. See [Budget Control](/ai-management/ai-studio/budgeting) for details.
 */}
