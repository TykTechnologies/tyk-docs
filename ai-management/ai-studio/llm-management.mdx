...
- **Don't Log Bodies:** Enable this flag to prevent the storage of request and response bodies in proxy logs, chat log entries, and analytics events on a per-LLM basis for privacy and compliance.
...
3. **Fill in the LLM Details:**
   ...
   - In the **Portal Display Information** section,
      ...
      - **Don't Log Bodies:** Toggle this option to disable the storage of request and response bodies in proxy logs, chat log entries, and analytics events for this LLM.
