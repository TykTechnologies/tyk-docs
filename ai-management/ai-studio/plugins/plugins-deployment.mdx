...
**See [Plugin Development Workflow](plugins-development-workflow)** for detailed setup, helper scripts, and the fastest development loop.
...
- **[Plugin Development Workflow](plugins-development-workflow)** - Fast iteration with file:// and reload API
- **[Plugin Overview](plugins-overview)** - All plugin types and capabilities
- **[SDK Reference](plugins-sdk)** - Complete SDK documentation
- **[Plugin Manifests](plugins-manifests)** - Manifest configuration
- **[Plugin Examples](plugins-examples)** - Working examples including community plugins
