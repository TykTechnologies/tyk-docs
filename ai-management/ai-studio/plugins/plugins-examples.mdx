...
> **Experimental**: Agent plugins are currently experimental. See [Agent Plugins Guide](plugins-studio-agent) for full documentation.
...
- **[Service API Reference](plugins-service-api)** - All Service API operations
- **[Microgateway Plugins Guide](plugins-microgateway)** - Gateway-specific patterns
- **[AI Portal UI Plugins Guide](plugins-portal-ui)** - Build portal-facing pages and forms
...
- **[Custom Endpoints Guide](plugins-custom-endpoints)** - Serve custom HTTP endpoints
