...
> **Looking for portal (end-user) pages?** See the [AI Portal UI Plugins Guide](plugins-portal-ui) for building pages visible to portal users, not just admins.
...
- **[AI Portal UI Plugins Guide](plugins-portal-ui)** - Build portal-facing pages visible to end users (not just admins)
- [Plugin Manifests & Permissions](plugins-manifests)
- [Service API Reference](plugins-service-api)
- [SDK Reference](plugins-sdk)
- [Plugin Deployment](plugins-deployment)
