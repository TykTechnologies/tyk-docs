...
This page covers the plugin code itself. To bind a built plugin to an App and make it available to users through the admin UI, see [Manage Agents](/ai-management/ai-studio/agents).
...
Create an Agent Object that binds the plugin to an App. You can do this via the API, as shown below, or from the admin UI. See [Manage Agents](/ai-management/ai-studio/agents) for the UI walkthrough.
