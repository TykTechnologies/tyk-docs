...
[Learn more →](/ai-management/ai-studio/plugins/microgateway)
...
- **[Development Workflow Guide](/ai-management/ai-studio/plugins/development-workflow)** - Fast iteration with file:// and reload API
- **[Plugin SDK Reference](/ai-management/ai-studio/plugins/sdk)** - Complete SDK documentation
- **[Plugin Examples](/ai-management/ai-studio/plugins/examples)** - Browse working examples (including production-ready community plugins)
- **[Object Hooks Guide](/ai-management/ai-studio/plugins/object-hooks)** - Intercept CRUD operations
- **[Custom Endpoints Guide](/ai-management/ai-studio/plugins/custom-endpoints)** - Serve custom HTTP endpoints (MCP, OAuth, webhooks)
- **[Microgateway Plugins Guide](/ai-management/ai-studio/plugins/microgateway)** - Gateway-specific patterns
- **[AI Studio UI Plugins Guide](/ai-management/ai-studio/plugins/studio-ui)** - Build admin plugin UIs
- **[AI Portal UI Plugins Guide](/ai-management/ai-studio/plugins/portal-ui)** - Build portal-facing plugin pages and forms
- **[AI Studio Agent Plugins Guide](/ai-management/ai-studio/plugins/studio-agent)** - Build conversational agents
- **[Service API Reference](/ai-management/ai-studio/plugins/service-api)** - Complete API documentation
- **[Plugin Deployment](/ai-management/ai-studio/plugins/deployment)** - Production deployment options
