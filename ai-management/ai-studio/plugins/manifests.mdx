...
See [Resource Provider Plugins](plugins-resource-types) for the full guide.
...
See [plugins-studio-ui.md](plugins-studio-ui) for complete rate-limiting-ui example.
