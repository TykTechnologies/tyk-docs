...
See [Plugin Manifests Guide](plugins-manifests) for complete manifest documentation.
...
- [Service API Reference](plugins-service-api) - Using services in hooks
- [Plugin Examples](plugins-examples) - Browse all examples
- [Best Practices](plugins-best-practices) - Advanced patterns
