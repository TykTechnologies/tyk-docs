...
See [Plugin Manifests Guide](manifests) for complete manifest documentation.
...
- [Plugin SDK Reference](sdk) - Core SDK documentation
- [Plugin Manifests](manifests) - Manifest configuration
- [Service API Reference](service-api) - Using services in hooks
- [Plugin Examples](examples) - Browse all examples
