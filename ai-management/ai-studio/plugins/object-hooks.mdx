...
- [Plugin SDK Reference](/ai-management/ai-studio/plugins/sdk) - Core SDK documentation
- [Plugin Manifests](/ai-management/ai-studio/plugins/manifests) - Manifest configuration
- [Service API Reference](/ai-management/ai-studio/plugins/service-api) - Using services in hooks
- [Plugin Examples](/ai-management/ai-studio/plugins/examples) - Browse all examples
- [Best Practices](/ai-management/ai-studio/plugins/best-practices) - Advanced patterns
