...
- [Plugin SDK Reference](plugins-sdk) - Core SDK concepts and capability interfaces
- [Plugin Manifests](plugins-manifests) - Manifest structure and permissions
- [Portal UI Plugins](plugins-portal-ui) - End-user portal integration
- [Custom Endpoint Plugins](plugins-custom-endpoints) - Gateway HTTP endpoints
- [Plugin Service API](plugins-service-api) - KV storage, events, and management APIs
