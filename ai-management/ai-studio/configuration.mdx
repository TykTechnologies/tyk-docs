...
2. Click to create a new Chat Experience.
    ...
    - **LLM Call settings:** Select the [LLM Call settings](/ai-management/ai-studio/call-settings) you want to use for this chat (e.g., `gpt-4o`). If the specific model settings are not available, you can create one in the [LLM model settings](/ai-management/ai-studio/llms) page. We have added defaults for the popular ones.
