...
Teams in Tyk AI Studio help you organize [Users](/ai-management/ai-studio/users) and easily manage their access to LLM providers, data sources, and tools. By linking Teams to specific [Catalogs](/ai-management/ai-studio/catalogs), you ensure users access only the AI resources relevant to their role.
