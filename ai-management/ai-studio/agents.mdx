...
<img src="/img/ai-management/agents-create-form.png" alt="Create Agent form in the AI Studio admin UI, showing Basic Information and the Plugin and App selectors under Agent Configuration" />
...
<img src="/img/ai-management/agents-list.png" alt="Agents list in the AI Studio admin UI, showing the empty state with a Create Agent button" />
