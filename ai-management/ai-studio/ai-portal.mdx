...
*   **Application Management:** Create and manage [Apps](/ai-management/ai-studio/admin-apps) that integrate LLMs, tools, and data sources for API access.
...
*   **Portal Branding:** Customize logos, colors, and themes to match organizational branding. See [Branding](/ai-management/ai-studio/branding).
