...
From v2.1.0, the Compliance dashboard (`/admin/compliance`) surfaces [Compliance Events](/ai-management/ai-studio/compliance-events) emitted by filter scripts alongside the existing blocked-request data:
