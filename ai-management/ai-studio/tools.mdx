...
*   **Assign to Groups:** Assign Tool Catalogues to specific [teams](/ai-management/ai-studio/user-management). This grants users in those groups *potential* access to the tools within the catalogue.
