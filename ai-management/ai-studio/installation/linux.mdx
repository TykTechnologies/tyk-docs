...
<Note>
**Important:** After generating the configuration files and before starting up the services, you **must** update these files with the secrets created in the [Generate Secrets](#generate-secrets) step. Additionally, as this is an Enterprise deployment, you must update the license key environment variable.
