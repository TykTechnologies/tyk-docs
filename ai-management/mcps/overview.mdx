...
<Note>
To govern AI agent traffic to MCP servers, including remote servers you don't run yourself, see [MCP Gateway](/ai-management/mcp-gateway/overview). It covers authentication, per-tool access control, rate limiting and observability.
</Note>
