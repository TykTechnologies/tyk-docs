...
<Note>
This page covers exposing your own Tyk-managed APIs as an MCP server. To govern AI agent traffic to remote MCP servers you don't run yourself, such as GitHub Copilot or Slack, see [MCP Gateway](/ai-management/mcp-gateway/overview) instead.
</Note>
