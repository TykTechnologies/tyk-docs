...
description: "Explore APIs, review policies, and audit users and keys in Tyk Dashboard by asking an AI assistant in plain language."
keywords: "AI MCP, Dashboard API-to-MCP, Tyk Dashboard API MCP, Dashboard API, Talk to Tyk Dashboard, AI Management"
sidebarTitle: "Tyk Dashboard MCP"
canonical: "https://tyk.io/docs/ai-management/mcps/dashboard-api-to-mcp"
---

## Overview

Use `tyk-dashboard-mcp` to expose your **Tyk Dashboard API** to AI assistants like Claude, Cursor, or VS Code extensions, for natural-language interaction with your Tyk Dashboard.

This tool is a preconfigured fork of the [api-to-mcp GitHub repository](https://github.com/TykTechnologies/api-to-mcp), designed specifically for the *Tyk Dashboard* API. It comes bundled with a predefined OpenAPI spec and overlays, so you don’t need to configure much manually.
  ...
  "mcpServers": {
    "tyk-dashboard-api": {
      ...
      "args": [
        ...
        "--headers",
        "{\"Authorization\":\"{dashboard-API-key}\"}"
      ],
      "enabled": true
    }
  }
