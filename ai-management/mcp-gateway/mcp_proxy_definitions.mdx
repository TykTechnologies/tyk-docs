...
- [MCP API configuration](/ai-management/mcp-gateway/mcp_api_extensions) — Complete field reference for every option in the `x-tyk-api-gateway` extension for MCP proxies.
