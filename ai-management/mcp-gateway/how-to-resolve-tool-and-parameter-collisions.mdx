...
description: "Find out which tool and parameter name collisions Tyk fixes automatically in REST API to MCP proxies, which fail with an error, and how to fix them."
