...
- [MCP OAS definition](/ai-management/mcp-gateway/mcp-proxy-definitions) — The complete structure of the `x-tyk-api-gateway` extension for MCP proxies — every field explained.
