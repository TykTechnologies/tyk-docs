...
See [REST API to MCP OAS definition](/ai-management/mcp-gateway/api-to-mcp-definitions) for the full field reference.
</Note>
...
This page covers definition structure shared by both proxy types. For the full `x-tyk-mcp-server` field reference and worked examples, see [REST API to MCP OAS definition](/ai-management/mcp-gateway/api-to-mcp-definitions).
