...
- **Restrict tool access**: Configure a tool allowlist so agents can only call the tools you have approved. See [Security Hardening Checklist](/ai-management/mcp-gateway/how-to-proxy-remote-mcp).
