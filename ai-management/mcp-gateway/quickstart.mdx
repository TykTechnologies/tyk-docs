...
2. **Name your proxy.** Enter `Mock MCP Server`. Tyk derives the listen path from the name automatically.

    Click **Continue**.

    ![Name your MCP proxy](/img/ai-management/mcp-quickstart-name-server.png)

3. **Set the upstream URL.** Enter `http://localhost:7878/mcp`.

    Click **Continue**.

    ![Set the upstream URL](/img/ai-management/mcp-quickstart-server-url.png)

4. **Connect gateways.** Select your gateway instances, or leave blank to deploy to all gateways.
...
{/* TODO: Add screenshot of MCP Inspector Tools tab showing the 15 tools listed, and the get_users response */}
