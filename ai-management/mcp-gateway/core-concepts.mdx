...
- [MCP OAS definitions](/ai-management/mcp-gateway/mcp-proxy-definitions): The full structure of the proxy definition, including all middleware maps and field reference.
...
- [Managing MCP proxies](/ai-management/mcp-gateway/managing-proxies): Create, update, and delete MCP proxies in the Dashboard.
