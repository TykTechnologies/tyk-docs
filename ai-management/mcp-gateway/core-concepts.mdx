...
You manage MCP proxy definitions through the [Tyk Gateway API](/ai-management/mcp-gateway/mcp_api_extensions) (at `/tyk/mcps`) or the [Tyk Dashboard](/ai-management/mcp-gateway/managing-proxies). For the full definition structure and field reference, see [MCP OAS definitions](/ai-management/mcp-gateway/mcp_proxy_definitions).
