...
description: "Add key authentication to an MCP proxy, issue an API key, and confirm that MCP Inspector gets a 401 error without the key. Takes about ten minutes."
