...
description: "Choose the right signal to monitor MCP traffic in Tyk: OpenTelemetry metrics, structured access logs, distributed traces, or Dashboard analytics."
