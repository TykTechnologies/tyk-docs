...
> For an explanation of how middleware fits into the overall MCP OAS definition structure (the three levels, their evaluation order, and how they interact), see [MCP definitions](/ai-management/mcp-gateway/mcp-proxy-definitions).
