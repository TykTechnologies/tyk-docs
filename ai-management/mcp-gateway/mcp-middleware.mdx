...
Plugins are loaded from the path specified or from a bundle configured in the global `pluginConfig` section. See [Custom plugins](/docs/plugins) for the full plugin development guide.
...
- [Custom plugins](/docs/plugins) — Building and deploying Go or JavaScript plugins for advanced use cases.
