...
- [MCP API extensions](/ai-management/mcp-gateway/mcp-api-extensions): Dashboard API and Gateway API endpoint reference for scripted or automated management.
...
- [MCP OAS definition](/ai-management/mcp-gateway/mcp-proxy-definitions): Every field in the `x-tyk-api-gateway` extension explained in full.
