...
- [MCP OAS definition](/ai-management/mcp-gateway/mcp-proxy-definitions): full structure of the Tyk OAS API definition, including the `server` and `upstream` sections where authentication is configured.
