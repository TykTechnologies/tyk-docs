...
Tyk supports Token Based Authentication in gRPC. See [Auth Tokens](/api-management/authentication/auth-token) to configure Token Based Authentication in Tyk. 
