...
Tyk supports Mutual Authentication in gRPC. See [Mutual TLS](/api-management/authentication-authorization#enable-mutual-tls) to configure Mutual Authentication in Tyk. 

### Basic Authentication
Tyk supports Basic Authentication in gRPC. See [Basic Authentication](/api-management/authentication-authorization#use-basic-authentication) to configure Basic Authentication in Tyk. 
...
Tyk supports Token Based Authentication in gRPC. See [Bearer Tokens](/api-management/authentication-authorization#use-bearer-tokens) to configure Token Based Authentication in Tyk. 
