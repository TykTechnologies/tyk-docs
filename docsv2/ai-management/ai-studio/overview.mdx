...
- Use the [AI Gateway](/docsv2/docsv2/ai-management/ai-studio/proxy) to enable secure, scalable access to AI services across teams
...
[Remote MCP server capabilities](/docsv2/docsv2/ai-management/mcps/overview#mcp-for-enterprise-use) - AI Studio can expose a remote MCP server, making it simple for enterprises to connect their internal APIs and tools securely and centrally, without relying on makeshift solutions or unauthorized local installations.

For more details about Model Context Protocol (MCP) integration, please visit the [Tyk MCPs overview](/docsv2/docsv2/ai-management/mcps/overview) page.
