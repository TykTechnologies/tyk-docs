...
Make sure that your CORS in the `Advanced Options` of the API is enabled and the settings are correct. This means:
 ...
 - [CORS in API Definition](/docsv2/5.7/api-management/gateway-config-tyk-classic#cross-origin-resource-sharing-cors)
 - [How to setup CORS](/docsv2/5.7/api-management/troubleshooting-debugging#how-to-setup-cors) 
