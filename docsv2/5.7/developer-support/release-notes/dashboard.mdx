...
| ---------------------------------------------------------- | ---------------------- | ---------------------- | -------- | 
| [GoLang](https://go.dev/dl/)                               | 1.23       | 1.23       | [Go plugins](/docsv2/5.7/api-management/plugins/golang) must be built using Go 1.23 | 
...
| [OpenAPI Specification](https://spec.openapis.org/oas/v3.0.3) | v3.0.x      | v3.0.x          | Supported by [Tyk OAS](/docsv2/5.7/api-management/gateway-config-tyk-oas#tyk-vendor-extension-reference)|
...
- [Docker Image to pull](https://hub.docker.com/r/tykio/tyk-dashboard/tags?page=&page_size=&ordering=&name=v5.8.1)
  - ```bash
    ...
    ```
- Helm charts
  - [tyk-charts v3.0.0](/docsv2/5.7/developer-support/release-notes/helm-chart#300-release-notes)
...
| [OpenAPI Specification](https://spec.openapis.org/oas/v3.0.3) | v3.0.x      | v3.0.x          | Supported by [Tyk OAS](/docsv2/5.7/api-management/gateway-config-tyk-oas)|
...
- [Docker Image to pull](https://hub.docker.com/r/tykio/tyk-dashboard/tags?page=&page_size=&ordering=&name=v5.7.2)
  - ```bash
    ...
    ```
- Helm charts
  - [tyk-charts v2.2.0](/docsv2/5.7/developer-support/release-notes/helm-chart#220-release-notes)
...
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| ---------------------------------------------------------- | ---------------------- | ---------------------- | -------- | 
| [GoLang](https://go.dev/dl/)                               | 1.22       | 1.22       | [Go plugins](/docsv2/5.7/api-management/plugins/golang#) must be built using Go 1.22 | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | Used by Tyk Dashboard | 
| [MongoDB](https://www.mongodb.com/try/download/community)  | 5.0.x, 6.0.x, 7.0.x  | 5.0.x, 6.0.x, 7.0.x  | Used by Tyk Dashboard | 
| [PostgreSQL](https://www.postgresql.org/download/)         | 12.x - 16.x LTS        | 12.x - 16.x            | Used by Tyk Dashboard | 
| [OpenAPI Specification](https://spec.openapis.org/oas/v3.0.3) | v3.0.x      | v3.0.x          | Supported by [Tyk OAS](/docsv2/5.7/api-management/gateway-config-tyk-oas)|
...
In 5.7.0, we have deprecated the dedicated [External OAuth](/docsv2/5.7/api-management/client-authentication#integrate-with-external-authorization-server-deprecated)  (Tyk Classic: `external_oauth`, Tyk OAS: `server.authentication.securitySchemes.externalOAuth`) and [OpenID Connect](/docsv2/5.7/api-management/client-authentication#integrate-with-openid-connect-deprecated)  (Tyk Classic: `auth_configs.oidc`, Tyk OAS: `server.authentication.oidc`) authentication methods. We advise users to switch to [JWT Authentication](/docsv2/5.7/basic-config-and-security/security/authentication-authorization/json-web-tokens).
...
[Setup guide for JWE OIDC SSO](/docsv2/5.7/api-management/external-service-integration#log-into-an-app-with-github-oauth)
</Accordion>
...
For detail usage of the `/audit-logs` endpoint, please see [Dashboard API documentation](/docsv2/5.7/tyk-dashboard-api).
</Accordion>
...
- ```bash
  ...
  ```
- Helm charts
  - [Tyk Charts v2.0.0](/docsv2/5.7/developer-support/release-notes/helm-chart#200-release-notes)
...
Now you can configure rate limits at the [endpoint level per client](/docsv2/5.7/api-management/rate-limit#key-level-rate-limiting), using new configuration options in the access key. Use Tyk's powerful [security policies](/docsv2/5.7/api-management/policies#what-is-a-security-policy) to create templates to set appropriate rate limits for your different categories of user.
...
We encourage users to switch to the recommended alternatives. For more detailed information, please refer to the [Documentation](/docsv2/5.7/api-management/client-authentication#integrate-with-openid-connect-deprecated)
...
- ```bash
  ...
  ```
- Helm charts
  - [tyk-charts v2.1.0](/docsv2/5.7/developer-support/release-notes/helm-chart#210-release-notes)
...
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| ---------------------------------------------------------- | ---------------------- | ---------------------- | -------- | 
| [GoLang](https://go.dev/dl/)                               | 1.21       | 1.21       | [Go plugins](/docsv2/5.7/api-management/plugins/golang#) must be built using Go 1.21 | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | Used by Tyk Dashboard | 
| [MongoDB](https://www.mongodb.com/try/download/community)  | 5.0.x, 6.0.x, 7.0.x  | 5.0.x, 6.0.x, 7.0.x  | Used by Tyk Dashboard | 
| [PostgreSQL](https://www.postgresql.org/download/)         | 12.x - 16.x LTS        | 12.x - 16.x            | Used by Tyk Dashboard | 
| [OpenAPI Specification](https://spec.openapis.org/oas/v3.0.3) | v3.0.x      | v3.0.x          | Supported by [Tyk OAS](/docsv2/5.7/api-management/gateway-config-tyk-oas)|
...
Now configure rate limits at the endpoint level for both [Tyk OAS](/docsv2/5.7/api-management/rate-limit#tyk-oas-api-definition) and [Tyk Classic APIs](/docsv2/5.7/api-management/rate-limit#tyk-classic-api-definition), providing granular protection for upstream services against overloading and abuse.
...
- ```bash
  ...
  ```
- Helm charts
  - [tyk-charts v1.6](/docsv2/5.7/developer-support/release-notes/helm-chart#160-release-notes)
...
- ```bash
  ...
  ```
- Helm charts
  - [tyk-charts v1.5](/docsv2/5.7/developer-support/release-notes/helm-chart#150-release-notes)
...
This is an advanced notice that the dedicated External OAuth, OpenID Connect (OIDC) authentication options, and SQLite support will be deprecated starting in version 5.7.0. We recommend that users of the [External OAuth](/docsv2/5.7/api-management/client-authentication#integrate-with-external-authorization-server-deprecated) and [OpenID Connect](/docsv2/5.7/api-management/client-authentication#integrate-with-openid-connect-deprecated) methods migrate to Tyk's dedicated [JWT Auth](/docsv2/5.7/basic-config-and-security/security/authentication-authorization/json-web-tokens) method. Please review your API configurations, as the Gateway logs will provide notifications for any APIs utilizing these methods.
...
The UI now displays a deprecation notice for the dedicated [External OAuth](/docsv2/5.7/api-management/client-authentication#integrate-with-external-authorization-server-deprecated) and [OpenID Connect (OIDC)](/docsv2/5.7/api-management/client-authentication#integrate-with-openid-connect-deprecated) authentication mechanisms. This provides advanced notification that these authentication options will be deprecated in version 5.7.0. Users are advised to migrate to the [JWT Auth](/docsv2/5.7/basic-config-and-security/security/authentication-authorization/json-web-tokens) method, which supports integration with both OAuth and OIDC providers, in preparation for future upgrade.
</Expandable>
</li>
</ul>
...
- [Docker Image to pull](https://hub.docker.com/r/tykio/tyk-dashboard/tags?page=&page_size=&ordering=&name=v5.3.6)
 - ```bash
   ...
   ```
- Helm charts
 - [tyk-charts v2.0](/docsv2/5.7/developer-support/release-notes/helm-chart#200-release-notes)
...
- [Docker Image to pull](https://hub.docker.com/r/tykio/tyk-dashboard/tags?page=&page_size=&ordering=&name=v5.3.4)
 - ```bash
   ...
   ```
- Helm charts
 - [tyk-charts v1.4](/docsv2/5.7/developer-support/release-notes/helm-chart#140-release-notes)
...
- ```bash
  ...
  ```
- Helm charts
  - [tyk-charts v1.3](/docsv2/5.7/developer-support/release-notes/helm-chart#130-release-notes)
...
This upgrade transitions Tyk OAS APIs out of [Early Access](/docsv2/5.7/developer-support/release-types/early-access-feature).
...
1. For Self Managed deployments - Backup Your environment using the [usual guidance](/docsv2/5.7/developer-support/upgrading#tyk-upgrade-guides-for-different-deployment-models) documented with every release (this includes backup config file and database).
2. For all deployments - Backup all your API definitions (Tyk OAS API and Classic Definitions):
   - For Tyk Cloud deployments - To perform the backup please use our guide for [exporting APIs and policies](/docsv2/5.7/developer-support/upgrading#backup-apis-and-policies).
   - For Self-Managed deployments -  To perform the backup please use [Tyk Sync](/docsv2/5.7/api-management/automations/sync).
...
Tyk OAS is now out of [Early Access](/docsv2/5.7/developer-support/release-types/early-access-feature) as we have reached feature maturity. You are now able to make use of the majority of Tyk's features from your Tyk OAS APIs, so they are a credible alternative to the legacy Tyk Classic APIs.
...
Tyk uses `mongo-go` as the default MongoDB driver from v5.3. This provides support for MongoDB 4.4.x, 5.0.x, 6.0.x and 7.0.x. If you are using older MongoDB versions e.g. 3.x, please set MongoDB driver to `mgo`. The [MongoDB supported versions](/docsv2/5.7/tyk-self-managed#supported-versions) page provides details on how to configure MongoDB drivers in Tyk.
</Accordion>
</AccordionGroup>
</li>
</ul>
...
Relaxed the strict validation for mock response so that the `Description` field is now optional for `response`, `responses` and `schema` within the OpenAPI description. Automatically configuring mock responses when using [Tyk OAS APIs](/docsv2/5.7/api-management/traffic-transformation#mock-responses-using-openapi-metadata) is now even easier.
</Accordion>
...
#### Release Highlights
Dashboard 5.2.5 was version bumped only, to align with Gateway 5.2.5. Subsequently, no changes were encountered in release 5.2.5. Gateway 5.2.5 was a critical patch release. For further information please see the release notes for Gateway [v5.2.5](/docsv2/5.7/developer-support/release-notes/gateway) 
...
Fixed two UI issues with the [OPA editor](/docsv2/5.7/api-management/dashboard-configuration#using-the-open-policy-agent-in-the-dashboard) in the Tyk Dashboard to improve experience when using this feature. Scrolling beyond the end of the OPA window does not now start to scroll the API Designer window, and minimizing then re-expanding the OPA editor no longer limits the text to one line.
</Accordion>
...
Fixed an issue where the [OPA editor](/docsv2/5.7/api-management/dashboard-configuration#using-the-open-policy-agent-in-the-dashboard) was not resizable. The fix ensures the floating OPA editor is now resizable and the resizing operation is smooth, improving user experience.
</Accordion>

<Accordion title={'User Search not working unless you enter the full email address'}>
Fixed an issue where the [User Search](/docsv2/5.7/api-management/user-management#search-users) was not working unless the full email address was entered. The fix restores the functionality of showing suggestions for names as they are typed in, improving user experience and search efficiency.
</Accordion>
...
Fixed an issue in the Classic API Designer where the 'use_standard_auth' value was constantly reverting to 'true' when editing an API with an [external OAuth flow](/docsv2/5.7/api-management/client-authentication#integrate-with-external-authorization-server-deprecated). This fix ensures the 'use_standard_auth' value remains consistent, enabling the use of external OAuth via the Raw API editor.
</Accordion>
...
Added a new Dashboard configuration option `allow_unsafe_oas`. This permits the modification of Tyk OAS APIs via the Tyk Classic API endpoints. This is not a recommended action due to the risk of inconsistent behavior and potential for breaking changes while Tyk OAS is in [Early Access](/docsv2/5.7/developer-support/release-types/early-access-feature). This is provided for early adopters and will be deprecated later, once Tyk OAS reaches full maturity.
</Expandable>
</li>
</ul>
...
We’ve added the ability to [configure](/docsv2/5.7/api-management/response-caching#configuring-the-middleware-in-the-tyk-oas-api-definition) per-endpoint timeouts for Tyk’s response cache, giving you increased flexibility to tailor your APIs to your upstream services. While doing this, we’ve also fixed a longstanding issue within the *Tyk Dashboard* so that you can configure more of the [advanced caching](/docsv2/5.7/api-management/response-caching#configuring-the-middleware-in-the-api-designer) options from within the UI.

##### Added Body Transform Middleware to Tyk OAS API Definition

With this release, we are adding the much requested *Body Transformations* to *Tyk OAS API Definition*. You can now [configure](/docsv2/5.7/api-management/gateway-config-tyk-oas#transformbody) middleware for both [request](/docsv2/5.7/api-management/traffic-transformation#request-body-overview) and [response](/docsv2/5.7/api-management/traffic-transformation#response-body-overview) *Body Transformations* and - as a *Tyk Dashboard* user - you’ll be able to do so from within our simple and elegant API Designer tool. Visually test and preview *Body Transformations* from within the API Designer.
...
Added a new [endpoint](/docsv2/5.7/tyk-dashboard-api), */system/stats*, to provide insight and operational statistics on total and active APIs deployed. The endpoint's flexible date filtering options, equip users to obtain comprehensive insights into usage trends.
</Expandable>
</li>
</ul>
...
Fixed an issue where the [Enforced Timeout](/docsv2/5.7/tyk-self-managed#enforced-timeouts) configuration parameter of an API endpoint accepted negative values, without displaying validation errors. With this fix, users receive clear feedback and prevent unintended configurations.
</Accordion>
...
documentation for a full description of this new [user role](/docsv2/5.7/api-management/user-management#user-permissions).

##### Import API examples from within the Dashboard

In 5.0 we introduced the possibility to import API examples manually or via
[_Tyk Sync_](/docsv2/5.7/api-management/automations/sync). We have now extended this feature and it is now possible to do this without
...
We added a [Dashboard API Endpoint](/docsv2/5.7/api-management/data-graph#automatically-creating-rest-udg-configuration-based-on-oas-specification) that is capable of taking an OAS 3.0.0 document and converting it into a UDG API.
...
size using [slave_options.rpc_pool_size](/docsv2/5.7/tyk-oss-gateway/configuration#slave_optionsrpc_pool_size)
...
- Added a feature to display a full [_Tyk Sync_](/docsv2/5.7/api-management/automations/sync) command that will allow a user to import an example UDG into their Dashboard
...
Go to the [Upgrading Tyk](/docsv2/5.7/developer-support/release-notes/gateway#upgrading-tyk) section for detailed upgrade instructions.
...
See how to [Choose a MongoDB driver](/docsv2/5.7/tyk-self-managed#choose-a-mongodb-driver)
...
We’ve improved support for [OAS Mock Responses](/docsv2/5.7/api-management/traffic-transformation#mock-response-overview), with the Tyk OAS API definition now allowing you to register multiple Mock Responses in a single API, providing you with increased testing flexibility.
...
- via command line [using tyk-sync](/docsv2/5.7/api-management/data-graph#udg-examples)
...
With this release we are also giving our users [improved headers for GQL APIs](/docsv2/5.7/api-management/graphql#graphql-apis-headers). It is now possible to use context variables in request headers and persist headers needed for introspection separately for improved security.
...
- Now you can turn a Kafka topic into a GraphQL subscription by simply [importing your AsyncAPI definition](/docsv2/5.7/api-management/dashboard-configuration#data-graphs-api)
...
[Importing OAS v3 via the Dashboard](/docsv2/5.7/api-management/gateway-config-managing-oas#importing-an-openapi-description-to-create-an-api)
...
Follow the [standard upgrade guide](/docsv2/5.7/developer-support/upgrading), there are no breaking changes in this release.

If you want switch from MongoDB to SQL, you can [use our migration tool](/docsv2/5.7/tyk-self-managed#migrating-from-an-existing-mongodb-instance), but keep in mind that it does not yet support the migration of your analytics data.


<Note>
Note: Upgrading the Golang version implies that all the Golang custom plugins that you are using need to be recompiled before migrating to 4.3 version of the Gateway. Check our docs for more details [Golang Plugins](/docsv2/5.7/api-management/plugins/golang).
</Note>
...
Tyk has always had a proprietary specification for defining APIs. From Tyk v4.1 we now support defining APIs using the Open API Specification (OAS) as well, which can offer significant time and complexity savings. [This is an early access capability](/docsv2/5.7/developer-support/release-types/early-access-feature).
...
This capability is available in both the open source and paid versions of Tyk. See our [Tyk OAS documentation](/docsv2/5.7/api-management/gateway-config-tyk-oas) for more details.
...
- Added option to configure certificates for Tyk Dashboard using [environment variables](/docsv2/5.7/tyk-dashboard/configuration#http_server_optionscertificates).
...
[Federation docs](/docsv2/5.7/api-management/graphql#overview-1)

[Subgraphs and Supergraphs docs](/docsv2/5.7/api-management/graphql#subgraphs-and-supergraphs)
...
[Subscriptions docs](/docsv2/5.7/api-management/graphql#graphql-subscriptions)
...
While SQL support for Tyk products does not depend on specific database features, with this release, we will provide official support for [PostgreSQL DB for production purposes](/docsv2/5.7/tyk-self-managed#postgresql), and SQLite for development and PoC environments. Note that SQL support is available for self-managed setups only.
...
[MongoDB to SQL migration docs](/docsv2/5.7/tyk-self-managed#migrating-from-an-existing-mongodb-instance)
...
Check our DCR docs [here](/docsv2/5.7/tyk-developer-portal/tyk-portal-classic/dynamic-client-registration)
...
We've updated the GraphQL functionality of our [Universal Data Graph](/docsv2/5.7/api-management/data-graph#overview). You’re now able to deeply nest GraphQL & REST APIs and stitch them together in any possible way.

Queries are now possible via WebSockets and Subscriptions are coming in the next Release (3.3.0).

You're also able to configure [upstream Headers dynamically](/docsv2/5.7/api-management/data-graph#header-forwarding), that is, you’re able to inject Headers from the client request into UDG upstream requests. For example, it can be used to acccess protected upstreams. 
...
#### Upgrade process
If you already have GraphQL or UDG APIs you need to follow this [upgrade guide](/docsv2/5.7/api-management/graphql#migrating-to-32).
...
This follows the recent changes that we have made to embed TIB (Tyk Identity Broker)in the dashboard. See 3.0 [release notes](/docsv2/5.7/developer-support/release-notes/dashboard#tyk-identity-broker-now-built-in-to-the-dashboard) for more information regarding this. 

To learn more [see the documentation](/docsv2/5.7/api-management/external-service-integration)
...
Docs [here](/docsv2/5.7/api-management/graphql#syncing-gql-schema)
...
Docs [here](/docsv2/5.7/api-management/graphql#graphql-playground)
...
[Docs here](/docsv2/5.7/tyk-developer-portal/tyk-portal-classic/key-requests)
...
See our updated [Tutorials](/docsv2/5.7/tyk-self-managed) section.
...
Read more about the [GraphQL](/docsv2/5.7/api-management/graphql) and [Universal Data Graph](/docsv2/5.7/api-management/data-graph#overview)
...
See updated tutorials on how to [create a policy](/docsv2/5.7/api-management/gateway-config-managing-classic#secure-an-api) and [keys](/docsv2/5.7/api-management/gateway-config-managing-classic#access-an-api)
...
See [updated flow details](/docsv2/5.7/api-management/external-service-integration#what-is-tyk-identity-broker-tib)
...
[Read more](/docsv2/5.7/tyk-self-managed#manage-multi-environment-and-distributed-setups)
...
At the moment the Response hook is supported for [Python and gRPC plugins](/docsv2/5.7/api-management/plugins/rich-plugins#coprocess-dispatcher---hooks).
...
[Read More](/docsv2/5.7/tyk-self-managed#set-up-liveness-health-checks)
...
[Read More](/docsv2/5.7/api-management/troubleshooting-debugging#capturing-detailed-logs)
...
[Read More](/docsv2/5.7/tyk-self-managed#configure-load-balancing-and-weighting-via-the-dashboard)
...
[Read More](/docsv2/5.7/api-management/tyk-pump#tyk-pump-configuration)
...
If you are upgrading from version 2.8, pls [read this guide](/docsv2/5.7/developer-support/release-notes/archived#upgrading-from-version-28)


## Further Information

### Upgrading Tyk
Please refer to the [upgrading Tyk](/docsv2/5.7/developer-support/upgrading) page for further guidance on the upgrade strategy.
...
- [OpenAPI Document](/docsv2/5.7/tyk-dashboard-api)
- [Postman Collection](https://www.postman.com/tyk-technologies/workspace/tyk-public-workspace/overview)

### FAQ

Please visit our [Developer Support](/docsv2/5.7/developer-support/community) page for further information relating to reporting bugs, upgrading Tyk, technical support and how to contribute.
