...
Recommended usage:
Tyk Dashboard setting: [allow-unsafe-oas](/docsv2/5.7/tyk-dashboard/configuration#allow_unsafe_oas)
Tyk Sync: use the [--allow-unsafe-oas](/docsv2/5.7/api-management/automations/sync) when invoking the CLI
