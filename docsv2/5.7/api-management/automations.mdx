...
- **A Tyk installation** (Self-Managed or Cloud)
  - If you don't have Tyk installed, follow our [installation guide](/docsv2/5.7/tyk-self-managed#installation-options-for-tyk-self-managed)
...
- **Tyk Dashboard v3+ access** (for Tyk Sync setup)
  - Learn how to set up the Tyk Dashboard [here](/docsv2/5.7/tyk-dashboard)
...
<Card href="/docsv2/5.7/api-management/automations/sync" img="/img/GitHub-Mark-64px.png">
**Read time: 10 mins**

Synchronize Tyk Environment With GitHub using Tyk Sync.
</Card>

<Card href="/docsv2/5.7/api-management/automations/operator" img="/img/k8s.png">
**Read time: 10 mins**
