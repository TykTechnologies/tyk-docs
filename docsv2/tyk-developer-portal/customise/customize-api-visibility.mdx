...
## Prerequisites
1. You have an API created in your Dashboard. See [Create an API](/docsv2/docsv2/api-management/gateway-config-managing-classic#create-an-api) for more details.
...
This flag can also be [set programatically](/docsv2/docsv2/tyk-developer-portal/tyk-portal-classic/customise/custom-developer-portal#updating-a-developer-example-adding-custom-fields).
