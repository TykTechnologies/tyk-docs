...
Refer to the [Tyk Gateway Configuration Reference](/docsv2/docsv2/tyk-oss-gateway/configuration#enforce_org_quotas) for more details on this setting.
...
Refer to the [Tyk OAS API Definition reference](/docsv2/docsv2/api-management/gateway-config-tyk-oas#global) for details.
...
Refer to the [Tyk Classic API Definition reference](/docsv2/docsv2/api-management/gateway-config-tyk-classic) for details.
