...
- [How to create UDG schema](/docsv2/docsv2/api-management/data-graph#creating-schema)
- [How to connect data sources](/docsv2/docsv2/api-management/data-graph#connect-datasource)
- [How to secure the data graph](/docsv2/docsv2/api-management/data-graph#security)
...
Head over to the [connect data source](/docsv2/docsv2/api-management/data-graph#udg) section to learn about the supported data sources and how to connect them to Tyk.
...
* [UDG Arguments](/docsv2/docsv2/api-management/data-graph#arguments)
* [UDG Datasources](/docsv2/docsv2/api-management/data-graph#udg)
...
See [Concept: Arguments](/docsv2/docsv2/api-management/data-graph#arguments) to learn more about it.
 ```
...
Global headers now have access to all [request context variables](/docsv2/docsv2/api-management/traffic-transformation#request-context-variables).
...
Data source headers now have access to all [request context variables](/docsv2/docsv2/api-management/traffic-transformation#request-context-variables).
...
Above steps are explained in detail in our [Getting started pages](/docsv2/docsv2/api-management/data-graph#connect-datasource).
...
For this tutorial we'll mitigate these risks using `Query Depth Limit` but you can also use common strategies like rate limiting and throttling, which you can read more about [here](/docsv2/api-management/rate-limit)
...
2. **Applying to query depth**
    ...
    Although we can directly create keys by selecting this API but we'll use policy as it will make it easier to update keys for this API in future. You can read more about policies [here](/docsv2/api-management/policies#what-is-a-security-policy)
...
We offer 3 ways of importing an example into Tyk:
 - Using [tyk-sync](/docsv2/docsv2/api-management/automations/sync#synchronize-api-configurations-with-github-actions)
 - Manually import via [Dashboard API Import](/docsv2/docsv2/api-management/gateway-config-managing-classic#import-an-api)
- Using Tyk Dashboard to browse and import the examples directly

#### Import via tyk-sync

Please follow the [tyk-sync documentation](/docsv2/docsv2/api-management/automations/sync#examples-publish-command) to learn more about this approach.
...
You can find more detailed instructions in the [Dashboard API Import documentation section](/docsv2/docsv2/api-management/gateway-config-managing-classic#import-an-api).
