...
Make sure that your CORS in the `Advanced Options` of the API is enabled and the settings are correct. This means:
 ...
 - [CORS in API Definition](/docsv2/docsv2/api-management/gateway-config-tyk-classic#cross-origin-resource-sharing-cors)
 - [How to setup CORS](/docsv2/docsv2/api-management/troubleshooting-debugging#how-to-setup-cors) 
