...
For more details, refer to the [OIDC SSO with JWE](/docsv2/nightly/docsv2/nightly/api-management/external-service-integration#social-profile-fields) documentation.
</Expandable>
</li>
