...
Learn more:
* [Tutorial: Create an API in File-based Mode](/docsv2/nightly/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
Learn more:
* [Tutorial: Create an API with the Dashboard](/docsv2/nightly/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
Learn more:
- [Dashboard API](/docsv2/nightly/api-management/dashboard-configuration#exploring-the-dashboard-api)
- [Gateway API](/docsv2/nightly/tyk-gateway-api)
...
Learn more:
- [Tyk Sync](/docsv2/nightly/api-management/automations/sync)
...
Learn more:
- [Tyk Operator](/docsv2/nightly/api-management/automations/operator#what-is-tyk-operator)
- [Using Tyk Operator to enable GitOps with Tyk](/docsv2/nightly/api-management/automations)
