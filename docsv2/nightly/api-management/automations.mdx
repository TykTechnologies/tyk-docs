...
- **A Tyk installation** (Self-Managed or Cloud)
  - If you don't have Tyk installed, follow our [installation guide](/docsv2/nightly/docsv2/nightly/tyk-self-managed#installation-options-for-tyk-self-managed)
...
- **Tyk Dashboard v3+ access** (for Tyk Sync setup)
  - Learn how to set up the Tyk Dashboard [here](/docsv2/nightly/docsv2/nightly/tyk-dashboard)
