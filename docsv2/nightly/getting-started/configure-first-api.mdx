...
Congratulations! You've successfully created, secured, and deployed your first API in Tyk Cloud. Next, explore more advanced features such as adding [rate limiting](/docsv2/nightly/docsv2/nightly/api-management/rate-limit#introduction) to protect your API from abuse.

Explore more features in your [dashboard](/docsv2/nightly/docsv2/nightly/getting-started/using-tyk-dashboard) to optimize and scale your API offerings.
