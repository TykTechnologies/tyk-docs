...
- **[API to MCP](/docsv2/nightly/ai-management/mcps/api-to-mcp)** – Convert existing APIs (via OpenAPI/Swagger specs) into MCP-accessible tools.
- **[Dashboard API to MCP](/docsv2/nightly/ai-management/mcps/dashboard-api-to-mcp)** – Expose the Tyk Dashboard API for management and monitoring.
- **[Tyk Docs MCP](/docsv2/nightly/ai-management/mcps/tyk-docs-mcp)** – Provide AI access to searchable Tyk documentation.
