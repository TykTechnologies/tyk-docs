...
*   **Chat Interface:** Access to all [Chat Experiences](/docsv2/nightly/ai-management/ai-studio/chat-interface) the user has permission to use, with a clean, intuitive UI for conversational interactions.
