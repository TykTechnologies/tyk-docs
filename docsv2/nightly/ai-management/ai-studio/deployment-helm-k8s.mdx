...
sidebarTitle: "Installation (Helm/K8s)"
...
Once deployed, proceed to the [Initial Configuration](/docsv2/nightly/docsv2/nightly/ai-management/ai-studio/configuration) guide to set up Tyk AI Studio.
