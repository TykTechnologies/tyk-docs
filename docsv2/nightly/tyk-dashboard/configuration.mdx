...
To understand how the environment variables notation works, see [Environment Variables](/docsv2/nightly/tyk-oss-gateway/configuration).
...
Please consult the [data storage configuration](/docsv2/nightly/api-management/dashboard-configuration#data-storage-solutions) guide for further information relating to how to configure Tyk's data storage across different database engines.
