...
You should also look at the [portal tutorial](/docsv2/nightly/docsv2/nightly/getting-started/tutorials/publish-api) for creating an API and publishing it to your Portal.
