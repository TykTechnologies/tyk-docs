...
`bundle_base_url` must point at your Tyk Cloud Control Plane's File Server endpoint, with your File Server API key passed as the `api_key` query parameter. You can find both values on your Control Plane, as described in [Uploading your Bundle](#uploading-your-bundle).
