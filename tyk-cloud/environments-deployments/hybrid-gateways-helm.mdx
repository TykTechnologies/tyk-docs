...
<Warning>
`tyk-hybrid` chart is deprecated. Please use our [Tyk Data Plane helm chart](/tyk-cloud/environments-deployments/hybrid-gateways#deploy-in-kubernetes-with-helm-chart) instead. 
...
Now it is time to publish a new API [Task 5 - Deploy your Cloud Data Plane and add your first API](/tyk-cloud/getting-started-tyk-cloud/first-api.md)
