...
A set of data and access permissions that can be applied to a user or team of users. See [User Roles](/tyk-cloud/teams-&-users/user-roles) for more details.
...
See [User Roles](/tyk-cloud/teams-&-users/user-roles) for more details
