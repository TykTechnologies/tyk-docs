...
This feature is built on Tyk Gateway's OpenTelemetry integration. See the [OpenTelemetry documentation](/api-management/traces#opentelemetry-tracing) for configuration options and sampling strategies.
