...
This feature is built on Tyk Gateway's OpenTelemetry integration. See the [OpenTelemetry documentation](/api-management/traces#opentelemetry) for configuration options and sampling strategies.
...
2. In the telemetry export section, enable the types you want:
    ...
    - **Enable Metrics**: Enable gateway metrics export (requires Gateway v5.13.0 or later). See [Default Metrics Exported](#default-metrics-exported) for what is included.
