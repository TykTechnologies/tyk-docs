...
<Note>
Metric customization (additional dimensions, filtering) is not self-service. Customers must raise a support request to Tyk at [support.tyk.io](https://support.tyk.io/).
