...
The following [user roles](/tyk-cloud/teams-&-users/user-roles.md) can perform existing User Admin tasks:

* [Organization Admin](/tyk-cloud/teams-&-users/user-roles.md#user-roles-within-tyk-cloud) - Can manage all users in the organization they are a member of.
* [Team Admin](/tyk-cloud/teams-&-users/user-roles.md#user-roles-within-tyk-cloud) - Can only manage the users of the team they are a member of.
