...
The following [user roles](/tyk-cloud/teams-&-users/user-roles) can perform existing User Admin tasks:

* [Organization Admin](/tyk-cloud/teams-&-users/user-roles#user-roles-within-tyk-cloud) - Can manage all users in the organization they are a member of.
