...
The following [user roles](/tyk-cloud/teams-&-users/user-roles.md) can perform existing Team Admin tasks:
...
You need to be a [Organization Admin](/tyk-cloud/teams-&-users/user-roles.md#user-roles-within-tyk-cloud) to create a new team.
...
You need to be a [Organization Admin](/tyk-cloud/teams-&-users/user-roles.md#user-roles-within-tyk-cloud) to delete a team.
...
You can now invite users to your new team. See [Managing Users](/tyk-cloud/teams-&-users/managing-users.md) for more details.
