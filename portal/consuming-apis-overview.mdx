...
- The **Live Portal** is the public-facing website where API Consumers browse API Catalogs, request access to API Products, manage their credentials, and create [Developer Apps](/portal/developer-app).
- The **Admin Portal** is the private management interface used by [API Owners](/portal/api-owner) and Portal Admins to configure the Portal, curate API Products, and manage access requests.
