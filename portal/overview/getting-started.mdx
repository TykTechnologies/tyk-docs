...
The Developer Portal acts as a client to the Tyk Dashboard API. For a detailed explanation of this architecture and how data flows between the Portal, Dashboard, and Gateway, see [Portal and Dashboard: The Architecture](/portal/overview/intro#portal-and-dashboard-the-architecture).
</Note>
