...
The endpoint URL for the Tyk Dashboard. This is where the Developer Portal will interact with the [Tyk Dashboard API](/platform-management/dashboard-api#exploring-the-dashboard-api) using its allocated [access credentials](/portal/api-provider#tyk-dashboard-api-access-credentials).
