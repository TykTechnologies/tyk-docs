...
For further guidance on launching the portal, please refer to one of the installation options: [Docker container](/portal/install/docker#docker), [Docker Compose](/portal/install/docker#docker-compose), [Helm chart](/portal/install/kubernetes#legacy-helm-chart), or [RPM package](/portal/install/linux#red-hat-rhel-%2F-centos).
...
Please refer to [the Bootstrapping section](/portal/install#bootstrapping-developer-portal) for implementing this step.
...
<Card href="/portal/install/docker#docker" img="/img/docker.png">
=======
...
<<<<<<< HEAD
<Card href="/portal/install/docker#docker-compose" img="/img/docker.png">
=======
...
<Card href="/portal/install/linux" img="/img/linux-icon.svg">
...
=======
You can continue configuring and customizing it either via the UI or the portal admin API. Please refer to [the Tyk Enterprise Developer Portal Concepts section](/portal/overview/concepts) for further guidance.
...
2. [Enterprise Developer Portal Admin API](/product-stack/tyk-enterprise-developer-portal/api-documentation/list-of-endpoints/portal-1.13.0-list-of-endpoints)
>>>>>>> 94d4aceb (push initial code)
