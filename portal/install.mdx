...
- **[Tyk Identity Broker](/tyk-identity-broker/overview)**. You only need this component if you want to configure Single Sign-On for the Tyk Developer Portal.
...
The portal requires a database to store metadata. See [Configure SQL Storage](/tyk-configuration-reference/sql) for supported databases, connection configuration, and connection pool tuning.
