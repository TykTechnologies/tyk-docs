...
description: "Install Tyk Developer Portal using Docker, Kubernetes, or Linux packages. This guide explains the architecture, requirements, and how to install and bootstrap the portal."
