...
#### Plan Management
Portal users can modify subscription plans for existing credentials without creating new credential sets. Plan changes maintain existing product associations where compatible.
