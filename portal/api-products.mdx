...
<Warning>
The scope must [exist in your Identity Provider](/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/dynamic-client-registration#define-oauth-2-0-scopes) when the API Product is published, so that the IdP is able to issue tokens containing the scope.
</Warning>
