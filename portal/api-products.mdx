...
## Credential Management and Reusability
The Tyk Developer Portal supports flexible credential reuse across API Products, reducing credential sprawl and improving the developer experience.

#### Single Credential, Multiple Products
Developers can add multiple API Products to a single credential when they share compatible characteristics:
...
#### Adding Products to Existing Credentials
...
#### Plan Management
Portal users can now modify subscription plans for existing credentials without creating new credential sets. Plan changes maintain existing product associations where compatible.

#### Product Removal
Individual API Products can be removed from credentials containing multiple products.
