...
In the Tyk Developer Portal, API Products serve as the primary unit of discovery, access control, and [monetization](/overview/intro#api-monetization-with-tyk-developer-portal) of your API portfolio.
