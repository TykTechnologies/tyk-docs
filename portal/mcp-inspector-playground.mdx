...
The Inspector is available for MCP-typed products only, and appears in two places. On the Product's detail page, the **API specification** tab embeds it inline under a **Try it** toggle (**Instructions** shows the operator-authored markdown instead). Selecting **Try it out** on an individual service opens that service's own documentation page, which shows the same **Try it** / **Instructions** toggle.
