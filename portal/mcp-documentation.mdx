...
description: "How MCP product documentation renders on the Live Portal, including the API specification tab and the docs page for MCP proxies."
sidebarTitle: "MCP Documentation"
keywords: "Developer Portal, MCP, Model Context Protocol, API specification, MCP server URL, product documentation"
---
...
## The API Specification Tab

On a Product's detail page, the **API specification** tab renders documentation for each of the Product's Services. What it renders depends on the Service's type:
...
Each MCP proxy also has its own documentation page, reachable from the catalogue card's **Docs** dropdown or from the API specification tab. The page shows:
...
<Accordion title="The API specification tab shows no documentation for an MCP proxy">
...
Use the **Select an API** dropdown above the rendered content on the API specification tab to switch between the MCP proxies in the Product.
