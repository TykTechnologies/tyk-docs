...
3. Edit the page content within the existing content blocks. Each content block can be switched to Markdown individually. See the [Markdown reference](/portal/customization/markdown) for supported features and limitations.
