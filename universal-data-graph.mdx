...
- [How to create UDG schema](/universal-data-graph/udg-getting-started/creating-schema.md)
- [How to connect data sources](/universal-data-graph/udg-getting-started/connect-datasource.md)
- [How to secure the data graph](/universal-data-graph/udg-getting-started/security.md)