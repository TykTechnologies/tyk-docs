...
Learn more:
* [Tutorial: Create an API in File-based Mode](/mintdocs/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
Learn more:
* [Tutorial: Create an API with the Dashboard](/mintdocs/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
Learn more:
- [Dashboard API](/mintdocs/api-management/dashboard-configuration#exploring-the-dashboard-api)
- [Gateway API](/mintdocs/tyk-gateway-api)
...
- [Using Tyk Operator to enable GitOps with Tyk](/mintdocs/api-management/automations)
