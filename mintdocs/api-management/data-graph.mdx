...
- [How to create UDG schema](/mintdocs/api-management/data-graph#creating-schema)
- [How to connect data sources](/mintdocs/api-management/data-graph#connect-datasource)
- [How to secure the data graph](/mintdocs/api-management/data-graph#security)
...
Head over to the [connect data source](/mintdocs/api-management/data-graph#udg) section to learn about the supported data sources and how to connect them to Tyk.
...
* [UDG Arguments](/mintdocs/api-management/data-graph#arguments)
* [UDG Datasources](/mintdocs/api-management/data-graph#udg)
...
See [Concept: Arguments](/mintdocs/api-management/data-graph#arguments) to learn more about it.
 ```
...
Global headers now have access to all [request context variables](/mintdocs/api-management/traffic-transformation#request-context-variables).
...
Data source headers now have access to all [request context variables](/mintdocs/api-management/traffic-transformation#request-context-variables).
...
Above steps are explained in detail in our [Getting started pages](/mintdocs/api-management/data-graph#connect-datasource).
...
We offer 3 ways of importing an example into Tyk:
 - Using [tyk-sync](/mintdocs/api-management/automations/sync#synchronize-api-configurations-with-github-actions)
 - Manually import via [Dashboard API Import](/mintdocs/api-management/gateway-config-managing-classic#import-an-api)
- Using Tyk Dashboard to browse and import the examples directly

#### Import via tyk-sync

Please follow the [tyk-sync documentation](/mintdocs/api-management/automations/sync#examples-publish-command) to learn more about this approach.
...
You can find more detailed instructions in the [Dashboard API Import documentation section](/mintdocs/api-management/gateway-config-managing-classic#import-an-api).
