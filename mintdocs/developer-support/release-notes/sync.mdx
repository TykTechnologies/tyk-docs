...
Recommended usage:
Tyk Dashboard setting: [allow-unsafe-oas](/mintdocs/tyk-dashboard/configuration#allow_unsafe_oas)
Tyk Sync: use the [--allow-unsafe-oas](/mintdocs/api-management/automations/sync) when invoking the CLI
