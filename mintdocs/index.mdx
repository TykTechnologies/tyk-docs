...
[Deployment Options](/apim/)     [Self-managed](/tyk-on-premises/)     [Cloud](/tyk-cloud/)     [**Using OAS API definition**](/mintdocs/api-management/gateway-config-managing-oas)

[Product Stack ](/mintdocs/ai-management/ai-studio/model-prices)
...
<CardGroup cols={2}>
  <Card title="Tyk Gateway (Open source)" icon="sparkles" horizontal href="/tyk-oss-gateway/">
    Open source Enterprise API Gateway.
  </Card>
  <Card title=" The GUI and analytics platform for Tyk." icon="sparkles" horizontal href="/tyk-dashboard/">
