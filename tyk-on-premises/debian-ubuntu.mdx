...
See [SQL configuration](/content/planning-for-production/database-settings/postgresql.md) for details on installing SQL in a production environment.
</Tab>
</Tabs>
...
- [Dashboard](/tyk-on-premises/debian-ubuntu/dashboard)
- [Pump](/tyk-on-premises/debian-ubuntu/analytics-pump)
- [Gateway](/tyk-on-premises/debian-ubuntu/gateway)
</Tab>
</Tabs>
