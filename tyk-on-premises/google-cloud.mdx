...
1. Via our [Ubuntu Setup](/tyk-on-premises/debian-ubuntu) on an installed Ubuntu Server within Google Cloud.
2. Via our [Docker Installation](/tyk-on-premises/docker) using Google Cloud's Docker support.
