...
When selecting a Tyk Self-managed license [(see the pricing page to compare the licenses)](https://tyk.io/price-comparison), you can choose between three deployment models: [Launch](/licensing#launch---perfect-to-get-started), [Flex](/licensing#flex---for-multiple-teams-within-a-single-data-center-or-cloud) and [Global Multi-team](/licensing#global-multi-team---for-the-largest-global-enterprises-at-scale). Read below to learn which model fits best for your scenario. 
