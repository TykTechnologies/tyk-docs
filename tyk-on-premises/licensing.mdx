...
When selecting a Tyk Self-managed license [(see the pricing page to compare the licenses)](https://tyk.io/price-comparison), you can choose between three deployment models: [Launch](/tyk-on-premises/licensing#launch---perfect-to-get-started), [Flex](/tyk-on-premises/licensing#flex---for-multiple-teams-within-a-single-data-center-or-cloud) and [Global Multi-team](/tyk-on-premises/licensing#global-multi-team---for-the-largest-global-enterprises-at-scale). Read below to learn which model fits best for your scenario. 
...
You might also need more depending on your average load or to handle seasonal peak traffic. See [Planning for Production](/planning-for-production) to learn more. 
...
✅ For larger organizations [with multiple teams](/tyk-multi-data-centre) and [data sovereignty](https://tyk.io/blog/strategies-for-dealing-with-data-sovereignty-at-scale/) requirements <br />
