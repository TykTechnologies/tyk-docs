...
1. Via our [Ubuntu Setup](/tyk-on-premises/debian-ubuntu) on an installed Ubuntu Server on Azure.
2. Via our [Docker Installation](/tyk-on-premises/docker) using Azure's Docker support.
