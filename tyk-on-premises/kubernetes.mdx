...
- [Quick Start with PostgreSQL](/deployment-and-operations/tyk-self-managed/deployment-lifecycle/installations/kubernetes/tyk-helm-tyk-stack-postgresql)
- [Quick Start with MongoDB](/deployment-and-operations/tyk-self-managed/deployment-lifecycle/installations/kubernetes/tyk-helm-tyk-stack-mongodb)
...
To get started go to [Tyk Operator](/api-management/automations#automate-api-management-in-kubernetes-environments).
