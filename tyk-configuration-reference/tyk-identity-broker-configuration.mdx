...
(env var: **TYK_IB_STORAGE_STORAGE_TYPE**)
...
(env var: **TYK_IB_STORAGE_MONGO_MONGO_URL**)

### Storage.mongo.db_name

The MongoDB database name to use for profile storage.

(env var: **TYK_IB_STORAGE_MONGO_DB_NAME**)
...
(env var: **TYK_IB_STORAGE_MONGO_MONGO_USE_SSL**)
