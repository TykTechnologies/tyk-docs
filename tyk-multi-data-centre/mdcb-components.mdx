...
### Optional Components
- One or more **Tyk Pumps** can be deployed within the Control Plane to export analytics data (request/response logs) to your [data sink of choice](/tyk-stack/tyk-pump/other-data-stores) for further analytics and visualisation.
