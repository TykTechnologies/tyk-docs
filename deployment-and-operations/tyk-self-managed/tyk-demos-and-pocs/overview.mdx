...
- [portal](https://github.com/TykTechnologies/tyk-k8s-demo/tree/main/src/deployments/portal): deploys the [Tyk Enterprise Developer Portal](/portal/overview/intro) as well as its dependency PostgreSQL.
...
<Note>
The Tyk Pro Docker demo does not provide access to the [Developer Portal](/portal/overview/intro).
</Note>
