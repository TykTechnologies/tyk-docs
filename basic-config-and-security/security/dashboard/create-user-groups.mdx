...
Tyk has a flexible [user permissions](/basic-config-and-security/security/dashboard/user-roles) system that provides Role Based Access Control (RBAC) for your Tyk Dashboard.
