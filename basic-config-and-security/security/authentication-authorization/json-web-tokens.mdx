...
This assumes you've already [setup an API](/getting-started/create-api) and are ready to protect it with JWT.
...
Please consult the Tyk Operator supporting documentation for an example of how to [configure JWT authentication](/product-stack/tyk-operator/advanced-configurations/client-authentication#jwt) with Tyk Operator.
