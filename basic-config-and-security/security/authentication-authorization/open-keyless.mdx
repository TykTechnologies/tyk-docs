...
Tyk OAS APIs are inherently "open" unless authentication is configured, however the older Tyk Classic API applies [Auth Token](/api-management/authentication/auth-token) protection by default.
