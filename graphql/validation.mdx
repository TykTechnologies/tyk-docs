...
When using the [Dashboard API](/tyk-apis/tyk-dashboard-api/api-definitions) the response for a broken schema will be a *400 Bad Request* with a body containing the validation errors. For example:
