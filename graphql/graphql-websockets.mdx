...
For setting up upstream connections (between Tyk Gateway and Upstream) please refer to the [GraphQL Subscriptions Key Concept](/getting-started/key-concepts/graphql-subscriptions).
