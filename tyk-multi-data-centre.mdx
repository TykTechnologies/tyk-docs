...
- You can physically [segment teams and environments](/advanced-configuration/manage-multiple-environments/with-tyk-multi-cloud) within a single physical data center, giving each team full control of its own API gateway and server resources without the noisy neighbors you might experience in a standard self-managed deployment.
...
- [The components of an MDCB deployment](/tyk-multi-data-centre/mdcb-components)
