...
No. A service can be linked to any number of rulesets at once, and each is evaluated and reported independently. A separate limit of 20 applies only to the CI/CD sandbox endpoint; see [Limits](/tyk-governance/evaluation-api#limits).
</Accordion>
