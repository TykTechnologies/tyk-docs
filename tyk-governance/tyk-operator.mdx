...
This page is for teams who manage both their APIs and their governance configuration as Kubernetes manifests. Their rulesets and the `TykOasApiDefinition` resources they govern live in the same Git repository.
