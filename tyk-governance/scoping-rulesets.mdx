...
3. **Is the service active?** Evaluation is triggered by deploying a service to the gateway. A service that has never been set to active has nothing recorded against it yet.
