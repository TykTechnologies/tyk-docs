...
Please [click here](/planning-for-production/monitoring/tyk-components) to read more about Tyk component monitoring and how to set it up.
...
Infrastructure sizing, benchmarks, and scaling will be explained in [this section](/planning-for-production/benchmarks).
