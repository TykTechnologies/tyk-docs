...
description: "Graceful Shutdown for Tyk Data Plane"
...
1. Immediately marks itself as shutting down. The `/ready` endpoint begins returning `503 Service Unavailable`.
