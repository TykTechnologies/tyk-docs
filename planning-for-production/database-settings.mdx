...
To mitigate the risk of decompression bombs, the maximum combined uncompressed size for the API definitions is limited to the value you configure for the `storage.max_decompressed_size`. Typically you should expect to see approximately 75% compression for Tyk OAS APIs.
