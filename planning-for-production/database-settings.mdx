...
You can enable Zstandard compression to reduce the storage footprint by setting [`storage.compress_api_definitions`](/tyk-oss-gateway/configuration#storagecompress_api_definitions) to `true` in your worker Gateway configuration:
