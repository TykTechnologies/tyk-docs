...
With the mongo-go driver, we support the latest versions of MongoDB (5.0.x, v6.0.x, v7.0.x, and v8.0.x) and also features such as the "+srv" connection string and SCRAM-SHA-256. For more details, visit the MongoDB doc:
