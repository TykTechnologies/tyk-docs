...
Set [`storage.compress_api_definitions`](/tyk-oss-gateway/configuration#storage-compress_api_definitions) and [`storage.compress_policies`](/tyk-oss-gateway/configuration#storage-compress_api_policies) in your Data Plane Gateway configuration to compress your API definition and policy backups respectively:
