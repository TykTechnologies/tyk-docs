...
Tyk uses the official MongoDB Go driver (`mongo-go`) by default to connect to MongoDB. 

With the `mongo-go` driver, we support the latest versions of MongoDB and also features such as the "+srv" connection string and SCRAM-SHA-256. For more details, visit the MongoDB doc:
* [Connection Guide](https://www.mongodb.com/docs/drivers/go/current/fundamentals/connection/)
* [Authentication Mechanisms](https://www.mongodb.com/docs/drivers/go/current/fundamentals/auth/)
