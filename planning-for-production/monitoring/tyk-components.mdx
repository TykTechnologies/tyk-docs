...
For information about our health check endpoint, please visit our [Liveness Health Check](/planning-for-production/ensure-high-availability/health-check) documentation.
...
The Tyk MDCB liveness health check endpoint can be configured [here](/tyk-multi-data-centre/setup-controller-data-centre#health-check). 
