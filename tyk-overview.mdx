...
- **[Tyk Operator](/api-management/automations#what-is-tyk-operator)**: Kubernetes-native API management that allows teams to manage APIs as Kubernetes resources.
...
- **[Tyk Sync](/api-management/automations#synchronize-tyk-environment-with-github-repository)**: Synchronizes API configurations across environments, supporting DevOps practices and CI/CD workflows.
