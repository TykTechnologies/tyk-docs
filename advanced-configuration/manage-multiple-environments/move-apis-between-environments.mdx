...
See [API Tagging](/advanced-configuration/manage-multiple-environments/with-tyk-on-premises#a-name-api-tagging-a-api-tagging-with-on-premises) for more details.

### API Sharding

You can also use [API Sharding](/advanced-configuration/manage-multiple-environments#api-sharding) to move APIs in a Shards (and or MDCB) Tyk Self-Managed installation.
...
You can also use our new Tyk-Sync tool which allows you to sync your APIs (and Policies) with a Version Control System (VCS). You can then move your APIs between environments. See [Tyk-Sync](/api-management/automations#synchronize-tyk-environment-with-github-repository) for more details.