...
Starting with Sync v1.5+ and Dashboard v5.3.2+, Tyk Sync supports both [Tyk OAS APIs](/docs3/5.8/api-management/gateway-config-tyk-oas) and [Tyk Classic APIs](/docs3/5.8/api-management/gateway-config-tyk-classic) when working with the Tyk Dashboard, without requiring special flags or configurations.
