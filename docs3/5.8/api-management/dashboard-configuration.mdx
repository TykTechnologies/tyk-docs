...
- Upstream settings including
   ...
   - [Service Discovery](/docs3/5.8/tyk-self-managed#service-discovery)
...
Please check [here](/docs3/5.8/tyk-self-managed#mongodb) for MongoDB driver and production configurations.
...
<Note>
Tyk no longer supports SQLite as of Tyk 5.7.0. To avoid disruption, please transition to [PostgreSQL](/docs3/5.8/tyk-self-managed#postgresql), [MongoDB](/docs3/5.8/tyk-self-managed#mongodb), or one of the listed compatible alternatives.
</Note>
