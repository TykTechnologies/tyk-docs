...
In order to complete the next steps, you need to have [Tyk Self Managed installed](/docs3/5.8/tyk-self-managed/install). You can also create a 5-week trial account in Tyk Cloud.
