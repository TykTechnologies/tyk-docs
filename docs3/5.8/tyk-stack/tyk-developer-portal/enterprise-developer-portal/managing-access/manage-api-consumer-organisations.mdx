...
Please refer to the [email notification section](/docs3/5.8/product-stack/tyk-enterprise-developer-portal/getting-started/setup-email-notifications) for further instructions for setting up the email server.
...
2. **Approve or reject organization registration requests**
    ...
    <br/><br/>Both emails are customizable. Refer to [the email customization documentation](/docs3/5.8/portal/customization/email-notifications) for further information on the email customization.
