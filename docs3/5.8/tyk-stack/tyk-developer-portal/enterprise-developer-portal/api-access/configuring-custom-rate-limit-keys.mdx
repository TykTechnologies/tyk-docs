...
To enable this, Tyk introduced support for custom rate limit keys in [Tyk 5.3.0](/docs3/5.8/developer-support/release-notes/dashboard#530-release-notes). This guide explains how to configure custom rate limit keys.

**Prerequisites**

This capability works with [Tyk 5.3.0](/docs3/5.8/developer-support/release-notes/dashboard#530-release-notes) or higher.
...
Additionally, it's possible to attach [custom attribute values](/docs3/5.8/portal/customization/user-model#add-custom-attributes-to-the-user-model) defined in a developer profile as metadata fields to credentials.
