  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="text-container">
        ...
        <a href="/docs3/5.8/{{.blocks.HeaderButtonLink.Content}}" class="btn btn-primary">{{.blocks.HeaderButtonLabel.Content}}</a>
    </div>
….
```
...
2. Upload the theme package that is created in the previous step to the portal. You can use the portal's [Admin dashboard](/docs3/5.8/portal/customization/themes#create-a-theme) or the [admin API](/docs3/5.8/product-stack/tyk-enterprise-developer-portal/api-documentation/tyk-edp-api) to do it.
![image](https://github.com/TykTechnologies/tyk-docs/assets/14009/f0e547b2-b521-4c3e-97ce-fd3a2a3b170b)
3. Finally, you need to [activate](/docs3/5.8/portal/customization/themes#activate-a-theme) the theme so that it will be applied to the portal.
