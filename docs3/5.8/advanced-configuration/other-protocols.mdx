...
1. **[TCP Proxy](/docs3/5.8/key-concepts/tcp-proxy)**

2. **[gRPC](/docs3/5.8/key-concepts/grpc-proxy)**

3. **[Server-Sent Events (SSE)](/docs3/5.8/advanced-configuration/sse-proxy)**

4. **[WebSockets](/docs3/5.8/advanced-configuration/websockets)**