...
The Tyk Cloud trial does not include access to [Hybrid deployments](/docs3/5.8/#deploy-hybrid-gateways) or the [Developer Portal](/docs3/5.8/portal/overview/intro).
To try out these capabilities, please get in touch for a [guided evaluation](https://tyk.io/guided-evaluation/) with our team.
</Note>


Welcome to the [Tyk Cloud Platform](/docs3/5.8/tyk-cloud)!
This guide will lead you through the following steps:
1. Signing up with [Tyk Cloud ](/docs3/5.8/tyk-cloud).
2. Creating your first [API](/docs3/5.8/api-management/gateway-config-introduction) using the [Tyk Dashboard](/docs3/5.8/tyk-dashboard).
3. Setting up a [Policy](/docs3/5.8/api-management/policies#what-is-a-security-policy) and Key to secure your APIs.
...
To create Tyk Cloud account follow this [guide](/docs3/5.8/getting-started/create-account).

2. **Get started with your first API with Tyk Dashboard**

To create your API using Tyk Dashboard follow this [guide](/docs3/5.8/getting-started/configure-first-api).
...
<Card title="Configuration" href="/docs3/5.8/tyk-cloud#add-custom-authentication">
**Python custom plugins**

Implement your own custom logic with Python based plugins
</Card>

<Card title="Configuration" href="/docs3/5.8/tyk-cloud#configure-custom-domains">
**Using custom domains**

Configure custom domain for your Dashboard and Developer Portal
</Card>

<Card title="Administration" href="/docs3/5.8/tyk-cloud#managing-environments">
**Manage environments**

Create and manage multiple environments within your Tyk Cloud organization
</Card>

<Card title="Administration" href="/docs3/5.8/tyk-cloud#managing-control-planes">
**Manage deployments**

Create and manage your Cloud Control Plane and Cloud Data Plane deployments
</Card>

<Card title="Administration" href="/docs3/5.8/tyk-cloud#managing-teams-and-users">
**Manage teams & users**

Create teams in your organization, define roles and manage user access
</Card>

<Card title="Account" href="/docs3/5.8/tyk-cloud#manage-accounts-and-billing">
**Manage billing**
...
This section walks you through how to start using Tyk Cloud, creating organization, environment and users before creating an API. If you are in a hurry, try the [Quick Start guide](/docs3/5.8/#quick-start-tyk-cloud) for a 5 min version of this tutorial. 
...
* We have some specific terminology used within Tyk Cloud. It would be useful to checkout our [Glossary](/docs3/5.8/#glossary) so you understand what we are referring to.
...
* Assign the account creator as a [Billing admin](/docs3/5.8/#user-roles-in-tyk-cloud) for the Organization. This user role allows you to manage the billing and plans for your org. You can also add other billing admins as required.
...
* **Step 2 - Select a Home Region:** Select a region from the drop-down list where your [Control Plane](/docs3/5.8/#glossary) will be deployed and your data stored. The number of regions available will depend on your license. Further regions can be added as an upgrade option.
...
For a manual setup you'll get started by [setting up your first team](/docs3/5.8/#create-your-first-team).
...
* **Step 1 - Name your Team:** Give your [Team](/docs3/5.8/#glossary) a name. You may find it useful to reflect the names used within your organization.

* **Step Two - Invite your Users:** Invite your [users](/docs3/5.8/#glossary) to your team. You'll only need their email address and which of the available [roles](/docs3/5.8/#glossary) you want to assign to them. This step is optional and can be completed within the dashboard later.
...
Next you'll create an [Environment](/docs3/5.8/#configure-environment-and-deployments).
...
* **Step 1 - Name your Environment:** Give your [Environment](/docs3/5.8/#glossary) a name. You may find it useful to reflect the names used within your organization such as Development, Production etc.
  
* **Step 2 - Name your Control Plane:** Give your [Control Plane](/docs3/5.8/#glossary) a name. Again, this is up to you and you may already have an infrastructure you want to re-create in Tyk Cloud.
  
* **Step 3 - Configure your first Cloud Data Plane:** Select the region you want to locate your [Cloud Data Plane](/docs3/5.8/#glossary) in from the drop-down list. Your Cloud Data Plane is not confined to the same region as your Organization and Control Plane but the amount of regions you have to choose from can be limited depending on your subscription plan. Give your Cloud Data Plane a name. 
...
1. Click [Deploy Control Plane and Create a Cloud Data Plane](/docs3/5.8/#glossary). You can watch your Control Plane being deployed and your Cloud Data Plane being created. You will then be taken to the Control Plane overview screen within the Tyk Cloud dashboard.
...
Next you'll [set up your first API](/docs3/5.8/#deploy-and-add-your-first-api) from the Tyk Dashboard.
...
For further details, please refer to the [release notes](/docs3/5.8/developer-support/release-notes/gateway#530-release-notes) for Tyk Gateway v5.3.0.
</Warning>


##### Steps to add an API in Tyk Cloud

* **Step 1 - Access the Dashboard:** Go to the Control Plane overview and click the dashboard link in the Ingress list. You'll be redirected to the Tyk Dashboard for your [Control Plane](/docs3/5.8/#glossary).
...
Your first API has been added. What's next? Testing it! This page shows how you can test an API that you have added to Tyk Cloud, to ensure that it’s functioning correctly. You'll now access the API you setup in [Task 5](/docs3/5.8/#deploy-and-add-your-first-api) from the Cloud Data Plane within Tyk Cloud.
...
* **Step 2 - Append the URL with your API:** You created a API named **my app** in [Task 5](/docs3/5.8/#deploy-and-add-your-first-api). Add `/my-app/` to the end of the URL. You should be taken to [https://httpbin.org/](https://httpbin.org/), which you added as the **Target URL** for the API in [Task 5](/docs3/5.8/#steps-to-add-an-api-in-tyk-cloud). 


Next you'll [view the analytics](/docs3/5.8/#view-analytics) for your API in the Dashboard.
...
* Adding [Plugins and Middleware](/docs3/5.8/#configure-plugins) to your Control Plane
...
<Note>
See [note](/docs3/5.8/#api-blueprint-is-being-deprecated) above regarding deprecation of support for API Blueprint.
</Note>
...
See [Tyk Classic API versioning](/docs3/5.8/api-management/gateway-config-tyk-classic#tyk-classic-api-versioning) for more details.
...
Your API will appear in your APIs list. If you select **EDIT** from the **ACTIONS** drop-down list, you can see the endpoints (from the [Endpoint Designer](/docs3/5.8/api-management/dashboard-configuration#endpoint-designer)) that have been created as part of the import process.
...
* [Managing Organizations](/docs3/5.8/#set-up-your-organisation)
* [Managing Environments](/docs3/5.8/#manage-environments-and-deployments)
* [Managing Control Planes](/docs3/5.8/#managing-control-planes)
* [Managing Cloud Data Planes](/docs3/5.8/#managing-cloud-data-plane)

It also covers links to how to start [managing your APIs](/docs3/5.8/#manage-apis) via the Tyk Dashboard, accessible from your Control Plane.

#### Organisations Overview

Your Organization is your "container" for all your Environments, Control Planes and Cloud Data Planes. When you setup your Organization when [creating your account](/docs3/5.8/getting-started/create-account), you assign it to a Home Region where all your data is stored. You cannot change this home region after creating your organization.
...
Environments are used to group your [Control Plane](/docs3/5.8/#glossary) and [Cloud Data Planes](/docs3/5.8/#glossary) into logical groups. For example you may want to create environments that reflect different departments of your organization.


<Note>
The number of Environments you can create is determined by your [plan](/docs3/5.8/#select-a-payment-plan)
</Note>


##### Prerequisites

The following [user roles](/docs3/5.8/#assign-user-roles) can perform Environment Admin tasks:
...
Control Planes are situated in your Organization's home region and provide links to an instance of the [Tyk Dashboard](/docs3/5.8/tyk-dashboard) and the [Developer Portal](/docs3/5.8/tyk-developer-portal). The Dashboard is where you perform all your API tasks. The developer portal allows your 3rd party developers access to your APIs. Cloud Data Planes are then connected to your Control Planes.


##### Prerequisites

All [user roles](/docs3/5.8/#assign-user-roles) can edit, deploy, undeploy, restart, redeploy all deployments within a team. Only the Organization Admin and the Team Admin can create or delete deployments.
...
<Note>
The number of Control Planes you can add is dependent on your [plan](/docs3/5.8/#select-a-payment-plan)
</Note>
...
5. (Optional) Enter a [custom domain](/docs3/5.8/#configure-custom-domains) if required
6. (Optional) Enable [plugins](/docs3/5.8/#configure-plugins) if required

##### Edit Control Planes

You can edit the following Control Plane settings:
* Change the Control Plane name
* Add a [custom domain](/docs3/5.8/#configure-custom-domains)
* Change the Bundle Channel and Bundle Version
* Enable [plugins](/docs3/5.8/#configure-plugins)



    <Note>
    The use of custom domains is dependent on your [plan](/docs3/5.8/#select-a-payment-plan)
    </Note>
...
<Note>
The number of Cloud Data Planes you can add is dependent on your [plan](/docs3/5.8/#select-a-payment-plan)
</Note>
...
- as [Cloud Gateways](/docs3/5.8/#managing-cloud-data-plane): Deployed and managed in *Tyk Cloud*, in any of our available regions. These are SaaS gateways, so there are no deployment or operational concerns.
...
* Connection details to remote control plane from the above [section](/docs3/5.8/#deploy-hybrid-gateways).

The following quick start guide explains how to use the [Tyk Data Plane Helm chart](/docs3/5.8/product-stack/tyk-charts/tyk-data-plane-chart) to configure Tyk Gateway that includes:
...
Set the below environment variables and replace values with connection details to your Tyk Cloud remote control plane. See the above [section](/docs3/5.8/#deploy-hybrid-gateways) on how to get the connection details.
...
For the complete installation guide and configuration options, please see [Tyk Data Plane Chart](/docs3/5.8/product-stack/tyk-charts/tyk-data-plane-chart).
...
* [Adding APIs](/docs3/5.8/api-management/gateway-config-managing-classic#create-an-api) to Tyk, including REST and GraphQL APIs
* Applying Quotas and Rate limits via [Security Policies](/docs3/5.8/api-management/gateway-config-managing-classic#secure-an-api) and [Keys](/docs3/5.8/api-management/gateway-config-managing-classic#access-an-api)
* [Securing](/docs3/5.8/api-management/security-best-practices#securing-apis-with-tyk) your APIs
* Viewing granular [Analytics](/docs3/5.8/api-management/dashboard-configuration#traffic-analytics) for your Tyk managed APIs
* [Transform traffic](/docs3/5.8/api-management/traffic-transformation) with the Tyk API Designer
* Add integration options such as [SSO](/docs3/5.8/api-management/external-service-integration#single-sign-on-sso) and [3rd Party IdentityProviders](/docs3/5.8/api-management/external-service-integration)
* [Adding Segment Tags](/docs3/5.8/#faqs)
...
- [Managing Teams](/docs3/5.8/#managing-teams)
- [Managing Users](/docs3/5.8/#managing-teams-and-users)
- Available Tyk Cloud [User Roles](/docs3/5.8/#user-roles-in-tyk-cloud)
- [Tyk Cloud Single Sign-On (SSO)](/docs3/5.8/#configure-single-sign-on-sso)

#### Managing Teams 

The following [user roles](/docs3/5.8/#user-roles-in-tyk-cloud) can perform existing Team Admin tasks:
...
You need to be a [Organization Admin](/docs3/5.8/#assign-user-roles) to create a new team.
...
You need to be a [Organization Admin](/docs3/5.8/#assign-user-roles) to delete a team.
...
You can now invite users to your new team. See [Managing Users](/docs3/5.8/#managing-teams-and-users) for more details.


#### Managing Users

The following [user roles](/docs3/5.8/#user-roles-in-tyk-cloud) can perform existing User Admin tasks:

* [Organization Admin](/docs3/5.8/#assign-user-roles) - Can manage all users in the organization they are a member of.
* [Team Admin](/docs3/5.8/#assign-user-roles) - Can only manage the users of the team they are a member of.
    ...
    You can also [add users to the Tyk Dashboard](/docs3/5.8/api-management/user-management#manage-tyk-dashboard-users) itself instead of inviting them as Tyk Cloud users. These users would likely be your API Developers and Engineers who manage the APIs.
    </Note>
...
You can [add users to the Tyk Dashboard](/docs3/5.8/api-management/user-management#manage-tyk-dashboard-users) itself instead of inviting them as Tyk Cloud users. These users would likely be your API Developers and Engineers who manage the APIs.   
...
* The available [Tyk Cloud Plans](/docs3/5.8/#select-a-payment-plan)
* Adding [Payment Methods](/docs3/5.8/#add-payment-methods)
* How to [upgrade from the free trial plan](/docs3/5.8/#upgrade-your-free-trial)
* [Managing Billing Admins](/docs3/5.8/#managing-billing-admin) on your account
* What to do if your account goes into [retirement](/docs3/5.8/#retire-your-account)
...
| ----------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 48 hours free trial <p>[Free Support SLA](/docs3/5.8/developer-support/support)</p> | This is for POC’s and those testing the Tyk platform. | Tyk Cloud has 48 hours free trial. You can always request a longer trial period or talk to support if you need help. |
| Starter <p>[Standard Support SLA](/docs3/5.8/developer-support/support)</p> | For single teams with low traffic, mostly small businesses that manage few APIs. | This plan includes all of the features of the Tyk Stack. You can have **[custom domains](/docs3/5.8/#configure-custom-domains)** and **[plugins](/docs3/5.8/#configure-plugins)**, along with management of upto 5 APIs. Standard support is provided.|
| Launch <p>[Standard Support SLA](/docs3/5.8/developer-support/support)</p> | For single teams with low traffic, mostly small businesses. | This plan includes all of the features of the Tyk Stack. You can have **[custom domains](/docs3/5.8/#configure-custom-domains)** and **[plugins](/docs3/5.8/#configure-plugins)** along with management of unlimited APIs. Standard support is provided. |
| Grow <p>[Standard Support SLA](/docs3/5.8/developer-support/support)</p> | For single teams with high traffic. | This plan includes all of the features of the Tyk Stack. In this plan, you have **[Hybrid Gateways](/docs3/5.8/#deploy-hybrid-gateways)** as an add on, along with standard support. |
| Scale <p>[Enhanced Support SLA](/docs3/5.8/developer-support/support)</p> | For global organizations with multiple teams, requiring gateway deployments in multiple locations. | This plan includes all of the features of the Tyk Stack. **Enhanced(silver) support** will be provided. |
...
As a *Billing Admin* user, you have the ability to edit or delete an existing payment method. Deleting a payment method without adding a new one will result in your plan going into [retirement](/docs3/5.8/#retire-your-account) at the end of your current billing cycle.
...
If your free trial ends without you upgrading, your account enters what we call [retirement](/docs3/5.8/#glossary).

**What does upgrading a free trial account involve?**

To upgrade your free trial, you (as a Billing Admin) need to:
* Add a [payment method](/docs3/5.8/#add-payment-methods) to your organization
* Select a new [plan](/docs3/5.8/#select-a-payment-plan) from our list
...
* Add, edit and delete [payment methods](/docs3/5.8/#add-payment-methods)
...
Your plan will go into [retirement](/docs3/5.8/#glossary) in the following scenarios:
...
Our Developer Portal is completely customizable. See [Portal Customization](/docs3/5.8/tyk-developer-portal/customise) for more details.
...
* [Python Plugins](/docs3/5.8/api-management/plugins/rich-plugins#overview)
* [JSVM](/docs3/5.8/api-management/plugins/javascript#)
* [Golang](/docs3/5.8/#configure-plugins)
...
Next you'll [set up the Python authentication code bundle](/docs3/5.8/tyk-cloud#create-a-python-code-bundle).
...
Next you will [create an API](/docs3/5.8/#test-middleware) from our Control Plane and see our middleware in action.
...
| File              | Description                                                                                                                                                                                                                                                                                       |
|-------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| custom_middleware | contains the middleware settings like the plugin driver you want to use (driver) and the hooks that your plugin will expose. We use the   **auth_check** for this tutorial. For other hooks see [here](/docs3/5.8/api-management/plugins/rich-plugins#coprocess-dispatcher---hooks). |
...
* You import decorators from the Tyk module that gives us the Hook decorator, and we import [Tyk Python API helpers](/docs3/5.8/api-management/plugins/rich-plugins#tyk-python-api-methods)
...
* A plugin bundle is a packaged version of the plugin, it may also contain a cryptographic signature of its contents. The -y flag tells the Tyk CLI tool to skip the signing process in order to simplify this tutorial. For more information on the Tyk CLI tool, see [here](/docs3/5.8/api-management/plugins/overview#how-plugin-bundles-work).
* You should now have a `bundle.zip` file in the plugin working directory.
* Next you will configure [uploading your plugin bundle file](/docs3/5.8/#uploading-your-bundle) to your Amazon S3 bucket.
...
1. Firstly you will need a local Tyk Gateway installation that allows you to create your Python plugin bundle. We recommend [installing our Self-Managed version on Ubuntu Bionic 18.04](/docs3/5.8/tyk-self-managed/install#install-tyk-on-debian-or-ubuntu).
...
<Warning>
`tyk-hybrid` chart is deprecated. Please use our [Tyk Data Plane helm chart](/docs3/5.8/#deploy-hybrid-gateways) instead. 

We recommend that all users to migrate to the `tyk-data-plane` Chart. Please review the [Configuration](/docs3/5.8/product-stack/tyk-charts/tyk-data-plane-chart#configuration) section of the new helm chart and cross-check with your existing configurations while planning for migration.
</Warning>
...
<Note>
Please make sure you are installing Redis versions that are supported by Tyk. Please refer to Tyk docs to get list of [supported versions](/docs3/5.8/tyk-self-managed#redis).
</Note>
...
#### Tyk Cloud Storage
When a client makes a request to a Tyk Gateway deployment, the details of the request and response are captured and [stored in Redis](/docs3/5.8/api-management/dashboard-configuration#traffic-analytics). Tyk Pump processes the records from Redis and forwards them to MongoDB. Finally, Tyk Cloud reads that data from MongoDB and displays its size(bytes) in the _Storage_ section of _Monitoring_. 
...
Since this functionality is powered by Tyk Gateway's OpenTelemetry integration, we recommend reviewing our comprehensive [OpenTelemetry documentation](/docs3/5.8/api-management/logs-metrics#opentelemetry)
...
- [Datadog](/docs3/5.8/#configure-providers)
- [Dynatrace](/docs3/5.8/#configure-providers)
- [New Relic](/docs3/5.8/#configure-providers)
- [Elastic](/docs3/5.8/#configure-providers)
- [Custom](/docs3/5.8/#configure-providers)
...
For details on the API endpoints and usage, see [Retrieving Audit Logs via API](/docs3/5.8/api-management/dashboard-configuration#retrieving-audit-logs-via-api).
...
To add either of the tags, see [Adding an API](/docs3/5.8/#steps-to-add-an-api-in-tyk-cloud) in the Getting Started section.
...
A set of data and access permissions that can be applied to a user or team of users. See [User Roles](/docs3/5.8/#user-roles-in-tyk-cloud) for more details.
...
Where an Organization has expired due to either a subscription failure or cancelation and is now within a "retirement" period of 30 days, during which an [Billing Admin](/docs3/5.8/#assign-user-roles) can reinstate full functionality by updating or creating a new subscription.
...
See [User Roles](/docs3/5.8/#user-roles-in-tyk-cloud) for more details
