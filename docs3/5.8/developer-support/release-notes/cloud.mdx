...
For a full list of changes, see the detailed [changelog](/docs3/5.8/#Changelog-v1.28.1) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs3/5.8/#Changelog-v1.28.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs3/5.8/#Changelog-v1.27.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs3/5.8/#Changelog-v1.26.0) below.
...
Tyk Cloud allows users to enable or disable audit logging for their [Control Plane](/docs3/5.8/api-management/mdcb#data-plane) (CP) deployments, providing greater flexibility in managing compliance and storage costs. To enable this feature, please contact your account manager.
...
For more details, check out the [documentation on Gateway versioning and auto-upgrades](/docs3/5.8/developer-support/release-types/long-term-support)
...
For more details, check out the [documentation on setting up Telemetry export](/docs3/5.8/tyk-cloud#enabling-telemetry-in-tyk-cloud).
