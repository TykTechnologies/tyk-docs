...
*FIPS compliance* means that the *FIPS Tyk Product* only uses FIPS 140-2 approved cryptographic [algorithms](/docs3/5.8/#fips-compliant-cryptographic-operations)
