...
This guide covers the essential first steps to take within the Tyk AI Studio UI after successfully deploying the platform using the [Installation Guide](/docs3/ai-management/ai-studio/deployment-k8s).
...
Refer to the **Configuration Options** detailed within the [Installation Guide](/docs3/ai-management/ai-studio/deployment-k8s) for specifics on setting these values during the deployment process.
