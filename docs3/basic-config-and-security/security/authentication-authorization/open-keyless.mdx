...
Tyk OAS APIs are inherently "open" unless authentication is configured, however the older Tyk Classic API applies [auth token](/docs3/api-management/authentication/bearer-token) protection by default.
