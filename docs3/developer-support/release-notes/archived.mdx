...
See our updated [Getting Started](/docs3/tyk-self-managed/install) section and [new CLI documentation](/docs3/tyk-self-managed).
...
> **TLDR**
> To get benefit or performance improvements ensure that you have `close_connections` set to `false` and set `max_idle_connections_per_host` according to our [production perfomance guide](/docs3/planning-for-production)
