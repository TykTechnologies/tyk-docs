...
*   **Upgrade Guides:** Please consult the official [Tyk Upgrade Documentation](/docs3/developer-support/upgrading) for detailed instructions.
*   **Release Notes:** Review the [Tyk Release Notes](/docs3/developer-support/release-notes/overview) for information on new features and changes in recent versions.
