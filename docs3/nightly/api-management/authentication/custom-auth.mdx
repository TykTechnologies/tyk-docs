...
To learn more about using Tyk Golang Plugins, go [here](/docs3/nightly/api-management/plugins/golang)
...
* See [Custom Authentication with a Python plugin](/docs3/nightly/api-management/plugins/rich-plugins#custom-authentication-plugin-tutorial) for a detailed example of a custom Python plugin.
* See [JavaScript Middleware](/docs3/nightly/api-management/plugins/javascript#) for more details on using JavaScript Middleware. 
