...
Refer to the [Tyk Gateway Configuration Reference](/docs3/nightly/tyk-oss-gateway/configuration#enforce_org_quotas) for more details on this setting.
...
Refer to the [Tyk OAS API Definition reference](/docs3/nightly/api-management/gateway-config-tyk-oas#global) for details.
...
Refer to the [Tyk Classic API Definition reference](/docs3/nightly/api-management/gateway-config-tyk-classic) for details.
...
Refer this [documentation](/docs3/nightly/#configuration-options).
</Accordion>
...
Refer this [documentation](/docs3/nightly/#api-level-configuration).
</Accordion>
