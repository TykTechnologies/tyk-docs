...
- **A Tyk installation** (Self-Managed or Cloud)
  - If you don't have Tyk installed, follow our [installation guide](/docs3/nightly/tyk-self-managed#installation-options-for-tyk-self-managed)
...
- **Tyk Dashboard v3+ access** (for Tyk Sync setup)
  - Learn how to set up the Tyk Dashboard [here](/docs3/nightly/tyk-dashboard)
...
<Card href="/docs3/nightly/api-management/automations/sync" img="/img/GitHub-Mark-64px.png">
**Read time: 10 mins**

Synchronize Tyk Environment With GitHub using Tyk Sync.
</Card>

<Card href="/docs3/nightly/api-management/automations/operator" img="/img/k8s.png">
**Read time: 10 mins**
