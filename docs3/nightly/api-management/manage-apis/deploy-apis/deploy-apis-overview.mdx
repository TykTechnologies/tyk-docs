...
Learn more:
* [Tutorial: Create an API in File-based Mode](/docs3/nightly/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
Learn more:
* [Tutorial: Create an API with the Dashboard](/docs3/nightly/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
Learn more:
- [Dashboard API](/docs3/nightly/api-management/dashboard-configuration#exploring-the-dashboard-api)
- [Gateway API](/docs3/nightly/tyk-gateway-api)
...
- [Using Tyk Operator to enable GitOps with Tyk](/docs3/nightly/api-management/automations)
