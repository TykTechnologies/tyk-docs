...
[section](/docs3/nightly/portal/customization/pages#edit-page-content)
...
- [Template Data](/docs3/nightly/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/docs3/nightly/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/docs3/nightly/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/docs3/nightly/#analytics)
- [Application Create](/docs3/nightly/#application-create)
- [Application Detail](/docs3/nightly/#application-detail)
- [Blogs](/docs3/nightly/#blogs)
- [Blog Detail](/docs3/nightly/#blog-detail)
- [Cart Checkout](/docs3/nightly/#cart-checkout)
- [Organization User Detail](/docs3/nightly/#organization-user-detail)
- [Organization User Edit](/docs3/nightly/#organization-user-edit)
- [Organization Users List](/docs3/nightly/#organization-users-list)
- [Product Detail](/docs3/nightly/#product-detail)
- [Product OAS Documentation](/docs3/nightly/#product-oas-documentation)
...
{{ range .posts }}
<div class="blog-post">
  <h2><a href="/docs3/nightly/{{ .URL }}">{{ .Title }}</a></h2>
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/docs3/nightly/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/docs3/nightly/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/docs3/nightly/portal/private/users">Cancel</a>
...
<div class="product-detail">
  ...
  <div class="related-post">
    <h3><a href="/docs3/nightly/{{ .Path }}">{{ .Title }}</a></h3>
    <img src="{{ .HeaderImage.URL }}" alt="{{ .Title }}">
    <p>{{ .Lede }}</p>
  </div>
  {{ end }}
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/docs3/nightly/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/docs3/nightly/#cancreateorganisation)
- [Clients](/docs3/nightly/#clients)
- [Current User](/docs3/nightly/#currentuser)
- [FeaturedProducts](/docs3/nightly/#featuredproducts)
- [FilterUserInvites](/docs3/nightly/#filteruserinvites)
- [FormatTime](/docs3/nightly/#formattime)
- [GetCart](/docs3/nightly/#getcart)
- [GetCatalogueList](/docs3/nightly/#getcataloguelist)
- [GetCataloguesForProduct](/docs3/nightly/#getcataloguesforproduct)
- [GetClientDescription](/docs3/nightly/#getclientdescription)
- [GetClientName](/docs3/nightly/#getclientname)
- [GetMenus](/docs3/nightly/#getmenus)
- [GetProducts](/docs3/nightly/#getproducts)
- [IsPortalDisabled](/docs3/nightly/#isportaldisabled)
- [IsPortalPrivate](/docs3/nightly/#isportalprivate)
- [ProductDocRenderer](/docs3/nightly/#productdocrenderer)
- [ProviderUpstreamURL](/docs3/nightly/#providerupstreamurl)
- [SplitStrings](/docs3/nightly/#splitstrings)
- [TruncateString](/docs3/nightly/#truncatestring)
- [TypeOfCredential](/docs3/nightly/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/docs3/nightly/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/docs3/nightly/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/docs3/nightly/portal/customization/menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/docs3/nightly/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/docs3/nightly/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/docs3/nightly/portal/customization/email-notifications)
for additional detail on email notifications sent by the portal.


### Available Email Templates

- [Access Request Approve/Reject](/docs3/nightly/#access-request-approvereject)
- [Access Request Submitted](/docs3/nightly/#access-request-submitted)
- [Activate and Deactivate](/docs3/nightly/#activate-and-deactivate)
- [New User Request](/docs3/nightly/#new-user-request)
- [Organization Approve](/docs3/nightly/#organization-approve)
- [Organization Reject](/docs3/nightly/#organization-reject)
- [Organization Request](/docs3/nightly/#organization-request)
- [Reset Password](/docs3/nightly/#reset-password)
- [Targeted Invite](/docs3/nightly/#targeted-invite)
- [Welcome User](/docs3/nightly/#welcome-user)
