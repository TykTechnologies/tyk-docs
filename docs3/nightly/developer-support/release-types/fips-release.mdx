...
*FIPS compliance* means that the *FIPS Tyk Product* only uses FIPS 140-2 approved cryptographic [algorithms](/docs3/nightly/#fips-compliant-cryptographic-operations)
