...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs3/nightly/#Changelog-v1.7.0) below.
...
For more details, refer to the [OIDC SSO with JWE](/docs3/nightly/api-management/external-service-integration#social-profile-fields) documentation.
</Expandable>
</li>
