...
For a full list of changes, see the detailed [changelog](/docs3/nightly/#Changelog-v1.28.1) below.
...
<h3 id="Changelog-v1.28.1">Changelog</h3>
#### Added
...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs3/nightly/#Changelog-v1.28.0) below.
...
<h3 id="Changelog-v1.28.0">Changelog</h3>
#### Added
...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs3/nightly/#Changelog-v1.27.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs3/nightly/#Changelog-v1.26.0) below.
...
Tyk Cloud allows users to enable or disable audit logging for their [Control Plane](/docs3/nightly/api-management/mdcb#data-plane) (CP) deployments, providing greater flexibility in managing compliance and storage costs. To enable this feature, please contact your account manager.
...
For more details, check out the [documentation on Gateway versioning and auto-upgrades](/docs3/nightly/developer-support/release-types/long-term-support)
...
For more details, check out the [documentation on setting up Telemetry export](/docs3/nightly/tyk-cloud#enabling-telemetry-in-tyk-cloud).
