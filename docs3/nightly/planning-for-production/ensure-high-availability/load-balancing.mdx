...
See [Service Discovery](/docs3/nightly/planning-for-production/ensure-high-availability/service-discovery) to see how you can integrate a service discovery system such as Consul or etcd with Tyk and enable dynamic load balancing support.
...
You can also perform [gRPC Load balancing](/docs3/nightly/key-concepts/grpc-proxy#grpc-load-balancing).
