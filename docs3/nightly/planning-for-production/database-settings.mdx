...
* [Redis](/docs3/nightly/planning-for-production/database-settings#redis)
* [MongoDB](/docs3/nightly/planning-for-production/database-settings#mongodb-sizing-guidelines)
* [PostgreSQL](/docs3/nightly/planning-for-production/database-settings#postgresql)

Please consult the [data storage configuration](/docs3/nightly/api-management/dashboard-configuration#data-storage-solutions) guide for further information relating to how to configure Tyk's data storage across different database engines.
...
**Capping Analytics**
Tyk Gateways can generate a lot of analytics data. Be sure to read about [capping your Dashboard analytics](/docs3/nightly/api-management/tyk-pump#tyk-pump-capping-analytics-data-storage)
...
* [Configure Dashboard MongoDB driver](/docs3/nightly/tyk-dashboard/configuration#mongo_driver)
* [Configure MDCB MongoDB driver](/docs3/nightly/tyk-multi-data-centre/mdcb-configuration-options#analyticsdriver)
...
<Note>
If you are using [DocumentDB](https://aws.amazon.com/documentdb/), [capped collections](/docs3/nightly/api-management/tyk-pump#tyk-pump-capping-analytics-data-storage) are not supported. See [here](https://docs.aws.amazon.com/documentdb/latest/developerguide/mongo-apis.html) for more details.
</Note>
...
More information on these configuration variables [here](/docs3/nightly/tyk-dashboard/configuration). 
