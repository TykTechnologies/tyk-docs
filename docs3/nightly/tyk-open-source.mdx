...
* [Tyk Gateway](/docs3/nightly/tyk-oss-gateway) - Fully fledged API Gateway (Start here!) - <a href="https://github.com/TykTechnologies/tyk" className="github-button" target="_blank" rel="noopener noreferrer">⭐ Star TykTechnologies/tyk</a>
* [Tyk Pump](/docs3/nightly/tyk-pump) - Send API analytics data to your chosen backend - <a href="https://github.com/TykTechnologies/tyk-pump" className="github-button" target="_blank" rel="noopener noreferrer">⭐ Star TykTechnologies/tyk-pump</a>
* [Tyk Identity Broker](/docs3/nightly/api-management/external-service-integration#what-is-tyk-identity-broker-tib) - Connect your third-party IdP systems - <a href="https://github.com/TykTechnologies/api-management/external-service-integration#what-is-tyk-identity-broker-tib" className="github-button" target="_blank" rel="noopener noreferrer">⭐ Star TykTechnologies/api-management/external-service-integration#what-is-tyk-identity-broker-tib</a>
* [Tyk Helm Chart](/docs3/nightly/product-stack/tyk-charts/overview) - Deploy Tyk in K8S - <a href="https://github.com/TykTechnologies/tyk-charts" className="github-button" target="_blank" rel="noopener noreferrer">⭐ Star TykTechnologies/tyk-charts</a>
...
We recommend [Tyk Gateway docker compose](https://github.com/TykTechnologies/tyk-gateway-docker) as the quickest way to get started. If you want to deploy it in a specific platform check our [installation options](/docs3/nightly/#installation-options-for-tyk-gateway) page.
...
<Card href="/docs3/nightly/tyk-open-source#install-tyk-gateway-with-docker" img="/img/docker.png">
**Read time: 10 mins**

Install with Docker.
</Card>

<Card href="/docs3/nightly/tyk-open-source#install-tyk-gateway-with-kubernetes" img="/img/k8s.png">
**Read time: 10 mins**

Install with K8s.
</Card>

<Card href="/docs3/nightly/tyk-open-source#install-tyk-gateway-with-ansible" img="/img/ansible.png">
**Read time: 10 mins**

Install with Ansible.
</Card>

<Card href="/docs3/nightly/tyk-open-source#install-tyk-gateway-on-red-hat-rhel--centos" img="/img/redhat-logo2.png">
**Read time: 10 mins**

Install on RHEL / CentOS.
</Card>

<Card href="/docs3/nightly/tyk-open-source#install-tyk-gateway-with-ubuntu" img="/img/debian-nd-753.png">
**Read time: 10 mins**

Install on Debian / Ubuntu.
</Card>

<Card href="/docs3/nightly/https://github.com/TykTechnologies/tyk" img="/img/GitHub-Mark-64px.png">
**Read time: 10 mins**
...
The following are required for a Tyk OSS installation:
 ...
 - MongoDB - Required only if you chose to use the Tyk Pump with your Tyk OSS installation. Same goes with any [other pump data stores](/docs3/nightly/api-management/tyk-pump#external-data-stores) you choose to use.
...
Get started with our [Quick Start guide](/docs3/nightly/#quick-start-with-helm-chart) or go to [Tyk Open Source helm chart](/docs3/nightly/product-stack/tyk-charts/tyk-oss-chart) for detailed installation instructions and configuration options.
...
For the complete installation guide and configuration options, please see [Tyk OSS Helm Chart](/docs3/nightly/product-stack/tyk-charts/tyk-oss-chart).

#### Configure Legacy Tyk Headless Helm Chart

<Warning>
`tyk-headless` chart is deprecated. Please use our Tyk Chart for Tyk Open Source at [tyk-oss](/docs3/nightly/#quick-start-with-helm-chart) instead. 

We recommend all users migrate to the `tyk-oss` Chart. Please review the [Configuration](/docs3/nightly/#quick-start-with-helm-chart) section of the new helm chart and cross-check with your existing configurations while planning for migration.
</Warning>
...
2. MongoDB/SQL - Required only if you choose to use the MongoDB/SQL Tyk pump with your Tyk OSS installation. The same goes for any
             [other pump](/docs3/nightly/api-management/tyk-pump#external-data-stores) you choose to use.
...
<Note>
Please make sure you are installing Redis versions that are supported by Tyk. Please refer to Tyk docs to get a list of [supported versions](/docs3/nightly/#supported-versions).
</Note>
...
*   The Tyk Gateway has a [dependency](/docs3/nightly/#supported-versions) on Redis. Follow the steps provided by Red Hat to make the installation of Redis, conducting a [search](https://access.redhat.com/search/?q=redis) for the correct version and distribution.
