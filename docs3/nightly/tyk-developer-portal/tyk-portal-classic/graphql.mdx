...
As of Tyk v3.0.0, you can now publish GraphQL APIs, including [Universal Data Graph](/docs3/nightly/api-management/data-graph#overview) APIs(UDG) to the Tyk Developer Portal.
