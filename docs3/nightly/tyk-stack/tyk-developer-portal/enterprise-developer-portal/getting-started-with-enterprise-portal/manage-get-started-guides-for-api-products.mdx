...
1. **Create and publish an API Product**
    ...
    To start with, create and publish an API Product. Please refer to the [Publish API Products and Plans](/docs3/nightly/portal/overview/getting-started#publish-an-api-product) page for further guidance.
