...
[section](/docs3/portal/customization/pages#edit-page-content)
...
- [Template Data](/docs3/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/docs3/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/docs3/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/docs3/#analytics)
- [Application Create](/docs3/#application-create)
- [Application Detail](/docs3/#application-detail)
- [Blogs](/docs3/#blogs)
- [Blog Detail](/docs3/#blog-detail)
- [Cart Checkout](/docs3/#cart-checkout)
- [Organization User Detail](/docs3/#organization-user-detail)
- [Organization User Edit](/docs3/#organization-user-edit)
- [Organization Users List](/docs3/#organization-users-list)
- [Product Detail](/docs3/#product-detail)
- [Product OAS Documentation](/docs3/#product-oas-documentation)
...
{{ range .posts }}
<div class="blog-post">
  <h2><a href="/docs3/{{ .URL }}">{{ .Title }}</a></h2>
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/docs3/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/docs3/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/docs3/portal/private/users">Cancel</a>
...
<div class="product-detail">
  ...
  <div class="related-post">
    <h3><a href="/docs3/{{ .Path }}">{{ .Title }}</a></h3>
    <img src="{{ .HeaderImage.URL }}" alt="{{ .Title }}">
    <p>{{ .Lede }}</p>
  </div>
  {{ end }}
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/docs3/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/docs3/#cancreateorganisation)
- [Clients](/docs3/#clients)
- [Current User](/docs3/#currentuser)
- [FeaturedProducts](/docs3/#featuredproducts)
- [FilterUserInvites](/docs3/#filteruserinvites)
- [FormatTime](/docs3/#formattime)
- [GetCart](/docs3/#getcart)
- [GetCatalogueList](/docs3/#getcataloguelist)
- [GetCataloguesForProduct](/docs3/#getcataloguesforproduct)
- [GetClientDescription](/docs3/#getclientdescription)
- [GetClientName](/docs3/#getclientname)
- [GetMenus](/docs3/#getmenus)
- [GetProducts](/docs3/#getproducts)
- [IsPortalDisabled](/docs3/#isportaldisabled)
- [IsPortalPrivate](/docs3/#isportalprivate)
- [ProductDocRenderer](/docs3/#productdocrenderer)
- [ProviderUpstreamURL](/docs3/#providerupstreamurl)
- [SplitStrings](/docs3/#splitstrings)
- [TruncateString](/docs3/#truncatestring)
- [TypeOfCredential](/docs3/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/docs3/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/docs3/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/docs3/portal/customization/menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/docs3/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/docs3/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/docs3/portal/customization/email-notifications)
for additional detail on email notifications sent by the portal.


### Available Email Templates

- [Access Request Approve/Reject](/docs3/#access-request-approvereject)
- [Access Request Submitted](/docs3/#access-request-submitted)
- [Activate and Deactivate](/docs3/#activate-and-deactivate)
- [New User Request](/docs3/#new-user-request)
- [Organization Approve](/docs3/#organization-approve)
- [Organization Reject](/docs3/#organization-reject)
- [Organization Request](/docs3/#organization-request)
- [Reset Password](/docs3/#reset-password)
- [Targeted Invite](/docs3/#targeted-invite)
- [Welcome User](/docs3/#welcome-user)
