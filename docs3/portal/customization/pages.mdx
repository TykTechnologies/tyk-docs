...
We suggest you read the [portal concepts](/docs3/portal/overview/concepts) first. If you've already done that, we will show you an example on how to:
...
<html lang="en">
 ...
 <head>
   ...
   <title>{{ if .page}} {{.page.Title}} {{else}} Developer Portal {{end}}</title>
    ...
    {/* Bootstrap core CSS */}
    <link href="/docs3/system/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="/docs3/assets/stylesheets/fonts.css" rel="stylesheet">
    <link href="/docs3/assets/stylesheets/main.css" rel="stylesheet">
