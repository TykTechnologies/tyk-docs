...
- Connect to a provider [Tyk Self-Managed](/docs3/portal/overview/getting-started#connect-to-a-provider)
- Create [policies with enforced access rights](/docs3/portal/overview/getting-started#create-api-products-and-plans) (API Product in the Portal)
- Create one or more [policies with enforced rate limit and quotas](/docs3/portal/overview/getting-started#create-api-products-and-plans) (Plan in the Portal)
