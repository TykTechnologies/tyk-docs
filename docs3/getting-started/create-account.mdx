...
Finally, you will be taken to the Tyk Dashboard. Select "Design From Scratch" and continue on to [our tutorial](/docs3/getting-started/configure-first-api) to learn how to setup and secure your APIs.
...
- **Create Your First API**: Follow our guide on [setting up and securing your first API](/docs3/getting-started/configure-first-api).
- **Explore the Dashboard**: Familiarize yourself with the [Tyk Cloud interface](/docs3/tyk-dashboard).
