...
import CreatePortalEntryInclude from '/snippets/5.9/create-portal-entry-include.mdx';
...
This is for the closed source [Tyk Developer Portal](/docs3/tyk-developer-portal) only
