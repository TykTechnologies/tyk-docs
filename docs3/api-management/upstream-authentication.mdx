...
- [Mutual TLS](/docs3/api-management/upstream-authentication/mtls)
- [Token-based authentication](/docs3/api-management/upstream-authentication/auth-token)
- [Request signing](/docs3/api-management/upstream-authentication/request-signing)
- [Basic Authentication](/docs3/api-management/upstream-authentication/basic-auth)
- [OAuth 2.0](/docs3/api-management/upstream-authentication/oauth)
    - [OAuth 2.0 Client Credentials](/docs3/api-management/upstream-authentication/oauth#oauth-client-credentials)
    - [OAuth 2.0 Password Grant](/docs3/api-management/upstream-authentication/oauth#oauth-resource-owner-password-credentials)
