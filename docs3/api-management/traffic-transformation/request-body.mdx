...
The middleware has direct access to the request body and also to dynamic data as follows:
 ...
 - values from [key-value (KV) storage](/docs3/tyk-self-managed#transformation-middleware) can be injected into the template using the notation appropriate to the location of the KV store
