...
To enhance security by restricting visibility of the credentials, these can be stored in a [key-value store](/docs3/tyk-self-managed/install), with only references included in the API definition.
