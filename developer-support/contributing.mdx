...
- [blacklisted_ips](/api-management/gateway-config-tyk-classic#ip-blocklist-middleware)
- [disable_ports_whitelist](/tyk-oss-gateway/configuration#disable_ports_whitelist)
- [enable_ip_blacklisting](/api-management/gateway-config-tyk-classic#ip-blocklist-middleware)
- [ports_whitelist](/tyk-oss-gateway/configuration#ports_whitelist)
