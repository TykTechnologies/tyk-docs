...
For production environments, it is recommended to use [Helm charts](#helm) or the [Tyk Operator](/docs/tyk-stack/tyk-operator/installing-tyk-operator/#upgrading-tyk-operator) to manage upgrades with zero downtime.
