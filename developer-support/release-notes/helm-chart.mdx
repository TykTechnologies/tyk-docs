...
Resolved an issue found on 5.1.0 where installing the Tyk Operator via Helm failed due to missing webhook annotation values in the chart. Users can now successfully install the Tyk Operator using Helm without encountering template rendering errors.
</Accordion>
