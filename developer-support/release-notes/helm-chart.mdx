...
#### Release Highlights
Tyk Charts 5.0.0 introduces a more secure default for client IP detection by setting the XFF depth to 1 for all new deployments. This release also aligns with the most recent Tyk LTS release [5.8.9](/developer-support/release-notes/dashboard#589-release-notes).
