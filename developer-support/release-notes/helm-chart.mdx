...
Added support for users to attach custom labels to Tyk Operator pods using the `podLabels` map. This functionality is already available for the Tyk Dashboard, Tyk Gateway, Tyk Developer Portal and Tyk Pump components.
</Accordion>
