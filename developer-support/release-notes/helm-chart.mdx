...
#### Release Highlights
Tyk Charts 5.0.0 is a version alignment release that ensures compatibility with the most recent Tyk LTS release [5.8.9](/developer-support/release-notes/dashboard#589-release-notes).
