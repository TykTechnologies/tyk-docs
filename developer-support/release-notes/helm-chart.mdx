...
#### Release Highlights
Tyk Charts 5.2.0 enhances Helm chart customization capabilities by adding pod labeling support for the Tyk Operator.
...
<Accordion title='Add `podLabels` support to Tyk Operator in helm chart'>
Added support for specifying custom `podLabels` for the Tyk Operator deployment in Helm charts. This allows users to attach custom labels to the underlying Tyk Operator pods, bringing it in line with the other Tyk components.
</Accordion>
