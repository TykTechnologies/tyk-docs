...
This is a version bump to align with Tyk LTS release 5.8.15.
No changes have been made to this release.

For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v5.2.1) below.

#### Breaking Changes
This release has no breaking changes.

#### Dependencies
<a id="dependencies-5.2.1"></a>
...
#### Downloads
- [Source code](https://github.com/TykTechnologies/tyk-charts/archive/refs/tags/v5.2.1.tar.gz)
- [ArtifactHub - tyk-stack](https://artifacthub.io/packages/helm/tyk-helm/tyk-stack/5.2.1)
- [ArtifactHub - tyk-control-plane](https://artifacthub.io/packages/helm/tyk-helm/tyk-control-plane/5.2.1)
- [ArtifactHub - tyk-data-plane](https://artifacthub.io/packages/helm/tyk-helm/tyk-data-plane/5.2.1)
- [ArtifactHub - tyk-oss](https://artifacthub.io/packages/helm/tyk-helm/tyk-oss/5.2.1)

#### Changelog
<a id="Changelog-v5.2.1" data-scroll-offset></a>
