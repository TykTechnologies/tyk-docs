...
The admission webhook for the security policy (`validate-tyk-tyk-io-v1alpha1-securitypolicy`) has been removed because it did not perform any functional validation. This change simplifies the operator deployment and reduces webhook overhead.
</Expandable>
