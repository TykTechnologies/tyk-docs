...
In this release, we have resolved a set of issues affecting the reliability of SecurityPolicy reconciliation under high load, and added a new environment variable to tune the Tyk Operator's HTTP connection pool to the Tyk Dashboard. We have also addressed CVEs to strengthen security.
