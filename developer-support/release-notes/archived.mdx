...
* Enable Tyk Identity Broker to apply LDAP filters to user search [Docs](/tyk-identity-broker/sso-ldap)
...
* For those who love to build everything in-house, we have added new API for custom dashboard authentication integrations. [Docs](/tyk-identity-broker/sso-proxy)
...
[Docs](/tyk-identity-broker/sso-proxy)
...
Tyk Identity Broker now fully support LDAP search with complex filters! [Docs](/tyk-identity-broker/sso-ldap)
