...
This release fixes an authorization issue in the billing subscription API and updates the Go toolchain to Go 1.26.
...
<Accordion title='Fixed an authorization issue in the billing subscription API'>
{/* TT-17510 */}
An authorization check was missing in the Ara billing subscription API that could, under certain conditions, allow an authenticated non-admin user to access or activate subscription plans intended to be restricted to Tyk staff. This has been fixed: staff-restricted plans are no longer visible or selectable by non-admin accounts, while existing self-service plan changes — including downgrading to a trial or free plan — continue to work as before. This issue was identified and responsibly disclosed through Tyk's vulnerability disclosure programme.
</Accordion>
...
- <a href="https://nvd.nist.gov/vuln/detail/CVE-2026-2673" target="_blank">CVE-2026-2673</a>
