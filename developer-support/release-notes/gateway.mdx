...
- `regexp_cache_max_entries`  caps the regular-expression cache (default: `5000`)
- `disable_regexp_cache_bound` restores the previous unbounded behaviour for deployments with a naturally limited set of patterns (default:`false`)
- `disable_auto_max_procs` restores the previous default behavior of GOMAXPROCS (default:`false`)
</Accordion>
