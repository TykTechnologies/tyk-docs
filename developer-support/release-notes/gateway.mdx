...
In this release, we have fixed a memory leak in the gateway that could occur when using JWT authentication. For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v5.11.1) below.
