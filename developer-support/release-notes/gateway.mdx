...
A new next-generation (`-ng`) [plugin compiler](/api-management/plugins/plugin-compiler) is now available, as an alternative to the existing compiler, with a significantly reduced the OS-level CVE surface compared to the current compiler.

This compiler adds [native linux/arm64 support](/api-management/plugins/plugin-compiler-ng#native-arm64-support). Plugins built on Apple Silicon or other arm64 hosts no longer need to run the compiler under emulation.
...
For more details see [Next-Generation Plugin Compiler](/api-management/plugins/plugin-compiler) and [Migrating to the Next-Generation Plugin Compiler](/api-management/plugins/plugin-compiler-ng-migration).
</Accordion>
...
For more details see [Next-Generation Plugin Compiler](/api-management/plugins/plugin-compiler-ng) and [Migrating to the Next-Generation Plugin Compiler](/api-management/plugins/plugin-compiler-ng-migration).
</Accordion>
