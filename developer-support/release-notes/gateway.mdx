...
This compiler adds [native linux/arm64 support](/api-management/plugins/plugin-compiler#native-arm64-support). Plugins built on Apple Silicon or other arm64 hosts no longer need to run the compiler under emulation.
...
For more details see [Next-Generation Plugin Compiler](/api-management/plugins/plugin-compiler) and [migrating from the existing compiler](/api-management/plugins/plugin-compiler#migrating-from-the-existing-compiler).
</Accordion>
