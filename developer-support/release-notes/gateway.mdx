...
Two new fields have been added to the Session object, which can be directly configured when creating Sessions using the [Keys API](/api-reference/keys/create-a-key-1) or [Policy API](/api-reference/policies/create-a-policy):
