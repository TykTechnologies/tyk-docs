...
<Note>
Tyk Helm Charts are configured to install the LTS version of Tyk Gateway. You will need to modify them to install v5.13.1.
</Note>
...
<Accordion title='Fix MCP distributed trace blind spot — operators can now trace requests end-to-end from agent through Tyk to upstream MCP server'>
