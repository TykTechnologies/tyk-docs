...
<Accordion title='Standardize application log timestamps to RFC3339'>
Tyk Gateway now outputs a consistent, RFC3339-compliant timestamp across all application log entries, resolving an inconsistency where the same log file could contain two different timestamp formats. 
