...
This compiler adds native `linux/arm64` support. Plugins built on Apple Silicon or other arm64 hosts no longer need to run the compiler under emulation.
...
For more details see [Golang Plugin Compiler](/api-management/plugins/golang#plugin-compiler).
</Accordion>
