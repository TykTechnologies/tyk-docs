...
Updated the Tyk Gateway and Plugin Compiler to use Go 1.25.5, ensuring compatibility with the latest Go runtime features and reducing exposure to potential security vulnerabilities in older versions.
</Accordion>
