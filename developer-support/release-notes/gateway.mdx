...
You must set [http_server_options.max_version](/tyk-oss-gateway/configuration#http_server_options-max_version) (or the equivalent environment variable)  to `771` if you require an upper limit of TLS 1.2.
  ...
  See [here](/api-management/certificates#supported-tls-versions) for details how to control TLS version and cipher suites.
...
For full details of TLS version configuration see [here](/api-management/certificates#supported-tls-versions).
</Accordion>
