...
Built on Go 1.25 with upgraded OpenTelemetry SDK dependencies, this release delivers cumulative performance improvements across trace lifecycle methods, context propagation, and metrics recording. Enhanced TLS defaults now use TLS 1.3 by default, aligning with industry security standards, while comprehensive CVE fixes in dependent libraries provide increased protection against security vulnerabilities.
