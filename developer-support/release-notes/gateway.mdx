...
In this version, we have updated the gateway TLS certificate to extend validity and improve compatibility with modern TLS standards. For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v5.3.13) below.
