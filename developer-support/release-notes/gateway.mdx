...
This patch fixes a security issue in GraphQL APIs using per-request auth propagation that could cause cross-user credential and response leakage, as well as some high-priority CVEs.
