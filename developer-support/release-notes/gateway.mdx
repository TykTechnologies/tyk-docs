...
For more details, please see the dedicated [JWT Auth](/basic-config-and-security/security/authentication-authorization/json-web-tokens#managing-authorization-with-jwt) section.
...
For more details, please see the [JWT Auth](/basic-config-and-security/security/authentication-authorization/json-web-tokens#jwt-signatures) section.
