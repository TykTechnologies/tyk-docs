...
In this release, we introduce unified path matching for OAS middleware, enabling wildcard and subpath support that brings feature parity with Classic APIs. Additionally, we have addressed several issues that improve API reliability, observability, and user experience.
