...
You must set the `"http_server_options.max_version":=771` (or the equivalent environment variable (`TYK_GW_HTTPSERVEROPTIONS_MAXVERSION`) if you require an upper limit of TLS 1.2.
