...
This patch upgrades Tyk Gateway to Go 1.24. For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v5.3.13) below.
...
<Accordion title='Updated Tyk Gateway to Go 1.24'>
Updated the Tyk Gateway to use Go 1.24, reducing exposure to potential security vulnerabilities in older versions.
</Accordion>
