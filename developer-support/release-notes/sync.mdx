...
#### Release Highlights
In this patch release, we updated Tyk Sync to use storage library v1.3.0. For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v2.1.5).
