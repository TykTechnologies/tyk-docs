...
Resolved an issue where syncing large numbers of policies and APIs could take hours instead of minutes. Tyk Sync will now correctly sync large deployments at the performance levels introduced in v1.5.0, restoring the expected sync performance.
</Accordion>
