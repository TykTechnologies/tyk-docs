...
#### Release Highlights
Tyk Sync 2.1.7 updates the Go version to 1.25, fixes a performance issue, and ensures compatibility with the most recent Tyk LTS release [5.8.14](/developer-support/release-notes/dashboard#5814-release-notes).
