...
#### Release Highlights
Tyk Sync 2.1.6 is a version alignment release that ensures compatibility with the most recent Tyk LTS release [5.8.12](/developer-support/release-notes/dashboard#5812-release-notes).
...
#### Release Highlights
Tyk Sync 2.1.4 is a version alignment release that ensures compatibility with the most recent Tyk LTS release [5.8.6](/developer-support/release-notes/dashboard#586-release-notes). No functional changes have been implemented in this release.
