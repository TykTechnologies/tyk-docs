...
- Promote a child API to become the new base (automatically converting the original base API to become a child)
- Delete all child versions with the base API
