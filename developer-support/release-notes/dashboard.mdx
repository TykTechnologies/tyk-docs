...
Upgrade to **EDP v1.17.2** before or immediately after upgrading the Dashboard. EDP v1.17.2 detects MCP Proxy APIs by type and filters all MCP Proxy policies from the developer catalogue.
