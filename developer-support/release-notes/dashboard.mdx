...
| [MongoDB](https://www.mongodb.com/try/download/community)  | 5.0.x, 6.0.x, 7.0.x  | 5.0.x, 6.0.x, 7.0.x  | Used by Tyk Dashboard | 
| [PostgreSQL](https://www.postgresql.org/download/)         | 12.x - 16.x LTS        | 12.x - 16.x            | Used by Tyk Dashboard | 
| [OpenAPI Specification](https://spec.openapis.org/oas/v3.0.3) | v3.0.x      | v3.0.x          | Supported by [Tyk OAS](/api-management/gateway-config-tyk-oas#tyk-oas-api-definition-object)|
...
- **Not Forward Compatible**
  ...
  - This means that any Tyk OAS APIs created in any previous release (4.1.0-5.2.x) cannot work with the new Tyk Dashboard v5.3.X without being migrated to its [latest format](/api-management/gateway-config-tyk-oas#tyk-oas-api-definition-object).
...
- **After upgrade (the good news)**
  - If you had a Tyk OAS API prior to v5.3.0 then Tyk Dashboard will automatically update the API definition to [latest format](/api-management/gateway-config-tyk-oas#tyk-oas-api-definition-object).
...
We’ve added the ability to [configure](/api-management/gateway-optimizations#configuring-the-middleware-in-the-tyk-oas-api-definition) per-endpoint timeouts for Tyk’s response cache, giving you increased flexibility to tailor your APIs to your upstream services. While doing this, we’ve also fixed a longstanding issue within the *Tyk Dashboard* so that you can configure more of the [advanced caching](/api-management/gateway-optimizations#configuring-the-middleware-in-the-api-designer) options from within the UI.
...
[Importing OAS v3 via the Dashboard](/api-management/gateway-config-managing-oas#using-the-tyk-dashboard-ui)
...
This capability is available in both the open source and paid versions of Tyk. See our [High Level Concepts](/api-management/gateway-config-managing-oas#) for more details, or jump to [OAS Getting Started documentation](/api-management/gateway-config-managing-oas#create-a-tyk-oas-api).
...
See our updated [Tutorials](/getting-started/installation) section.
