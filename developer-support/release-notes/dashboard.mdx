...
- [Docker Image to pull](https://hub.docker.com/r/tykio/tyk-dashboard/tags?page=&page_size=&ordering=&name=v5.10.2)
  - ```bash
    ...
    ```
- Helm charts
  - [tyk-charts v4.1.0](/developer-support/release-notes/helm-chart#400-release-notes)
...
Fixed an issue where JWKS cache timeout values could not be saved in the API Designer. The timeout field would appear to accept values, but would disappear after saving the API configuration.
</Accordion>
