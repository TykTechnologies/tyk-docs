...
- **A new Governance tab** on every API shows its compliance status, a breakdown by ruleset, and a filterable table of issues, each with a severity level (Error, Warn, or Info) and specific "how to fix" guidance.
...
In this release, Tyk Governance supports Tyk OAS APIs only. Tyk Governance is disabled by default — contact your Tyk account team to enable it for your organization. For more information, visit our documentation at [PLACEHOLDER: insert Tyk Governance documentation link].
</Accordion>
