...
|--------|-------------------|-------------|
| 5.13.1 | MDCB v2.11.0       | MDCB v2.11.0 |
...
<Note>
Tyk Helm Charts are configured to install the LTS version of Tyk Dashboard. You will need to modify them to install v5.13.1.
</Note>
