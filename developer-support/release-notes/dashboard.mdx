...
- Now you can turn a Kafka topic into a GraphQL subscription by simply [importing your AsyncAPI definition](/platform-management/dashboard-api#data-graphs-api)
