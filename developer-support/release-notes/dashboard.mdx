...
This patch release contains various bug fixes and introduces enhanced Open Policy Agent support for API type detection. For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v5.8.9).
