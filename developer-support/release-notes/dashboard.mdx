...
The Dashboard now includes a new dedicated endpoint (`/api/apis/:apiId/certs`) that accurately retrieves all associated certificates, providing complete visibility of certificate usage across all TLS/SSL scenarios for each API.
</Accordion>
