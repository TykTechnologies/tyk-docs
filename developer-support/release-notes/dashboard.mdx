...
This patch release addresses a severity of CVEs present in 5.3.12. For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v5.3.13) below.
