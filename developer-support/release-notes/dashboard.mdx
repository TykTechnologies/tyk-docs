...
This is a security-only patch release for Tyk Dashboard. It contains no functional or behavioral changes; it addresses several CVEs identified in dependent libraries. For the full list of CVEs addressed, see the Security Fixes section of the Changelog below.

For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v5.13.3) below.
...
#### Dependencies
<a id="dependencies-5.13.3"></a>

| Dashboard Version | Recommended Releases | Backwards Compatibility |
| :------ | :---------------- | :---------------- |
| 5.13.3  | MDCB v2.13.0      | MDCB v2.13.0      |
|         | Operator v1.5.0   | Operator v0.17    |
|         | Sync v2.2.2       | Sync v2.2.2       |
|         | Helm Chart v5.4.0 | Helm all versions |
|         | EDP v1.19.0       | EDP all versions  |
...
#### Upgrade instructions
<a id="upgrade-5.13.3"></a>

If you are upgrading to 5.13.3, please follow the detailed [upgrade instructions](#upgrading-tyk).

#### Downloads

- [Docker Image to pull](https://hub.docker.com/r/tykio/tyk-dashboard/tags?page=&page_size=&ordering=&name=v5.13.3)
  - ```bash
    docker pull tykio/tyk-dashboard:v5.13.3
    ```
- Helm charts
  - [tyk-charts](/developer-support/release-notes/helm-chart)

#### Changelog
<a id="Changelog-v5.13.3" data-scroll-offset></a>
