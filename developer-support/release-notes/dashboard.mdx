...
For a more thorough guide on how to set IAM Auth, please see here: https://tyk.io/docs/tyk-configuration-reference/redis-cluster-sentinel#iam-authentication
