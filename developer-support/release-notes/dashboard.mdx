...
#### Release xx December 2025

#### Release Highlights

For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v5.8.9).
...
|         | Helm Chart v4.2.0  | Helm all versions |
| | EDP v1.15.0 | EDP all versions |
