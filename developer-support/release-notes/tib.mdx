...
Tyk Identity Broker now supports IAM-based authentication for Google Cloud Memorystore for Redis Cluster and Valkey, as an alternative to a static password.
...
{/* TT-17611 */}
Tyk Identity Broker can now authenticate to Google Cloud Memorystore for Redis/Valkey using GCP IAM-based authentication, as an alternative to a static Redis password.
...
For more details, refer to the [OIDC SSO with JWE](/api-management/single-sign-on-social-idp#json-web-encryption-jwe) documentation.
</Expandable>
