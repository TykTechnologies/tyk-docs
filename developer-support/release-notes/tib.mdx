...
This release extends GCP IAM-based authentication for Redis/Valkey to TIB's storage connection and updates the Go toolchain to Go 1.26. This release also addresses reported CVEs in dependent libraries.
