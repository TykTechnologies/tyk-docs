...
In this release, we have added an integrated GraphQL Playground to the Developer Portal, upgraded the Tyk Portal to Golang 1.24, and fixed a high-priority CVE.
...
- **Schema Documentation**: Admins can upload GraphQL Schema Definition Language (SDL) files (.graphql, .graphqls, or JSON format) to provide rich documentation and enable full playground functionality.
...
Learn more about GraphQL documentation and playground features in our [API Products documentation](/portal/api-products#GraphQL-Playground-in-the-Developer-Portal)

</Accordion>

<Accordion title={'Improved Clarity for GraphQL Server URL Field and Playground Messaging'}>
Updated the title and helper text for the GraphQL server endpoint field in the API Product > Documentation tab to improve clarity. The field is now labeled “GraphQL server URL” with an updated description explaining that it represents the API Gateway URL loaded into the GraphQL Playground. Additionally, the read-only banner shown in the Playground has been reworded to clearly indicate when the server URL is missing or invalid.
...
Fixed the following CVEs identified in the Tyk Portal, providing increased protection against security
vulnerabilities:

- <a href="https://nvd.nist.gov/vuln/detail/cve-2020-8911" target="_blank">CVE-2020-8911</a>
- <a href="https://nvd.nist.gov/vuln/detail/CVE-2018-20796" target="_blank">CVE-2018-20796</a>
- <a href="https://nvd.nist.gov/vuln/detail/CVE-2019-1010022" target="_blank">CVE-2019-1010022</a>
- <a href="https://nvd.nist.gov/vuln/detail/CVE-2019-1010023" target="_blank">CVE-2019-1010023</a>
- <a href="https://nvd.nist.gov/vuln/detail/CVE-2019-1010024" target="_blank">CVE-2019-1010024</a>
- <a href="https://nvd.nist.gov/vuln/detail/CVE-2019-1010025" target="_blank">CVE-2019-1010025</a>
- <a href="https://nvd.nist.gov/vuln/detail/CVE-2019-9192" target="_blank">CVE-2019-9192</a>
- <a href="https://nvd.nist.gov/vuln/detail/CVE-2023-36308" target="_blank">CVE-2023-36308</a>
