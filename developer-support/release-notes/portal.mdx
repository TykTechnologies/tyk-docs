...
The Developer Portal now supports Auth Token-Certificate binding to enhance mTLS security, preventing vulnerabilities from mismatched tokens and certificates.
