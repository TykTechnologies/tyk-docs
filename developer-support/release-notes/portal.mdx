...
Tyk Developer Portal fixes CVEs and has been updated to Go 1.25 and Debian 13 (Trixie) for enhanced security and performance. This release also resolves several Portal API issues, including incorrect `Content-Type` headers, improper null value handling for enum fields, and some policy reference inconsistencies.
