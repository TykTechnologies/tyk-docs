...
In this release, we have added an integrated GraphQL Playground to the Developer Portal, upgraded the Tyk Portal to Golang 1.24, and fixed a priority CVE as well as a bug.
