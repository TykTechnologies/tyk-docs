...
Tyk Developer Portal has been updated to Go 1.25 for enhanced security and performance. This release resolves several Portal API issues, including incorrect `Content-Type` headers, improper null value handling for enum fields, policy reference inconsistencies, and scope mapping cleanup when deleting DCR products. 
