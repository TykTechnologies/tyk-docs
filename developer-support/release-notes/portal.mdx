...
Fixed an issue where the option to "Attach Mutual TLS Certificate" section was incorrectly displayed on the App Details page for Managed mTLS Products. This is now only be offered for Self-Serve mTLS Products, allowing the API Consumer to register their client certificate. For Managed mTLS Products, the permitted client certificates are registered by the API Owner in the Admin Portal.
</Accordion>
