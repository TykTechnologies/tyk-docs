...
<Note>
**If you are upgrading Tyk Dashboard to v5.13.0, we strongly recommend that you upgrade to Developer Portal v1.17.1 at the same time.**
...
With the introduction of MCP Proxy support in the Gateway and Dashboard, however, Policies may be created on the Dashboard that grant access to MCP proxies. Prior to Developer Portal v1.17.1, such Policies would be visible in the Developer Portal and could be inadvertently published to Portal users.
