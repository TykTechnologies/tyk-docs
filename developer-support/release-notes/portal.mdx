...
SSO profile configuration fields (CallbackBaseURL and ReturnURL) are now editable in the Admin Portal, allowing admins to customize authentication URLs instead of being forced to use auto-generated values
</Accordion>

<Accordion title='Editable Redirect URLs in App Settings'>
Redirect URLs can now be edited directly within the "My Apps" section of the Live Portal after app creation. Previously, this field was only configurable during initial app setup. This enhancement brings the Redirect URL field in line with other editable app properties like name and description.
</Accordion>
...
Users can now access their app credentials directly from product documentation pages (OpenAPI, GraphQL playground) without navigating away.
</Accordion>
