...
Fixed an issue where the "Attach Certificate" option disappeared after detaching a certificate from mTLS credentials. Developers can now properly re-attach certificates to their applications as intended.
</Accordion>
