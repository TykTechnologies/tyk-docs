...
The Developer Portal now properly supports rotation and revocation operations for Tyk Managed Custom Credentials. Custom credentials now support the same lifecycle management as standard Tyk tokens.
</Accordion>
