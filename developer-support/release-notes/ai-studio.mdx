...
Some features documented elsewhere in these pages were only introduced in a specific release. Check this table if you are not sure whether your installed version supports a feature.

| Feature | Introduced In |
| :--- | :--- |
| [AWS Bedrock as an LLM provider](/ai-management/ai-studio/llm-management) | 2.1.0 |
| [Compliance Events from filter scripts](/ai-management/ai-studio/compliance-events) | 2.1.0 |
| Per-LLM analytics attribution (`llm_id` on proxy logs) | 2.1.0 |
| [Export chat conversations to PDF](/ai-management/ai-studio/chat-interface) | 2.1.0 |
| Per-LLM request/response body logging toggle (`Disable Request/Response Body Logging`) | 2.1.0 |

Everything not listed here has been available since at least 2.0.
