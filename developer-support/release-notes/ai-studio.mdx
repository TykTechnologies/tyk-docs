...
Use this table to check the minimum version a feature needs, without reading the full changelog below.

| Feature | Since | Documentation |
|---|---|---|
| AWS Bedrock LLM provider | v2.1.0 | [LLM Management](/ai-management/ai-studio/llm-management) |
| Compliance Events | v2.1.0 | [Compliance Events](/ai-management/ai-studio/compliance-events) |
| Per-LLM analytics attribution | v2.1.0 | [Analytics & Monitoring](/ai-management/ai-studio/analytics#per-llm-attribution) |
| Prometheus and OpenTelemetry metrics | v2.1.0 | [Analytics & Monitoring](/ai-management/ai-studio/analytics#prometheus-and-opentelemetry-metrics) |
| Disable Request/Response Body Logging | v2.1.0 | [LLM Management](/ai-management/ai-studio/llm-management) |
| Chat conversation PDF export | v2.1.0 | [Chat Interface](/ai-management/ai-studio/chat-interface) |
