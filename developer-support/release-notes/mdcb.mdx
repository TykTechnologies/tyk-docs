...
- [max_connections](/tyk-multi-data-centre/mdcb-configuration-options) sets the maximum number of concurrent RPC connections MDCB will accept from Data Plane Gateways. 
- [max_connection_idle_time](/tyk-multi-data-centre/mdcb-configuration-options) sets the maximum time an idle RPC connection is kept open before MDCB closes it; this is configured with a readable duration (e.g. "5m").
