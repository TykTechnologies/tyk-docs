...
Tyk MDCB has been updated to Go 1.25 for enhanced security and performance. This release adds a new `omit_analytics_index_creation` configuration option to prevent PostgreSQL deadlocks when running multiple MDCB instances.
