...
In this patch release, we deliver enhanced reliability with upgraded storage library v1.3.0, resolved MongoDB connection leaks, and faster gateway recovery after Redis outages. For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v2.8.7).
