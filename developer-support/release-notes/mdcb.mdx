...
<Note>
Client IdP registry support requires Tyk Gateway and Tyk Dashboard v5.14.0 or higher. Tyk Dashboard has no client IdP storage or endpoints below v5.14.0, so this feature stays inert on Tyk v5.13.x LTS deployments.
</Note>
