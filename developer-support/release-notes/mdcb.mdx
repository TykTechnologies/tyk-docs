...
MDCB 2.11.0 adds dedicated RPC dispatchers for MCP analytics in hybrid deployments, giving Data Planes an isolated channel to route raw and aggregated MCP traffic records to the Control Plane independently of standard API analytics.
...
<Accordion title='Added dedicated MCP analytics RPC dispatchers for hybrid deployments'>
