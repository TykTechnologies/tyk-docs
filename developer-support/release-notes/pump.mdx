...
For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v1.13.3).
...
For further information, please check the [changelog](#Changelog-v1.13.3) below.

#### Upgrade instructions

For users currently on v1.13.2, we strongly recommend promptly upgrading to the latest release. If you are working with an older version (lower major), it is advisable to bypass version 1.13.0 and proceed directly to this latest patch release.
<br/>
