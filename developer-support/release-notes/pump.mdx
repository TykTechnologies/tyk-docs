...
#### Release Highlights
Tyk Pump has been updated to Go 1.25 for enhanced security and performance. This release improves the stdout pump with cleaner, more readable JSON logs by properly formatting escaped characters in request and response fields.
