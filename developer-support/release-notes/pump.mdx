...
| Legacy (deprecated) | Use for [standard Mongo pump](/api-management/tyk-pump#mongo-pump) | Use for [Mongo uptime pump](/planning-for-production/ensure-high-availability/uptime-tests) |
|---|---|---|
