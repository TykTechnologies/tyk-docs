...
#### Release Highlights
This release improves the stdout pump with cleaner, more readable JSON logs by properly formatting escaped characters in request and response fields. It also introduces MCP analytics support, enabling Tyk Pump to store and process MCP Gateway traffic records across MongoDB, PostgreSQL, Elasticsearch, and Prometheus backends.
...
<Accordion title='Improved readability of stdout pump JSON logs'>
...
<Accordion title='Added MCP analytics support'>
