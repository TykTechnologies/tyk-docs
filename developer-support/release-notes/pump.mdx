...
#### Release Highlights
Tyk Pump 1.15.0 introduces comprehensive support for Model Context Protocol (MCP) analytics, enabling specialized handling and observability of AI traffic in both single and MDCB deployments. This release also improves log readability and updates the Go runtime for enhanced security and performance.
...
The Tyk Pump has been updated to Golang 1.25, improving security by staying up-to-date with Go versions.
</Accordion>
