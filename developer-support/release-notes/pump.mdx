...
- Add the ability to generate future data in demo mode using --demo-future-data flag. Demo data generation assigns synthetic timestamps inside the requested generated hour so timestamp fields and denormalized date parts stay aligned.
