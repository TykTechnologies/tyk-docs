...
<Accordion title='Fix duplicate MCP analytics log entries'>
Resolved an issue where MCP records were being written twice to analytics storage. Tyk Pump will now correctly write each MCP analytics record once.
</Accordion>
