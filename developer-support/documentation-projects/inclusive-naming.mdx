...
##### Config parameters
- [allow_master_keys](/tyk-dashboard/configuration#allow_master_keys)
...
- [blacklisted_ips](/tyk-apis/tyk-gateway-api/api-definition-objects/ip-blacklisting#ip-blocklist-middleware)
- [disable_ports_whitelist](/key-concepts/tcp-proxy#allowing-specific-ports)
- [enable_ip_blacklisting](/tyk-apis/tyk-gateway-api/api-definition-objects/ip-blacklisting#ip-blocklist-middleware)
...
The Tyk Classic APIs *Endpoint Designer* shows configuration of [blacklist](/product-stack/tyk-gateway/middleware/block-list-tyk-classic#configuring-the-block-list-in-the-api-designer) and [whitelist](/product-stack/tyk-gateway/middleware/allow-list-tyk-classic#configuring-the-allow-list-in-the-api-designer) middleware plugins.
