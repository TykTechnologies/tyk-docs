...
- [analytics_storage.master_name](/tyk-oss-gateway/configuration#analytics_storage-master_name)
- [cache_storage.master_name](/tyk-oss-gateway/configuration#cache_storage-master_name)
- [storage.master_name](/tyk-oss-gateway/configuration#storage-master_name)
...
- [version_data.versions.version-name.extended_paths.white_list](/api-management/traffic-transformation/allow-list#api-definition). There is also a parameter with equivalent functionality under the `paths` object (`version_data.versions.{version_name}.paths.white_list`).
...
- [analytics_storage.master_name](/tyk-multi-data-centre/mdcb-configuration-options#analytics_storage-master_name)
- [storage.master_name](/tyk-multi-data-centre/mdcb-configuration-options#storage-master_name)

#### Tyk Pump

The following Tyk Pump configuration parameters contain tier 1 word occurrences:
- [analytics_storage_config.master_name](/tyk-pump/tyk-pump-configuration/tyk-pump-environment-variables#analytics_storage_config-master_name)
