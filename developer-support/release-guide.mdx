...
7. **Sync component versions to tyk-install:**
    ...
    If the workflow does not trigger automatically, run it manually from the [Actions tab](https://github.com/TykTechnologies/tyk-docs/actions/workflows/sync-versions-to-tyk-install.yml).
