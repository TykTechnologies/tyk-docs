...
5. **How to Backup Middleware Directory for Custom Plugins ?**
    ...
    Details on middleware installation for [Tyk Self-Managed users](/api-management/plugins/javascript-installing-jsvm#installing-middleware-on-tyk-self-managed) (users of the licensed product).
    Details on middleware installation for [Tyk Open Source users](/api-management/plugins/javascript-installing-jsvm#installing-middleware-on-tyk-oss)
