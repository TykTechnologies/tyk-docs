...
If you are using Self Managed deployment then we recommend that you use [Tyk Sync](/api-management/automations#synchronize-tyk-environment-with-github-repository) to backup your Tyk APIs and policies. 
