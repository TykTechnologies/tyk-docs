...
You can find the full [log levels](/log-data) in our documentation.
...
We recommend always using the [Long-Term Support (LTS) release](/developer-support/special-releases-and-features/long-term-support-releases) for stability and long term support.
...
1. Search the rest of documentation including [Tyk FAQ Section](/frequently-asked-questions)
