...
<Card href="/deployment-and-operations/tyk-open-source-api-gateway/quick-start" img="/img/docker.png">
**Read time: 2 mins**

Install with Docker.
</Card>

<Card href="/apim/open-source/installation#install-tyk-gateway-with-kubernetes" img="/img/k8s.png">
**Read time: 10 mins**

Install with K8s.
</Card>

<Card href="/apim/open-source/installation#install-tyk-gateway-with-ansible" img="/img/ansible.png">
**Read time: 10 mins**

Install with Ansible.
</Card>

<Card href="/apim/open-source/installation#install-tyk-gateway-on-red-hat-rhel-%2F-centos" img="/img/redhat-logo2.png">
**Read time: 10 mins**

Install on RHEL / CentOS.
</Card>

<Card href="/apim/open-source/installation#install-tyk-gateway-with-ubuntu" img="/img/debian-nd-753.png">
**Read time: 10 mins**
...
2. MongoDB/SQL - Required only if you choose to use the MongoDB/SQL Tyk pump with your Tyk OSS installation. The same goes for any
             [other pump](/api-management/logs/external-data-sinks) you choose to use.
