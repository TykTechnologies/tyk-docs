...
When combined, the Default User Permissions provide the baseline and group permissions are merged on top. Where there is a conflict, the higher permission level wins. If the user is an [admin](/api-management/user-management#admin-users), group permissions are skipped to preserve admin rights.
