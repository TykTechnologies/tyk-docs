      ...
      <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="parent-container">
            <div>
              <div className="image-container mb-6">
                <img src="/img/tyk-cloud.svg" alt="Guided evaluation" className="home-img" />
              </div>
        ...
        <div className="border border-gray-300 p-8 flex flex-col items-center text-center h-full">
          <div className="parent-container">
            <div>
              <div className="image-container mb-6">
                <img src="/img/tyk-sm.svg" alt="48-hour free trial" />
              </div>
        ...
        <div className="border border-gray-300 p-8 flex flex-col items-center text-center h-full">
          <div className="parent-container">
            <div>
              <div className="image-container mb-6">
                <img src="/img/poc.svg" alt="Guided evaluation" className="home-img" />
              </div>
