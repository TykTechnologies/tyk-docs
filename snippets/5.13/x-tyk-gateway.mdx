...
**Field: `state` ([State](/5.13/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/5.13/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/5.13/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/5.13/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/5.13/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/5.13/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/5.13/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/5.13/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/5.13/#listenpath))**
...
**Field: `customDomain` ([Domain](/5.13/#domain))**
...
**Field: `value` ([ErrorOverridesMap](/5.13/#erroroverridesmap))**
...
it will be accessible only via [internal looping](/5.13/advanced-configuration/transform-traffic/looping) or as a [child API version](/5.13/api-management/api-versioning#base-and-child-apis).
...
**Field: `cache` ([ServiceDiscoveryCache](/5.13/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/5.13/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/5.13/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/5.13/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/5.13/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/5.13/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/5.13/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/5.13/#customkeylifetime))**
...
**Field: `protectedResourceMetadata` ([ProtectedResourceMetadata](/5.13/#protectedresourcemetadata))**
...
**Field: `certificateAuth` ([CertificateAuth](/5.13/#certificateauth))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/5.13/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/5.13/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/5.13/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/5.13/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/5.13/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/5.13/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/5.13/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/5.13/#customplugins))**
...
**Field: `cache` ([Cache](/5.13/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/5.13/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/5.13/#transformheaders))**
...
Type defined as object of `Operation` values, see [Operation](/5.13/#operation) definition.
...
Type defined as object of `MCPPrimitive` values, see [MCPPrimitive](/5.13/#mcpprimitive) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/5.13/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/5.13/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/5.13/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/5.13/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/5.13/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/5.13/#authenticationplugin))**
...
**Field: `value` ([ReadableDuration](/5.13/#readableduration))**
...
**Field: `bundle` ([PluginBundle](/5.13/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/5.13/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/5.13/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/5.13/#customplugin) definition.
...
**Field: `add` ([Headers](/5.13/#headers))**
...
**Field: `customRetentionPeriod` ([ReadableDuration](/5.13/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/5.13/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/5.13/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/5.13/#readableduration))**
...
**Field: `headers` ([Headers](/5.13/#headers))**
...
Type defined as array of `Header` values, see [Header](/5.13/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/5.13/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/5.13/#extractcredentialsfrombody))**
...
**Field: `type` ([CustomClaimValidationType](/5.13/#customclaimvalidationtype))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/5.13/#endpointpostplugin) definition.
...
**Field: `match` ([ErrorMatcher](/5.13/#errormatcher))**
Match contains optional additional matching criteria.

**Field: `response` ([ErrorResponse](/5.13/#errorresponse))**
...
**Field: `cache` ([IntrospectionCache](/5.13/#introspectioncache))**
...
**Field: `jtiValidation` ([JTIValidation](/5.13/#jtivalidation))**
JTIValidation contains the configuration for the validation of the JWT ID.
...
**Field: `fromOASExamples` ([FromOASExamples](/5.13/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/5.13/#notifications))**
...
**Field: `jwt` ([JWTValidation](/5.13/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/5.13/#introspection))**
...
**Field: `allow` ([Allowance](/5.13/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/5.13/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/5.13/#allowance))**
...
**Field: `internal` ([Internal](/5.13/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/5.13/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/5.13/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/5.13/#transformbody))**
...
**Field: `enforcedTimeout` ([EnforceTimeout](/5.13/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/5.13/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/5.13/#signature))**
...
**Field: `in` ([URLRewriteInput](/5.13/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/5.13/#urlrewritecondition))**
