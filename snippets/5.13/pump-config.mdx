...
This setting has no effect for aggregate pumps used to generate [Tyk Dashboard Analytics](/5.13/api-management/dashboard-analytics) which do not directly transmit the Traffic Logs.
...
[Instrumentation docs](/5.13/api-management/logs-metrics).
...
Expose profiling information to support debugging of Tyk Pump. This operates in the same way as for Tyk Gateway, as explained [here](/5.13/api-management/troubleshooting-debugging).
