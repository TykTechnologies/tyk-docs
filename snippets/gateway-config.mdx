...
This feature significantly reduces Redis memory usage in MDCB deployments where policies are cached locally on Data Plane Gateways.  A conservative estimate is a 70-75% reduction in size.
The Gateway can read both compressed and uncompressed formats for backward compatibility.
