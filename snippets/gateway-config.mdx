...
Maximum decompressed size (in bytes) for API definitions and policies respectively when using compression.  This limit prevents memory exhaustion during decompression.
