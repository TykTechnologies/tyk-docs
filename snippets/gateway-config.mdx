...
ENV: <b>TYK_GW_ENABLECONFIGINSPECTION</b><br />
Type: `bool`<br />
...
### security.allow_unsafe_dynamic_mtls_token
ENV: <b>TYK_GW_SECURITY_ALLOWUNSAFEDYNAMICMTLSTOKEN</b><br />
Type: `bool`<br />
...
ENV: <b>TYK_GW_STORAGE_COMPRESSAPIDEFINITIONS</b><br />
Type: `bool`<br />
...
### storage.compress_policies
ENV: <b>TYK_GW_STORAGE_COMPRESSPOLICIES</b><br />
Type: `bool`<br />
...
ENV: <b>TYK_GW_STORAGE_MAXDECOMPRESSEDSIZE</b><br />
Type: `int64`<br />
...
ENV: <b>TYK_GW_STORAGE_IAMAUTH_SERVICEACCOUNT</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_STORAGE_IAMAUTH_TOKENREFRESHBEFOREEXPIRY</b><br />
Type: `string`<br />
...
### slave_options.rpc_cert_fetch_max_elapsed_time
ENV: <b>TYK_GW_SLAVEOPTIONS_RPCCERTFETCHMAXELAPSEDTIME</b><br />
Type: `float32`<br />
...
### slave_options.rpc_cert_fetch_initial_interval
ENV: <b>TYK_GW_SLAVEOPTIONS_RPCCERTFETCHINITIALINTERVAL</b><br />
Type: `float32`<br />

RPCCertFetchInitialInterval sets the initial retry interval in seconds for certificate fetch backoff (default: 0.1)

### slave_options.rpc_cert_fetch_max_interval
ENV: <b>TYK_GW_SLAVEOPTIONS_RPCCERTFETCHMAXINTERVAL</b><br />
Type: `float32`<br />

RPCCertFetchMaxInterval sets the maximum retry interval in seconds for certificate fetch backoff (default: 2)

### slave_options.rpc_cert_fetch_retry_enabled
ENV: <b>TYK_GW_SLAVEOPTIONS_RPCCERTFETCHRETRYENABLED</b><br />
Type: `bool`<br />

RPCCertFetchRetryEnabled enables exponential backoff retry for certificate fetch from MDCB during startup (default: true)

### slave_options.rpc_cert_fetch_max_retries
ENV: <b>TYK_GW_SLAVEOPTIONS_RPCCERTFETCHMAXRETRIES</b><br />
Type: `int`<br />
...
### slave_options.sync_used_certs_only
ENV: <b>TYK_GW_SLAVEOPTIONS_SYNCUSEDCERTSONLY</b><br />
Type: `bool`<br />
...
ENV: <b>TYK_GW_RATELIMITRESPONSEHEADERS</b><br />
Type: `RateLimitSource`<br />
...
If you do not set this value, or set it to `0`, Tyk uses the Go standard library default of 2 connections. Tyk recommends setting this value to `500` for production environments.
...
ENV: <b>TYK_GW_GRACEFULSHUTDOWNDELAYSECONDS</b><br />
Type: `int`<br />
...
ENV: <b>TYK_GW_ANALYTICSSTORAGE_IAMAUTH_ENABLED</b><br />
Type: `bool`<br />

Set to true to use IAM-based authentication for this storage connection.

### analytics_storage.iam_auth.provider
ENV: <b>TYK_GW_ANALYTICSSTORAGE_IAMAUTH_PROVIDER</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_ANALYTICSSTORAGE_IAMAUTH_SERVICEACCOUNT</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_ANALYTICSSTORAGE_IAMAUTH_TOKENREFRESHBEFOREEXPIRY</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_REGEXPCACHEMAXENTRIES</b><br />
Type: `int`<br />
...
ENV: <b>TYK_GW_DISABLEREGEXPCACHEBOUND</b><br />
Type: `bool`<br />
...
ENV: <b>TYK_GW_DISABLEAUTOMAXPROCS</b><br />
Type: `bool`<br />
...
ENV: <b>TYK_GW_CACHESTORAGE_IAMAUTH_ENABLED</b><br />
Type: `bool`<br />

Set to true to use IAM-based authentication for this storage connection.

### cache_storage.iam_auth.provider
ENV: <b>TYK_GW_CACHESTORAGE_IAMAUTH_PROVIDER</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_CACHESTORAGE_IAMAUTH_SERVICEACCOUNT</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_CACHESTORAGE_IAMAUTH_TOKENREFRESHBEFOREEXPIRY</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_SKIPVERIFYEXISTINGPLUGINBUNDLE</b><br />
Type: `bool`<br />
...
### opentelemetry.span_batch_config
Configuration for the batch span processor.
Only applies when SpanProcessorType is "batch".

### opentelemetry.span_batch_config.max_queue_size
ENV: <b>TYK_GW_OPENTELEMETRY_SPANBATCHCONFIG_MAXQUEUESIZE</b><br />
Type: `int`<br />
...
### opentelemetry.span_batch_config.max_export_batch_size
ENV: <b>TYK_GW_OPENTELEMETRY_SPANBATCHCONFIG_MAXEXPORTBATCHSIZE</b><br />
Type: `int`<br />
...
### opentelemetry.span_batch_config.batch_timeout
ENV: <b>TYK_GW_OPENTELEMETRY_SPANBATCHCONFIG_BATCHTIMEOUT</b><br />
Type: `int`<br />
...
### opentelemetry.custom_trace_header
ENV: <b>TYK_GW_OPENTELEMETRY_CUSTOMTRACEHEADER</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_ENABLED</b><br />
Type: `bool`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_EXPORTER</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_ENDPOINT</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_HEADERS</b><br />
Type: `map[string]string`<br />

A map of headers that will be sent with HTTP requests to the collector.

### opentelemetry.traces.connection_timeout
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_CONNECTIONTIMEOUT</b><br />
Type: `int`<br />

Timeout for establishing a connection to the collector.
Defaults to 1 second.

### opentelemetry.traces.resource_name
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_RESOURCENAME</b><br />
Type: `string`<br />
...
### opentelemetry.traces.tls.enable
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_TLS_ENABLE</b><br />
Type: `bool`<br />

Set this to `true` to enable TLS for the connection to the OpenTelemetry
collector. Defaults to false.

### opentelemetry.traces.tls.insecure_skip_verify
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_TLS_INSECURESKIPVERIFY</b><br />
Type: `bool`<br />

Set to `true` to disable verification of the server’s certificate chain. Not recommended for production environments.
Defaults to false.

### opentelemetry.traces.tls.ca_file
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_TLS_CAFILE</b><br />
Type: `string`<br />
...
### opentelemetry.traces.tls.cert_file
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_TLS_CERTFILE</b><br />
Type: `string`<br />

Path to the cert file.

### opentelemetry.traces.tls.key_file
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_TLS_KEYFILE</b><br />
Type: `string`<br />

Path to the key file.

### opentelemetry.traces.tls.max_version
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_TLS_MAXVERSION</b><br />
Type: `string`<br />
...
### opentelemetry.traces.tls.min_version
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_TLS_MINVERSION</b><br />
Type: `string`<br />
...
### opentelemetry.traces.span_processor_type
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_SPANPROCESSORTYPE</b><br />
Type: `string`<br />

Type of the span processor to use. Valid values are "simple" or "batch".
Defaults to "batch".

### opentelemetry.traces.span_batch_config
Configuration for the batch span processor.
Only applies when SpanProcessorType is "batch".

### opentelemetry.traces.span_batch_config.max_queue_size
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_SPANBATCHCONFIG_MAXQUEUESIZE</b><br />
Type: `int`<br />
...
### opentelemetry.traces.span_batch_config.max_export_batch_size
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_SPANBATCHCONFIG_MAXEXPORTBATCHSIZE</b><br />
Type: `int`<br />
...
### opentelemetry.traces.span_batch_config.batch_timeout
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_SPANBATCHCONFIG_BATCHTIMEOUT</b><br />
Type: `int`<br />
...
### opentelemetry.traces.context_propagation
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_CONTEXTPROPAGATION</b><br />
Type: `string`<br />
...
### opentelemetry.traces.custom_trace_header
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_CUSTOMTRACEHEADER</b><br />
Type: `string`<br />
...
### opentelemetry.traces.sampling
Defines the configurations to use in the sampler.

### opentelemetry.traces.sampling.type
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_SAMPLING_TYPE</b><br />
Type: `string`<br />
...
### opentelemetry.traces.sampling.rate
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_SAMPLING_RATE</b><br />
Type: `float64`<br />
...
### opentelemetry.traces.sampling.parent_based
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_SAMPLING_PARENTBASED</b><br />
Type: `bool`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_TRACES_MCPTRACECONTEXT</b><br />
Type: `MCPTraceContextConfig`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_ENABLED</b><br />
Type: `bool`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_EXPORTER</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_ENDPOINT</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_HEADERS</b><br />
Type: `map[string]string`<br />

A map of headers that will be sent with HTTP requests to the collector.

### opentelemetry.metrics.connection_timeout
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_CONNECTIONTIMEOUT</b><br />
Type: `int`<br />

Timeout for establishing a connection to the collector.
Defaults to 1 second.

### opentelemetry.metrics.resource_name
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_RESOURCENAME</b><br />
Type: `string`<br />
...
### opentelemetry.metrics.tls
TLS configuration used by the exporter to authenticate the OpenTelemetry collector

### opentelemetry.metrics.tls.enable
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_TLS_ENABLE</b><br />
Type: `bool`<br />

Set this to `true` to enable TLS for the connection to the OpenTelemetry
collector. Defaults to false.

### opentelemetry.metrics.tls.insecure_skip_verify
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_TLS_INSECURESKIPVERIFY</b><br />
Type: `bool`<br />

Set to `true` to disable verification of the server’s certificate chain. Not recommended for production environments.
Defaults to false.

### opentelemetry.metrics.tls.ca_file
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_TLS_CAFILE</b><br />
Type: `string`<br />
...
### opentelemetry.metrics.tls.cert_file
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_TLS_CERTFILE</b><br />
Type: `string`<br />

Path to the cert file.

### opentelemetry.metrics.tls.key_file
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_TLS_KEYFILE</b><br />
Type: `string`<br />

Path to the key file.

### opentelemetry.metrics.tls.max_version
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_TLS_MAXVERSION</b><br />
Type: `string`<br />
...
### opentelemetry.metrics.tls.min_version
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_TLS_MINVERSION</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_EXPORTINTERVAL</b><br />
Type: `int`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_TEMPORALITY</b><br />
Type: `string`<br />
...
### opentelemetry.metrics.shutdown_timeout
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_SHUTDOWNTIMEOUT</b><br />
Type: `int`<br />

ShutdownTimeout is the timeout in seconds for graceful shutdown of the exporter.
Defaults to 30 seconds.

### opentelemetry.metrics.retry
Retry configuration for exporter failures.

### opentelemetry.metrics.retry.enabled
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_RETRY_ENABLED</b><br />
Type: `bool`<br />

Enabled enables retry on export failures.
Defaults to true.

### opentelemetry.metrics.retry.initial_interval
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_RETRY_INITIALINTERVAL</b><br />
Type: `int`<br />

InitialInterval is the initial backoff interval in milliseconds.
Defaults to 5000 (5 seconds).

### opentelemetry.metrics.retry.max_interval
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_RETRY_MAXINTERVAL</b><br />
Type: `int`<br />

MaxInterval is the maximum backoff interval in milliseconds.
Defaults to 30000 (30 seconds).

### opentelemetry.metrics.retry.max_elapsed_time
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_RETRY_MAXELAPSEDTIME</b><br />
Type: `int`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_CARDINALITYLIMIT</b><br />
Type: `int`<br />
...
### opentelemetry.metrics.runtime_metrics
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_RUNTIMEMETRICS</b><br />
Type: `bool`<br />

RuntimeMetrics enables Go runtime metrics collection (goroutines, memory, GC).
Defaults to true when metrics are enabled.

### opentelemetry.metrics.api_metrics
ENV: <b>TYK_GW_OPENTELEMETRY_METRICS_APIMETRICS</b><br />
Type: `apimetrics.APIMetricDefinitions`<br />
...
### error_overrides
ENV: <b>TYK_GW_ERROROVERRIDES</b><br />
Type: `apidef.ErrorOverridesMap`<br />
...
### jwks.cache.timeout
ENV: <b>TYK_GW_JWKS_CACHE_TIMEOUT</b><br />
Type: `int64`<br />
...
ENV: <b>TYK_GW_ALLOWUNSAFEPOLICYIDS</b><br />
Type: `bool`<br />
