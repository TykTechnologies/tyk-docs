...
### auth_override.force_auth_provider
ENV: <b>TYK_GW_AUTHOVERRIDE_FORCEAUTHPROVIDER</b><br />
Type: `bool`<br />

### auth_override.auth_provider
### auth_override.auth_provider.name
ENV: <b>TYK_GW_AUTHOVERRIDE_AUTHPROVIDER_NAME</b><br />
Type: `AuthProviderCode`<br />

### auth_override.auth_provider.storage_engine
ENV: <b>TYK_GW_AUTHOVERRIDE_AUTHPROVIDER_STORAGEENGINE</b><br />
Type: `StorageEngineCode`<br />

### auth_override.auth_provider.meta
ENV: <b>TYK_GW_AUTHOVERRIDE_AUTHPROVIDER_META</b><br />
Type: `map[string]interface{}`<br />

### auth_override.force_session_provider
ENV: <b>TYK_GW_AUTHOVERRIDE_FORCESESSIONPROVIDER</b><br />
Type: `bool`<br />

### auth_override.session_provider
### auth_override.session_provider.name
ENV: <b>TYK_GW_AUTHOVERRIDE_SESSIONPROVIDER_NAME</b><br />
Type: `SessionProviderCode`<br />

### auth_override.session_provider.storage_engine
ENV: <b>TYK_GW_AUTHOVERRIDE_SESSIONPROVIDER_STORAGEENGINE</b><br />
Type: `StorageEngineCode`<br />

### auth_override.session_provider.meta
ENV: <b>TYK_GW_AUTHOVERRIDE_SESSIONPROVIDER_META</b><br />
Type: `map[string]interface{}`<br />
...
### override_messages.message
ENV: <b>TYK_GW_OVERRIDEMESSAGES_MESSAGE</b><br />
Type: `map[string]string`<br />

### override_messages.code
ENV: <b>TYK_GW_OVERRIDEMESSAGES_CODE</b><br />
Type: `map[string]int`<br />
