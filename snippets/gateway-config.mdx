...
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_EXPORTER</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_ENDPOINT</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_HEADERS</b><br />
Type: `map[string]string`<br />

A map of headers that will be sent with HTTP requests to the collector.

### opentelemetry.connection_timeout
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_CONNECTIONTIMEOUT</b><br />
Type: `int`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_RESOURCENAME</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_TLS_ENABLE</b><br />
Type: `bool`<br />

Flag that can be used to enable TLS. Defaults to false (disabled).

### opentelemetry.tls.insecure_skip_verify
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_TLS_INSECURESKIPVERIFY</b><br />
Type: `bool`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_TLS_CAFILE</b><br />
Type: `string`<br />

Path to the CA file.

### opentelemetry.tls.cert_file
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_TLS_CERTFILE</b><br />
Type: `string`<br />

Path to the cert file.

### opentelemetry.tls.key_file
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_TLS_KEYFILE</b><br />
Type: `string`<br />

Path to the key file.

### opentelemetry.tls.max_version
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_TLS_MAXVERSION</b><br />
Type: `string`<br />
...
ENV: <b>TYK_GW_OPENTELEMETRY_EXPORTERCONFIG_TLS_MINVERSION</b><br />
Type: `string`<br />
