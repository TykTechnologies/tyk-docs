...
### analytics_storage.compress_api_definitions
ENV: <b>TYK_GW_ANALYTICSSTORAGE_COMPRESSAPIDEFINITIONS</b><br />
Type: `bool`<br />
...
### analytics_storage.max_decompressed_size
ENV: <b>TYK_GW_ANALYTICSSTORAGE_MAXDECOMPRESSEDSIZE</b><br />
Type: `int64`<br />
...
### cache_storage.compress_api_definitions
ENV: <b>TYK_GW_CACHESTORAGE_COMPRESSAPIDEFINITIONS</b><br />
Type: `bool`<br />
...
### cache_storage.max_decompressed_size
ENV: <b>TYK_GW_CACHESTORAGE_MAXDECOMPRESSEDSIZE</b><br />
Type: `int64`<br />
