...
Expose profiling information to support debugging of Tyk Pump. This operates in the same as for Tyk Gateway, as explained [here](/troubleshooting/tyk-gateway/profiling).
