...
[Instrumentation docs](/docs/basic-config-and-security/report-monitor-trigger-events/instrumentation).
...
Expose profiling information to support debugging of Tyk Pump. This operates in the same as for Tyk Gateway, as explained [here](/docs/troubleshooting/tyk-gateway/profiling).
