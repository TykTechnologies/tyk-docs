...
**Field: `state` ([State](/5.10/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/5.10/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/5.10/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/5.10/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/5.10/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/5.10/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/5.10/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/5.10/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/5.10/#listenpath))**
...
**Field: `customDomain` ([Domain](/5.10/#domain))**
...
it will be accessible only via [internal looping](/5.10/advanced-configuration/transform-traffic/looping) or as a [child API version](/5.10/api-management/api-versioning#base-and-child-apis).
...
**Field: `cache` ([ServiceDiscoveryCache](/5.10/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/5.10/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/5.10/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/5.10/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/5.10/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/5.10/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/5.10/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/5.10/#customkeylifetime))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/5.10/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/5.10/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/5.10/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/5.10/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/5.10/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/5.10/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/5.10/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/5.10/#customplugins))**
...
**Field: `cache` ([Cache](/5.10/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/5.10/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/5.10/#transformheaders))**
...
Type defined as object of `Operation` values, see [Operation](/5.10/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/5.10/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/5.10/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/5.10/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/5.10/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/5.10/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/5.10/#authenticationplugin))**
...
**Field: `value` ([ReadableDuration](/5.10/#readableduration))**
...
**Field: `bundle` ([PluginBundle](/5.10/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/5.10/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/5.10/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/5.10/#customplugin) definition.
...
**Field: `add` ([Headers](/5.10/#headers))**
...
**Field: `customRetentionPeriod` ([ReadableDuration](/5.10/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/5.10/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/5.10/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/5.10/#readableduration))**
...
**Field: `headers` ([Headers](/5.10/#headers))**
...
Type defined as array of `Header` values, see [Header](/5.10/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/5.10/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/5.10/#extractcredentialsfrombody))**
...
**Field: `type` ([CustomClaimValidationType](/5.10/#customclaimvalidationtype))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/5.10/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/5.10/#introspectioncache))**
...
**Field: `jtiValidation` ([JTIValidation](/5.10/#jtivalidation))**
JTIValidation contains the configuration for the validation of the JWT ID.
...
**Field: `fromOASExamples` ([FromOASExamples](/5.10/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/5.10/#notifications))**
...
**Field: `jwt` ([JWTValidation](/5.10/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/5.10/#introspection))**
...
**Field: `allow` ([Allowance](/5.10/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/5.10/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/5.10/#allowance))**
...
**Field: `internal` ([Internal](/5.10/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/5.10/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/5.10/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/5.10/#transformbody))**
...
**Field: `enforcedTimeout` ([EnforceTimeout](/5.10/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/5.10/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/5.10/#signature))**
...
**Field: `in` ([URLRewriteInput](/5.10/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/5.10/#urlrewritecondition))**
