...
**Field: `state` ([State](/docs/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/docs/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/docs/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/docs/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/docs/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/docs/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/docs/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/docs/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/docs/#listenpath))**
...
**Field: `customDomain` ([Domain](/docs/#domain))**
...
This field controls the exposure of the API on the Gateway. When set to `true`, the API will not be made available for external access and will not be included in API listings returned by the Gateway's management APIs; it will be accessible only via [internal looping](/docs/advanced-configuration/transform-traffic/looping) or as a [child API version](/docs/api-management/api-versioning#base-and-child-apis).
...
**Field: `cache` ([ServiceDiscoveryCache](/docs/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/docs/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/docs/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/docs/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/docs/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/docs/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/docs/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/docs/#customkeylifetime))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/docs/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/docs/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/docs/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/docs/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/docs/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/docs/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/docs/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/docs/#customplugins))**
...
**Field: `cache` ([Cache](/docs/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/docs/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/docs/#transformheaders))**
...
Type defined as object of `Operation` values, see [Operation](/docs/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/docs/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/docs/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/docs/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/docs/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/docs/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/docs/#authenticationplugin))**
...
**Field: `value` ([ReadableDuration](/docs/#readableduration))**
...
**Field: `bundle` ([PluginBundle](/docs/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/docs/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/docs/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/docs/#customplugin) definition.
...
**Field: `add` ([Headers](/docs/#headers))**
...
**Field: `customRetentionPeriod` ([ReadableDuration](/docs/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/docs/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/docs/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/docs/#readableduration))**
...
**Field: `headers` ([Headers](/docs/#headers))**
...
Type defined as array of `Header` values, see [Header](/docs/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/docs/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/docs/#extractcredentialsfrombody))**
...
**Field: `type` ([CustomClaimValidationType](/docs/#customclaimvalidationtype))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/docs/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/docs/#introspectioncache))**
...
**Field: `jtiValidation` ([JTIValidation](/docs/#jtivalidation))**
JTIValidation contains the configuration for the validation of the JWT ID.
...
**Field: `fromOASExamples` ([FromOASExamples](/docs/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/docs/#notifications))**
...
**Field: `jwt` ([JWTValidation](/docs/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/docs/#introspection))**
...
**Field: `allow` ([Allowance](/docs/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/docs/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/docs/#allowance))**
...
**Field: `internal` ([Internal](/docs/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/docs/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/docs/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/docs/#transformbody))**
...
**Field: `enforcedTimeout` ([EnforceTimeout](/docs/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/docs/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/docs/#signature))**
...
**Field: `in` ([URLRewriteInput](/docs/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/docs/#urlrewritecondition))**
