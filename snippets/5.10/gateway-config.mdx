...
**Note:** The limit is applied only when the [Response Body Transform middleware](/5.10/api-management/traffic-transformation/response-body) is enabled.
