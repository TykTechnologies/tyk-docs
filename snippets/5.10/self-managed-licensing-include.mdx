...
See [licensing](/getting-started/quick-start) and [deployment models](/tyk-self-managed/install) to learn about the different deployment options for Self-Managed.
