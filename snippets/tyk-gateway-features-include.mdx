...
**OpenAPI Standards**: Keep your OpenAPI 3.0 description as source of truth with [Tyk OAS APIs](/getting-started/key-concepts/high-level-concepts), import your Swagger and OAS2/3 documents to scaffold Tyk Classic APIs.
