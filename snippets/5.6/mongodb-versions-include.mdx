...
<br />
We can not guarantee full compatibility with these versions of MongoDB for Tyk and recommend upgrading to a supported MongoDB version. In particular, when using Tyk OAS APIs with [Tyk 5.3.0](/5.6/product-stack/tyk-dashboard/release-notes/version-5.3#TykOAS-v5.3.0) onwards, the minimum supported version of MongoDB is 5.0.
</Note>
