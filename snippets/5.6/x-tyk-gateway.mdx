...
**Field: `state` ([State](/5.6/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/5.6/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/5.6/#servicediscovery))**
...
**Field: `listenPath` ([ListenPath](/5.6/#listenpath))**
...
**Field: `customDomain` ([Domain](/5.6/#domain))**
...
**Field: `detailedActivityLogs` ([DetailedActivityLogs](/5.6/#detailedactivitylogs))**
DetailedActivityLogs configures detailed analytics recording.

**Field: `detailedTracing` ([DetailedTracing](/5.6/#detailedtracing))**
DetailedTracing enables OpenTelemetry's detailed tracing for this API.


Tyk classic API definition: `detailed_tracing`.

**Field: `eventHandlers` ([EventHandlers](/5.6/#eventhandlers))**
...
**Field: `cache` ([ServiceDiscoveryCache](/5.6/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/5.6/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/5.6/#readableduration))**
...
**Field: `securitySchemes` ([SecuritySchemes](/5.6/#securityschemes))**
...
**Field: `prePlugins` ([CustomPlugins](/5.6/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/5.6/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/5.6/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/5.6/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/5.6/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/5.6/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/5.6/#customplugins))**
...
**Field: `cache` ([Cache](/5.6/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/5.6/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/5.6/#transformheaders))**
...
**Field: `contextVariables` ([ContextVariables](/5.6/#contextvariables))**
ContextVariables contains the configuration related to Tyk context variables.

**Field: `trafficLogs` ([TrafficLogs](/5.6/#trafficlogs))**
...
Type defined as object of `Operation` values, see [Operation](/5.6/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/5.6/#pinnedpublickey) definition.
...
**Field: `scopes` ([Scopes](/5.6/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/5.6/#authenticationplugin))**
...
**Field: `` ([WebhookEvent](/5.6/#webhookevent))**
...
**Field: `bundle` ([PluginBundle](/5.6/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/5.6/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/5.6/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/5.6/#customplugin) definition.
...
**Field: `idExtractor` ([IDExtractor](/5.6/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/5.6/#readableduration))**
...
**Field: `headers` ([Headers](/5.6/#headers))**
...
Type defined as array of `Header` values, see [Header](/5.6/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/5.6/#idextractorconfig))**
...
**Field: `header` ([AuthSource](/5.6/#authsource))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/5.6/#extractcredentialsfrombody))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/5.6/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/5.6/#introspectioncache))**
...
**Field: `fromOASExamples` ([FromOASExamples](/5.6/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/5.6/#notifications))**
...
**Field: `jwt` ([JWTValidation](/5.6/#jwtvalidation))**
JWT configures JWT validation.

**Field: `introspection` ([Introspection](/5.6/#introspection))**
...
**Field: `allow` ([Allowance](/5.6/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/5.6/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/5.6/#allowance))**
IgnoreAuthentication ignores authentication on request by allowance.

**Field: `internal` ([Internal](/5.6/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/5.6/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/5.6/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/5.6/#transformbody))**
...
Type defined as object of `Path` values, see [Path](/5.6/#path) definition.
...
**Field: `enforcedTimeout` ([EnforceTimeout](/5.6/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/5.6/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/5.6/#signature))**
...
**Field: `in` ([URLRewriteInput](/5.6/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/5.6/#urlrewritecondition))**
