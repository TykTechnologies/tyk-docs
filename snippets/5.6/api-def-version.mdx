...
* `version_data.{version-name}.extended_paths.url_rewrites`: Configuration for the [URL rewrite](/5.6/product-stack/tyk-gateway/middleware/url-rewrite-middleware) middleware.
...
See [Versioning](/5.6/getting-started/key-concepts/versioning) for more details on versioning your APIs.
