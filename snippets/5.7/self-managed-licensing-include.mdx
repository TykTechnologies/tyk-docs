...
See [licensing and deployment models](/5.7/tyk-self-managed#tyk-self-managed-licensepricing) to learn about the different deployment options for Self-Managed.
