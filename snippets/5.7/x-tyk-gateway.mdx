...
**Field: `state` ([State](/5.7/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/5.7/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/5.7/#servicediscovery))**
...
**Field: `listenPath` ([ListenPath](/5.7/#listenpath))**
...
**Field: `customDomain` ([Domain](/5.7/#domain))**
...
**Field: `detailedActivityLogs` ([DetailedActivityLogs](/5.7/#detailedactivitylogs))**
DetailedActivityLogs configures detailed analytics recording.

**Field: `detailedTracing` ([DetailedTracing](/5.7/#detailedtracing))**
DetailedTracing enables OpenTelemetry's detailed tracing for this API.


Tyk classic API definition: `detailed_tracing`.

**Field: `eventHandlers` ([EventHandlers](/5.7/#eventhandlers))**
...
**Field: `cache` ([ServiceDiscoveryCache](/5.7/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/5.7/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/5.7/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/5.7/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/5.7/#upstreamoauth))**
...
**Field: `securitySchemes` ([SecuritySchemes](/5.7/#securityschemes))**
...
**Field: `prePlugins` ([CustomPlugins](/5.7/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/5.7/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/5.7/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/5.7/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/5.7/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/5.7/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/5.7/#customplugins))**
...
**Field: `cache` ([Cache](/5.7/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/5.7/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/5.7/#transformheaders))**
...
**Field: `contextVariables` ([ContextVariables](/5.7/#contextvariables))**
ContextVariables contains the configuration related to Tyk context variables.

**Field: `trafficLogs` ([TrafficLogs](/5.7/#trafficlogs))**
...
Type defined as object of `Operation` values, see [Operation](/5.7/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/5.7/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/5.7/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/5.7/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/5.7/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/5.7/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/5.7/#authenticationplugin))**
...
**Field: `` ([WebhookEvent](/5.7/#webhookevent))**
...
**Field: `bundle` ([PluginBundle](/5.7/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/5.7/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/5.7/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/5.7/#customplugin) definition.
...
**Field: `idExtractor` ([IDExtractor](/5.7/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/5.7/#readableduration))**
...
**Field: `headers` ([Headers](/5.7/#headers))**
...
Type defined as array of `Header` values, see [Header](/5.7/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/5.7/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/5.7/#extractcredentialsfrombody))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/5.7/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/5.7/#introspectioncache))**
...
**Field: `fromOASExamples` ([FromOASExamples](/5.7/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/5.7/#notifications))**
...
**Field: `jwt` ([JWTValidation](/5.7/#jwtvalidation))**
JWT configures JWT validation.

**Field: `introspection` ([Introspection](/5.7/#introspection))**
...
**Field: `allow` ([Allowance](/5.7/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/5.7/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/5.7/#allowance))**
IgnoreAuthentication ignores authentication on request by allowance.

**Field: `internal` ([Internal](/5.7/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/5.7/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/5.7/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/5.7/#transformbody))**
...
Type defined as object of `Path` values, see [Path](/5.7/#path) definition.
...
**Field: `enforcedTimeout` ([EnforceTimeout](/5.7/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/5.7/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/5.7/#signature))**
...
**Field: `in` ([URLRewriteInput](/5.7/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/5.7/#urlrewritecondition))**
