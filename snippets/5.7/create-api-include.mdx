...
In order to complete this tutorial, you need to have [Tyk Self Managed installed](/5.7/tyk-self-managed#installation-options-for-tyk-self-managed).
...
4. **Set up authentication for your API**
    ...
    - **Enable client certificate**: Tyk supports the use of Mutual TLS to authenticate requests to your API; you would use this checkbox to enable this mode. See [Mutual TLS](/5.7/api-management/client-authentication#use-mutual-tls) for details on implementing this feature. For this tutorial, leave this unchecked.
