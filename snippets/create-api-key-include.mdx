...
4. **Add Configuration Details**
    ...
    4. Configure Behaviour on key expiry. When an expiry is set, the **Behaviour on key expiry** options appear:
        ...
        <img src="/img/2.10/behaviour_on_key_expiry_key.png" alt="Behaviour on key expiry options on the Add Key page" />

        * **Delete key** (Default): Removes the session data from Redis immediately upon expiration.
