...
* `version_data.{version-name}.extended_paths.url_rewrites`: Configuration for the [URL rewrite](/transform-traffic/url-rewriting#url-rewriting-overview) middleware.
...
See [Versioning](/api-management/api-versioning#tyk-classic-api-versioning-1) for more details on versioning your APIs.
