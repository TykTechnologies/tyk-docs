...
* `version_data.{version-name}.extended_paths.url_rewrites`: Configuration for the [URL rewrite](/product-stack/tyk-gateway/middleware/url-rewrite-middleware) middleware.
