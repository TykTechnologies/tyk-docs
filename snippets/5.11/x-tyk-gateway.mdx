...
**Field: `state` ([State](/5.11/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/5.11/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/5.11/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/5.11/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/5.11/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/5.11/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/5.11/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/5.11/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/5.11/#listenpath))**
...
**Field: `customDomain` ([Domain](/5.11/#domain))**
...
it will be accessible only via [internal looping](/5.11/advanced-configuration/transform-traffic/looping) or as a [child API version](/5.11/api-management/api-versioning#base-and-child-apis).
...
**Field: `cache` ([ServiceDiscoveryCache](/5.11/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/5.11/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/5.11/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/5.11/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/5.11/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/5.11/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/5.11/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/5.11/#customkeylifetime))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/5.11/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/5.11/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/5.11/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/5.11/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/5.11/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/5.11/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/5.11/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/5.11/#customplugins))**
...
**Field: `cache` ([Cache](/5.11/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/5.11/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/5.11/#transformheaders))**
...
Type defined as object of `Operation` values, see [Operation](/5.11/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/5.11/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/5.11/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/5.11/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/5.11/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/5.11/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/5.11/#authenticationplugin))**
...
**Field: `value` ([ReadableDuration](/5.11/#readableduration))**
...
**Field: `bundle` ([PluginBundle](/5.11/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/5.11/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/5.11/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/5.11/#customplugin) definition.
...
**Field: `add` ([Headers](/5.11/#headers))**
...
**Field: `customRetentionPeriod` ([ReadableDuration](/5.11/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/5.11/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/5.11/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/5.11/#readableduration))**
...
**Field: `headers` ([Headers](/5.11/#headers))**
...
Type defined as array of `Header` values, see [Header](/5.11/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/5.11/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/5.11/#extractcredentialsfrombody))**
...
**Field: `type` ([CustomClaimValidationType](/5.11/#customclaimvalidationtype))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/5.11/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/5.11/#introspectioncache))**
...
**Field: `jtiValidation` ([JTIValidation](/5.11/#jtivalidation))**
JTIValidation contains the configuration for the validation of the JWT ID.
...
**Field: `fromOASExamples` ([FromOASExamples](/5.11/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/5.11/#notifications))**
...
**Field: `jwt` ([JWTValidation](/5.11/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/5.11/#introspection))**
...
**Field: `allow` ([Allowance](/5.11/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/5.11/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/5.11/#allowance))**
...
**Field: `internal` ([Internal](/5.11/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/5.11/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/5.11/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/5.11/#transformbody))**
...
**Field: `enforcedTimeout` ([EnforceTimeout](/5.11/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/5.11/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/5.11/#signature))**
...
**Field: `in` ([URLRewriteInput](/5.11/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/5.11/#urlrewritecondition))**
