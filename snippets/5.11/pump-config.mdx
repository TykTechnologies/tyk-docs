...
[Instrumentation docs](/5.11/api-management/logs-metrics).
...
Expose profiling information to support debugging of Tyk Pump. This operates in the same way as for Tyk Gateway, as explained [here](/5.11/api-management/troubleshooting-debugging).
