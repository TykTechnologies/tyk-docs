...
4. **Add Configuration Details**
    ...
    3. Set an Expiry time after which the key will expire. Select a value from the drop-down list. This is a required setting. See [Key Expiry](/5.12/api-management/policies#key-expiry) for more details.
