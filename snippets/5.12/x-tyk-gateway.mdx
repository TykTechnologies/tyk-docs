...
**Field: `state` ([State](/5.12/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/5.12/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/5.12/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/5.12/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/5.12/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/5.12/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/5.12/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/5.12/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/5.12/#listenpath))**
...
**Field: `customDomain` ([Domain](/5.12/#domain))**
...
it will be accessible only via [internal looping](/5.12/advanced-configuration/transform-traffic/looping) or as a [child API version](/5.12/api-management/api-versioning#base-and-child-apis).
...
**Field: `cache` ([ServiceDiscoveryCache](/5.12/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/5.12/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/5.12/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/5.12/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/5.12/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/5.12/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/5.12/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/5.12/#customkeylifetime))**
...
**Field: `protectedResourceMetadata` ([ProtectedResourceMetadata](/5.12/#protectedresourcemetadata))**
...
**Field: `certificateAuth` ([CertificateAuth](/5.12/#certificateauth))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/5.12/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/5.12/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/5.12/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/5.12/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/5.12/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/5.12/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/5.12/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/5.12/#customplugins))**
...
**Field: `cache` ([Cache](/5.12/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/5.12/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/5.12/#transformheaders))**
...
Type defined as object of `Operation` values, see [Operation](/5.12/#operation) definition.
...
Type defined as object of `MCPPrimitive` values, see [MCPPrimitive](/5.12/#mcpprimitive) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/5.12/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/5.12/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/5.12/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/5.12/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/5.12/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/5.12/#authenticationplugin))**
...
**Field: `value` ([ReadableDuration](/5.12/#readableduration))**
...
**Field: `bundle` ([PluginBundle](/5.12/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/5.12/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/5.12/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/5.12/#customplugin) definition.
...
**Field: `add` ([Headers](/5.12/#headers))**
...
**Field: `customRetentionPeriod` ([ReadableDuration](/5.12/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/5.12/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/5.12/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/5.12/#readableduration))**
...
**Field: `headers` ([Headers](/5.12/#headers))**
...
Type defined as array of `Header` values, see [Header](/5.12/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/5.12/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/5.12/#extractcredentialsfrombody))**
...
**Field: `type` ([CustomClaimValidationType](/5.12/#customclaimvalidationtype))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/5.12/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/5.12/#introspectioncache))**
...
**Field: `jtiValidation` ([JTIValidation](/5.12/#jtivalidation))**
JTIValidation contains the configuration for the validation of the JWT ID.
...
**Field: `fromOASExamples` ([FromOASExamples](/5.12/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/5.12/#notifications))**
...
**Field: `jwt` ([JWTValidation](/5.12/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/5.12/#introspection))**
...
**Field: `allow` ([Allowance](/5.12/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/5.12/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/5.12/#allowance))**
...
**Field: `internal` ([Internal](/5.12/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/5.12/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/5.12/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/5.12/#transformbody))**
...
**Field: `enforcedTimeout` ([EnforceTimeout](/5.12/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/5.12/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/5.12/#signature))**
...
**Field: `in` ([URLRewriteInput](/5.12/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/5.12/#urlrewritecondition))**
