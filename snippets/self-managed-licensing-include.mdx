...
See [licensing](/docsv2/tyk-self-managed#getting-started-with-tyk-self-managed) and [deployment models](/docsv2/tyk-self-managed#installation-options-for-tyk-self-managed) to learn about the different deployment options for Self-Managed.
