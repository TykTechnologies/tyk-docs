...
3. Set an Expiry time after which the key will expire. Select a value from the drop-down list. This is a required setting. See [Key Expiry](/5.5/basic-config-and-security/security/key-level-security#key-expiry) for more details.
