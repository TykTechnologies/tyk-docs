...
**Field: `state` ([State](/5.5/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/5.5/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/5.5/#servicediscovery))**
...
**Field: `listenPath` ([ListenPath](/5.5/#listenpath))**
...
**Field: `customDomain` ([Domain](/5.5/#domain))**
...
**Field: `detailedActivityLogs` ([DetailedActivityLogs](/5.5/#detailedactivitylogs))**
DetailedActivityLogs configures detailed analytics recording.

**Field: `detailedTracing` ([DetailedTracing](/5.5/#detailedtracing))**
DetailedTracing enables OpenTelemetry's detailed tracing for this API.


Tyk classic API definition: `detailed_tracing`.

**Field: `eventHandlers` ([EventHandlers](/5.5/#eventhandlers))**
...
**Field: `cache` ([ServiceDiscoveryCache](/5.5/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/5.5/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/5.5/#readableduration))**
...
**Field: `securitySchemes` ([SecuritySchemes](/5.5/#securityschemes))**
...
**Field: `prePlugins` ([CustomPlugins](/5.5/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/5.5/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/5.5/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/5.5/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/5.5/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/5.5/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/5.5/#customplugins))**
...
**Field: `cache` ([Cache](/5.5/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/5.5/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/5.5/#transformheaders))**
...
**Field: `contextVariables` ([ContextVariables](/5.5/#contextvariables))**
ContextVariables contains the configuration related to Tyk context variables.

**Field: `trafficLogs` ([TrafficLogs](/5.5/#trafficlogs))**
...
Type defined as object of `Operation` values, see [Operation](/5.5/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/5.5/#pinnedpublickey) definition.
...
**Field: `scopes` ([Scopes](/5.5/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/5.5/#authenticationplugin))**
...
**Field: `` ([WebhookEvent](/5.5/#webhookevent))**
...
**Field: `bundle` ([PluginBundle](/5.5/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/5.5/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/5.5/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/5.5/#customplugin) definition.
...
**Field: `idExtractor` ([IDExtractor](/5.5/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/5.5/#readableduration))**
...
**Field: `headers` ([Headers](/5.5/#headers))**
...
Type defined as array of `Header` values, see [Header](/5.5/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/5.5/#idextractorconfig))**
...
**Field: `header` ([AuthSource](/5.5/#authsource))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/5.5/#extractcredentialsfrombody))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/5.5/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/5.5/#introspectioncache))**
...
**Field: `fromOASExamples` ([FromOASExamples](/5.5/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/5.5/#notifications))**
...
**Field: `jwt` ([JWTValidation](/5.5/#jwtvalidation))**
JWT configures JWT validation.

**Field: `introspection` ([Introspection](/5.5/#introspection))**
...
**Field: `allow` ([Allowance](/5.5/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/5.5/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/5.5/#allowance))**
IgnoreAuthentication ignores authentication on request by allowance.

**Field: `internal` ([Internal](/5.5/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/5.5/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/5.5/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/5.5/#transformbody))**
...
Type defined as object of `Path` values, see [Path](/5.5/#path) definition.
...
**Field: `enforcedTimeout` ([EnforceTimeout](/5.5/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/5.5/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/5.5/#signature))**
...
**Field: `in` ([URLRewriteInput](/5.5/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/5.5/#urlrewritecondition))**
