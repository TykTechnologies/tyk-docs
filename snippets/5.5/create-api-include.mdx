...
In order to complete this tutorial, you need to have [Tyk Self Managed installed](/5.5/tyk-self-managed/install).
...
- **Enable client certificate**: Tyk supports the use of Mutual TLS to authenticate requests to your API; you would use this checkbox to enable this mode. See [Mutual TLS](/5.5/basic-config-and-security/security/mutual-tls) for details on implementing this feature. For this tutorial, leave this unchecked.
