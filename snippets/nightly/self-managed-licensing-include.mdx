...
See [licensing](/docs3/nightly/tyk-self-managed#getting-started-with-tyk-self-managed) and [deployment models](/docs3/nightly/tyk-self-managed#installation-options-for-tyk-self-managed) to learn about the different deployment options for Self-Managed.
