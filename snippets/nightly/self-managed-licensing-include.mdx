...
See [licensing](/nightly/getting-started/quick-start) and [deployment models](/nightly/tyk-self-managed/install) to learn about the different deployment options for Self-Managed.
