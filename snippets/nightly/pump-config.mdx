...
This setting has no effect for aggregate pumps used to generate [Tyk Dashboard Analytics](/nightly/api-management/dashboard-analytics) which do not directly transmit the Traffic Logs.
...
ENV: <b>TYK_PMP_ANALYTICSSTORAGECONFIG_IAMAUTH_PROVIDER</b><br />
Type: `string`<br />
...
ENV: <b>TYK_PMP_ANALYTICSSTORAGECONFIG_IAMAUTH_SERVICEACCOUNT</b><br />
Type: `string`<br />
...
ENV: <b>TYK_PMP_ANALYTICSSTORAGECONFIG_IAMAUTH_TOKENREFRESHBEFOREEXPIRY</b><br />
Type: `string`<br />
...
ENV: <b>TYK_PMP_ANALYTICSSTORAGECONFIG_IAMAUTH_ENABLED</b><br />
Type: `bool`<br />
...
[Instrumentation docs](/nightly/api-management/logs-metrics).
...
Expose profiling information to support debugging of Tyk Pump. This operates in the same way as for Tyk Gateway, as explained [here](/nightly/api-management/troubleshooting-debugging).
