...
[Instrumentation docs](/docs/nightly/basic-config-and-security/report-monitor-trigger-events/instrumentation).
...
Expose profiling information to support debugging of Tyk Pump. This operates in the same as for Tyk Gateway, as explained [here](/docs/nightly/troubleshooting/tyk-gateway/profiling).
