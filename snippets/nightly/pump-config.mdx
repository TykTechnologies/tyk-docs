...
[Instrumentation docs](/nightly/basic-config-and-security/report-monitor-trigger-events/instrumentation).
...
Expose profiling information to support debugging of Tyk Pump. This operates in the same as for Tyk Gateway, as explained [here](/nightly/api-management/troubleshooting-debugging).
