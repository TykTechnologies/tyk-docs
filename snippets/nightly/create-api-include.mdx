...
4. **Set up authentication for your API**
    ...
    - **Enable client certificate**: Tyk supports the use of Mutual TLS to authenticate requests to your API; you would use this checkbox to enable this mode. See [Mutual TLS](/nightly/api-management/implement-tls#secure-hosted-apis-with-mtls) for details on implementing this feature. For this tutorial, leave this unchecked.
