...
For a detailed tutorial on using OAS with Tyk Gateway, check out our guide to [creating a Tyk OAS API Definition](/docs3/nightly/api-management/gateway-config-managing-oas#creating-an-api).
</Note>


**Prerequisites**

In order to complete this tutorial, you need to have [Tyk Self Managed installed](/docs3/nightly/tyk-self-managed#installation-options-for-tyk-self-managed).
...
4. **Set up authentication for your API**
    ...
    - **Enable client certificate**: Tyk supports the use of Mutual TLS to authenticate requests to your API; you would use this checkbox to enable this mode. See [Mutual TLS](/docs3/nightly/basic-config-and-security/security/mutual-tls/client-mtls#why-use-mutual-tls) for details on implementing this feature. For this tutorial, leave this unchecked.
