...
**Field: `info` ([Info](/docs3/nightly/#info))**
Info contains the main metadata for the API definition.

**Field: `upstream` ([Upstream](/docs3/nightly/#upstream))**
Upstream contains the configurations related to the upstream.

**Field: `server` ([Server](/docs3/nightly/#server))**
Server contains the configurations related to the server.

**Field: `middleware` ([Middleware](/docs3/nightly/#middleware))**
...
**Field: `state` ([State](/docs3/nightly/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/docs3/nightly/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/docs3/nightly/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/docs3/nightly/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/docs3/nightly/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/docs3/nightly/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/docs3/nightly/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/docs3/nightly/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/docs3/nightly/#listenpath))**
...
**Field: `customDomain` ([Domain](/docs3/nightly/#domain))**
...
**Field: `global` ([Global](/docs3/nightly/#global))**
Global contains configuration for middleware that affects the whole API (all endpoints).

**Field: `operations` ([Operations](/docs3/nightly/#operations))**
...
**Field: `cache` ([ServiceDiscoveryCache](/docs3/nightly/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/docs3/nightly/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/docs3/nightly/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/docs3/nightly/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/docs3/nightly/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/docs3/nightly/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/docs3/nightly/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/docs3/nightly/#customkeylifetime))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/docs3/nightly/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/docs3/nightly/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/docs3/nightly/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/docs3/nightly/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/docs3/nightly/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/docs3/nightly/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/docs3/nightly/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/docs3/nightly/#customplugins))**
...
**Field: `cache` ([Cache](/docs3/nightly/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/docs3/nightly/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/docs3/nightly/#transformheaders))**
...
**Field: `contextVariables` ([ContextVariables](/docs3/nightly/#contextvariables))**
ContextVariables contains the configuration related to Tyk context variables.

**Field: `trafficLogs` ([TrafficLogs](/docs3/nightly/#trafficlogs))**
TrafficLogs contains the configurations related to API level log analytics.

**Field: `requestSizeLimit` ([GlobalRequestSizeLimit](/docs3/nightly/#globalrequestsizelimit))**
RequestSizeLimit contains the configuration related to limiting the global request size.

**Field: `ignoreCase` ([IgnoreCase](/docs3/nightly/#ignorecase))**
...
Type defined as object of `Operation` values, see [Operation](/docs3/nightly/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/docs3/nightly/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/docs3/nightly/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/docs3/nightly/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/docs3/nightly/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/docs3/nightly/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/docs3/nightly/#authenticationplugin))**
...
**Field: `value` ([ReadableDuration](/docs3/nightly/#readableduration))**
...
**Field: `type` ([Kind](/docs3/nightly/#kind))**
...
**Field: `bundle` ([PluginBundle](/docs3/nightly/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/docs3/nightly/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/docs3/nightly/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/docs3/nightly/#customplugin) definition.
...
**Field: `add` ([Headers](/docs3/nightly/#headers))**
...
**Field: `customRetentionPeriod` ([ReadableDuration](/docs3/nightly/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/docs3/nightly/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/docs3/nightly/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/docs3/nightly/#readableduration))**
...
**Field: `headers` ([Headers](/docs3/nightly/#headers))**
...
Type defined as array of `Header` values, see [Header](/docs3/nightly/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/docs3/nightly/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/docs3/nightly/#extractcredentialsfrombody))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/docs3/nightly/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/docs3/nightly/#introspectioncache))**
...
**Field: `fromOASExamples` ([FromOASExamples](/docs3/nightly/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/docs3/nightly/#notifications))**
...
**Field: `jwt` ([JWTValidation](/docs3/nightly/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/docs3/nightly/#introspection))**
...
**Field: `allow` ([Allowance](/docs3/nightly/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/docs3/nightly/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/docs3/nightly/#allowance))**
IgnoreAuthentication ignores authentication on request by allowance.

**Field: `internal` ([Internal](/docs3/nightly/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/docs3/nightly/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/docs3/nightly/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/docs3/nightly/#transformbody))**
...
**Field: `urlRewrite` ([URLRewrite](/docs3/nightly/#urlrewrite))**
URLRewrite contains the URL rewriting configuration.

**Field: `cache` ([CachePlugin](/docs3/nightly/#cacheplugin))**
Cache contains the caching plugin configuration.

**Field: `enforceTimeout` ([EnforceTimeout](/docs3/nightly/#enforcetimeout))**
EnforceTimeout contains the request timeout configuration.

**Field: `validateRequest` ([ValidateRequest](/docs3/nightly/#validaterequest))**
ValidateRequest contains the request validation configuration.

**Field: `mockResponse` ([MockResponse](/docs3/nightly/#mockresponse))**
MockResponse contains the mock response configuration.

**Field: `virtualEndpoint` ([VirtualEndpoint](/docs3/nightly/#virtualendpoint))**
VirtualEndpoint contains virtual endpoint configuration.

**Field: `postPlugins` ([EndpointPostPlugins](/docs3/nightly/#endpointpostplugins))**
PostPlugins contains endpoint level post plugins configuration.

**Field: `circuitBreaker` ([CircuitBreaker](/docs3/nightly/#circuitbreaker))**
CircuitBreaker contains the configuration for the circuit breaker functionality.

**Field: `trackEndpoint` ([TrackEndpoint](/docs3/nightly/#trackendpoint))**
TrackEndpoint contains the configuration for enabling analytics and logs.

**Field: `doNotTrackEndpoint` ([TrackEndpoint](/docs3/nightly/#trackendpoint))**
DoNotTrackEndpoint contains the configuration for disabling analytics and logs.

**Field: `requestSizeLimit` ([RequestSizeLimit](/docs3/nightly/#requestsizelimit))**
RequestSizeLimit limits the maximum allowed size of the request body in bytes.

**Field: `rateLimit` ([RateLimitEndpoint](/docs3/nightly/#ratelimitendpoint))**
...
Type defined as object of `Path` values, see [Path](/docs3/nightly/#path) definition.
...
**Field: `enforcedTimeout` ([EnforceTimeout](/docs3/nightly/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/docs3/nightly/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/docs3/nightly/#signature))**
...
**Field: `in` ([URLRewriteInput](/docs3/nightly/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/docs3/nightly/#urlrewritecondition))**
