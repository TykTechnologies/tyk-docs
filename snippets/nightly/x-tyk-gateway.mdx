...
**Field: `state` ([State](/docs/nightly/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/docs/nightly/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/docs/nightly/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/docs/nightly/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/docs/nightly/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/docs/nightly/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/docs/nightly/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/docs/nightly/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/docs/nightly/#listenpath))**
...
**Field: `customDomain` ([Domain](/docs/nightly/#domain))**
...
**Field: `global` ([Global](/docs/nightly/#global))**
Global contains configuration for middleware that affects the whole API (all endpoints).

**Field: `operations` ([Operations](/docs/nightly/#operations))**
...
This field controls the exposure of the API on the Gateway. When set to `true`, the API will not be made available for external access and will not be included in API listings returned by the Gateway's management APIs; it will be accessible only via [internal looping](/docs/nightly/advanced-configuration/transform-traffic/looping) or as a [child API version](/docs/nightly/api-management/api-versioning#base-and-child-apis).
...
**Field: `cache` ([ServiceDiscoveryCache](/docs/nightly/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/docs/nightly/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/docs/nightly/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/docs/nightly/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/docs/nightly/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/docs/nightly/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/docs/nightly/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/docs/nightly/#customkeylifetime))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/docs/nightly/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/docs/nightly/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/docs/nightly/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/docs/nightly/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/docs/nightly/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/docs/nightly/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/docs/nightly/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/docs/nightly/#customplugins))**
...
**Field: `cache` ([Cache](/docs/nightly/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/docs/nightly/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/docs/nightly/#transformheaders))**
...
**Field: `contextVariables` ([ContextVariables](/docs/nightly/#contextvariables))**
ContextVariables contains the configuration related to Tyk context variables.

**Field: `trafficLogs` ([TrafficLogs](/docs/nightly/#trafficlogs))**
TrafficLogs contains the configurations related to API level log analytics.

**Field: `requestSizeLimit` ([GlobalRequestSizeLimit](/docs/nightly/#globalrequestsizelimit))**
RequestSizeLimit contains the configuration related to limiting the global request size.

**Field: `ignoreCase` ([IgnoreCase](/docs/nightly/#ignorecase))**
...
Type defined as object of `Operation` values, see [Operation](/docs/nightly/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/docs/nightly/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/docs/nightly/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/docs/nightly/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/docs/nightly/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/docs/nightly/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/docs/nightly/#authenticationplugin))**
...
**Field: `value` ([ReadableDuration](/docs/nightly/#readableduration))**
...
**Field: `type` ([Kind](/docs/nightly/#kind))**
...
**Field: `bundle` ([PluginBundle](/docs/nightly/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/docs/nightly/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/docs/nightly/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/docs/nightly/#customplugin) definition.
...
**Field: `add` ([Headers](/docs/nightly/#headers))**
...
**Field: `customRetentionPeriod` ([ReadableDuration](/docs/nightly/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/docs/nightly/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/docs/nightly/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/docs/nightly/#readableduration))**
...
**Field: `headers` ([Headers](/docs/nightly/#headers))**
...
Type defined as array of `Header` values, see [Header](/docs/nightly/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/docs/nightly/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/docs/nightly/#extractcredentialsfrombody))**
...
**Field: `type` ([CustomClaimValidationType](/docs/nightly/#customclaimvalidationtype))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/docs/nightly/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/docs/nightly/#introspectioncache))**
...
**Field: `jtiValidation` ([JTIValidation](/docs/nightly/#jtivalidation))**
JTIValidation contains the configuration for the validation of the JWT ID.
...
**Field: `fromOASExamples` ([FromOASExamples](/docs/nightly/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/docs/nightly/#notifications))**
...
**Field: `jwt` ([JWTValidation](/docs/nightly/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/docs/nightly/#introspection))**
...
**Field: `allow` ([Allowance](/docs/nightly/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/docs/nightly/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/docs/nightly/#allowance))**
...
**Field: `internal` ([Internal](/docs/nightly/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/docs/nightly/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/docs/nightly/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/docs/nightly/#transformbody))**
...
**Field: `urlRewrite` ([URLRewrite](/docs/nightly/#urlrewrite))**
URLRewrite contains the URL rewriting configuration.

**Field: `cache` ([CachePlugin](/docs/nightly/#cacheplugin))**
Cache contains the caching plugin configuration.

**Field: `enforceTimeout` ([EnforceTimeout](/docs/nightly/#enforcetimeout))**
EnforceTimeout contains the request timeout configuration.

**Field: `validateRequest` ([ValidateRequest](/docs/nightly/#validaterequest))**
ValidateRequest contains the request validation configuration.

**Field: `mockResponse` ([MockResponse](/docs/nightly/#mockresponse))**
MockResponse contains the mock response configuration.

**Field: `virtualEndpoint` ([VirtualEndpoint](/docs/nightly/#virtualendpoint))**
VirtualEndpoint contains virtual endpoint configuration.

**Field: `postPlugins` ([EndpointPostPlugins](/docs/nightly/#endpointpostplugins))**
PostPlugins contains endpoint level post plugins configuration.

**Field: `circuitBreaker` ([CircuitBreaker](/docs/nightly/#circuitbreaker))**
CircuitBreaker contains the configuration for the circuit breaker functionality.

**Field: `trackEndpoint` ([TrackEndpoint](/docs/nightly/#trackendpoint))**
TrackEndpoint contains the configuration for enabling analytics and logs.

**Field: `doNotTrackEndpoint` ([TrackEndpoint](/docs/nightly/#trackendpoint))**
DoNotTrackEndpoint contains the configuration for disabling analytics and logs.

**Field: `requestSizeLimit` ([RequestSizeLimit](/docs/nightly/#requestsizelimit))**
RequestSizeLimit limits the maximum allowed size of the request body in bytes.

**Field: `rateLimit` ([RateLimitEndpoint](/docs/nightly/#ratelimitendpoint))**
...
**Field: `DELETE` ([Plugins](/docs/nightly/#plugins))**
Delete holds plugin configuration for DELETE requests.

**Field: `GET` ([Plugins](/docs/nightly/#plugins))**
Get holds plugin configuration for GET requests.

**Field: `HEAD` ([Plugins](/docs/nightly/#plugins))**
Head holds plugin configuration for HEAD requests.

**Field: `OPTIONS` ([Plugins](/docs/nightly/#plugins))**
Options holds plugin configuration for OPTIONS requests.

**Field: `PATCH` ([Plugins](/docs/nightly/#plugins))**
Patch holds plugin configuration for PATCH requests.

**Field: `POST` ([Plugins](/docs/nightly/#plugins))**
Post holds plugin configuration for POST requests.

**Field: `PUT` ([Plugins](/docs/nightly/#plugins))**
Put holds plugin configuration for PUT requests.

**Field: `TRACE` ([Plugins](/docs/nightly/#plugins))**
Trace holds plugin configuration for TRACE requests.

**Field: `CONNECT` ([Plugins](/docs/nightly/#plugins))**
Connect holds plugin configuration for CONNECT requests.

### **Paths**

Paths is a mapping of API endpoints to Path plugin configurations. This field is part of the [Middleware](/docs/nightly/#middleware) structure.


The string keys in this object represent URL path patterns (e.g. `/users`, `/users/{id}`, `/api/*`) that match API endpoints.

Type defined as object of `Path` values, see [Path](/docs/nightly/#path) definition.
...
**Field: `enforcedTimeout` ([EnforceTimeout](/docs/nightly/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/docs/nightly/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/docs/nightly/#signature))**
...
**Field: `in` ([URLRewriteInput](/docs/nightly/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/docs/nightly/#urlrewritecondition))**
