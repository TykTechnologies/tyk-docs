...
**Field: `state` ([State](/nightly/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/nightly/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/nightly/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/nightly/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/nightly/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/nightly/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/nightly/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/nightly/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/nightly/#listenpath))**
...
**Field: `customDomain` ([Domain](/nightly/#domain))**
...
**Field: `value` ([ErrorOverridesMap](/nightly/#erroroverridesmap))**
...
it will be accessible only via [internal looping](/nightly/advanced-configuration/transform-traffic/looping) or as a [child API version](/nightly/api-management/api-versioning#base-and-child-apis).
...
**Field: `cache` ([ServiceDiscoveryCache](/nightly/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/nightly/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/nightly/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/nightly/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/nightly/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/nightly/#upstreamrequestsigning))**
...
**Field: `protectedResourceMetadata` ([ProtectedResourceMetadata](/nightly/#protectedresourcemetadata))**
...
**Field: `certificateAuth` ([CertificateAuth](/nightly/#certificateauth))**
...
Type defined as object of `MCPPrimitive` values, see [MCPPrimitive](/nightly/#mcpprimitive) definition.
...
SecuritySchemes holds security scheme values keyed by the scheme name declared in `components.securitySchemes`. Each value can be an `oauth2` scheme — see [OAuth2](/nightly/#oauth2) for the full configuration contract.
...
**Deprecated in Tyk 5.14.0.** Use `authentication.securitySchemes[name].oauth2.protectedResourceMetadata` ([OAuth2](/nightly/#oauth2)) instead. Tyk Dashboard migrates existing configurations automatically on startup. This block remains for downgrade safety.
...
**Field: `type` ([CustomClaimValidationType](/nightly/#customclaimvalidationtype))**
...
**Field: `match` ([ErrorMatcher](/nightly/#errormatcher))**
Match contains optional additional matching criteria.

**Field: `response` ([ErrorResponse](/nightly/#errorresponse))**
...
**Field: `jtiValidation` ([JTIValidation](/nightly/#jtivalidation))**
JTIValidation contains the configuration for the validation of the JWT ID.
...
**Field: `scopeCheck` ([ScopeCheck](/nightly/#scopecheck))**
...
**Field: `exchange` ([OAuth2Exchange](/nightly/#oauth2exchange))**
...
**Field: `scopeCheck` ([OAuth2ScopeCheck](/nightly/#oauth2scopecheck))**
ScopeCheck enables OAS-native scope enforcement against the inbound token's claims.

**Field: `protectedResourceMetadata` ([OAuth2ProtectedResourceMetadata](/nightly/#oauth2protectedresourcemetadata))**
...
**Field: `tokenExchange` ([OAuth2TokenExchange](/nightly/#oauth2tokenexchange))**
...
**Field: `providers` (`[]`[OAuth2ExchangeProvider](/nightly/#oauth2exchangeprovider))**
...
**Field: `cache` ([OAuth2ExchangeCache](/nightly/#oauth2exchangecache))**
...
**Field: `maxTimeout` ([ReadableDuration](/nightly/#readableduration))**
...
**Field: `safetyMargin` ([ReadableDuration](/nightly/#readableduration))**
...
Paths is a mapping of API endpoints to Path plugin configurations. This field is part of the [Middleware](/nightly/#middleware) structure.
