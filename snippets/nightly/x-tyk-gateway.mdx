...
**Field: `enforceTimeout` ([GlobalEnforceTimeout](/nightly/#globalenforcetimeout))**
...
**Field: `tool` ([DerivedTool](/nightly/#derivedtool))**
...
**Field: `annotations` ([DerivedToolAnnotations](/nightly/#derivedtoolannotations))**
...
**Field: `protectedResourceMetadata` ([OAuth2PRM](/nightly/#oauth2prm))**
...
**Field: `source` ([TykMCPServerSource](/nightly/#tykmcpserversource))**
