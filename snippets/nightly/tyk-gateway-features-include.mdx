...
**OpenAPI Standards**: Keep your OpenAPI 3.0 description as source of truth with [Tyk OAS APIs](/docs3/nightly/api-management/gateway-config-managing-oas#), import your Swagger and OAS2/3 documents to scaffold Tyk Classic APIs.
...
**CORS** - Enable [CORS](/docs3/nightly/api-management/security-features#cross-origin-resource-sharing-cors) for certain APIs so users can make browser-based requests
