...
**DEPRECATED**. Use `api_defaults` instead. Forces StripListenPath to true for all APIs created or updated through the Tyk Dashboard or imported via Tyk Sync.

### api_defaults
ENV: <b>TYK_DB_APIDEFAULTS</b><br />
Type: `object`<br />

Allows setting default values for APIs created or updated through the Tyk Dashboard or imported via Tyk Sync.

#### api_defaults.strip_listen_path
ENV: <b>TYK_DB_APIDEFAULTS_STRIPLISTENPATH</b><br />
Type: `bool`<br />

Forces StripListenPath to true for all APIs created or updated through the Tyk Dashboard or imported via Tyk Sync.
### notify_on_change
