...
ForceApiDefaults specifically forces the StripListenPath setting to true for all APIs created or updated through the Tyk Dashboard or imported via Tyk Sync.
Note: Despite its generic name, this setting currently only affects the StripListenPath behavior.
