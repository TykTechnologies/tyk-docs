...
### webhooks_http_timeout
ENV: <b>PORTAL_WEBHOOKS_HTTP_TIMEOUT</b><br />
Type: `int`<br />

Controls the HTTP timeout for webhook requests.

### webhooks_queue_size
ENV: <b>PORTAL_WEBHOOKS_QUEUE_SIZE</b><br />
Type: `int`<br />

Sets the size of the webhook processing queue.
