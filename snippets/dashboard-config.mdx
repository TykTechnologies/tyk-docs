...
If set to true, this forces the [listenPath.strip](https://chatgpt.com/api-management/gateway-config-tyk-oas#listenpath) setting to true for all APIs created or updated through the Tyk Dashboard API or UI.
