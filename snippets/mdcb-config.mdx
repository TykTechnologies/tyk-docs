...
Set it above the Gateway's [slave_options.call_timeout](/tyk-oss-gateway/configuration#slave_options-call_timeout) (the longest RPC call duration) and [slave_options.ping_timeout](/tyk-oss-gateway/configuration#slave_options-ping_timeout) (the data plane keepalive interval, ~10s), to reduce reconnect and TLS handshake churn.
