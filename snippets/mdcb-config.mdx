...
and /debug/pprof/ for performance profiling. RPC connection controls (`max_connection_idle_time`, `max_connections`) are configurable only under `server_options` and do not apply here.
