...
This setting has no effect for aggregate pumps used to generate [Tyk Dashboard Analytics](/api-management/dashboard-analytics) which
do not directly transmit the Traffic Logs.
