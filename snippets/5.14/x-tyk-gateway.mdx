...
**Field: `state` ([State](/5.14/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/5.14/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/5.14/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/5.14/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/5.14/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/5.14/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/5.14/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/5.14/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/5.14/#listenpath))**
...
**Field: `customDomain` ([Domain](/5.14/#domain))**
...
**Field: `value` ([ErrorOverridesMap](/5.14/#erroroverridesmap))**
...
it will be accessible only via [internal looping](/5.14/advanced-configuration/transform-traffic/looping) or as a [child API version](/5.14/api-management/api-versioning#base-and-child-apis).
...
**Field: `cache` ([ServiceDiscoveryCache](/5.14/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/5.14/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/5.14/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/5.14/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/5.14/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/5.14/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/5.14/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/5.14/#customkeylifetime))**
...
**Field: `protectedResourceMetadata` ([ProtectedResourceMetadata](/5.14/#protectedresourcemetadata))**
...
**Field: `certificateAuth` ([CertificateAuth](/5.14/#certificateauth))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/5.14/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/5.14/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/5.14/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/5.14/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/5.14/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/5.14/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/5.14/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/5.14/#customplugins))**
...
**Field: `cache` ([Cache](/5.14/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/5.14/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/5.14/#transformheaders))**
...
Type defined as object of `Operation` values, see [Operation](/5.14/#operation) definition.
...
Type defined as object of `MCPPrimitive` values, see [MCPPrimitive](/5.14/#mcpprimitive) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/5.14/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/5.14/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/5.14/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/5.14/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/5.14/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/5.14/#authenticationplugin))**
...
SecuritySchemes holds security scheme values keyed by the scheme name declared in `components.securitySchemes`. Each value can be an `oauth2` scheme — see [OAuth2](/5.14/#oauth2) for the full configuration contract.
...
**Field: `value` ([ReadableDuration](/5.14/#readableduration))**
...
**Deprecated in Tyk 5.14.0.** Use `authentication.securitySchemes[name].oauth2.protectedResourceMetadata` ([OAuth2](/5.14/#oauth2)) instead. Tyk Dashboard migrates existing configurations automatically on startup. This block remains for downgrade safety.
...
**Field: `bundle` ([PluginBundle](/5.14/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/5.14/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/5.14/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/5.14/#customplugin) definition.
...
**Field: `add` ([Headers](/5.14/#headers))**
...
**Field: `customRetentionPeriod` ([ReadableDuration](/5.14/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/5.14/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/5.14/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/5.14/#readableduration))**
...
**Field: `headers` ([Headers](/5.14/#headers))**
...
Type defined as array of `Header` values, see [Header](/5.14/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/5.14/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/5.14/#extractcredentialsfrombody))**
...
**Field: `type` ([CustomClaimValidationType](/5.14/#customclaimvalidationtype))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/5.14/#endpointpostplugin) definition.
...
**Field: `match` ([ErrorMatcher](/5.14/#errormatcher))**
Match contains optional additional matching criteria.

**Field: `response` ([ErrorResponse](/5.14/#errorresponse))**
...
**Field: `cache` ([IntrospectionCache](/5.14/#introspectioncache))**
...
**Field: `jtiValidation` ([JTIValidation](/5.14/#jtivalidation))**
JTIValidation contains the configuration for the validation of the JWT ID.
...
**Field: `scopeCheck` ([ScopeCheck](/5.14/#scopecheck))**
...
**Field: `exchange` ([OAuth2Exchange](/5.14/#oauth2exchange))**
...
**Field: `fromOASExamples` ([FromOASExamples](/5.14/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/5.14/#notifications))**
...
**Field: `jwt` ([JWTValidation](/5.14/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/5.14/#introspection))**
...
**Field: `scopeCheck` ([OAuth2ScopeCheck](/5.14/#oauth2scopecheck))**
ScopeCheck enables OAS-native scope enforcement against the inbound token's claims.

**Field: `protectedResourceMetadata` ([OAuth2ProtectedResourceMetadata](/5.14/#oauth2protectedresourcemetadata))**
...
**Field: `tokenExchange` ([OAuth2TokenExchange](/5.14/#oauth2tokenexchange))**
...
**Field: `providers` (`[]`[OAuth2ExchangeProvider](/5.14/#oauth2exchangeprovider))**
...
**Field: `cache` ([OAuth2ExchangeCache](/5.14/#oauth2exchangecache))**
...
**Field: `maxTimeout` ([ReadableDuration](/5.14/#readableduration))**
...
**Field: `safetyMargin` ([ReadableDuration](/5.14/#readableduration))**
...
**Field: `allow` ([Allowance](/5.14/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/5.14/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/5.14/#allowance))**
...
**Field: `internal` ([Internal](/5.14/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/5.14/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/5.14/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/5.14/#transformbody))**
...
**Field: `enforcedTimeout` ([EnforceTimeout](/5.14/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/5.14/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/5.14/#signature))**
...
**Field: `in` ([URLRewriteInput](/5.14/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/5.14/#urlrewritecondition))**
