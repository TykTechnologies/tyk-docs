...
Allows MDCB to use Mutual TLS. This requires to set `server_options.use_ssl` to true. See [Mutual TLS](/5.8/basic-config-and-security/security/mutual-tls) for more details.
