...
[Instrumentation docs](/5.8/api-management/logs-metrics).
...
Expose profiling information to support debugging of Tyk Pump. This operates in the same as for Tyk Gateway, as explained [here](/5.8/api-management/troubleshooting-debugging).
