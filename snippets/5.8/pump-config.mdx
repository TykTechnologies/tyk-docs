...
[Instrumentation docs](/docs/5.8/basic-config-and-security/report-monitor-trigger-events/instrumentation).
...
Expose profiling information to support debugging of Tyk Pump. This operates in the same as for Tyk Gateway, as explained [here](/docs/5.8/troubleshooting/tyk-gateway/profiling).
