...
it will be accessible only via [internal looping](/5.8/advanced-configuration/transform-traffic/looping) or as a [child API version](/5.8/api-management/api-versioning#base-and-child-apis).
