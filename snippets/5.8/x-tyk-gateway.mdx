...
**Field: `state` ([State](/5.8/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/5.8/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/5.8/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/5.8/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/5.8/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/5.8/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/5.8/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/5.8/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/5.8/#listenpath))**
...
**Field: `customDomain` ([Domain](/5.8/#domain))**
...
This field controls the exposure of the API on the Gateway. When set to `true`, the API will not be made available for external access and will not be included in API listings returned by the Gateway's management APIs; it will be accessible only via [internal looping](/5.8/advanced-configuration/transform-traffic/looping) or as a [child API version](/5.8/api-management/api-versioning#base-and-child-apis).
...
**Field: `cache` ([ServiceDiscoveryCache](/5.8/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/5.8/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/5.8/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/5.8/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/5.8/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/5.8/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/5.8/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/5.8/#customkeylifetime))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/5.8/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/5.8/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/5.8/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/5.8/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/5.8/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/5.8/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/5.8/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/5.8/#customplugins))**
...
**Field: `cache` ([Cache](/5.8/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/5.8/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/5.8/#transformheaders))**
...
Type defined as object of `Operation` values, see [Operation](/5.8/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/5.8/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/5.8/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/5.8/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/5.8/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/5.8/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/5.8/#authenticationplugin))**
...
**Field: `value` ([ReadableDuration](/5.8/#readableduration))**
...
**Field: `bundle` ([PluginBundle](/5.8/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/5.8/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/5.8/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/5.8/#customplugin) definition.
...
**Field: `customRetentionPeriod` ([ReadableDuration](/5.8/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/5.8/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/5.8/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/5.8/#readableduration))**
...
**Field: `headers` ([Headers](/5.8/#headers))**
...
Type defined as array of `Header` values, see [Header](/5.8/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/5.8/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/5.8/#extractcredentialsfrombody))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/5.8/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/5.8/#introspectioncache))**
...
**Field: `fromOASExamples` ([FromOASExamples](/5.8/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/5.8/#notifications))**
...
**Field: `jwt` ([JWTValidation](/5.8/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/5.8/#introspection))**
...
**Field: `allow` ([Allowance](/5.8/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/5.8/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/5.8/#allowance))**
...
**Field: `internal` ([Internal](/5.8/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/5.8/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/5.8/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/5.8/#transformbody))**
...
**Field: `enforcedTimeout` ([EnforceTimeout](/5.8/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/5.8/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/5.8/#signature))**
...
**Field: `in` ([URLRewriteInput](/5.8/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/5.8/#urlrewritecondition))**
