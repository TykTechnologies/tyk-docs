...
**Field: `state` ([State](/docs3/5.8/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/docs3/5.8/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/docs3/5.8/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/docs3/5.8/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/docs3/5.8/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/docs3/5.8/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/docs3/5.8/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/docs3/5.8/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/docs3/5.8/#listenpath))**
...
**Field: `customDomain` ([Domain](/docs3/5.8/#domain))**
...
**Field: `cache` ([ServiceDiscoveryCache](/docs3/5.8/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/docs3/5.8/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/docs3/5.8/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/docs3/5.8/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/docs3/5.8/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/docs3/5.8/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/docs3/5.8/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/docs3/5.8/#customkeylifetime))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/docs3/5.8/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/docs3/5.8/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/docs3/5.8/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/docs3/5.8/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/docs3/5.8/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/docs3/5.8/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/docs3/5.8/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/docs3/5.8/#customplugins))**
...
**Field: `cache` ([Cache](/docs3/5.8/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/docs3/5.8/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/docs3/5.8/#transformheaders))**
...
**Field: `contextVariables` ([ContextVariables](/docs3/5.8/#contextvariables))**
ContextVariables contains the configuration related to Tyk context variables.

**Field: `trafficLogs` ([TrafficLogs](/docs3/5.8/#trafficlogs))**
TrafficLogs contains the configurations related to API level log analytics.

**Field: `requestSizeLimit` ([GlobalRequestSizeLimit](/docs3/5.8/#globalrequestsizelimit))**
RequestSizeLimit contains the configuration related to limiting the global request size.

**Field: `ignoreCase` ([IgnoreCase](/docs3/5.8/#ignorecase))**
...
Type defined as object of `Operation` values, see [Operation](/docs3/5.8/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/docs3/5.8/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/docs3/5.8/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/docs3/5.8/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/docs3/5.8/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/docs3/5.8/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/docs3/5.8/#authenticationplugin))**
...
**Field: `value` ([ReadableDuration](/docs3/5.8/#readableduration))**
...
**Field: `type` ([Kind](/docs3/5.8/#kind))**
...
**Field: `bundle` ([PluginBundle](/docs3/5.8/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/docs3/5.8/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/docs3/5.8/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/docs3/5.8/#customplugin) definition.
...
**Field: `add` ([Headers](/docs3/5.8/#headers))**
...
**Field: `customRetentionPeriod` ([ReadableDuration](/docs3/5.8/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/docs3/5.8/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/docs3/5.8/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/docs3/5.8/#readableduration))**
...
**Field: `headers` ([Headers](/docs3/5.8/#headers))**
...
Type defined as array of `Header` values, see [Header](/docs3/5.8/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/docs3/5.8/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/docs3/5.8/#extractcredentialsfrombody))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/docs3/5.8/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/docs3/5.8/#introspectioncache))**
...
**Field: `fromOASExamples` ([FromOASExamples](/docs3/5.8/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/docs3/5.8/#notifications))**
...
**Field: `jwt` ([JWTValidation](/docs3/5.8/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/docs3/5.8/#introspection))**
...
**Field: `allow` ([Allowance](/docs3/5.8/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/docs3/5.8/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/docs3/5.8/#allowance))**
IgnoreAuthentication ignores authentication on request by allowance.

**Field: `internal` ([Internal](/docs3/5.8/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/docs3/5.8/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/docs3/5.8/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/docs3/5.8/#transformbody))**
...
**Field: `urlRewrite` ([URLRewrite](/docs3/5.8/#urlrewrite))**
URLRewrite contains the URL rewriting configuration.

**Field: `cache` ([CachePlugin](/docs3/5.8/#cacheplugin))**
Cache contains the caching plugin configuration.

**Field: `enforceTimeout` ([EnforceTimeout](/docs3/5.8/#enforcetimeout))**
EnforceTimeout contains the request timeout configuration.

**Field: `validateRequest` ([ValidateRequest](/docs3/5.8/#validaterequest))**
ValidateRequest contains the request validation configuration.

**Field: `mockResponse` ([MockResponse](/docs3/5.8/#mockresponse))**
MockResponse contains the mock response configuration.

**Field: `virtualEndpoint` ([VirtualEndpoint](/docs3/5.8/#virtualendpoint))**
VirtualEndpoint contains virtual endpoint configuration.

**Field: `postPlugins` ([EndpointPostPlugins](/docs3/5.8/#endpointpostplugins))**
PostPlugins contains endpoint level post plugins configuration.

**Field: `circuitBreaker` ([CircuitBreaker](/docs3/5.8/#circuitbreaker))**
CircuitBreaker contains the configuration for the circuit breaker functionality.

**Field: `trackEndpoint` ([TrackEndpoint](/docs3/5.8/#trackendpoint))**
TrackEndpoint contains the configuration for enabling analytics and logs.

**Field: `doNotTrackEndpoint` ([TrackEndpoint](/docs3/5.8/#trackendpoint))**
DoNotTrackEndpoint contains the configuration for disabling analytics and logs.

**Field: `requestSizeLimit` ([RequestSizeLimit](/docs3/5.8/#requestsizelimit))**
RequestSizeLimit limits the maximum allowed size of the request body in bytes.

**Field: `rateLimit` ([RateLimitEndpoint](/docs3/5.8/#ratelimitendpoint))**
...
Type defined as object of `Path` values, see [Path](/docs3/5.8/#path) definition.
...
**Field: `enforcedTimeout` ([EnforceTimeout](/docs3/5.8/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/docs3/5.8/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/docs3/5.8/#signature))**
...
**Field: `in` ([URLRewriteInput](/docs3/5.8/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/docs3/5.8/#urlrewritecondition))**
