...
**Field: `state` ([State](/docs3/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/docs3/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/docs3/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/docs3/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/docs3/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/docs3/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/docs3/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/docs3/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/docs3/#listenpath))**
...
**Field: `customDomain` ([Domain](/docs3/#domain))**
...
**Field: `cache` ([ServiceDiscoveryCache](/docs3/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/docs3/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/docs3/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/docs3/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/docs3/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/docs3/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/docs3/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/docs3/#customkeylifetime))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/docs3/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/docs3/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/docs3/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/docs3/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/docs3/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/docs3/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/docs3/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/docs3/#customplugins))**
...
**Field: `cache` ([Cache](/docs3/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/docs3/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/docs3/#transformheaders))**
...
Type defined as object of `Operation` values, see [Operation](/docs3/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/docs3/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/docs3/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/docs3/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/docs3/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/docs3/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/docs3/#authenticationplugin))**
...
**Field: `value` ([ReadableDuration](/docs3/#readableduration))**
...
**Field: `bundle` ([PluginBundle](/docs3/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/docs3/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/docs3/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/docs3/#customplugin) definition.
...
**Field: `add` ([Headers](/docs3/#headers))**
...
**Field: `customRetentionPeriod` ([ReadableDuration](/docs3/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/docs3/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/docs3/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/docs3/#readableduration))**
...
**Field: `headers` ([Headers](/docs3/#headers))**
...
Type defined as array of `Header` values, see [Header](/docs3/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/docs3/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/docs3/#extractcredentialsfrombody))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/docs3/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/docs3/#introspectioncache))**
...
**Field: `fromOASExamples` ([FromOASExamples](/docs3/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/docs3/#notifications))**
...
**Field: `jwt` ([JWTValidation](/docs3/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/docs3/#introspection))**
...
**Field: `allow` ([Allowance](/docs3/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/docs3/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/docs3/#allowance))**
IgnoreAuthentication ignores authentication on request by allowance.

**Field: `internal` ([Internal](/docs3/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/docs3/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/docs3/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/docs3/#transformbody))**
...
Type defined as object of `Path` values, see [Path](/docs3/#path) definition.
...
**Field: `enforcedTimeout` ([EnforceTimeout](/docs3/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/docs3/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/docs3/#signature))**
...
**Field: `in` ([URLRewriteInput](/docs3/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/docs3/#urlrewritecondition))**
