...
See [licensing](/docs3/getting-started/quick-start) and [deployment models](/docs3/tyk-self-managed/install) to learn about the different deployment options for Self-Managed.
