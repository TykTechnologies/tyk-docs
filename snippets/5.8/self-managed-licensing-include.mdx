...
See [licensing](/docs/5.8/getting-started/quick-start) and [deployment models](/docs/5.8/tyk-self-managed/install) to learn about the different deployment options for Self-Managed.
