...
See [licensing](/docs3/5.8/getting-started/quick-start) and [deployment models](/docs3/5.8/tyk-self-managed/install) to learn about the different deployment options for Self-Managed.
