...
For more information on how policies are constructed and a detailed explanation of their properties, please see the [Security Policies](/basic-config-and-security/security/security-policies) section.
