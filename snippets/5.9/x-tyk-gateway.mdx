...
**Field: `state` ([State](/5.9/#state))**
State holds configuration for API definition states (active, internal).

**Field: `versioning` ([Versioning](/5.9/#versioning))**
...
**Field: `serviceDiscovery` ([ServiceDiscovery](/5.9/#servicediscovery))**
...
**Field: `uptimeTests` ([UptimeTests](/5.9/#uptimetests))**
...
**Field: `mutualTLS` ([MutualTLS](/5.9/#mutualtls))**
...
**Field: `certificatePinning` ([CertificatePinning](/5.9/#certificatepinning))**
...
**Field: `preserveHostHeader` ([PreserveHostHeader](/5.9/#preservehostheader))**
...
**Field: `preserveTrailingSlash` ([PreserveTrailingSlash](/5.9/#preservetrailingslash))**
...
**Field: `listenPath` ([ListenPath](/5.9/#listenpath))**
...
**Field: `customDomain` ([Domain](/5.9/#domain))**
...
This field controls the exposure of the API on the Gateway. When set to `true`, the API will not be made available for external access and will not be included in API listings returned by the Gateway's management APIs; it will be accessible only via [internal looping](/5.9/advanced-configuration/transform-traffic/looping) or as a [child API version](/5.9/api-management/api-versioning#base-and-child-apis).
...
**Field: `cache` ([ServiceDiscoveryCache](/5.9/#servicediscoverycache))**
...
**Field: `domainToPublicKeysMapping` ([PinnedPublicKeys](/5.9/#pinnedpublickeys))**
...
**Field: `per` ([ReadableDuration](/5.9/#readableduration))**
...
**Field: `basicAuth` ([UpstreamBasicAuth](/5.9/#upstreambasicauth))**
BasicAuth holds the basic authentication configuration for upstream API authentication.

**Field: `oauth` ([UpstreamOAuth](/5.9/#upstreamoauth))**
OAuth contains the configuration for OAuth2 Client Credentials flow.

**Field: `requestSigning` ([UpstreamRequestSigning](/5.9/#upstreamrequestsigning))**
...
**Field: `securitySchemes` ([SecuritySchemes](/5.9/#securityschemes))**
SecuritySchemes contains security schemes definitions.

**Field: `customKeyLifetime` ([CustomKeyLifetime](/5.9/#customkeylifetime))**
...
Type defined as array of `EventHandler` values, see [EventHandler](/5.9/#eventhandler) definition.
...
**Field: `prePlugins` ([CustomPlugins](/5.9/#customplugins))**
...
**Field: `postAuthenticationPlugin` ([PostAuthenticationPlugin](/5.9/#postauthenticationplugin))**
...
**Field: `postAuthenticationPlugins` ([CustomPlugins](/5.9/#customplugins))**
...
**Field: `postPlugin` ([PostPlugin](/5.9/#postplugin))**
...
**Field: `postPlugins` ([CustomPlugins](/5.9/#customplugins))**
...
**Field: `responsePlugin` ([ResponsePlugin](/5.9/#responseplugin))**
...
**Field: `responsePlugins` ([CustomPlugins](/5.9/#customplugins))**
...
**Field: `cache` ([Cache](/5.9/#cache))**
Cache contains the configurations related to caching.

Tyk classic API definition: `cache_options`.

**Field: `transformRequestHeaders` ([TransformHeaders](/5.9/#transformheaders))**
...
**Field: `transformResponseHeaders` ([TransformHeaders](/5.9/#transformheaders))**
...
Type defined as object of `Operation` values, see [Operation](/5.9/#operation) definition.
...
Type defined as array of `PinnedPublicKey` values, see [PinnedPublicKey](/5.9/#pinnedpublickey) definition.
...
**Field: `header` ([AuthSource](/5.9/#authsource))**
...
**Field: `clientCredentials` ([ClientCredentials](/5.9/#clientcredentials))**
ClientCredentials holds the configuration for OAuth2 Client Credentials flow.

**Field: `password` ([PasswordAuthentication](/5.9/#passwordauthentication))**
...
**Field: `scopes` ([Scopes](/5.9/#scopes))**
...
**Field: `config` ([AuthenticationPlugin](/5.9/#authenticationplugin))**
...
**Field: `value` ([ReadableDuration](/5.9/#readableduration))**
...
**Field: `bundle` ([PluginBundle](/5.9/#pluginbundle))**
Bundle configures custom plugin bundles.

**Field: `data` ([PluginConfigData](/5.9/#pluginconfigdata))**
...
**Field: `plugins` ([CustomPlugins](/5.9/#customplugins))**
...
Type defined as array of `CustomPlugin` values, see [CustomPlugin](/5.9/#customplugin) definition.
...
**Field: `customRetentionPeriod` ([ReadableDuration](/5.9/#readableduration))**
CustomRetentionPeriod configures a custom value for how long the analytics is retained for,
defaults to 100 years.

**Field: `plugins` ([CustomAnalyticsPlugins](/5.9/#customanalyticsplugins))**
...
**Field: `idExtractor` ([IDExtractor](/5.9/#idextractor))**
...
**Field: `cooldownPeriod` ([ReadableDuration](/5.9/#readableduration))**
...
**Field: `headers` ([Headers](/5.9/#headers))**
...
Type defined as array of `Header` values, see [Header](/5.9/#header) definition.
...
**Field: `config` ([IDExtractorConfig](/5.9/#idextractorconfig))**
...
**Field: `extractCredentialsFromBody` ([ExtractCredentialsFromBody](/5.9/#extractcredentialsfrombody))**
...
Type defined as array of `EndpointPostPlugin` values, see [EndpointPostPlugin](/5.9/#endpointpostplugin) definition.
...
**Field: `cache` ([IntrospectionCache](/5.9/#introspectioncache))**
...
**Field: `fromOASExamples` ([FromOASExamples](/5.9/#fromoasexamples))**
...
**Field: `notifications` ([Notifications](/5.9/#notifications))**
...
**Field: `jwt` ([JWTValidation](/5.9/#jwtvalidation))**
JWT configures JWT validation.


Tyk classic API definition: `external_oauth.providers[].jwt`.

**Field: `introspection` ([Introspection](/5.9/#introspection))**
...
**Field: `allow` ([Allowance](/5.9/#allowance))**
Allow request by allowance.

**Field: `block` ([Allowance](/5.9/#allowance))**
Block request by allowance.

**Field: `ignoreAuthentication` ([Allowance](/5.9/#allowance))**
...
**Field: `internal` ([Internal](/5.9/#internal))**
Internal makes the endpoint only respond to internal requests.

**Field: `transformRequestMethod` ([TransformRequestMethod](/5.9/#transformrequestmethod))**
TransformRequestMethod allows you to transform the method of a request.

**Field: `transformRequestBody` ([TransformBody](/5.9/#transformbody))**
TransformRequestBody allows you to transform request body.
When both `path` and `body` are provided, body would take precedence.

**Field: `transformResponseBody` ([TransformBody](/5.9/#transformbody))**
...
**Field: `enforcedTimeout` ([EnforceTimeout](/5.9/#enforcetimeout))**
...
Type defined as `RateLimit`, see [RateLimit](/5.9/#ratelimit) definition.
...
**Field: `signatureValidation` ([Signature](/5.9/#signature))**
...
**Field: `in` ([URLRewriteInput](/5.9/#urlrewriteinput))**
...
**Field: `condition` ([URLRewriteCondition](/5.9/#urlrewritecondition))**
