...
canonical: "https://tyk.io/docs/docs/api-management/automations"
---
...
- **A Tyk installation** (Self-Managed or Cloud)
  - If you don't have Tyk installed, follow our [installation guide](/docs/tyk-self-managed/install)
...
- **Tyk Dashboard v3+ access** (for Tyk Sync setup)
  - Learn how to set up the Tyk Dashboard [here](/docs/tyk-dashboard)
...
<Card href="/docs/api-management/automations/sync" img="/img/GitHub-Mark-64px.png">
**Read time: 10 mins**

Synchronize Tyk Environment With GitHub using Tyk Sync.
</Card>

<Card href="/docs/api-management/automations/operator" img="/img/k8s.png">
**Read time: 10 mins**
