...
**Learn more:**
* [Create an API in file-based mode](/docs/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
**Learn more:**
* [Create an API with the Dashboard](/docs/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
**Learn more:**
- [Dashboard API](/docs/api-management/dashboard-configuration#exploring-the-dashboard-api)
...
- [Using Tyk Operator to enable GitOps](/docs/api-management/automations)
