...
Refer to the [Tyk Gateway Configuration Reference](/docs/tyk-oss-gateway/configuration#enforce_org_quotas) for more details on this setting.
...
Refer to the [Tyk OAS API Definition reference](/docs/api-management/gateway-config-tyk-oas#global) for details.
...
Refer to the [Tyk Classic API Definition reference](/docs/api-management/gateway-config-tyk-classic) for details.
...
Refer this [documentation](/docs/#configuration-options).
</Accordion>
...
Refer this [documentation](/docs/#api-level-configuration).
</Accordion>
