...
For information about our health check endpoint, please visit our [Liveness Health Check](/docs/#liveness-health-check) documentation.
...
The Tyk Dashboard liveness health check endpoint can be configured [here](/docs/tyk-dashboard/configuration#health_check_endpoint_name). 

The Tyk MDCB liveness health check endpoint can be configured [here](/docs/api-management/mdcb#health-check). 
...
* [Redis Sizing](/docs/planning-for-production/database-settings#redis-sizing-guidelines)
* [PostgreSQL Sizing](/docs/planning-for-production/database-settings#postgresql-sizing-guidelines)
* [MongoDB Sizing](/docs/planning-for-production/database-settings#mongodb-sizing-guidelines)
