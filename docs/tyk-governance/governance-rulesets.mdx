...
- You can now use this ruleset to [evaluate APIs](/docs/tyk-governance/api-evaluation)
...
Once you've created rulesets, you can use them to validate APIs through the [API Evaluation](/docs/tyk-governance/api-evaluation) feature, which allows you to check API specifications against your governance standards.
</Accordion>
</AccordionGroup>
