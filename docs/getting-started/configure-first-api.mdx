...
Congratulations! You've successfully created, secured, and deployed your first API in Tyk Cloud. Next, explore more advanced features such as adding [rate limiting](/docs/api-management/rate-limit#introduction) to protect your API from abuse.

Explore more features in your [dashboard](/docs/getting-started/using-tyk-dashboard) to optimize and scale your API offerings.
