...
canonical: "https://tyk.io/docs/docs/tyk-stack/tyk-developer-portal/enterprise-developer-portal/getting-started-with-enterprise-portal/manage-get-started-guides-for-api-products"
---
...
1. **Create and publish an API Product**
    ...
    To start with, create and publish an API Product. Please refer to the [Publish API Products and Plans](/docs/portal/overview/getting-started#publish-an-api-product) page for further guidance.
