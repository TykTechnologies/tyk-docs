---
title: "Manage Users"
'og:description': "How to manage users in Tyk developer portal"
sidebarTitle: "Users"
tags: ['Developer Portal', 'Tyk', 'API Consumer', 'Users', 'Self Registration', 'Invite Users', 'Approve Requests']
canonical: "https://tyk.io/docs/docs/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/manage-api-consumers"
---
...
6. To generate the invite email, click **More Options** in the Overview section and then **Send invite**.
    ...
    To customize the invite email, please refer to the [Email customization section](/docs/portal/customization/email-notifications) for guidance.
