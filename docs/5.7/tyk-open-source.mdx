...
* [Tyk Gateway](/docs/5.7/tyk-oss-gateway) - Fully fledged API Gateway (Start here!) - <a href="https://github.com/TykTechnologies/tyk" className="github-button" target="_blank" rel="noopener noreferrer">⭐ Star TykTechnologies/tyk</a>
* [Tyk Pump](/docs/5.7/tyk-pump) - Send API analytics data to your chosen backend - <a href="https://github.com/TykTechnologies/tyk-pump" className="github-button" target="_blank" rel="noopener noreferrer">⭐ Star TykTechnologies/tyk-pump</a>
* [Tyk Identity Broker](/docs/5.7/api-management/external-service-integration#what-is-tyk-identity-broker-tib) - Connect your third-party IdP systems - <a href="https://github.com/TykTechnologies/api-management/external-service-integration#what-is-tyk-identity-broker-tib" className="github-button" target="_blank" rel="noopener noreferrer">⭐ Star TykTechnologies/api-management/external-service-integration#what-is-tyk-identity-broker-tib</a>
* [Tyk Helm Chart](/docs/5.7/product-stack/tyk-charts/overview) - Deploy Tyk in K8S - <a href="https://github.com/TykTechnologies/tyk-charts" className="github-button" target="_blank" rel="noopener noreferrer">⭐ Star TykTechnologies/tyk-charts</a>
...
The following are required for a Tyk OSS installation:
 ...
 - MongoDB - Required only if you chose to use the Tyk Pump with your Tyk OSS installation. Same goes with any [other pump data stores](/docs/5.7/api-management/tyk-pump#external-data-stores) you choose to use.
...
Get started with our [Quick Start guide](#quick-start-with-helm-chart) or go to [Tyk Open Source helm chart](/docs/5.7/product-stack/tyk-charts/tyk-oss-chart) for detailed installation instructions and configuration options.
...
You are now ready to [create an API](/docs/5.7/api-management/gateway-config-managing-classic#create-an-api).

For the complete installation guide and configuration options, please see [Tyk OSS Helm Chart](/docs/5.7/product-stack/tyk-charts/tyk-oss-chart).
...
2. MongoDB/SQL - Required only if you choose to use the MongoDB/SQL Tyk pump with your Tyk OSS installation. The same goes for any
             [other pump](/docs/5.7/api-management/tyk-pump#external-data-stores) you choose to use.
