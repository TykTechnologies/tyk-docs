...
- **A Tyk installation** (Self-Managed or Cloud)
  - If you don't have Tyk installed, follow our [installation guide](/docs/5.7/tyk-self-managed#installation-options-for-tyk-self-managed)
...
- **Tyk Dashboard v3+ access** (for Tyk Sync setup)
  - Learn how to set up the Tyk Dashboard [here](/docs/5.7/tyk-dashboard)
