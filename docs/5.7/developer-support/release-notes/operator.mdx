...
Go to the [Upgrading Tyk Operator](/docs/5.7/api-management/automations/operator#install-and-configure-tyk-operator) section for detailed upgrade instructions.
...
[Learn More](/docs/5.7/api-management/upstream-authentication#request-signing)
</Accordion>
...
[Learn More](/docs/5.7/api-management/automations/operator#create-a-tykstreamsapidefinition-custom-resource)
</Expandable>
</li>
</ul>
...
{/* Required. Use the following statement if there are no breaking changes, or explain if there are */}
{/* This release has no breaking changes. */}
**License Requirement:** Tyk Operator is now a closed-source product and requires a valid license key to operate. Please follow our [Installation and Upgrade Guide](/docs/5.7/api-management/automations/operator#install-and-configure-tyk-operator) to set your license key before installation or upgrade.
...
Go to the [Upgrading Tyk Operator](/docs/5.7/api-management/automations/operator#upgrading-tyk-operator) section for detailed upgrade instructions.
...
- [Docker image v1.0.0](https://hub.docker.com/r/tykio/tyk-operator/tags?page=&page_size=&ordering=&name=v1.0.0)
  - ```bash
    ...
    ```
- Helm chart
  - [tyk-charts v2.1.0](/docs/5.7/developer-support/release-notes/helm-chart#210-release-notes) {/* This is the link to the Helm charts links. Please be mindful that this URL is only available a few hours or day/s after we release the main release, so this link needs to be updated in a separate iteration */}
{/* source code tarball for oss projects */}
...
Learn More: [Create Tyk OAS API](/docs/5.7/api-management/automations/operator#set-up-tyk-oas-api)
</Accordion>
...
Learn More: [Tyk Ingress Controller](/docs/5.7/api-management/automations/operator#control-kubernetes-ingress-resources)
</Accordion>
...
Learn More: [Key-Level Per-API Rate Limits and Quota](/docs/5.7/api-management/automations/operator#security-policy-example)
</Accordion>
...
Learn More: [Key-Level Per-Endpoint Rate Limits](/docs/5.7/api-management/automations/operator#security-policy-example)
</Accordion>
...
Learn More: [TykOasApiDefinition in Security Policy](/docs/5.7/api-management/automations/operator#add-a-security-policy-to-your-api)
</Accordion>
...
Learn More: [Event Webhook with Tyk Classic](/docs/5.7/api-management/gateway-events#webhook-event-handlers-with-tyk-classic-apis)
</Accordion>
...
- [introspection](/docs/5.7/api-management/graphql#turning-off-introspection) option to enable/disable GraphQL introspection
- [graphql.proxy.auth_headers](/docs/5.7/api-management/graphql#creating-a-graphql-api-via-the-dashboard-ui)
- [graphql.proxy.subscription_type](/docs/5.7/api-management/graphql#graphql-subscriptions)
- [graphql.proxy.request_headers](/docs/5.7/api-management/graphql#request-headers)
