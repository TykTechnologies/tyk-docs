...
* [Adding APIs](/docs/api-management/gateway-config-managing-classic#create-an-api) to Tyk, including REST and GraphQL APIs
* Applying Quotas and Rate limits via [Security Policies](/docs/api-management/gateway-config-managing-classic#secure-an-api) and [Keys](/docs/api-management/gateway-config-managing-classic#access-an-api)
* [Securing](/docs/api-management/security-best-practices#securing-apis-with-tyk) your APIs
* Viewing granular [Analytics](/docs/api-management/dashboard-configuration#traffic-analytics) for your Tyk managed APIs
* [Transform traffic](/docs/api-management/traffic-transformation) with the Tyk API Designer
* Add integration options such as [SSO](/docs/api-management/external-service-integration#single-sign-on-sso) and [3rd Party IdentityProviders](/docs/api-management/external-service-integration)
* [Adding Segment Tags](/docs/tyk-cloud/troubleshooting-support)
