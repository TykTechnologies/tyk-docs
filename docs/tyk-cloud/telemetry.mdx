...
Since this functionality is powered by Tyk Gateway's OpenTelemetry integration, we recommend reviewing our comprehensive [OpenTelemetry documentation](/docs/api-management/logs-metrics#opentelemetry)
...
- [Datadog](/docs/#configure-providers)
- [Dynatrace](/docs/#configure-providers)
- [New Relic](/docs/#configure-providers)
- [Elastic](/docs/#configure-providers)
- [Custom](/docs/#configure-providers)
