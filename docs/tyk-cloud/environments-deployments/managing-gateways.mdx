...
All [user roles](/docs/tyk-cloud/teams-users#assign-user-roles) can edit, deploy, undeploy, restart, redeploy all deployments within a team. Only the Organization Admin and the Team Admin can create or delete deployments.
...
<Note>
The number of Cloud Data Planes you can add is dependent on your [plan](/docs/tyk-cloud/account-billing#select-a-payment-plan)
</Note>
...
* Enable [plugins](/docs/tyk-cloud/using-plugins)
    ...
    <Note>
    The use of custom domains is dependent on your [plan](/docs/tyk-cloud/account-billing#select-a-payment-plan)
    </Note>
...
The Auto Upgrade feature is only available for Control Plane deployments. When enabled on a Control Plane, it will automatically upgrade the corresponding data planes related to this control plane. For more information, see the [Tyk Cloud Control Plane Auto Upgrade Documentation](/docs/tyk-cloud/environments-deployments/managing-control-planes).
