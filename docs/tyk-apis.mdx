...
canonical: "https://tyk.io/docs/docs/tyk-apis"
---
...
<Card title="OpenAPI" href="/docs/tyk-dashboard-api" img="/img/logos/tyk-logo-selfmanaged.svg">
...
<Card title="OpenAPI" href="/docs/dashboard-admin-api">
Dashboard Admin API
<br /><br />
*Provision & administrate Tyk Dashboard*
</Card>

<Card title="OpenAPI" href="/docs/tyk-mdcb-api">
MDCB API
<br /><br />
*Monitor & diagnose Tyk data planes*
</Card>

<Card title="OpenAPI" href="/docs/product-stack/tyk-enterprise-developer-portal/api-documentation/tyk-edp-api">
...
<Card title="OpenAPI" href="/docs/tyk-gateway-api" img="/img/logos/tyk-logo-opensource.svg">
