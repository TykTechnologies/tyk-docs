...
canonical: "https://tyk.io/docs/docs/nightly/basic-config-and-security/security/authentication-authorization/open-keyless"
---
...
Tyk OAS APIs are inherently "open" unless authentication is configured, however the older Tyk Classic API applies [auth token](/docs/nightly/api-management/authentication/bearer-token) protection by default.
