...
canonical: "https://tyk.io/docs/docs/nightly/tyk-apis/tyk-portal-api/portal-documentation"
---

import LegacyClassicPortalApi from '/snippets/nightly/legacy-classic-portal-api.mdx';

<LegacyClassicPortalApi/>
This page describes the endpoints to create [catalog](/docs/nightly/#catalog) and [Swagger documentation](/docs/nightly/#documentation) for your API.
