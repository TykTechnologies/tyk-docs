...
canonical: "https://tyk.io/docs/docs/nightly/tyk-components"
---
...
<Card title="Tyk Gateway" href="/docs/nightly/tyk-components#tyk-gateway">
The open-source core of Tyk that handles request routing, rate-limiting, and caching.
</Card>

<Card title="Tyk Dashboard" href="/docs/nightly/tyk-components#tyk-dashboard">
A powerful interface for managing and monitoring APIs, users, and permissions.
</Card>

<Card title="Tyk Enterprise Developer Portal" href="/docs/nightly/tyk-components#tyk-enterprise-developer-portal">
A customizable portal for enabling API discovery and user self-service.
</Card>

<Card title="Tyk Multi Data Centre Bridge" href="/docs/nightly/tyk-components#tyk-multi-data-centre-bridge-mdcb">
Enables centralized API management across distributed data centers for global reach and compliance.
</Card>

<Card title="Tyk Pump" href="/docs/nightly/tyk-components#tyk-pump">
Aggregates and exports API analytics from Gateway to enable insights and advanced monitoring.
</Card>

<Card title="Tyk Operator" href="/docs/nightly/tyk-components#tyk-operator">
Integrates with Kubernetes for seamless API management within containerized environments.
</Card>

<Card title="Tyk Streams" href="/docs/nightly/tyk-components#tyk-streams">
Enables real-time event streaming for APIs, ideal for push notifications and live data.
</Card>

<Card title="Tyk Sync" href="/docs/nightly/tyk-components#tyk-sync">
Synchronizes API configurations across environments for consistency and streamlined deployments.
</Card>

<Card title="Tyk Identity Broker" href="/docs/nightly/tyk-components#tyk-identity-broker">
Facilitates single sign-on (SSO) and integrates external identity providers with APIs.
</Card>

<Card title="Tyk Helm Charts" href="/docs/nightly/tyk-components#tyk-helm-charts">
Provides templated configurations to simplify deploying Tyk in Kubernetes.
</Card>

<Card title="Universal Data Graph" href="/docs/nightly/tyk-components#universal-data-graph-udg">
...
The **[Tyk Gateway](/docs/nightly/tyk-oss-gateway)** is the core of Tyk’s API management platform. This open-source, high-performance API gateway handles crucial API tasks:
...
The **[Tyk Dashboard](/docs/nightly/tyk-dashboard)** is a GUI interface for managing, monitoring, and configuring APIs. It integrates with the Tyk Gateway and offers centralized control for all API operations:
...
The **[Tyk Developer Portal](/docs/nightly/tyk-developer-portal)** provides a self-service interface for developers to access and interact with APIs. Key functionalities include:
...
The **[Tyk Multi Data Centre Bridge (MDCB)](/docs/nightly/tyk-multi-data-centre)** enables centralized control over API configurations across distributed regions or data centers. It’s ideal for global API infrastructure, offering:
...
**[Tyk Pump](/docs/nightly/tyk-pump)** is a lightweight tool that aggregates API analytics from the Tyk Gateway and exports them to various storage systems for analysis:
...
The **[Tyk Operator](/docs/nightly/api-management/automations/operator#what-is-tyk-operator)** is a Kubernetes-native API management solution, allowing teams to deploy and manage APIs as Kubernetes resources:
...
**[Tyk Streams](/docs/nightly/api-management/event-driven-apis#)** is Tyk’s real-time data streaming tool for APIs, enabling applications to receive data as events happen:
...
**[Tyk Sync](/docs/nightly/api-management/automations/sync)** facilitates configuration synchronization, helping teams manage API configurations across different environments:
...
The **[Tyk Identity Broker](/docs/nightly/api-management/external-service-integration#what-is-tyk-identity-broker-tib)** simplifies authentication by connecting APIs with external identity providers (IDPs), supporting single sign-on (SSO) capabilities:
...
**[Tyk Helm Charts](/docs/nightly/product-stack/tyk-charts/overview)** provide templated configurations for deploying Tyk components in Kubernetes, enabling efficient setup and management:
...
The **[Universal Data Graph (UDG)](/docs/nightly/api-management/data-graph#overview)** provides a single API endpoint for accessing data from multiple sources using GraphQL, offering:
...
1. **[Getting Started with Tyk Gateway](/docs/nightly/tyk-oss-gateway)**  
...
2. **[Set Up and Configure the Tyk Dashboard](/docs/nightly/tyk-dashboard)**  
...
3. **[Explore API Security](/docs/nightly/api-management/client-authentication)**  
...
4. **[Implement Multi-Region Deployments with MDCB](/docs/nightly/tyk-multi-data-centre)**  
...
5. **[Use Tyk Sync for Consistent Configuration Management](/docs/nightly/api-management/automations/sync)**  
...
6. **[Explore Tyk Developer Portal for Enhanced Developer Experience](/docs/nightly/tyk-developer-portal)**  
