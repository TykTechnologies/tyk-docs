...
canonical: "https://tyk.io/docs/docs/nightly/tyk-dashboard/configuration"
---
...
To understand how the environment variables notation works, see [Environment Variables](/docs/nightly/tyk-oss-gateway/configuration).
