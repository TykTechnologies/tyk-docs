...
canonical: "https://tyk.io/docs/docs/nightly/advanced-configuration/other-protocols"
---
...
1. **[TCP Proxy](/docs/nightly/key-concepts/tcp-proxy)**

2. **[gRPC](/docs/nightly/key-concepts/grpc-proxy)**

3. **[Server-Sent Events (SSE)](/docs/nightly/advanced-configuration/sse-proxy)**

4. **[WebSockets](/docs/nightly/advanced-configuration/websockets)**