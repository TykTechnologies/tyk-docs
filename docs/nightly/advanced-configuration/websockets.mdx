...
canonical: "https://tyk.io/docs/docs/nightly/advanced-configuration/websockets"
---
...
See the [Access an API](/docs/nightly/api-management/gateway-config-managing-classic#access-an-api) tutorial for details on adding an Authentication Token to your APIs.
