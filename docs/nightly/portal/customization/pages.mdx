...
sidebarTitle: "Pages"
canonical: "https://tyk.io/docs/docs/nightly/portal/customization/pages"
---

We suggest you read the [portal concepts](/docs/nightly/portal/overview/concepts) first. If you've already done that, we will show you an example on how to:
...
<html lang="en">
 ...
 <head>
   ...
   <title>{{ if .page}} {{.page.Title}} {{else}} Developer Portal {{end}}</title>
    ...
    {/* Bootstrap core CSS */}
    <link href="/docs/nightly/system/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="/docs/nightly/assets/stylesheets/fonts.css" rel="stylesheet">
    <link href="/docs/nightly/assets/stylesheets/main.css" rel="stylesheet">
