...
canonical: "https://tyk.io/docs/docs/nightly/portal/customization/templates"
---
...
[section](/docs/nightly/portal/customization/pages#edit-page-content)
...
- [Template Data](/docs/nightly/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/docs/nightly/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/docs/nightly/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/docs/nightly/#analytics)
- [Application Create](/docs/nightly/#application-create)
- [Application Detail](/docs/nightly/#application-detail)
- [Blogs](/docs/nightly/#blogs)
- [Blog Detail](/docs/nightly/#blog-detail)
- [Cart Checkout](/docs/nightly/#cart-checkout)
- [Organization User Detail](/docs/nightly/#organization-user-detail)
- [Organization User Edit](/docs/nightly/#organization-user-edit)
- [Organization Users List](/docs/nightly/#organization-users-list)
- [Product Detail](/docs/nightly/#product-detail)
- [Product OAS Documentation](/docs/nightly/#product-oas-documentation)
...
{{ range .posts }}
<div class="blog-post">
  <h2><a href="/docs/nightly/{{ .URL }}">{{ .Title }}</a></h2>
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/docs/nightly/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/docs/nightly/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/docs/nightly/portal/private/users">Cancel</a>
...
<div class="product-detail">
  ...
  <div class="related-post">
    <h3><a href="/docs/nightly/{{ .Path }}">{{ .Title }}</a></h3>
    <img src="{{ .HeaderImage.URL }}" alt="{{ .Title }}">
    <p>{{ .Lede }}</p>
  </div>
  {{ end }}
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/docs/nightly/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/docs/nightly/#cancreateorganisation)
- [Clients](/docs/nightly/#clients)
- [Current User](/docs/nightly/#currentuser)
- [FeaturedProducts](/docs/nightly/#featuredproducts)
- [FilterUserInvites](/docs/nightly/#filteruserinvites)
- [FormatTime](/docs/nightly/#formattime)
- [GetCart](/docs/nightly/#getcart)
- [GetCatalogueList](/docs/nightly/#getcataloguelist)
- [GetCataloguesForProduct](/docs/nightly/#getcataloguesforproduct)
- [GetClientDescription](/docs/nightly/#getclientdescription)
- [GetClientName](/docs/nightly/#getclientname)
- [GetMenus](/docs/nightly/#getmenus)
- [GetProducts](/docs/nightly/#getproducts)
- [IsPortalDisabled](/docs/nightly/#isportaldisabled)
- [IsPortalPrivate](/docs/nightly/#isportalprivate)
- [ProductDocRenderer](/docs/nightly/#productdocrenderer)
- [ProviderUpstreamURL](/docs/nightly/#providerupstreamurl)
- [SplitStrings](/docs/nightly/#splitstrings)
- [TruncateString](/docs/nightly/#truncatestring)
- [TypeOfCredential](/docs/nightly/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/docs/nightly/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/docs/nightly/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/docs/nightly/portal/customization/menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/docs/nightly/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/docs/nightly/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/docs/nightly/portal/customization/email-notifications)
for additional detail on email notifications sent by the portal.


### Available Email Templates

- [Access Request Approve/Reject](/docs/nightly/#access-request-approvereject)
- [Access Request Submitted](/docs/nightly/#access-request-submitted)
- [Activate and Deactivate](/docs/nightly/#activate-and-deactivate)
- [New User Request](/docs/nightly/#new-user-request)
- [Organization Approve](/docs/nightly/#organization-approve)
- [Organization Reject](/docs/nightly/#organization-reject)
- [Organization Request](/docs/nightly/#organization-request)
- [Reset Password](/docs/nightly/#reset-password)
- [Targeted Invite](/docs/nightly/#targeted-invite)
- [Welcome User](/docs/nightly/#welcome-user)
