...
canonical: "https://tyk.io/docs/docs/nightly/tyk-developer-portal/tyk-portal-classic/curity-dcr"
---
...
- A [Tyk Self-Managed installation](/docs/nightly/tyk-self-managed/install) (Gateway + Dashboard).
