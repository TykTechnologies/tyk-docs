...
canonical: "https://tyk.io/docs/docs/nightly/product-stack/tyk-operator/getting-started/tyk-operator-multiple-organisations"
---
...
An [OperatorContext](/docs/nightly/api-management/automations/operator#multi-tenancy-in-tyk) specifies the parameters for connecting and authenticating with a Tyk Dashboard. Below is an example of how to define an `OperatorContext`:
