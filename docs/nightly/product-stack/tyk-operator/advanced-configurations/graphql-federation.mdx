...
canonical: "https://tyk.io/docs/docs/nightly/product-stack/tyk-operator/advanced-configurations/graphql-federation"
---

## Introduction

Tyk, with release *v4.0* offers [GraphQL federation](/docs/nightly/api-management/graphql#federation-version-support) that allows you to divide GraphQL implementation across multiple back-end
...
Tyk Operator uses Custom Resources called [SubGraph](/docs/nightly/#subgraph) and [SuperGraph](/docs/nightly/#supergraph), that allows users to model the relationship between Subgraphs and Supergraphs.
...
Let's assume that a developer responsible for the [Users SubGraph](/docs/nightly/#users-subgraph) would like to delete `username` field from the Users SubGraph.
Also, the [Supergraph](/docs/nightly/#supergraph-1) called Social Media already uses the Users Subgraph.
