...
canonical: "https://tyk.io/docs/docs/nightly/product-stack/tyk-sync/installing-tyk-sync"
---
...
| Method           | Description                        |
| :---------------- | :---------------------------------- |
| **[Docker](/docs/nightly/#install-on-docker)**       | Run Tyk Sync in a container |
| **[Packagecloud](/docs/nightly/#install-via-package-manager-packagecloud)** | Hosts packages for linux distributions |
