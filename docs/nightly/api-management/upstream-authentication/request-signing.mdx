...
keywords: "security, upstream authentication, gateway to upstream, request signing"
sidebarTitle: "Request Signing"
canonical: "https://tyk.io/docs/docs/nightly/api-management/upstream-authentication/request-signing"
---
...
For Request Signing, you must configure [upstream.authentication.upstreamRequestSigning](/docs/nightly/api-management/gateway-config-tyk-oas#upstreamrequestsigning), providing the following settings:
...
The Tyk Classic equivalent is [request_signing](/docs/nightly/api-management/gateway-config-tyk-classic#upstream-authentication).
