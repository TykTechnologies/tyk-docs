...
canonical: "https://tyk.io/docs/docs/nightly/api-management/authentication/custom-auth"
---
...
To learn more about using Tyk Golang Plugins, go [here](/docs/nightly/api-management/plugins/golang)
...
* See [Custom Authentication with a Python plugin](/docs/nightly/api-management/plugins/rich-plugins#custom-authentication-plugin-tutorial) for a detailed example of a custom Python plugin.
* See [JavaScript Middleware](/docs/nightly/api-management/plugins/javascript#) for more details on using JavaScript Middleware. 
