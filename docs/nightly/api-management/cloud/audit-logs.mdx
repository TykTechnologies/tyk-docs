...
canonical: "https://tyk.io/docs/docs/nightly/api-management/cloud/audit-logs"
---
...
For details on the API endpoints and usage, see [Retrieving Audit Logs via API](/docs/nightly/api-management/dashboard-configuration#retrieving-audit-logs-via-api).
