...
canonical: "https://tyk.io/docs/docs/nightly/api-management/manage-apis/deploy-apis/deploy-apis-overview"
---
...
**Learn more:**
* [Create an API in file-based mode](/docs/nightly/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
**Learn more:**
* [Create an API with the Dashboard](/docs/nightly/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
**Learn more:**
- [Dashboard API](/docs/nightly/api-management/dashboard-configuration#exploring-the-dashboard-api)
- [Gateway API](/docs/nightly/tyk-gateway-api)
...
- [Using Tyk Operator to enable GitOps](/docs/nightly/api-management/automations)
