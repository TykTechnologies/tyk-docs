...
canonical: "https://tyk.io/docs/docs/nightly/api-management/request-quotas"
---
...
Refer to the [Tyk Gateway Configuration Reference](/docs/nightly/tyk-oss-gateway/configuration#enforce_org_quotas) for more details on this setting.
...
Refer to the [Tyk OAS API Definition reference](/docs/nightly/api-management/gateway-config-tyk-oas#global) for details.
...
Refer to the [Tyk Classic API Definition reference](/docs/nightly/api-management/gateway-config-tyk-classic) for details.
...
Refer this [documentation](/docs/nightly/#configuration-options).
</Accordion>
...
Refer this [documentation](/docs/nightly/#api-level-configuration).
</Accordion>
