...
canonical: "https://tyk.io/docs/docs/nightly/api-management/sync/quick-start"
---
...
Follow this [guide](/docs/nightly/product-stack/tyk-sync/installing-tyk-sync) to install Tyk Sync. You can either use the Docker image or download the binary directly. We will be using the Docker image for this quick start.
