...
keywords: "GraphQL, Schema, Types, Custom Scalars"
sidebarTitle: "Schema Types"
canonical: "https://tyk.io/docs/docs/nightly/api-management/graphql/graphql-schema-types"
---
...
Tyk supports [GraphQL Federation v1](/docs/nightly/api-management/graphql#graphql-federation) for building unified APIs across multiple services.
