...
- [Mutual TLS](/docs/nightly/api-management/upstream-authentication/mtls)
- [Token-based authentication](/docs/nightly/api-management/upstream-authentication/auth-token)
- [Request signing](/docs/nightly/api-management/upstream-authentication/request-signing)
- [Basic Authentication](/docs/nightly/api-management/upstream-authentication/basic-auth)
- [OAuth 2.0](/docs/nightly/api-management/upstream-authentication/oauth)
    - [OAuth 2.0 Client Credentials](/docs/nightly/api-management/upstream-authentication/oauth#oauth-client-credentials)
    - [OAuth 2.0 Password Grant](/docs/nightly/api-management/upstream-authentication/oauth#oauth-resource-owner-password-credentials)
