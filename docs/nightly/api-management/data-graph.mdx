...
canonical: "https://tyk.io/docs/docs/nightly/api-management/data-graph"
---
...
- [How to create UDG schema](/docs/nightly/api-management/data-graph#creating-schema)
- [How to connect data sources](/docs/nightly/api-management/data-graph#connect-datasource)
- [How to secure the data graph](/docs/nightly/api-management/data-graph#security)
...
Head over to the [connect data source](/docs/nightly/api-management/data-graph#udg) section to learn about the supported data sources and how to connect them to Tyk.
...
* [UDG Arguments](/docs/nightly/api-management/data-graph#arguments)
* [UDG Datasources](/docs/nightly/api-management/data-graph#udg)
...
See [Concept: Arguments](/docs/nightly/api-management/data-graph#arguments) to learn more about it.
 ```
...
Global headers now have access to all [request context variables](/docs/nightly/api-management/traffic-transformation/request-context-variables).
...
Data source headers now have access to all [request context variables](/docs/nightly/api-management/traffic-transformation/request-context-variables).
...
Above steps are explained in detail in our [Getting started pages](/docs/nightly/api-management/data-graph#connect-datasource).
...
You can learn more about it [here](/docs/nightly/#udg)
...
To learn more about arguments click [here](/docs/nightly/#arguments)

To learn more about reusing response fields click [here](/docs/nightly/#reusing-response-fields)
...
You can learn more about field mapping [here](/docs/nightly/#field-mappings)
...
For this tutorial we'll mitigate these risks using `Query Depth Limit` but you can also use common strategies like rate limiting and throttling, which you can read more about [here](/docs/nightly/api-management/rate-limit)
...
2. **Applying to query depth**
    ...
    Although we can directly create keys by selecting this API but we'll use policy as it will make it easier to update keys for this API in future. You can read more about policies [here](/docs/nightly/api-management/policies#what-is-a-security-policy)
...
We offer 3 ways of importing an example into Tyk:
 - Using [tyk-sync](/docs/nightly/api-management/sync/use-cases#synchronize-api-configurations-with-github-actions)
 - Manually import via [Dashboard API Import](/docs/nightly/api-management/gateway-config-managing-classic#import-an-api)
- Using Tyk Dashboard to browse and import the examples directly

#### Import via tyk-sync

Please follow the [tyk-sync documentation](/docs/nightly/product-stack/tyk-sync/commands#examples-publish-command) to learn more about this approach.
...
You can find more detailed instructions in the [Dashboard API Import documentation section](/docs/nightly/api-management/gateway-config-managing-classic#import-an-api).
