...
canonical: "https://tyk.io/docs/docs/nightly/api-management/automations"
---
...
- **A Tyk installation** (Self-Managed or Cloud)
  - If you don't have Tyk installed, follow our [installation guide](/docs/nightly/tyk-self-managed/install)
...
- **Tyk Dashboard v3+ access** (for Tyk Sync setup)
  - Learn how to set up the Tyk Dashboard [here](/docs/nightly/tyk-dashboard)
...
<Card href="/docs/nightly/api-management/automations/sync" img="/img/GitHub-Mark-64px.png">
**Read time: 10 mins**

Synchronize Tyk Environment With GitHub using Tyk Sync.
</Card>

<Card href="/docs/nightly/api-management/automations/operator" img="/img/k8s.png">
**Read time: 10 mins**
