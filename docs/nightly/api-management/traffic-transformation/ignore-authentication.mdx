...
canonical: "https://tyk.io/docs/docs/nightly/api-management/traffic-transformation/ignore-authentication"
---

## Overview
<a id="ignore-authentication-overview"></a>
...
You can also set case sensitivity for the entire Tyk Gateway in its [configuration file](/docs/nightly/tyk-oss-gateway/configuration#ignore_endpoint_case) `tyk.conf`. If case insensitivity is configured at the gateway level, this will override the endpoint-level setting.

#### Endpoint parsing

When using the ignore authentication middleware, we recommend that you familiarize yourself with Tyk's [URL matching](/docs/nightly/getting-started/key-concepts/url-matching) options.
...
## Using Tyk OAS
<a id="ignore-authentication-using-tyk-oas"></a>

The [Ignore Authentication](/docs/nightly/api-management/traffic-transformation/ignore-authentication) middleware instructs Tyk Gateway to skip the authentication step for calls to an endpoint, even if authentication is enabled for the API.
...
If you're using the legacy Tyk Classic APIs, then check out the [Tyk Classic](/docs/nightly/#ignore-authentication-using-classic) page.
...
## Using Classic
<a id="ignore-authentication-using-classic"></a>

The [Ignore Authentication](/docs/nightly/api-management/traffic-transformation/ignore-authentication) middleware instructs Tyk Gateway to skip the authentication step for calls to an endpoint, even if authentication is enabled for the API.

When working with Tyk Classic APIs the middleware is configured in the Tyk Classic API Definition. You can do this via the Tyk Dashboard API or in the API Designer.

If you're using the newer Tyk OAS APIs, then check out the [Tyk OAS](/docs/nightly/#ignore-authentication-using-tyk-oas) page.
