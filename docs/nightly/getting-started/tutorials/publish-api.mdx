...
canonical: "https://tyk.io/docs/docs/nightly/getting-started/tutorials/publish-api"
---
...
This is for the closed source [Tyk Developer Portal](/docs/nightly/tyk-developer-portal) only
