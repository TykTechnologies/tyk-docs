...
canonical: "https://tyk.io/docs/docs/nightly/tyk-stack/tyk-operator/installing-tyk-operator"
---

## Introduction

We assume you have already installed Tyk. If you don’t have it, check out [Tyk
Cloud](/docs/nightly/tyk-cloud#quick-start-tyk-cloud) or [Tyk Self
Managed](/docs/nightly/tyk-self-managed) page. [Tyk Helm
Chart](/docs/nightly/product-stack/tyk-charts/overview) is the preferred (and easiest) way to install Tyk on Kubernetes.
...
Tyk Operator needs a [user credential](/docs/nightly/api-management/automations/operator#operator-user) to connect with
...
[Using Tyk Operator to enable GitOps with Tyk](/docs/nightly/api-management/automations) about
...
Alternatively, you have the option to manually handle TLS certificates by disabling the `cert-manager` requirement. For more details, please refer to this [configuration](/docs/nightly/#webhook-configuration).
...
If you are using [Tyk Stack](/docs/nightly/product-stack/tyk-charts/tyk-stack-chart), [Tyk Control
Plane](/docs/nightly/product-stack/tyk-charts/tyk-control-plane-chart), or [Tyk Open
Source Chart](/docs/nightly/product-stack/tyk-charts/tyk-oss-chart), you can install Tyk Operator alongside other Tyk
...
another name, configure it through Helm Chart [envFrom](/docs/nightly/#install-tyk-operator-and-custom-resource-definitions-crds) value.
...
You can configure [Tyk Operator as Ingress Controller](/docs/nightly/product-stack/tyk-operator/tyk-ingress-controller) so
...
[WATCH_INGRESS_CLASS](/docs/nightly/#configure-tyk-operator-via-environment-variable-or-tyk-operator-conf-secret) through `tyk-operator-conf` or the environment variable.
