...
canonical: "https://tyk.io/docs/docs/nightly/tyk-governance/api-repository"
---
...
For detailed installation and configuration instructions, please refer to the [Installation and Setup](/docs/nightly/tyk-governance/installation) page.
