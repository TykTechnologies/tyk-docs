...
canonical: "https://tyk.io/docs/docs/nightly/developer-support/deprecation"
---
...
*   **Upgrade Guides:** Please consult the official [Tyk Upgrade Documentation](/docs/nightly/developer-support/upgrading) for detailed instructions.
*   **Release Notes:** Review the [Tyk Release Notes](/docs/nightly/developer-support/release-notes/overview) for information on new features and changes in recent versions.
