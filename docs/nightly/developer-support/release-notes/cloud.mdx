...
canonical: "https://tyk.io/docs/docs/nightly/developer-support/release-notes/cloud"
---
...
For a complete list of changes, see the detailed [changelog](/docs/nightly/#Changelog-v1.30.0) below.
...
Introduced automated email notifications to inform organisations and team admins when a Control Plane [auto-upgrade](/docs/nightly/tyk-cloud/environments-deployments/managing-control-planes#auto-upgrade) begins. Notifications include key details such as deployment name and version changes, helping teams track upgrade activity more effectively.
</Expandable>
</li>
...
For a complete list of changes, see the detailed [changelog](/docs/nightly/#Changelog-v1.29.0) below.
...
For a full list of changes, see the detailed [changelog](/docs/nightly/#Changelog-v1.28.1) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs/nightly/#Changelog-v1.28.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs/nightly/#Changelog-v1.27.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs/nightly/#Changelog-v1.26.0) below.
...
Tyk Cloud allows users to enable or disable audit logging for their [Control Plane](/docs/nightly/api-management/mdcb#data-plane) (CP) deployments, providing greater flexibility in managing compliance and storage costs. To enable this feature, please contact your account manager.
...
For more details, check out the [documentation on Gateway versioning and auto-upgrades](/docs/nightly/developer-support/release-types/long-term-support)
...
For more details, check out the [documentation on setting up Telemetry export](/docs/nightly/tyk-cloud/telemetry).
...
This Tyk Cloud update introduces features that improve both flexibility in plugin management and user onboarding. Now, [Mserv](/docs/nightly/tyk-cloud/using-plugins#uploading-your-bundle),  supports **multiple plugin bundles**, allowing greater customization and easier deployment of plugin configurations. Additionally, we added an **embedded product tour** to enhance the deployment experience, offering a guided walkthrough of Tyk Dashboard’s features, ideal for users familiarizing themselves with the platform during onboarding.

For a comprehensive list of improvements and fixes, please check the detailed [changelog](/docs/nightly/#Changelog-v1.23.0) below.
