...
canonical: "https://tyk.io/docs/docs/nightly/ai-management/ai-studio/quickstart"
---
...
Continue to the [First Steps guide](/docs/nightly/ai-management/ai-studio/configuration) for detailed configuration instructions.
