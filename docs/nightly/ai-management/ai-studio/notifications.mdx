...
canonical: "https://tyk.io/docs/docs/nightly/ai-management/ai-studio/notifications"
---
...
*   **[Budget Control](/docs/nightly/ai-management/ai-studio/llm-management):**
    *   Approaching spending limit threshold (e.g., 80% of budget).
    *   Reaching or exceeding spending limit.
*   **[User Management](/docs/nightly/ai-management/ai-studio/user-management):**
