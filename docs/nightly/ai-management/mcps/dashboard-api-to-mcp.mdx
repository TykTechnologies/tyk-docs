...
canonical: "https://tyk.io/docs/docs/nightly/ai-management/mcps/dashboard-api-to-mcp"
---
...
Explore the core functionality in the [API to MCP guide](/docs/nightly/ai-management/mcps/api-to-mcp).
