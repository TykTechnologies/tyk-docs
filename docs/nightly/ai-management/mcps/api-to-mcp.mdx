...
canonical: "https://tyk.io/docs/docs/nightly/ai-management/mcps/api-to-mcp"
---
...
If you're looking for quick setup, [jump to Quick Start](/docs/nightly/#quick-start). For deeper understanding, see [How It Works](/docs/nightly/#how-it-works) and [Use Cases](/docs/nightly/#use-cases).
