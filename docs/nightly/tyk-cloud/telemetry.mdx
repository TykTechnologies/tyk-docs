...
canonical: "https://tyk.io/docs/docs/nightly/tyk-cloud/telemetry"
---
...
Since this functionality is powered by Tyk Gateway's OpenTelemetry integration, we recommend reviewing our comprehensive [OpenTelemetry documentation](/docs/nightly/api-management/logs-metrics#opentelemetry)
...
- [Datadog](/docs/nightly/#configure-providers)
- [Dynatrace](/docs/nightly/#configure-providers)
- [New Relic](/docs/nightly/#configure-providers)
- [Elastic](/docs/nightly/#configure-providers)
- [Custom](/docs/nightly/#configure-providers)
