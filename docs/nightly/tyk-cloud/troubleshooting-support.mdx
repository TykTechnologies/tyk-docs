...
canonical: "https://tyk.io/docs/docs/nightly/tyk-cloud/troubleshooting-support"
---
...
To add either of the tags, see [Adding an API](/docs/nightly/tyk-cloud#steps-to-add-an-api-in-tyk-cloud) in the Getting Started section.
