...
canonical: "https://tyk.io/docs/docs/nightly/tyk-cloud/account-billing"
---
...
* The available [Tyk Cloud Plans](/docs/nightly/tyk-cloud/account-billing#select-a-payment-plan)
* Adding [Payment Methods](/docs/nightly/#add-payment-methods)
* How to [upgrade from the free trial plan](/docs/nightly/#upgrade-your-free-trial)
* [Managing Billing Admins](/docs/nightly/#managing-billing-admin) on your account
* What to do if your account goes into [retirement](/docs/nightly/#retire-your-account)
...
As a *Billing Admin* user, you have the ability to edit or delete an existing payment method. Deleting a payment method without adding a new one will result in your plan going into [retirement](/docs/nightly/#retire-your-account) at the end of your current billing cycle.
...
If your free trial ends without you upgrading, your account enters what we call [retirement](/docs/nightly/tyk-cloud#glossary).

**What does upgrading a free trial account involve?**

To upgrade your free trial, you (as a Billing Admin) need to:
* Add a [payment method](/docs/nightly/#add-payment-methods) to your organization
* Select a new [plan](/docs/nightly/tyk-cloud/account-billing#select-a-payment-plan) from our list
...
* Add, edit and delete [payment methods](/docs/nightly/#add-payment-methods)
...
Your plan will go into [retirement](/docs/nightly/tyk-cloud#glossary) in the following scenarios:
