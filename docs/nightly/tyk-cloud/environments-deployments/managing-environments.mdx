...
keywords: "Environments, Tyk Cloud, Control Plane, Cloud Data Plane"
sidebarTitle: "Environments"
canonical: "https://tyk.io/docs/docs/nightly/tyk-cloud/environments-deployments/managing-environments"
---

## Introduction

Environments are used to group your [Control Plane](/docs/nightly/tyk-cloud#glossary) and [Cloud Data Planes](/docs/nightly/tyk-cloud#glossary) into logical groups. For example you may want to create environments that reflect different departments of your organization.


<Note>
The number of Environments you can create is determined by your [plan](/docs/nightly/tyk-cloud/account-billing#select-a-payment-plan)
</Note>


## Prerequisites

The following [user roles](/docs/nightly/tyk-cloud/teams-users#assign-user-roles) can perform Environment Admin tasks:
