...
keywords: "API Management, Tyk Cloud, Control Plane, Security"
sidebarTitle: "Managing APIs"
canonical: "https://tyk.io/docs/docs/nightly/tyk-cloud/securing-your-apis"
---
...
* [Adding APIs](/docs/nightly/api-management/gateway-config-managing-classic#create-an-api) to Tyk, including REST and GraphQL APIs
* Applying Quotas and Rate limits via [Security Policies](/docs/nightly/api-management/gateway-config-managing-classic#secure-an-api) and [Keys](/docs/nightly/api-management/gateway-config-managing-classic#access-an-api)
* [Securing](/docs/nightly/api-management/security-best-practices#securing-apis-with-tyk) your APIs
* Viewing granular [Analytics](/docs/nightly/api-management/dashboard-configuration#traffic-analytics) for your Tyk managed APIs
* [Transform traffic](/docs/nightly/api-management/traffic-transformation) with the Tyk API Designer
* Add integration options such as [SSO](/docs/nightly/api-management/external-service-integration#single-sign-on-sso) and [3rd Party IdentityProviders](/docs/nightly/api-management/external-service-integration)
* [Adding Segment Tags](/docs/nightly/tyk-cloud/troubleshooting-support)
