...
[section](/docs/portal/customization/pages#edit-page-content)
...
- [Template Data](/docs/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/docs/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/docs/#email-templates): Information about email-specific templates and their available data.
...
- [Application Create](/docs/#application-create)
- [Application Detail](/docs/#application-detail)
- [Blogs](/docs/#blogs)
- [Blog Detail](/docs/#blog-detail)
- [Cart Checkout](/docs/#cart-checkout)
- [Organization User Detail](/docs/#organization-user-detail)
- [Organization User Edit](/docs/#organization-user-edit)
- [Organization Users List](/docs/#organization-users-list)
- [Product Detail](/docs/#product-detail)
- [Product OAS Documentation](/docs/#product-oas-documentation)
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/docs/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/docs/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/docs/portal/private/users">Cancel</a>
...
<div class="product-detail">
  ...
  <div class="related-post">
    <h3><a href="/docs/{{ .Path }}">{{ .Title }}</a></h3>
    <img src="{{ .HeaderImage.URL }}" alt="{{ .Title }}">
    <p>{{ .Lede }}</p>
  </div>
  {{ end }}
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/docs/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/docs/#cancreateorganisation)
- [Clients](/docs/#clients)
- [Current User](/docs/#currentuser)
- [FeaturedProducts](/docs/#featuredproducts)
- [FilterUserInvites](/docs/#filteruserinvites)
- [FormatTime](/docs/#formattime)
- [GetCart](/docs/#getcart)
- [GetCatalogueList](/docs/#getcataloguelist)
- [GetCataloguesForProduct](/docs/#getcataloguesforproduct)
- [GetClientDescription](/docs/#getclientdescription)
- [GetClientName](/docs/#getclientname)
- [GetMenus](/docs/#getmenus)
- [GetProducts](/docs/#getproducts)
- [IsPortalDisabled](/docs/#isportaldisabled)
- [IsPortalPrivate](/docs/#isportalprivate)
- [ProductDocRenderer](/docs/#productdocrenderer)
- [ProviderUpstreamURL](/docs/#providerupstreamurl)
- [SplitStrings](/docs/#splitstrings)
- [TruncateString](/docs/#truncatestring)
- [TypeOfCredential](/docs/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/docs/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/docs/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/docs/portal/customization/menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/docs/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/docs/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/docs/portal/customization/email-notifications)
for additional detail on email notifications sent by the portal.


### Available Email Templates

- [Access Request Approve/Reject](/docs/#access-request-approvereject)
- [Access Request Submitted](/docs/#access-request-submitted)
- [Activate and Deactivate](/docs/#activate-and-deactivate)
- [New User Request](/docs/#new-user-request)
- [Organization Approve](/docs/#organization-approve)
- [Organization Reject](/docs/#organization-reject)
- [Organization Request](/docs/#organization-request)
- [Reset Password](/docs/#reset-password)
- [Targeted Invite](/docs/#targeted-invite)
- [Welcome User](/docs/#welcome-user)
