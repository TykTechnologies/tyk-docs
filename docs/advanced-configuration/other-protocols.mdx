...
1. **[TCP Proxy](/docs/key-concepts/tcp-proxy)**

2. **[gRPC](/docs/key-concepts/grpc-proxy)**

3. **[Server-Sent Events (SSE)](/docs/advanced-configuration/sse-proxy)**

4. **[WebSockets](/docs/advanced-configuration/websockets)**