...
| Method           | Description                        |
| :---------------- | :---------------------------------- |
| **[Docker](/docs/#install-on-docker)**       | Run Tyk Sync in a container |
| **[Packagecloud](/docs/#install-via-package-manager-packagecloud)** | Hosts packages for linux distributions |
