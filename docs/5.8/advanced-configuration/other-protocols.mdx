...
canonical: "https://tyk.io/docs/docs/5.8/advanced-configuration/other-protocols"
---
...
1. **[TCP Proxy](/docs/5.8/key-concepts/tcp-proxy)**

2. **[gRPC](/docs/5.8/key-concepts/grpc-proxy)**

3. **[Server-Sent Events (SSE)](/docs/5.8/advanced-configuration/sse-proxy)**

4. **[WebSockets](/docs/5.8/advanced-configuration/websockets)**