...
canonical: "https://tyk.io/docs/docs/5.8/portal/customization/templates"
---
...
[section](/docs/5.8/portal/customization/pages#edit-page-content)
...
- [Template Data](/docs/5.8/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/docs/5.8/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/docs/5.8/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/docs/5.8/#analytics)
- [Application Create](/docs/5.8/#application-create)
- [Application Detail](/docs/5.8/#application-detail)
- [Blogs](/docs/5.8/#blogs)
- [Blog Detail](/docs/5.8/#blog-detail)
- [Cart Checkout](/docs/5.8/#cart-checkout)
- [Organization User Detail](/docs/5.8/#organization-user-detail)
- [Organization User Edit](/docs/5.8/#organization-user-edit)
- [Organization Users List](/docs/5.8/#organization-users-list)
- [Product Detail](/docs/5.8/#product-detail)
- [Product OAS Documentation](/docs/5.8/#product-oas-documentation)
...
{{ range .posts }}
<div class="blog-post">
  <h2><a href="/docs/5.8/{{ .URL }}">{{ .Title }}</a></h2>
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/docs/5.8/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/docs/5.8/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/docs/5.8/portal/private/users">Cancel</a>
...
<div class="product-detail">
  ...
  <div class="related-post">
    <h3><a href="/docs/5.8/{{ .Path }}">{{ .Title }}</a></h3>
    <img src="{{ .HeaderImage.URL }}" alt="{{ .Title }}">
    <p>{{ .Lede }}</p>
  </div>
  {{ end }}
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/docs/5.8/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/docs/5.8/#cancreateorganisation)
- [Clients](/docs/5.8/#clients)
- [Current User](/docs/5.8/#currentuser)
- [FeaturedProducts](/docs/5.8/#featuredproducts)
- [FilterUserInvites](/docs/5.8/#filteruserinvites)
- [FormatTime](/docs/5.8/#formattime)
- [GetCart](/docs/5.8/#getcart)
- [GetCatalogueList](/docs/5.8/#getcataloguelist)
- [GetCataloguesForProduct](/docs/5.8/#getcataloguesforproduct)
- [GetClientDescription](/docs/5.8/#getclientdescription)
- [GetClientName](/docs/5.8/#getclientname)
- [GetMenus](/docs/5.8/#getmenus)
- [GetProducts](/docs/5.8/#getproducts)
- [IsPortalDisabled](/docs/5.8/#isportaldisabled)
- [IsPortalPrivate](/docs/5.8/#isportalprivate)
- [ProductDocRenderer](/docs/5.8/#productdocrenderer)
- [ProviderUpstreamURL](/docs/5.8/#providerupstreamurl)
- [SplitStrings](/docs/5.8/#splitstrings)
- [TruncateString](/docs/5.8/#truncatestring)
- [TypeOfCredential](/docs/5.8/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/docs/5.8/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/docs/5.8/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/docs/5.8/portal/customization/menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/docs/5.8/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/docs/5.8/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/docs/5.8/portal/customization/email-notifications)
for additional detail on email notifications sent by the portal.


### Available Email Templates

- [Access Request Approve/Reject](/docs/5.8/#access-request-approvereject)
- [Access Request Submitted](/docs/5.8/#access-request-submitted)
- [Activate and Deactivate](/docs/5.8/#activate-and-deactivate)
- [New User Request](/docs/5.8/#new-user-request)
- [Organization Approve](/docs/5.8/#organization-approve)
- [Organization Reject](/docs/5.8/#organization-reject)
- [Organization Request](/docs/5.8/#organization-request)
- [Reset Password](/docs/5.8/#reset-password)
- [Targeted Invite](/docs/5.8/#targeted-invite)
- [Welcome User](/docs/5.8/#welcome-user)
