...
canonical: "https://tyk.io/docs/docs/5.8/portal/resource-migration"
---
...
This capability was made possible with introduction of [Custom IDs](/docs/5.8/#custom-ids-in-developer-portal) (more on this later) in v1.13.
