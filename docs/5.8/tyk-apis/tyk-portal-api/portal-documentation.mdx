...
canonical: "https://tyk.io/docs/docs/5.8/tyk-apis/tyk-portal-api/portal-documentation"
---
...
This page describes the endpoints to create [catalog](/docs/5.8/#catalog) and [Swagger documentation](/docs/5.8/#documentation) for your API.
