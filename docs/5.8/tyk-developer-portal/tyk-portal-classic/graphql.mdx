...
canonical: "https://tyk.io/docs/docs/5.8/tyk-developer-portal/tyk-portal-classic/graphql"
---
...
As of Tyk v3.0.0, you can now publish GraphQL APIs, including [Universal Data Graph](/docs/5.8/api-management/data-graph#overview) APIs(UDG) to the Tyk Developer Portal.
