...
canonical: "https://tyk.io/docs/docs/5.8/ai-management/mcps/tyk-docs-mcp"
---
...
**Step 2.**
Once connected, ask the AI to perform an operation as suggested in the [use cases above](/docs/5.8/#use-cases)
