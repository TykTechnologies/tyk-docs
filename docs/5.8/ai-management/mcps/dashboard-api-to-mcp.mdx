...
canonical: "https://tyk.io/docs/docs/5.8/ai-management/mcps/dashboard-api-to-mcp"
---
...
Explore the core functionality in the [API to MCP guide](/docs/5.8/ai-management/mcps/api-to-mcp).
