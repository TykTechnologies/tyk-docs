...
canonical: "https://tyk.io/docs/docs/5.8/developer-support/release-notes/tib"
---
...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs/5.8/#Changelog-v1.7.0) below.
...
For more details, refer to the [OIDC SSO with JWE](/docs/5.8/api-management/external-service-integration#social-profile-fields) documentation.
</Expandable>
</li>
