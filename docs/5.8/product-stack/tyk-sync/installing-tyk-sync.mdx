...
canonical: "https://tyk.io/docs/docs/5.8/product-stack/tyk-sync/installing-tyk-sync"
---
...
| Method           | Description                        |
| :---------------- | :---------------------------------- |
| **[Docker](/docs/5.8/#install-on-docker)**       | Run Tyk Sync in a container |
| **[Packagecloud](/docs/5.8/#install-via-package-manager-packagecloud)** | Hosts packages for linux distributions |
