...
keywords: "Tyk Governance, API Labeling, API Categorization"
sidebarTitle: "API Labeling and Categorization"
canonical: "https://tyk.io/docs/docs/5.8/tyk-governance/api-labeling"
---

[Overview](/docs/5.8/#overview) | [Quick Start](/docs/5.8/#quick-start) | [How It Works](/docs/5.8/#how-it-works) | [Use Cases](/docs/5.8/#use-cases) | [Best Practices](/docs/5.8/#best-practices-and-recommendations) | [FAQs](/docs/5.8/#faqs) | [Troubleshooting](/docs/5.8/#troubleshooting)
