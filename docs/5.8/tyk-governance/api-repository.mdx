...
keywords: "Tyk Governance, API Repository"
sidebarTitle: "Federated API Repository"
canonical: "https://tyk.io/docs/docs/5.8/tyk-governance/api-repository"
---
...
For detailed installation and configuration instructions, please refer to the [Installation and Setup](/docs/5.8/tyk-governance/installation) page.
