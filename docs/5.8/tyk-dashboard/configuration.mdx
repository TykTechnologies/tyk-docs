...
canonical: "https://tyk.io/docs/docs/5.8/tyk-dashboard/configuration"
---
...
To understand how the environment variables notation works, see [Environment Variables](/docs/5.8/tyk-oss-gateway/configuration).
