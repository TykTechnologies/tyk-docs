...
- [Mutual TLS](/docs/5.8/api-management/upstream-authentication/mtls)
- [Token-based authentication](/docs/5.8/api-management/upstream-authentication/auth-token)
- [Request signing](/docs/5.8/api-management/upstream-authentication/request-signing)
- [Basic Authentication](/docs/5.8/api-management/upstream-authentication/basic-auth)
- [OAuth 2.0](/docs/5.8/api-management/upstream-authentication/oauth)
    - [OAuth 2.0 Client Credentials](/docs/5.8/api-management/upstream-authentication/oauth#oauth-client-credentials)
    - [OAuth 2.0 Password Grant](/docs/5.8/api-management/upstream-authentication/oauth#oauth-resource-owner-password-credentials)
