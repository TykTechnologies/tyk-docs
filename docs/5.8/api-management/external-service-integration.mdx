...
canonical: "https://tyk.io/docs/docs/5.8/api-management/external-service-integration"
---
...
This page introduces general features of Tyk Identity Broker (TIB) and how to configure them. If you are looking for global configurations of the TIB deployment refer this [config file](/docs/5.8/tyk-configuration-reference/tyk-identity-broker-configuration).
...
Refer to this [document](/docs/5.8/tyk-identity-broker/tib-rest-api)
...
1. [Login with 3rd party social providers](/docs/5.8/api-management/single-sign-on-social-idp)
2. [Login with any IdP that supports OIDC](/docs/5.8/api-management/single-sign-on-oidc)
3. [Login with any IdP that supports SAML](/docs/5.8/api-management/single-sign-on-saml)
3. [Login with LDAP](/docs/5.8/api-management/single-sign-on-ldap)
...
- `/admin/sso` - See [Dashboard Admin API SSO](/docs/5.8/api-management/dashboard-configuration#single-sign-on-api-1) for more details.
- `/api/sso` -  See [Dashboard API SSO](/docs/5.8/api-management/dashboard-configuration#single-sign-on-api) for more details.
