...
canonical: "https://tyk.io/docs/docs/5.8/api-management/automations"
---
...
- **A Tyk installation** (Self-Managed or Cloud)
  - If you don't have Tyk installed, follow our [installation guide](/docs/5.8/tyk-self-managed/install)
...
- **Tyk Dashboard v3+ access** (for Tyk Sync setup)
  - Learn how to set up the Tyk Dashboard [here](/docs/5.8/tyk-dashboard)
...
<Card href="/docs/5.8/api-management/automations/sync" img="/img/GitHub-Mark-64px.png">
**Read time: 10 mins**

Synchronize Tyk Environment With GitHub using Tyk Sync.
</Card>

<Card href="/docs/5.8/api-management/automations/operator" img="/img/k8s.png">
**Read time: 10 mins**
