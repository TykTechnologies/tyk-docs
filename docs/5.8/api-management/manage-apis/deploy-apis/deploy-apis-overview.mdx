...
canonical: "https://tyk.io/docs/docs/5.8/api-management/manage-apis/deploy-apis/deploy-apis-overview"
---
...
**Learn more:**
* [Create an API in file-based mode](/docs/5.8/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
**Learn more:**
* [Create an API with the Dashboard](/docs/5.8/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
**Learn more:**
- [Dashboard API](/docs/5.8/api-management/dashboard-configuration#exploring-the-dashboard-api)
- [Gateway API](/docs/5.8/tyk-gateway-api)
...
**Learn more:**
- [Tyk Sync](/docs/5.8/api-management/automations/sync)
...
**Learn more:**
- [Tyk Operator](/docs/5.8/api-management/automations/operator#what-is-tyk-operator)
- [Using Tyk Operator to enable GitOps](/docs/5.8/api-management/automations)
