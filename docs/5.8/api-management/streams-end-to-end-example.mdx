...
'og:description': "A comprehensive end-to-end example of Tyk Streams implementation"
sidebarTitle: "Tyk Streams End-to-End Example"
tags: ['Tyk Streams', 'Event-Driven APIs', 'Kafka', 'WebSockets', 'SSE', 'Correlation IDs']
canonical: "https://tyk.io/docs/docs/5.8/api-management/streams-end-to-end-example"
---
