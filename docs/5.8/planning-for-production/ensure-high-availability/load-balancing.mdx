...
canonical: "https://tyk.io/docs/docs/5.8/planning-for-production/ensure-high-availability/load-balancing"
---
...
See [Service Discovery](/docs/5.8/planning-for-production/ensure-high-availability/service-discovery) to see how you can integrate a service discovery system such as Consul or etcd with Tyk and enable dynamic load balancing support.
...
You can also perform [gRPC Load balancing](/docs/5.8/key-concepts/grpc-proxy#grpc-load-balancing).
