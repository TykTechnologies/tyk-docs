...
canonical: "https://tyk.io/docs/docs/5.8/planning-for-production"
---
...
To secure your Tyk installation, you can configure the following settings in your [tyk.conf](/docs/5.8/tyk-oss-gateway/configuration):
