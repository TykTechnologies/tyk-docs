...
canonical: "https://tyk.io/docs/docs/5.8/tyk-cloud/initial-portal-config"
---
...
Our Developer Portal is completely customizable. See [Portal Customization](/docs/5.8/tyk-developer-portal/customise) for more details.
