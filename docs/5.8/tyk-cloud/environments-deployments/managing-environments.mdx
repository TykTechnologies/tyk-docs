...
canonical: "https://tyk.io/docs/docs/5.8/tyk-cloud/environments-deployments/managing-environments"
---

## Introduction

Environments are used to group your [Control Plane](/docs/5.8/tyk-cloud#glossary) and [Cloud Data Planes](/docs/5.8/tyk-cloud#glossary) into logical groups. For example you may want to create environments that reflect different departments of your organization.


<Note>
The number of Environments you can create is determined by your [plan](/docs/5.8/tyk-cloud/account-billing#select-a-payment-plan)
</Note>


## Prerequisites

The following [user roles](/docs/5.8/tyk-cloud/teams-users#assign-user-roles) can perform Environment Admin tasks:
