...
canonical: "https://tyk.io/docs/docs/5.8/troubleshooting/tyk-dashboard/not-found-error-developer-portal"
---
...
You should also look at the [portal tutorial](/docs/5.8/getting-started/tutorials/publish-api) for creating an API and publishing it to your Portal.
