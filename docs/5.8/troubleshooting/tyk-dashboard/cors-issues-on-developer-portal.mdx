...
canonical: "https://tyk.io/docs/docs/5.8/troubleshooting/tyk-dashboard/cors-issues-on-developer-portal"
---
...
Make sure that your CORS in the `Advanced Options` of the API is enabled and the settings are correct. This means:
 ...
 - [CORS in API Definition](/docs/5.8/api-management/gateway-config-tyk-classic#cross-origin-resource-sharing-cors)
 - [How to setup CORS](/docs/5.8/api-management/troubleshooting-debugging#how-to-setup-cors) 
