...
canonical: "https://tyk.io/docs/docs/5.8/getting-started/tutorials/publish-api"
---
...
This is for the closed source [Tyk Developer Portal](/docs/5.8/tyk-developer-portal) only
