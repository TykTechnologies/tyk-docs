...
canonical: "https://tyk.io/docs/docs/5.8/tyk-stack/tyk-developer-portal/enterprise-developer-portal/getting-started-with-enterprise-portal/manage-get-started-guides-for-api-products"
---
...
1. **Create and publish an API Product**
    ...
    To start with, create and publish an API Product. Please refer to the [Publish API Products and Plans](/docs/5.8/portal/overview/getting-started#publish-an-api-product) page for further guidance.
