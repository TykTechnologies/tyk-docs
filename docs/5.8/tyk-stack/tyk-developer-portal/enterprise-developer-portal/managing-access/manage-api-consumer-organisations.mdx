...
canonical: "https://tyk.io/docs/docs/5.8/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/manage-api-consumer-organisations"
---
...
Please refer to the [email notification section](/docs/5.8/product-stack/tyk-enterprise-developer-portal/getting-started/setup-email-notifications) for further instructions for setting up the email server.
...
2. **Approve or reject organization registration requests**
    ...
    <br/><br/>Both emails are customizable. Refer to [the email customization documentation](/docs/5.8/portal/customization/email-notifications) for further information on the email customization.
