...
canonical: "https://tyk.io/docs/docs/5.8/tyk-stack/tyk-operator/create-an-api"
---
...
First, specify the details of your API using the [ApiDefinition CRD](/docs/5.8/api-management/automations/operator#apidefinition-crd), then deploy it to create the corresponding Kubernetes resource. Tyk Operator will take control of the CRD and create the actual API in the Tyk data plane.
...
- [HTTP Proxy example](/docs/5.8/tyk-stack/tyk-operator/create-an-api#set-up-manifest-for-http)
...
You can visit the [ApiDefinition CRD](/docs/5.8/api-management/automations/operator#apidefinition-crd) page to see all the latest API Definitions fields and features we support.
...
<Note>
Tyk Operator supported authentication types are listed in the [API Definition features](/docs/5.8/api-management/automations/operator#apidefinition-crd) section.
</Note>
...
Below, we take you through how to define the security policy but you can also find [Security Policy Example](/docs/5.8/tyk-stack/tyk-operator/create-an-api#security-policy-example) below.
