...
canonical: "https://tyk.io/docs/docs/5.8/tyk-stack/tyk-operator/installing-tyk-operator"
---

## Introduction

We assume you have already installed Tyk. If you don’t have it, check out [Tyk
Cloud](/docs/5.8/tyk-cloud#quick-start-tyk-cloud) or [Tyk Self
Managed](/docs/5.8/tyk-self-managed) page. [Tyk Helm
Chart](/docs/5.8/product-stack/tyk-charts/overview) is the preferred (and easiest) way to install Tyk on Kubernetes.
...
Tyk Operator needs a [user credential](/docs/5.8/api-management/automations/operator#operator-user) to connect with
...
[Using Tyk Operator to enable GitOps with Tyk](/docs/5.8/api-management/automations) about
...
Alternatively, you have the option to manually handle TLS certificates by disabling the `cert-manager` requirement. For more details, please refer to this [configuration](/docs/5.8/#webhook-configuration).
...
If you are using [Tyk Stack](/docs/5.8/product-stack/tyk-charts/tyk-stack-chart), [Tyk Control
Plane](/docs/5.8/product-stack/tyk-charts/tyk-control-plane-chart), or [Tyk Open
Source Chart](/docs/5.8/product-stack/tyk-charts/tyk-oss-chart), you can install Tyk Operator alongside other Tyk
...
another name, configure it through Helm Chart [envFrom](/docs/5.8/#install-tyk-operator-and-custom-resource-definitions-crds) value.
...
You can configure [Tyk Operator as Ingress Controller](/docs/5.8/product-stack/tyk-operator/tyk-ingress-controller) so
...
[WATCH_INGRESS_CLASS](/docs/5.8/#configure-tyk-operator-via-environment-variable-or-tyk-operator-conf-secret) through `tyk-operator-conf` or the environment variable.
