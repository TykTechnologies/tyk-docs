...
canonical: "https://tyk.io/docs/docs/5.9/tyk-cloud/troubleshooting-support"
---
...
To add either of the tags, see [Adding an API](/docs/5.9/tyk-cloud#steps-to-add-an-api-in-tyk-cloud) in the Getting Started section.
