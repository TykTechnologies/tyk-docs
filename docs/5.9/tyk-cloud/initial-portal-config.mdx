...
canonical: "https://tyk.io/docs/docs/5.9/tyk-cloud/initial-portal-config"
---
...
Our Developer Portal is completely customizable. See [Portal Customization](/docs/5.9/tyk-developer-portal/customise) for more details.
