...
canonical: "https://tyk.io/docs/docs/5.9/tyk-cloud/securing-your-apis"
---
...
* [Adding APIs](/docs/5.9/api-management/gateway-config-managing-classic#create-an-api) to Tyk, including REST and GraphQL APIs
* Applying Quotas and Rate limits via [Security Policies](/docs/5.9/api-management/gateway-config-managing-classic#secure-an-api) and [Keys](/docs/5.9/api-management/gateway-config-managing-classic#access-an-api)
* [Securing](/docs/5.9/api-management/security-best-practices#securing-apis-with-tyk) your APIs
* Viewing granular [Analytics](/docs/5.9/api-management/dashboard-configuration#traffic-analytics) for your Tyk managed APIs
* [Transform traffic](/docs/5.9/api-management/traffic-transformation) with the Tyk API Designer
* Add integration options such as [SSO](/docs/5.9/api-management/external-service-integration#single-sign-on-sso) and [3rd Party IdentityProviders](/docs/5.9/api-management/external-service-integration)
* [Adding Segment Tags](/docs/5.9/tyk-cloud/troubleshooting-support)
