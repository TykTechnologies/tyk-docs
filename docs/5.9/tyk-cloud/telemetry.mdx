...
canonical: "https://tyk.io/docs/docs/5.9/tyk-cloud/telemetry"
---
...
Since this functionality is powered by Tyk Gateway's OpenTelemetry integration, we recommend reviewing our comprehensive [OpenTelemetry documentation](/docs/5.9/api-management/logs-metrics#opentelemetry)
...
- [Datadog](/docs/5.9/#configure-providers)
- [Dynatrace](/docs/5.9/#configure-providers)
- [New Relic](/docs/5.9/#configure-providers)
- [Elastic](/docs/5.9/#configure-providers)
- [Custom](/docs/5.9/#configure-providers)
