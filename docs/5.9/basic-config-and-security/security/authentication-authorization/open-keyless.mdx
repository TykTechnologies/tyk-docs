...
canonical: "https://tyk.io/docs/docs/5.9/basic-config-and-security/security/authentication-authorization/open-keyless"
---
...
Tyk OAS APIs are inherently "open" unless authentication is configured, however the older Tyk Classic API applies [auth token](/docs/5.9/api-management/authentication/bearer-token) protection by default.
