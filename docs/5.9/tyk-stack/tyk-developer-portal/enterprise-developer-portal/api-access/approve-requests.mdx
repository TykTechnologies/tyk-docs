...
canonical: "https://tyk.io/docs/docs/5.9/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/approve-requests"
---
...
Depending on your configuration, these requests can be processed [automatically]() or require [manual approval](/docs/5.9/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/approve-requests#manual-approval-workflow).
...
The manual approval workflow provides API Owners with oversight of all API access. When an API Consumer completes an [access request](/docs/5.9/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/approve-requests#requesting-access-to-an-api-product), API Owners receive notification of pending request via [email](/docs/5.9/product-stack/tyk-enterprise-developer-portal/getting-started/setup-email-notifications) and should then:
...
For trusted users or specific API Products, you can enable automatic approval in the [subscription Plan](/docs/5.9/portal/api-plans#auto-approve-provisioning-requests).
...
If the [email service](/docs/5.9/product-stack/tyk-enterprise-developer-portal/getting-started/setup-email-notifications) is configured, then:
