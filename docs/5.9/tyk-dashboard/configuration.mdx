...
canonical: "https://tyk.io/docs/docs/5.9/tyk-dashboard/configuration"
---

import DashboardConfig from '/snippets/5.9/dashboard-config.mdx';
...
To understand how the environment variables notation works, see [Environment Variables](/docs/5.9/tyk-oss-gateway/configuration).
