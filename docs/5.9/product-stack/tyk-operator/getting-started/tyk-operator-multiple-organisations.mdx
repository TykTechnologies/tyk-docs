...
canonical: "https://tyk.io/docs/docs/5.9/product-stack/tyk-operator/getting-started/tyk-operator-multiple-organisations"
---
...
An [OperatorContext](/docs/5.9/api-management/automations/operator#multi-tenancy-in-tyk) specifies the parameters for connecting and authenticating with a Tyk Dashboard. Below is an example of how to define an `OperatorContext`:
