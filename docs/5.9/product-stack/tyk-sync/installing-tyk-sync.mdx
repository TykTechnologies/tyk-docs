...
canonical: "https://tyk.io/docs/docs/5.9/product-stack/tyk-sync/installing-tyk-sync"
---
...
| Method           | Description                        |
| :---------------- | :---------------------------------- |
| **[Docker](/docs/5.9/#install-on-docker)**       | Run Tyk Sync in a container |
| **[Packagecloud](/docs/5.9/#install-via-package-manager-packagecloud)** | Hosts packages for linux distributions |
