...
sidebarTitle: "Pages"
canonical: "https://tyk.io/docs/docs/5.9/portal/customization/pages"
---

We suggest you read the [portal concepts](/docs/5.9/portal/overview/concepts) first. If you've already done that, we will show you an example on how to:
...
<html lang="en">
 ...
 <head>
   ...
   <title>{{ if .page}} {{.page.Title}} {{else}} Developer Portal {{end}}</title>
    ...
    {/* Bootstrap core CSS */}
    <link href="/docs/5.9/system/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="/docs/5.9/assets/stylesheets/fonts.css" rel="stylesheet">
    <link href="/docs/5.9/assets/stylesheets/main.css" rel="stylesheet">
