...
canonical: "https://tyk.io/docs/docs/5.9/tyk-governance/api-repository"
---
...
For detailed installation and configuration instructions, please refer to the [Installation and Setup](/docs/5.9/tyk-governance/installation) page.
