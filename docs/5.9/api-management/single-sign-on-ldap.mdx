...
canonical: "https://tyk.io/docs/docs/5.9/api-management/single-sign-on-ldap"
---
...
1. **[Creating a Profile in Dashboard](/docs/5.9/#create-profile)**
2. **[Testing the SSO Flow](/docs/5.9/#testing-the-sso-flow)**
...
This guide assumes you already have a Tyk environment set up, with a Gateway and Dashboard. If you don't, please follow the [Tyk Self-Managed getting started guide](/docs/5.9/tyk-self-managed/install).
...
1. **Set up the LDAP profile**
    ...
    * `OrgId`: The organization id which the profile is connected to - make sure this is the correct id for your organization (see the [Dashboard Admin API documentation](/docs/5.9/api-management/dashboard-configuration#organizations-api) for details on how to retrieve this)
