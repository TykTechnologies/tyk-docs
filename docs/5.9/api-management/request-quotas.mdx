...
canonical: "https://tyk.io/docs/docs/5.9/api-management/request-quotas"
---
...
Refer to the [Tyk Gateway Configuration Reference](/docs/5.9/tyk-oss-gateway/configuration#enforce_org_quotas) for more details on this setting.
...
Refer to the [Tyk OAS API Definition reference](/docs/5.9/api-management/gateway-config-tyk-oas#global) for details.
...
Refer to the [Tyk Classic API Definition reference](/docs/5.9/api-management/gateway-config-tyk-classic) for details.
...
Refer this [documentation](/docs/5.9/#configuration-options).
</Accordion>
...
Refer this [documentation](/docs/5.9/#api-level-configuration).
</Accordion>
