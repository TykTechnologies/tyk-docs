...
canonical: "https://tyk.io/docs/docs/5.9/api-management/cloud/audit-logs"
---
...
For details on the API endpoints and usage, see [Retrieving Audit Logs via API](/docs/5.9/api-management/dashboard-configuration#retrieving-audit-logs-via-api).
