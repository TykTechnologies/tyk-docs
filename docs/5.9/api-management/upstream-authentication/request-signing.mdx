...
canonical: "https://tyk.io/docs/docs/5.9/api-management/upstream-authentication/request-signing"
---
...
For Request Signing, you must configure [upstream.authentication.upstreamRequestSigning](/docs/5.9/api-management/gateway-config-tyk-oas#upstreamrequestsigning), providing the following settings:
...
The Tyk Classic equivalent is [request_signing](/docs/5.9/api-management/gateway-config-tyk-classic#upstream-authentication).
