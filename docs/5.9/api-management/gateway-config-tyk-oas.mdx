...
canonical: "https://tyk.io/docs/docs/5.9/api-management/gateway-config-tyk-oas"
---
...
The [Tyk Vendor Extension](/docs/5.9/#tyk-vendor-extension) follows the same architectural style as the OpenAPI Specification and is encapsulated in a single object that is appended to the OpenAPI description, creating a *Tyk OAS API definition*.
