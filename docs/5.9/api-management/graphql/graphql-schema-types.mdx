...
canonical: "https://tyk.io/docs/docs/5.9/api-management/graphql/graphql-schema-types"
---
...
Tyk supports [GraphQL Federation v1](/docs/5.9/api-management/graphql#graphql-federation) for building unified APIs across multiple services.
