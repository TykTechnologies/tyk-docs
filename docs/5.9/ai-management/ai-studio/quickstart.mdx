...
canonical: "https://tyk.io/docs/docs/5.9/ai-management/ai-studio/quickstart"
---
...
Continue to the [First Steps guide](/docs/5.9/ai-management/ai-studio/configuration) for detailed configuration instructions.
