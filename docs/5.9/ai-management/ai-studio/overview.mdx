...
canonical: "https://tyk.io/docs/docs/5.9/ai-management/ai-studio/overview"
---
...
- Use the [AI Gateway](/docs/5.9/ai-management/ai-studio/proxy) to enable secure, scalable access to AI services across teams
...
AI Studio provides comprehensive [MCP (Model Context Protocol) capabilities](/docs/5.9/ai-management/mcps/overview#mcp-for-enterprise-use) including:
...
For more details about Model Context Protocol (MCP) integration, please visit the [Tyk MCPs overview](/docs/5.9/ai-management/mcps/overview) page.
