...
canonical: "https://tyk.io/docs/docs/5.9/ai-management/ai-studio/notifications"
---
...
*   **[Budget Control](/docs/5.9/ai-management/ai-studio/llm-management):**
    *   Approaching spending limit threshold (e.g., 80% of budget).
    *   Reaching or exceeding spending limit.
*   **[User Management](/docs/5.9/ai-management/ai-studio/user-management):**
