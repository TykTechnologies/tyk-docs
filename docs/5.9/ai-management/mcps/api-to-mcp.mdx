...
canonical: "https://tyk.io/docs/docs/5.9/ai-management/mcps/api-to-mcp"
---
...
If you're looking for quick setup, [jump to Quick Start](/docs/5.9/#quick-start). For deeper understanding, see [How It Works](/docs/5.9/#how-it-works) and [Use Cases](/docs/5.9/#use-cases).
