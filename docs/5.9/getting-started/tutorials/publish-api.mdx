...
canonical: "https://tyk.io/docs/docs/5.9/getting-started/tutorials/publish-api"
---
...
This is for the closed source [Tyk Developer Portal](/docs/5.9/tyk-developer-portal) only
