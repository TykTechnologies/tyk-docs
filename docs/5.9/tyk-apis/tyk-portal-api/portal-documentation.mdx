...
canonical: "https://tyk.io/docs/docs/5.9/tyk-apis/tyk-portal-api/portal-documentation"
---

import LegacyClassicPortalApi from '/snippets/5.9/legacy-classic-portal-api.mdx';

<LegacyClassicPortalApi/>
This page describes the endpoints to create [catalog](/docs/5.9/#catalog) and [Swagger documentation](/docs/5.9/#documentation) for your API.
