...
canonical: "https://tyk.io/docs/docs/5.9/developer-support/contributing"
---
...
- **[Inclusive naming](/docs/5.9/developer-support/documentation-projects/inclusive-naming)** - Information about Tyk's inclusive language initiative and the work done to update documentation terminology
