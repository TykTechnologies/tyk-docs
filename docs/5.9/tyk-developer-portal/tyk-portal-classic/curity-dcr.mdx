...
canonical: "https://tyk.io/docs/docs/5.9/tyk-developer-portal/tyk-portal-classic/curity-dcr"
---
...
- A [Tyk Self-Managed installation](/docs/5.9/tyk-self-managed/install) (Gateway + Dashboard).
