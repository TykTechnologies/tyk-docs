...
canonical: "https://tyk.io/docs/docs/5.9/tyk-developer-portal/tyk-portal-classic/portal-events-notifications"
---
...
See [Monitors](/docs/5.9/api-management/gateway-events#monitoring-quota-consumption) for details of how to configure quota consumption monitors.
...
To configure them, add an `event_options` section to an Organization when you are creating them. See [Creating an Organization via the Dashboard Admin API](/docs/5.9/api-management/dashboard-configuration#create-an-organization) for more details.
