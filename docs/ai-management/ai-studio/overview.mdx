...
- Use the [AI Gateway](/docs/ai-management/ai-studio/proxy) to enable secure, scalable access to AI services across teams
...
AI Studio provides comprehensive [MCP (Model Context Protocol) capabilities](/docs/ai-management/mcps/overview#mcp-for-enterprise-use) including:
...
For more details about Model Context Protocol (MCP) integration, please visit the [Tyk MCPs overview](/docs/ai-management/mcps/overview) page.
