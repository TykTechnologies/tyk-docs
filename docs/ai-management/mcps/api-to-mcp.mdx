...
If you're looking for quick setup, [jump to Quick Start](/docs/#quick-start). For deeper understanding, see [How It Works](/docs/#how-it-works) and [Use Cases](/docs/#use-cases).
