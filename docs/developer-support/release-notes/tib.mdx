...
canonical: "https://tyk.io/docs/docs/developer-support/release-notes/tib"
---
...
For a comprehensive list of changes, please refer to the detailed [changelog](/docs/#Changelog-v1.7.0) below.
...
For more details, refer to the [OIDC SSO with JWE](/docs/api-management/external-service-integration#social-profile-fields) documentation.
</Expandable>
</li>
