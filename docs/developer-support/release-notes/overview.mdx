...
canonical: "https://tyk.io/docs/docs/developer-support/release-notes/overview"
---
...
Please consult our [LTS policy](/docs/developer-support/release-types/long-term-support) for information and guidelines relating to Long Term Support releases.
