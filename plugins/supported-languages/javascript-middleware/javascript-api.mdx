...
- `TykGetKeyData(api_key, api_id)`: Use this method to retrieve a [session object](/getting-started/key-concepts/what-is-a-session-object) for the key and the API provided:
