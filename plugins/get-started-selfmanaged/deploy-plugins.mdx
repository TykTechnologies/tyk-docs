...
<Note>
For added security, please consider signing your [bundles](/plugins/how-to-serve-plugins#global-parameters), especially if the connection between the Gateways and the Bundler server traverses the internet.
</Note>
...
<Note>
For seamless deployments, take a look at multi-version [plugin support](/plugins/supported-languages/golang#upgrading-tyk) to enable zero downtime deployments of your Tyk Gateway installs
</Note>
