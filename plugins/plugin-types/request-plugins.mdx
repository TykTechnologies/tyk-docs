...
There are 4 different phases in the [request lifecycle](/concepts/middleware-execution-order) you can inject custom plugins, including [Authentication plugins](/plugins/plugin-types/auth-plugins/auth-plugins).  There are performance advantages to picking the correct phase, and of course that depends on your use case and what functionality you need.
