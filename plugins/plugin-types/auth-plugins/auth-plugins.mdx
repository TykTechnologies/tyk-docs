...
- [Go custom authentication plugin](/api-management/automations#custom-plugin-auth-go)
- [gRPC custom authentication plugin](/api-management/automations#custom-plugin-auth-grpc)
