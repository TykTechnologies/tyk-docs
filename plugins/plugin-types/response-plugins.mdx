...
[Go response plugins](/product-stack/tyk-gateway/advanced-configurations/plugins/golang/writing-go-plugins#creating-a-custom-response-plugin) have been available since Tyk v3.2.
