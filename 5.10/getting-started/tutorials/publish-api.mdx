...
import CreatePortalEntryInclude from '/snippets/5.10/create-portal-entry-include.mdx';
import LegacyClassicPortalApi from '/snippets/5.10/legacy-classic-portal-api.mdx';

<LegacyClassicPortalApi/>

This is for the closed source [Tyk Developer Portal](/5.10/portal/overview/intro) only
