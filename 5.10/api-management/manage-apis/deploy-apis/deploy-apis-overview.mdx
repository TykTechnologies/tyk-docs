...
**Learn more:**
* [Create an API in file-based mode](/5.10/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
**Learn more:**
* [Create an API with the Dashboard](/5.10/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
**Learn more:**
- [Dashboard API](/5.10/api-management/dashboard-configuration#exploring-the-dashboard-api)
- [Gateway API](/5.10/tyk-gateway-api)
...
- [Using Tyk Operator to enable GitOps](/5.10/api-management/automations)
