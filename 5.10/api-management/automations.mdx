...
canonical: "https://tyk.io/docs/api-management/automations"
---
...
- **A Tyk installation** (Self-Managed or Cloud)
  - If you don't have Tyk installed, follow our [installation guide](/5.10/tyk-self-managed/install)
...
- **Tyk Dashboard v3+ access** (for Tyk Sync setup)
  - Learn how to set up the Tyk Dashboard [here](/5.10/api-management/dashboard-configuration)
...
<Card href="/5.10/api-management/automations/sync" img="/img/GitHub-Mark-64px.png">
**Read time: 10 mins**

Synchronize Tyk Environment With GitHub using Tyk Sync.
</Card>

<Card href="/5.10/api-management/automations/operator" img="/img/k8s.png">
**Read time: 10 mins**
