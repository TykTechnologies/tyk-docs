...
description: Detailed explanation of key technical concepts that form the foundation
  of Tyk Governance, including federated API management, governance rulesets, and
  the technical architecture.
keywords: Tyk Governance, API Governance, Federated API Management, Governance Concepts
