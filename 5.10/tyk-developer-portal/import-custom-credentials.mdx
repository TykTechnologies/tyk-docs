...
| :------------- | :---------------------- | :------------------------- |
| Developer Portal | Available since [v1.12.0](/5.10/developer-support/release-notes/portal#1-12-0-release-notes) | Enterprise |
...
1. Create an [application](/5.10/portal/developer-app) in the Developer Portal for the user.
2. Add a custom credential to that app.
4. Select one or more [API Product](/5.10/portal/api-products) and the [Plan](/5.10/portal/api-plans) to associate with that credential.
