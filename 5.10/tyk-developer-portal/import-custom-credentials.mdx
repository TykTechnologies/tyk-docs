...
description: This guide explains how an admin of the Tyk Developer Portal can associate
  API Products with Tyk Managed Custom Credentials. It covers the manual UI steps,
  how to verify on the developer portal, and guidance for bulk imports via the Developer
  Portal APIs.
