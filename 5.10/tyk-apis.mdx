---
canonical: https://tyk.io/docs/tyk-apis
description: The Tyk API Hub. In this section you will find OpenAPI docs for the APIs
  for Tyk Gateway, Tyk Dashboard and other Tyk products
keywords: swagger, REST, Tyk APIs, Tyk OpenAPI Specs APIs, OPenAPI, OAS
...
<Card title="OpenAPI" href="/5.10/tyk-dashboard-api" img="/img/logos/tyk-logo-selfmanaged.svg">
...
<Card title="OpenAPI" href="/5.10/dashboard-admin-api">
Dashboard Admin API
<br /><br />
*Provision & administrate Tyk Dashboard*
</Card>

<Card title="OpenAPI" href="/5.10/tyk-mdcb-api">
MDCB API
<br /><br />
*Monitor & diagnose Tyk data planes*
</Card>

<Card title="OpenAPI" href="/5.10/product-stack/tyk-enterprise-developer-portal/api-documentation/tyk-edp-api">
...
<Card title="OpenAPI" href="/5.10/tyk-gateway-api" img="/img/logos/tyk-logo-opensource.svg">
