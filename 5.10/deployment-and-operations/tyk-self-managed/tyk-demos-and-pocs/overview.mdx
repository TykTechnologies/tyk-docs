---
canonical: https://tyk.io/docs/deployment-and-operations/tyk-self-managed/tyk-demos-and-pocs/overview
description: Explore Tyk demos and proof of concepts to quickly set up Tyk Self-Managed,
  including the Tyk Gateway, Dashboard, and analytics processing pipeline.
...
- [portal](https://github.com/TykTechnologies/tyk-k8s-demo/tree/main/src/deployments/portal): deploys the [Tyk Enterprise Developer Portal](/5.10/portal/overview/intro) as well as its dependency PostgreSQL.
...
The Tyk Pro Docker demo is our full [Self-Managed](/5.10/#docker-demo) solution, which includes our Gateway, Dashboard, and analytics processing pipeline. This demo will run Tyk Self-Managed on your machine, which contains 5 containers: Tyk Gateway, Tyk Dashboard, Tyk Pump, Redis and MongoDB. This demo is great for proof of concept and demo purposes, but if you want to test performance, you will need to move each component to a separate machine.
