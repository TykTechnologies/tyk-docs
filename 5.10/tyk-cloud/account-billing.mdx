...
* The available [Tyk Cloud Plans](/5.10/tyk-cloud/account-billing#select-a-payment-plan)
* Adding [Payment Methods](/5.10/#add-payment-methods)
* How to [upgrade from the free trial plan](/5.10/#upgrade-your-free-trial)
* [Managing Billing Admins](/5.10/#managing-billing-admin) on your account
* What to do if your account goes into [retirement](/5.10/#retire-your-account)
...
As a *Billing Admin* user, you have the ability to edit or delete an existing payment method. Deleting a payment method without adding a new one will result in your plan going into [retirement](/5.10/#retire-your-account) at the end of your current billing cycle.
...
If your free trial ends without you upgrading, your account enters what we call [retirement](/5.10/tyk-cloud#glossary).

**What does upgrading a free trial account involve?**

To upgrade your free trial, you (as a Billing Admin) need to:
* Add a [payment method](/5.10/#add-payment-methods) to your organization
* Select a new [plan](/5.10/tyk-cloud/account-billing#select-a-payment-plan) from our list
...
* Add, edit and delete [payment methods](/5.10/#add-payment-methods)
...
Your plan will go into [retirement](/5.10/tyk-cloud#glossary) in the following scenarios:
