---
canonical: https://tyk.io/docs/tyk-cloud/teams-users/single-sign-on
description: Learn how to set up and manage Single Sign-On (SSO) in Tyk Cloud Control
  Plane deployments.
keywords: Single Sign-On, SSO, Tyk Cloud, Control Plane, Configuration
