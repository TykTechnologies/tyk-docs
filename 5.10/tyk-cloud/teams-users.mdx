...
- [Managing Teams](/5.10/#managing-teams)
- [Managing Users](/5.10/tyk-cloud/teams-users)
- Available Tyk Cloud [User Roles](/5.10/tyk-cloud/teams-users#user-roles-within-tyk-cloud)
- [Tyk Cloud Single Sign-On (SSO)](/5.10/tyk-cloud/teams-users/single-sign-on)

## Managing Teams 

The following [user roles](/5.10/tyk-cloud/teams-users#user-roles-within-tyk-cloud) can perform existing Team Admin tasks:
...
You need to be a [Organization Admin](/5.10/tyk-cloud/teams-users#assign-user-roles) to create a new team.
...
You need to be a [Organization Admin](/5.10/tyk-cloud/teams-users#assign-user-roles) to delete a team.
...
You can now invite users to your new team. See [Managing Users](/5.10/tyk-cloud/teams-users) for more details.


## Managing Users

The following [user roles](/5.10/tyk-cloud/teams-users#user-roles-within-tyk-cloud) can perform existing User Admin tasks:

* [Organization Admin](/5.10/tyk-cloud/teams-users#assign-user-roles) - Can manage all users in the organization they are a member of.
* [Team Admin](/5.10/tyk-cloud/teams-users#assign-user-roles) - Can only manage the users of the team they are a member of.
    ...
    You can also [add users to the Tyk Dashboard](/5.10/api-management/user-management#manage-tyk-dashboard-users) itself instead of inviting them as Tyk Cloud users. These users would likely be your API Developers and Engineers who manage the APIs.
    </Note>
...
You can [add users to the Tyk Dashboard](/5.10/api-management/user-management#manage-tyk-dashboard-users) itself instead of inviting them as Tyk Cloud users. These users would likely be your API Developers and Engineers who manage the APIs.   
