...
Since this functionality is powered by Tyk Gateway's OpenTelemetry integration, we recommend reviewing our comprehensive [OpenTelemetry documentation](/5.10/api-management/logs-metrics#opentelemetry)
...
- [Datadog](/5.10/#configure-providers)
- [Dynatrace](/5.10/#configure-providers)
- [New Relic](/5.10/#configure-providers)
- [Elastic](/5.10/#configure-providers)
- [Custom](/5.10/#configure-providers)
