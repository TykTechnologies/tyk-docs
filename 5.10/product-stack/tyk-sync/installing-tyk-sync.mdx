...
| Method           | Description                        |
| :---------------- | :---------------------------------- |
| **[Docker](/5.10/#install-on-docker)**       | Run Tyk Sync in a container |
| **[Packagecloud](/5.10/#install-via-package-manager-packagecloud)** | Hosts packages for linux distributions |
