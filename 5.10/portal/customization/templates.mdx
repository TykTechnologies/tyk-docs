...
[section](/5.10/portal/customization/pages#edit-page-content)
...
- [Template Data](/5.10/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/5.10/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/5.10/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/5.10/#analytics)
- [Application Create](/5.10/#application-create)
- [Application Detail](/5.10/#application-detail)
- [Blogs](/5.10/#blogs)
- [Blog Detail](/5.10/#blog-detail)
- [Cart Checkout](/5.10/#cart-checkout)
- [Organization User Detail](/5.10/#organization-user-detail)
- [Organization User Edit](/5.10/#organization-user-edit)
- [Organization Users List](/5.10/#organization-users-list)
- [Product Detail](/5.10/#product-detail)
- [Product OAS Documentation](/5.10/#product-oas-documentation)
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/5.10/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/5.10/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/5.10/portal/private/users">Cancel</a>
...
<div class="product-detail">
  ...
  <div class="related-post">
    <h3><a href="/5.10/{{ .Path }}">{{ .Title }}</a></h3>
    <img src="{{ .HeaderImage.URL }}" alt="{{ .Title }}">
    <p>{{ .Lede }}</p>
  </div>
  {{ end }}
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/5.10/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/5.10/#cancreateorganisation)
- [Clients](/5.10/#clients)
- [Current User](/5.10/#currentuser)
- [FeaturedProducts](/5.10/#featuredproducts)
- [FilterUserInvites](/5.10/#filteruserinvites)
- [FormatTime](/5.10/#formattime)
- [GetCart](/5.10/#getcart)
- [GetCatalogueList](/5.10/#getcataloguelist)
- [GetCataloguesForProduct](/5.10/#getcataloguesforproduct)
- [GetClientDescription](/5.10/#getclientdescription)
- [GetClientName](/5.10/#getclientname)
- [GetMenus](/5.10/#getmenus)
- [GetProducts](/5.10/#getproducts)
- [IsPortalDisabled](/5.10/#isportaldisabled)
- [IsPortalPrivate](/5.10/#isportalprivate)
- [ProductDocRenderer](/5.10/#productdocrenderer)
- [ProviderUpstreamURL](/5.10/#providerupstreamurl)
- [SplitStrings](/5.10/#splitstrings)
- [TruncateString](/5.10/#truncatestring)
- [TypeOfCredential](/5.10/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/5.10/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/5.10/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/5.10/portal/customization/menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/5.10/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/5.10/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/5.10/portal/customization/email-notifications)
for additional detail on email notifications sent by the portal.


### Available Email Templates

- [Access Request Approve/Reject](/5.10/#access-request-approvereject)
- [Access Request Submitted](/5.10/#access-request-submitted)
- [Activate and Deactivate](/5.10/#activate-and-deactivate)
- [New User Request](/5.10/#new-user-request)
- [Organization Approve](/5.10/#organization-approve)
- [Organization Reject](/5.10/#organization-reject)
- [Organization Request](/5.10/#organization-request)
- [Reset Password](/5.10/#reset-password)
- [Targeted Invite](/5.10/#targeted-invite)
- [Welcome User](/5.10/#welcome-user)
