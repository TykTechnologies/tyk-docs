...
description: Release notes documenting updates, enhancements, and changes for Tyk
  Identity Broker versions within the 1.6.x series.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.10/#Changelog-v1.7.0) below.
...
For more details, refer to the [OIDC SSO with JWE](/5.10/api-management/external-service-integration#social-profile-fields) documentation.
</Expandable>
