...
- **[Inclusive naming](/5.10/developer-support/documentation-projects/inclusive-naming)** - Information about Tyk's inclusive language initiative and the work done to update documentation terminology
...
Our docs uses [Mintlify](https://mintlify.com/). For detailed technical guidance on creating and updating documentation pages, see the [technical guide](/5.10/developer-support/contribution-guides).
