  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="text-container">
        ...
        <a href="/5.13/{{.blocks.HeaderButtonLink.Content}}" class="btn btn-primary">{{.blocks.HeaderButtonLabel.Content}}</a>
    </div>
….
```
...
2. Upload the theme package that is created in the previous step to the portal. You can use the portal's [Admin dashboard](/5.13/portal/customization/themes#create-a-theme) or the [admin API](/5.13/product-stack/tyk-enterprise-developer-portal/api-documentation/tyk-edp-api) to do it.

3. Finally, you need to [activate](/5.13/portal/customization/themes#activate-a-theme) the theme so that it will be applied to the portal.
