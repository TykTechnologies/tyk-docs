...
[section](/5.13/portal/customization/pages#edit-page-content)
...
- [Template Data](/5.13/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/5.13/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/5.13/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/5.13/#analytics)
- [Application Create](/5.13/#application-create)
- [Application Detail](/5.13/#application-detail)
- [Blogs](/5.13/#blogs)
- [Blog Detail](/5.13/#blog-detail)
- [Cart Checkout](/5.13/#cart-checkout)
- [Organization User Detail](/5.13/#organization-user-detail)
- [Organization User Edit](/5.13/#organization-user-edit)
- [Organization Users List](/5.13/#organization-users-list)
- [Product Detail](/5.13/#product-detail)
- [Product OAS Documentation](/5.13/#product-oas-documentation)
...
| `{{ .MarkdownContent }}` | Markdown content (see [Markdown reference](/5.13/portal/customization/markdown)) |
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/5.13/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/5.13/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/5.13/portal/private/users">Cancel</a>
...
<div class="product-detail">
  ...
  <div class="related-post">
    <h3><a href="/5.13/{{ .Path }}">{{ .Title }}</a></h3>
    <img src="{{ .HeaderImage.URL }}" alt="{{ .Title }}">
    <p>{{ .Lede }}</p>
  </div>
  {{ end }}
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/5.13/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/5.13/#cancreateorganisation)
- [Clients](/5.13/#clients)
- [Current User](/5.13/#currentuser)
- [FeaturedProducts](/5.13/#featuredproducts)
- [FilterUserInvites](/5.13/#filteruserinvites)
- [FormatTime](/5.13/#formattime)
- [GetCart](/5.13/#getcart)
- [GetCatalogueList](/5.13/#getcataloguelist)
- [GetCataloguesForProduct](/5.13/#getcataloguesforproduct)
- [GetClientDescription](/5.13/#getclientdescription)
- [GetClientName](/5.13/#getclientname)
- [GetMenus](/5.13/#getmenus)
- [GetProducts](/5.13/#getproducts)
- [IsPortalDisabled](/5.13/#isportaldisabled)
- [IsPortalPrivate](/5.13/#isportalprivate)
- [ProductDocRenderer](/5.13/#productdocrenderer)
- [ProviderUpstreamURL](/5.13/#providerupstreamurl)
- [SplitStrings](/5.13/#splitstrings)
- [TruncateString](/5.13/#truncatestring)
- [TypeOfCredential](/5.13/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/5.13/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/5.13/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/5.13/portal/customization/menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/5.13/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/5.13/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/5.13/portal/customization/email-notifications)
for additional detail on email notifications sent by the portal.


### Available Email Templates

- [Access Request Approve/Reject](/5.13/#access-request-approvereject)
- [Access Request Submitted](/5.13/#access-request-submitted)
- [Activate and Deactivate](/5.13/#activate-and-deactivate)
- [Key Expiration Warning](/5.13/#key-expiration-warning)
- [Key Expired](/5.13/#key-expired)
- [New User Request](/5.13/#new-user-request)
- [Organization Approve](/5.13/#organization-approve)
- [Organization Reject](/5.13/#organization-reject)
- [Organization Request](/5.13/#organization-request)
- [Reset Password](/5.13/#reset-password)
- [Targeted Invite](/5.13/#targeted-invite)
- [Welcome User](/5.13/#welcome-user)
