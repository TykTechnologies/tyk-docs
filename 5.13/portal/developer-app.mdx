...
- **Note**: Reassigning an App may alter which other users of the Live Portal can [view](/5.13/portal/developer-app#visibility) it and have access to its credentials
...
- **Restrictions**:
  - When a user is in the [Default Organisation](/5.13/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/manage-api-consumer-organisations#developer-app-visibility), all of their Developer Apps will be restricted to Personal visibility
  - When a user is *only* in the [Default Team](/5.13/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/manage-api-consumer-organisations#developer-app-visibility-1) of a Custom Organisation, all of their Developer Apps will be restricted to Personal or Organisation level visibility
