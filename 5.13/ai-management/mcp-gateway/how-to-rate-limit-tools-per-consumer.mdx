...
canonical: "https://tyk.io/docs/ai-management/mcp-gateway/how-to-rate-limit-tools-per-consumer"
---
...
For the full picture of how rate limits compose across the middleware and policy layers, see [MCP proxy policies](/5.13/ai-management/mcp-gateway/policies).
