...
canonical: "https://tyk.io/docs/ai-management/ai-studio/model-router"
---
...
- References an existing [LLM configuration](/5.13/ai-management/ai-studio/llm-management)
...
The Model Router entity is closely related to [LLM Management](/5.13/ai-management/ai-studio/llm-management), as the vendors within a pool reference the configured LLMs.
