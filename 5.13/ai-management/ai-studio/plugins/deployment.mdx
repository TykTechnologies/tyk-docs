...
description: "Explore the three plugin deployment methods supported by Tyk AI Studio: local filesystem, remote gRPC, and OCI registry."
...
# Edge Gateway (defaults to /var/lib/microgateway/plugins)
...
**See [Plugin Development Workflow](/5.13/ai-management/ai-studio/plugins/development-workflow)** for detailed setup, helper scripts, and the fastest development loop.
