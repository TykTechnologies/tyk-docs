...
description: "A comprehensive reference of working plugin examples in the Tyk AI Studio repository, demonstrating real-world patterns for different plugin capabilities."
keywords: "AI Studio, AI Management, Plugin SDK"
sidebarTitle: "Example Plugins"
canonical: "https://tyk.io/docs/ai-management/ai-studio/plugins/examples"
---
## Availability
...
> **Experimental**: Agent plugins are currently experimental. See [Agent Plugins Guide](/5.13/ai-management/ai-studio/plugins/studio-agent) for full documentation.
