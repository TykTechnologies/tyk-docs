...
description: "Learn how to register and serve arbitrary HTTP endpoints on the Edge Gateway using Custom Endpoint plugins for use cases like OAuth providers and webhooks."
keywords: "AI Studio, AI Management, Plugin SDK"
sidebarTitle: "Custom Endpoint"
canonical: "https://tyk.io/docs/ai-management/ai-studio/plugins/custom-endpoints"
---
## Availability
...
```mermaid
graph LR
    A[Client] -->|HTTP Request| B[Edge Gateway]
...
See [`examples/plugins/gateway/custom-echo-endpoint/`](https://github.com/TykTechnologies/ai-studio/tree/main/examples/plugins/gateway/custom-echo-endpoint) for a complete, working example that combines **CustomEndpointHandler** + **UIProvider** + **ConfigProvider**. It echoes request metadata and serves content configurable via the Studio admin UI.
