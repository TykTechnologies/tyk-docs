...
canonical: "https://tyk.io/docs/ai-management/ai-studio/plugins/manifests"
---
## Availability
...
See [Resource Provider Plugins](/5.13/ai-management/ai-studio/plugins/resource-types) for the full guide.
...
See [plugins-studio-ui.md](/5.13/ai-management/ai-studio/plugins/studio-ui) for complete rate-limiting-ui example.
