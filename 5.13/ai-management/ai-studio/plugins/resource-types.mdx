...
description: "Learn how to register custom resource types that integrate into the App creation flow, participate in privacy scoring, and work with group-based access control."
keywords: "AI Studio, AI Management, Plugin SDK"
sidebarTitle: "Resource Provider"
canonical: "https://tyk.io/docs/ai-management/ai-studio/plugins/resource-types"
---
## Availability
