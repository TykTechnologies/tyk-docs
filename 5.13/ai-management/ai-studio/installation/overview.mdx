...
For production and multi-instance deployments, you can configure AI Studio to use [NATS JetStream](/5.13/ai-management/ai-studio/installation/nats) as the message queue backend.
...
<Card href="/5.13/ai-management/ai-studio/quickstart" img="/img/docker.png">
...
<Card href="/5.13/ai-management/ai-studio/deployment-k8s" img="/img/k8s.png">

Install on Kubernetes
</Card>

<Card href="/5.13/ai-management/ai-studio/installation/linux" img="/img/linux-icon.svg">
