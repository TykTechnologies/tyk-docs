...
import DashboardConfig from '/snippets/5.13/dashboard-config.mdx';
...
To understand how the environment variables notation works, see [Environment Variables](/5.13/tyk-oss-gateway/configuration).
