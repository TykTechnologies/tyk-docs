...
1. **[TCP Proxy](/5.13/key-concepts/tcp-proxy)**

2. **[gRPC](/5.13/key-concepts/grpc-proxy)**

3. **[Server-Sent Events (SSE)](/5.13/advanced-configuration/sse-proxy)**

4. **[WebSockets](/5.13/advanced-configuration/websockets)**