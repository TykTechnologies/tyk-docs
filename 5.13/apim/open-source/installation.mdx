...
Get started with our [Quick Start guide](#quick-start-with-helm-chart) or go to [Tyk Open Source helm chart](/5.13/product-stack/tyk-charts/tyk-oss-chart) for detailed installation instructions and configuration options.
