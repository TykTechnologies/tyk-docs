...
Tyk OAS APIs are inherently "open" unless authentication is configured, however the older Tyk Classic API applies [Auth Token](/5.13/api-management/authentication/bearer-token) protection by default.
