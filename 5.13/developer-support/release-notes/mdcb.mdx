...
keywords: "release notes, MDCB, Tyk Multi Data-Center, Tyk Multi Data-Center"
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v2.11.0).
...
If you are upgrading to 2.11.0, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v2.10.0).
...
#### Upgrade instructions
If you are upgrading to 2.10.0, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v2.9.1).
...
#### Upgrade instructions
If you are upgrading to 2.9.1, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v2.9.0).
...
#### Upgrade instructions
If you are upgrading to 2.9.0, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
In this release, we have fixed some priority CVEs. For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v2.8.8). 
...
#### Upgrade instructions
If you are upgrading to 2.8.8, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
In this patch release, we've resolved MongoDB connection leaks, and faster gateway recovery after Redis outages. For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v2.8.7).
...
#### Upgrade instructions
If you are upgrading to 2.8.7, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
In this patch release, we fixed high-priority CVEs. For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v2.8.6).
...
#### Upgrade instructions
If you are upgrading to 2.8.6, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v2.8.5).
...
#### Upgrade instructions
If you are upgrading to 2.8.5, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v2.8.4).
...
If you are upgrading to 2.8.4, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
Check the [Upgrade and Compatibility section](/5.13/#upgrade-instructions) for details on the recommended upgrade path.
</Expandable>
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v2.8.3).
...
#### Upgrade instructions
If you are upgrading to 2.8.3, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
#### Upgrade instructions
If you are upgrading to 2.8.2, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
#### Upgrade instructions
If you are upgrading to 2.8.1, please follow the detailed [upgrade instructions](/5.13/#upgrading-tyk).
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v2.8.0) below.
...
Please refer to the [changelog](/5.13/#Changelog-v2.7.0) below.
...
Please refer to the [changelog](/5.13/#Changelog-v2.6.0) below.
...
#### Release Highlights
This release contains bug fixes as detailed in the [changelog](/5.13/#Changelog-v2.5.1) below.
...
Please refer to the [changelog](/5.13/#Changelog-v2.5.0) below.
...
#### Release Highlights
This release enhances compatibility as detailed in the [changelog](/5.13/#Changelog-v2.4.2) below.
...
#### Release Highlights
This release enhances compatibility as detailed in the [changelog](/5.13/#Changelog-v2.4.1) below.
...
#### Release Highlights
MDCB 2.4.0 is an update for compatibility for synchronisation with Tyk v5.2 API Definitions. It also enables gateway information visualisation on Tyk Dashboard v5.2+. Please refer to the [changelog](/5.13/#Changelog-v2.4.0) below.
