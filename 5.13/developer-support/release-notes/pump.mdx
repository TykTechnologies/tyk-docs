...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v1.15.0).
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v1.14.1). 

#### Breaking Changes

This release has no breaking changes, however a misconfiguration that previously caused a silent failure is now surfaced and causes the Pump to crash on startup, see [known issues](/5.13/#known-issues).
...
In this release, we've enhanced Tyk Pump's security capabilities by introducing support for custom CA certificates for Kafka, Elasticsearch, and Splunk pumps. For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v1.14.0). 
...
In this release, we have fixed some priority CVEs. For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v1.13.3). 
...
In this patch release, we've resolved SQL Pump schema migration issues for sharded tables. For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v1.13.2).
...
There are no deprecations in this release.
For further information, please check the [changelog](/5.13/#Changelog-v1.13.2) below.
...
In this patch release, we fixed high-priority CVEs. For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v1.13.1).
...
There are no deprecations in this release.
For further information, please check the [changelog](/5.13/#Changelog-v1.13.1) below.
...
For further information, please check the [changelog](/5.13/#Changelog-v1.13.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v1.12.2) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.13/#Changelog-v1.12.1) below.
...
Users are strongly advised to follow the recommended [upgrade instructions](/5.13/#upgrading-tyk) provided by Tyk before applying any updates.
