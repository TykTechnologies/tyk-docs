...
### Step 3. Testing and Verifying Traces
    ...
    3. Create a simple API and deploy it to your Tyk Gateway. You can follow the [Tyk Dashboard documentation](/5.13/api-management/gateway-config-managing-classic#create-an-api) for more information.
