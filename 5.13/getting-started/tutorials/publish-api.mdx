...
import CreatePortalEntryInclude from '/snippets/5.13/create-portal-entry-include.mdx';
import LegacyClassicPortalApi from '/snippets/5.13/legacy-classic-portal-api.mdx';

<LegacyClassicPortalApi/>

This is for the closed source [Tyk Developer Portal](/5.13/portal/overview/intro) only
