...
| :-------- | :------ | :------- |
| Tyk Enterprise Developer Portal | Available since [v1.7.0](/5.13/developer-support/release-notes/portal#1-7-0-release-notes) | Enterprise |
...
For more information on configuration options, refer to the [Portal Configuration Reference](/5.13/product-stack/tyk-enterprise-developer-portal/deploy/configuration#audit-log-settings).
