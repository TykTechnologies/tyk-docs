...
| :------------- | :---------------------- | :------------------------- |
| Developer Portal | Available since [v1.16.0](/5.13/developer-support/release-notes/portal#1-16-0-release-notes) | Enterprise |
...
3. Developer Portal Setup with
    ...
    5. Approved access request to an API Product as a developer and an application already created. please refer to the [guide](/5.13/tyk-developer-portal/direct-access-flow#instructions).

## What we will do

1. Request access to an [API Product](/5.13/portal/api-products) as a developer and create a new [application](/5.13/portal/developer-app).
2. Add more products to an existing application by reusing credentials.
3. Change the [Plan](/5.13/portal/api-plans) for an existing credential.
