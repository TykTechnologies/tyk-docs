...
- You can now use this ruleset to [evaluate APIs](/5.12/tyk-governance/api-evaluation)
...
Once you've created rulesets, you can use them to validate APIs through the [API Evaluation](/5.12/tyk-governance/api-evaluation) feature, which allows you to check API specifications against your governance standards.
</Accordion>
</AccordionGroup>
