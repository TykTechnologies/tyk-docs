...
The LLM entity is closely related to [Model Prices](/5.12/ai-management/ai-studio/model-prices) (which define the cost of using the LLM) and [Model Routers](/5.12/ai-management/ai-studio/model-router) (which can route requests across multiple LLMs).
