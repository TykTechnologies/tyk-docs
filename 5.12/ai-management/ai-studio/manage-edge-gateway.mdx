...
For more details on the data plane architecture and request processing, see the [Edge Gateway (Data Plane) Component](/5.12/ai-management/ai-studio/proxy) documentation.
