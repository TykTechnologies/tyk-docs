...
> **Experimental**: Agent plugins are currently experimental. See [Agent Plugins Guide](/5.12/ai-management/ai-studio/plugins/studio-agent) for full documentation.
