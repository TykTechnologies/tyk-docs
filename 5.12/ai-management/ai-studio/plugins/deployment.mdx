...
**See [Plugin Development Workflow](/5.12/ai-management/ai-studio/plugins/development-workflow)** for detailed setup, helper scripts, and the fastest development loop.
