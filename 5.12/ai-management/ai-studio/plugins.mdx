...
{/* [Learn more →](/5.12/plugins-edge gateway) */}
...
{/* [Learn more →](/5.12/plugins-studio-ui) */}
...
{/* [Learn more →](/5.12/plugins-studio-agent) */}
...
{/* [Learn more →](/5.12/plugins-object-hooks) */}
...
{/* Plugins can also run as standalone gRPC services in a sidecar or elsewhere on the network, rather than as local sub-processes. See [Plugin Deployment](/5.12/./plugins-deployment) for details. */}
...
{/* [Learn more about Service API →](/5.12/[plugins-service-api](https://docs.claude.com/en/docs/plugins-service-api))) */}
...
{/* [Learn more about deployment →](/5.12/[plugins-deployment](https://docs.claude.com/en/docs/plugins-deployment))) */}
...
{/* [Learn more about manifests →](/5.12/[plugins-manifests](https://docs.claude.com/en/docs/plugins-manifests))) */}
...
5. Build and test with `file://` deployment (see [Development Workflow Guide](/5.12/) for fast iteration)
6. Deploy with `grpc://` or `oci://` for production

**Pro tip**: Use the reload API (`POST /api/v1/plugins/{id}/reload`) to test changes instantly without reinstalling. See the [Development Workflow Guide](/5.12/) for the fastest iteration loop.
...
**Note**: If you have existing plugins using the old SDKs (`edge gateway/plugins/sdk` or `pkg/ai_studio_sdk`), see the [Migration Guide](/5.12/) for upgrade instructions.
