...
> **Important:** Analytics must be **explicitly enabled** in the Edge Gateway configuration for data to appear in Studio dashboards. This is a common stumbling block — see the [Analytics](/5.12/./analytics.md) docs for configuration details.
...
This provides **eventually-accurate** budget control across a multi-gateway environment. See [Budget Control](/5.12/./budgeting.md) for details.
 */}
## Configuration Reference

To know more about configuring AI Studio, see the [Configuration Reference](/5.12/ai-management/ai-studio/ai-studio-env) for detailed documentation on all environment variables.