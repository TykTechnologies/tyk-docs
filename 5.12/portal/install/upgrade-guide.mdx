...
{/* 1. **Check the [Compatibility Matrix](/5.12/portal/overview/compatibility-matrix)** to confirm the new Portal version is compatible with your Tyk Dashboard version. */}
