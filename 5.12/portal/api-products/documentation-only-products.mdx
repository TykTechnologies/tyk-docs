...
<Note>
For an overview of API Products, see [API Products](/5.12/portal/api-products). For steps to create a standard API Product with live access, see the API Products page.
</Note>
