...
[section](/5.12/portal/customization/pages#edit-page-content)
...
- [Template Data](/5.12/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/5.12/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/5.12/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/5.12/#analytics)
- [Application Create](/5.12/#application-create)
- [Application Detail](/5.12/#application-detail)
- [Blogs](/5.12/#blogs)
- [Blog Detail](/5.12/#blog-detail)
- [Cart Checkout](/5.12/#cart-checkout)
- [Organization User Detail](/5.12/#organization-user-detail)
- [Organization User Edit](/5.12/#organization-user-edit)
- [Organization Users List](/5.12/#organization-users-list)
- [Product Detail](/5.12/#product-detail)
- [Product OAS Documentation](/5.12/#product-oas-documentation)
...
| `{{ .MarkdownContent }}` | Markdown content (see [Markdown reference](/5.12/portal/customization/markdown)) |
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/5.12/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/5.12/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/5.12/portal/private/users">Cancel</a>
...
<div class="product-detail">
  ...
  <div class="related-post">
    <h3><a href="/5.12/{{ .Path }}">{{ .Title }}</a></h3>
    <img src="{{ .HeaderImage.URL }}" alt="{{ .Title }}">
    <p>{{ .Lede }}</p>
  </div>
  {{ end }}
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/5.12/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/5.12/#cancreateorganisation)
- [Clients](/5.12/#clients)
- [Current User](/5.12/#currentuser)
- [FeaturedProducts](/5.12/#featuredproducts)
- [FilterUserInvites](/5.12/#filteruserinvites)
- [FormatTime](/5.12/#formattime)
- [GetCart](/5.12/#getcart)
- [GetCatalogueList](/5.12/#getcataloguelist)
- [GetCataloguesForProduct](/5.12/#getcataloguesforproduct)
- [GetClientDescription](/5.12/#getclientdescription)
- [GetClientName](/5.12/#getclientname)
- [GetMenus](/5.12/#getmenus)
- [GetProducts](/5.12/#getproducts)
- [IsPortalDisabled](/5.12/#isportaldisabled)
- [IsPortalPrivate](/5.12/#isportalprivate)
- [ProductDocRenderer](/5.12/#productdocrenderer)
- [ProviderUpstreamURL](/5.12/#providerupstreamurl)
- [SplitStrings](/5.12/#splitstrings)
- [TruncateString](/5.12/#truncatestring)
- [TypeOfCredential](/5.12/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/5.12/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/5.12/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/5.12/portal/customization/menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/5.12/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/5.12/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/5.12/portal/customization/email-notifications)
for additional detail on email notifications sent by the portal.


### Available Email Templates

- [Access Request Approve/Reject](/5.12/#access-request-approvereject)
- [Access Request Submitted](/5.12/#access-request-submitted)
- [Activate and Deactivate](/5.12/#activate-and-deactivate)
- [New User Request](/5.12/#new-user-request)
- [Organization Approve](/5.12/#organization-approve)
- [Organization Reject](/5.12/#organization-reject)
- [Organization Request](/5.12/#organization-request)
- [Reset Password](/5.12/#reset-password)
- [Targeted Invite](/5.12/#targeted-invite)
- [Welcome User](/5.12/#welcome-user)
