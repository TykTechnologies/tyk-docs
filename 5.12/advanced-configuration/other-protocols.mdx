...
1. **[TCP Proxy](/5.12/key-concepts/tcp-proxy)**

2. **[gRPC](/5.12/key-concepts/grpc-proxy)**

3. **[Server-Sent Events (SSE)](/5.12/advanced-configuration/sse-proxy)**

4. **[WebSockets](/5.12/advanced-configuration/websockets)**