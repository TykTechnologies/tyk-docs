...
<Note>
From Portal v1.16.0, you can alternatively configure a [custom SSO login URL](#custom-sso-login-url) to redirect users directly to your external IdP login page without building one.
</Note>
