...
- **Tyk Self-Managed**: Install the full lifecycle API management solution in your own infrastructure.
    ...
    > This page focuses on getting started with Tyk Cloud, If you are looking for information on Tyk Self-Managed, please refer to the [Getting Started with Tyk Self-Managed Guide](/5.12/getting-started/quick-start).
...
Finally, you will be taken to the Tyk Dashboard. Select "Design From Scratch" and continue on to [our tutorial](/5.12/getting-started/configure-first-api) to learn how to setup and secure your APIs.
...
- **Create Your First API**: Follow our guide on [setting up and securing your first API](/5.12/getting-started/configure-first-api).
- **Explore the Dashboard**: Familiarize yourself with the [Tyk Cloud interface](/5.12/api-management/dashboard-configuration).
