...
keywords: "Tyk Cloud, Release notes, v1.23, 1.23.0, v1.24, 1.24.0, v1.25, 1.25.0, v1.26, 1.26.0, 1.27.0, 1.28.0, 1.28.1, 1.29.0, 1.30.0, changelog"
...
This release upgrades Tyk Cloud to Golang 1.25 for enhanced security and transitions to Enterprise Edition Gateway images by default, ensuring full feature support and consistency between Dashboard and Gateway components. For a comprehensive list of changes, please refer to the detailed [changelog](/5.12/#Changelog-v1.30.3). 
...
For a complete list of changes, see the detailed [changelog](/5.12/#Changelog-v1.30.0) below.
...
Introduced automated email notifications to inform organisations and team admins when a Control Plane [auto-upgrade](/5.12/tyk-cloud/environments-deployments/managing-control-planes#auto-upgrade) begins. Notifications include key details such as deployment name and version changes, helping teams track upgrade activity more effectively.
</Expandable>
...
For a complete list of changes, see the detailed [changelog](/5.12/#Changelog-v1.29.0) below.
...
For a full list of changes, see the detailed [changelog](/5.12/#Changelog-v1.28.1) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.12/#Changelog-v1.28.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.12/#Changelog-v1.27.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.12/#Changelog-v1.26.0) below.
...
Tyk Cloud allows users to enable or disable audit logging for their [Control Plane](/5.12/api-management/mdcb#data-plane) (CP) deployments, providing greater flexibility in managing compliance and storage costs. To enable this feature, please contact your account manager.
...
For more details, check out the [documentation on Gateway versioning and auto-upgrades](/5.12/developer-support/release-types/long-term-support)
...
For more details, check out the [documentation on setting up Telemetry export](/5.12/tyk-cloud/telemetry).
