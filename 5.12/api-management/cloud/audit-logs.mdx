...
For details on the API endpoints and usage, see [Retrieving Audit Logs via API](/5.12/api-management/dashboard-configuration#retrieving-audit-logs-via-api).
