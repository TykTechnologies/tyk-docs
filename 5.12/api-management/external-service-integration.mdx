...
This page introduces general features of Tyk Identity Broker (TIB) and how to configure them. If you are looking for global configurations of the TIB deployment refer this [config file](/5.12/tyk-configuration-reference/tyk-identity-broker-configuration).
...
Refer to this [document](/5.12/tyk-identity-broker/tib-rest-api)
...
1. [Login with 3rd party social providers](/5.12/api-management/single-sign-on-social-idp)
2. [Login with any IdP that supports OIDC](/5.12/api-management/single-sign-on-oidc)
3. [Login with any IdP that supports SAML](/5.12/api-management/single-sign-on-saml)
3. [Login with LDAP](/5.12/api-management/single-sign-on-ldap)
...
- `/admin/sso` - See [Dashboard Admin API SSO](/5.12/api-management/dashboard-configuration#single-sign-on-api-1) for more details.
- `/api/sso` -  See [Dashboard API SSO](/5.12/api-management/dashboard-configuration#single-sign-on-api) for more details.
