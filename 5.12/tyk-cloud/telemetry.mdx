...
Since this functionality is powered by Tyk Gateway's OpenTelemetry integration, we recommend reviewing our comprehensive [OpenTelemetry documentation](/5.12/api-management/traces#opentelemetry)
...
- [Datadog](/5.12/#configure-providers)
- [Dynatrace](/5.12/#configure-providers)
- [New Relic](/5.12/#configure-providers)
- [Elastic](/5.12/#configure-providers)
- [Custom](/5.12/#configure-providers)
