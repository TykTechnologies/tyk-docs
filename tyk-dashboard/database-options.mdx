...
Please check [here](/planning-for-production/database-settings/postgresql) for production configurations.

See the following pages for configuring your SQL installation with Tyk:

* [Configuring Tyk Dashboard](/planning-for-production/database-settings/postgresql)
* [Configuring Tyk Pumps](/planning-for-production/database-settings/postgresql)
