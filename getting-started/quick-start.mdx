...
Continue to the [Core API Management Capabilities](/getting-started/core-capabilities) guide to explore API security, monitoring, and traffic transformation using the pre-configured APIs.
