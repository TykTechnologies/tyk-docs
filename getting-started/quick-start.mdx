...
- **[Tyk Dashboard](/api-management/dashboard-configuration)**: A [REST API](/tyk-dashboard-api) with a [web interface](/getting-started/using-tyk-dashboard) for managing your APIs, policies, and monitoring
...
* **Monitoring**: In [Monitoring](/api-management/dashboard-analytics#traffic-analytics), you can view activity reports, logs, and analytics related to your APIs.
* **System Management**: In [System Management](/platform-management/open-policy-agent), you can affect OPA rules that define fine-grained access control for managing and enforcing permissions on various actions and resources in Tyk’s API management system.
