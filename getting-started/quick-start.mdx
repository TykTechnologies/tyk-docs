...
- **[Tyk Dashboard](/api-management/dashboard-configuration)**: A [REST API](/platform-management/dashboard-api#exploring-the-dashboard-api) with a [web interface](/getting-started/using-tyk-dashboard) for managing your APIs, policies, and monitoring
...
* **System Management**: In [System Management](/platform-management/open-policy-agent#extend-permissions-using-open-policy-agent-opa), you can affect OPA rules that define fine-grained access control for managing and enforcing permissions on various actions and resources in Tyk’s API management system.
