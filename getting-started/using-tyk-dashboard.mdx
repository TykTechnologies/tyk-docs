...
* **API Templates**: API Templates allow you to create APIs with preconfigured settings quickly. You can set these up manually or save them from an API which you've already created. You can learn more about API Templates [here](/platform-management/api-templates).
...
* **Keys**: [Keys](/api-management/access-control/sessions-and-keys/understanding-sessions) are central to securing your APIs through Tyk. In this tab, you can handle the permissions, rate and throttling limits, and quotas associated with a given key. 
...
* **User Settings**: In User Settings, you can setup [TIB profiles](/tyk-identity-broker/overview#profile). This allows your users to access Tyk-managed APIs using their existing credentials.
...
* **OPA Rules**: You can use this tab to edit your [OPA Rules](/platform-management/open-policy-agent)- you can use these custom rules to control the behavior of all of your dashboard APIs. For example, you can restrict regular users to GET requests only, while allowing POST requests for admin roles. 
