...
2. **Add a Policy or API to Your Key**:
   ...
   <!-- TODO: Update screenshot to show "Record payload in traffic logs" instead of "Enable Detailed Logging" -->
...
4. Click on the **Configuration Tab** and add the below details.
   - **Record payload in traffic logs**: This is optional and disabled by default.
