...
In this tutorial we show you how to create a minimal Tyk OAS API using the Tyk Gateway API, starting with a [Tyk OAS API Definition](/getting-started/using-oas-definitions/oas-glossary#tyk-oas-api-definition).
...
You can also create APIs using the Tyk Dashboard API, starting with a [Tyk OAS API Definition](/getting-started/using-oas-definitions/oas-glossary#tyk-oas-api-definition).
...
You can make use of Tyk Operator custom resources to configure [Tyk OAS API](/getting-started/using-oas-definitions/oas-glossary#tyk-oas-api-definition) in a Kubernetes environment.

In this [tutorial](/api-management/automations#set-up-oas-api) we guide you through the steps to create a new Tyk OAS API using Tyk Operator.