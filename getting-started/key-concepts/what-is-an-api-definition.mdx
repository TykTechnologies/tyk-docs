...
For global configurations of the gateway that are not related to specific user's API, use the [config file](/tyk-oss-gateway/configuration)
...
- [Tyk OAS API Definition Objects](/tyk-apis/tyk-gateway-api/oas/x-tyk-oas-doc)
- [Tyk Classic API Definition Objects](/tyk-gateway-api/api-definition-objects)
