...
<Note>
  **Prerequisite:** Complete the [Getting Started](/getting-started/quick-start) guide to set up your Tyk Self-Managed environment before continuing.
</Note>
...
1. **Make a Request to the XML Endpoint:**
   - Using your API key from the [previous section](/getting-started/secure-api#exploring-authentication-methods), make a request to the XML endpoint (on the Tyk Gateway):
     ```
