...
'og:description': "How to configure Non HTTP Protocols"
...
You can also perform [gRPC load balancing](/5.7/#grpc-load-balancing).
...
Tyk supports Mutual Authentication in gRPC. See [Mutual TLS](/5.7/api-management/client-authentication#use-mutual-tls) to configure Mutual Authentication in Tyk. 

### Basic Authentication
Tyk supports Basic Authentication in gRPC. See [Basic Authentication](/5.7/api-management/client-authentication#use-basic-authentication) to configure Basic Authentication in Tyk. 
...
Tyk supports Token Based Authentication in gRPC. See [Bearer Tokens](/5.7/api-management/client-authentication#use-auth-tokens) to configure Token Based Authentication in Tyk. 
...
Tyk is able to perform load balancing on gRPC traffic using an approach similar to our native [Load Balancing](/5.7/tyk-self-managed#load-balancing) functionality.
...
See the [Access an API](/5.7/api-management/gateway-config-managing-classic#access-an-api) tutorial for details on adding an Authentication Token to your APIs.
