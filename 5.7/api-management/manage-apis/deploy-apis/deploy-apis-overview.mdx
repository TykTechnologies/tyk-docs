...
Learn more:
* [Tutorial: Create an API in File-based Mode](/5.7/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
Learn more:
* [Tutorial: Create an API with the Dashboard](/5.7/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
Learn more:
- [Dashboard API](/5.7/api-management/dashboard-configuration#exploring-the-dashboard-api)
- [Gateway API](/5.7/tyk-gateway-api)
...
- [Using Tyk Operator to enable GitOps with Tyk](/5.7/api-management/automations)
