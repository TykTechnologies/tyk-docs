...
import DashboardConfig from '/snippets/5.7/dashboard-config.mdx';
...
Please consult the [data storage configuration](/5.7/api-management/dashboard-configuration#data-storage-solutions) guide for further information relating to how to configure Tyk's data storage across different database engines.
