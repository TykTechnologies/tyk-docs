...
'og:description': "Customization options for enterprise developer portal"
  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="text-container">
        ...
        <a href="/5.7/{{.blocks.HeaderButtonLink.Content}}" class="btn btn-primary">{{.blocks.HeaderButtonLabel.Content}}</a>
    </div>
….
```
...
2. Upload the theme package that is created in the previous step to the portal. You can use the portal's [Admin dashboard](/5.7/portal/customization#create-a-theme) or the [admin API](/5.7/product-stack/tyk-enterprise-developer-portal/api-documentation/tyk-edp-api) to do it.
![image](https://github.com/TykTechnologies/tyk-docs/assets/14009/f0e547b2-b521-4c3e-97ce-fd3a2a3b170b)
3. Finally, you need to [activate](/5.7/portal/customization#activate-a-theme) the theme so that it will be applied to the portal.
...
[section](/5.7/portal/customization#edit-page-content)
...
- [Template Data](/5.7/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/5.7/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/5.7/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/5.7/#analytics)
- [Application Create](/5.7/#application-create)
- [Application Detail](/5.7/#application-detail)
- [Blogs](/5.7/#blogs)
- [Blog Detail](/5.7/#blog-detail)
- [Cart Checkout](/5.7/#cart-checkout)
- [Organization User Detail](/5.7/#organization-user-detail)
- [Organization User Edit](/5.7/#organization-user-edit)
- [Organization Users List](/5.7/#organization-users-list)
- [Product Detail](/5.7/#product-detail)
- [Product OAS Documentation](/5.7/#product-oas-documentation)
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/5.7/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/5.7/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/5.7/portal/private/users">Cancel</a>
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/5.7/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/5.7/#cancreateorganisation)
- [Clients](/5.7/#clients)
- [Current User](/5.7/#currentuser)
- [FeaturedProducts](/5.7/#featuredproducts)
- [FilterUserInvites](/5.7/#filteruserinvites)
- [FormatTime](/5.7/#formattime)
- [GetCart](/5.7/#getcart)
- [GetCatalogueList](/5.7/#getcataloguelist)
- [GetCataloguesForProduct](/5.7/#getcataloguesforproduct)
- [GetClientDescription](/5.7/#getclientdescription)
- [GetClientName](/5.7/#getclientname)
- [GetMenus](/5.7/#getmenus)
- [GetProducts](/5.7/#getproducts)
- [IsPortalDisabled](/5.7/#isportaldisabled)
- [IsPortalPrivate](/5.7/#isportalprivate)
- [ProductDocRenderer](/5.7/#productdocrenderer)
- [ProviderUpstreamURL](/5.7/#providerupstreamurl)
- [SplitStrings](/5.7/#splitstrings)
- [TruncateString](/5.7/#truncatestring)
- [TypeOfCredential](/5.7/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/5.7/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/5.7/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/5.7/portal/customization#configure-menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/5.7/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/5.7/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/5.7/portal/customization#configure-email-notifications)
for additional detail on email notifications sent by the portal.


#### Available Email Templates

- [Access Request Approve/Reject](/5.7/#access-request-approvereject)
- [Access Request Submitted](/5.7/#access-request-submitted)
- [Activate and Deactivate](/5.7/#activate-and-deactivate)
- [New User Request](/5.7/#new-user-request)
- [Organization Approve](/5.7/#organization-approve)
- [Organization Reject](/5.7/#organization-reject)
- [Organization Request](/5.7/#organization-request)
- [Reset Password](/5.7/#reset-password)
- [Targeted Invite](/5.7/#targeted-invite)
- [Welcome User](/5.7/#welcome-user)
...
We suggest you read the [portal concepts](/5.7/portal/overview#developer-portal-concepts) first. If you've already done that, we will show you an example on how to:
...
<html lang="en">
 ...
 <head>
   ...
   <title>{{ if .page}} {{.page.Title}} {{else}} Developer Portal {{end}}</title>
    ...
    {/* Bootstrap core CSS */}
    <link href="/5.7/system/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="/5.7/assets/stylesheets/fonts.css" rel="stylesheet">
    <link href="/5.7/assets/stylesheets/main.css" rel="stylesheet">
...
Both of them are defined as [partials](/5.7/portal/customization#file-structure-of-a-theme) in the portal directory in `/themes/default/partials/`.
...
Admin users can create additional navigational menus and render them on any page of the live portal. This customization requires changes to a theme and is covered in the [Full customization section](/5.7/portal/customization#configure-menus).
...
2. Select a menu that you want to modify. By default, the Developer portal has only one **Primary** menu. If you want to add more menus and render them on the live portal, please refer to [Full customization section](/5.7/portal/customization#configure-menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    <li class="nav-item {{ if .Children }}dropdown{{end}} mr-2">
      <a class="nav-link {{ if .Children }}dropdown-toggle{{end}}" href="/5.7/{{.Path}}" {{ if .Children }}data-toggle="dropdown" aria-haspopup=”true" aria-expanded="false"{{end}}>{{.Tag}}</a>
      {{ if .Children }}
...
3. `{{ if .Children }}`: This line checks if the menu item has any submenus. If it does it loops through those children `{{ range .Children }}` and finally renders them `<a class="dropdown-item" href="/5.7/{{.Path}}">{{.Tag}}</a>` similarly as the main menu items.
...
- A Tyk Self-Managed [installation](/5.7/tyk-self-managed#installation-options-for-tyk-self-managed)
...
- **Attribute ID**: A string that consists of letters (a-zA-Z), numbers (0-9), dashes, and underscores. This is used to reference the attribute in the [Admin APIs](/5.7/product-stack/tyk-enterprise-developer-portal/api-documentation/tyk-edp-api) screen.
...
When creating a user account from the admin UI or via [the admin APIs](/5.7/product-stack/tyk-enterprise-developer-portal/api-documentation/tyk-edp-api), an admin user can create the user account as active or inactive.
...
2. **Select Event Types for the Webhook**
    ...
    To finish configuration, select types of events that should be sent to the **Target URL** and save the changes. Refer the docs below to know more about [supported event types](/5.7/#supported-portal-events)
...
- [UserRegistered](/5.7/portal/customization#new-user-registered) when a new user is registered.
- [UserAccountActivated](/5.7/portal/customization#user-account-activated) when a user is activated.
- [UserAccountDeactivated](/5.7/portal/customization#user-account-deactivated) when a user is deactivated.
- [PasswordReset](/5.7/portal/customization#password-reset) when a user tries to reset a password.
- [ApplicationRegistered](/5.7/portal/customization#new-application-registered) when a new API consumer application is created.
- [CredentialRegistered](/5.7/portal/customization#new-credential-is-created) when a new API credential is created.
- [AccessRequestCreated](/5.7/portal/customization#new-access-request-created) when a new API access request is created.
- [AccessRequestApproved](/5.7/portal/customization#an-access-request-is-approved) when an API access request is approved.
- [AccessRequestRejected](/5.7/portal/customization#an-access-request-is-rejected) when an API access request is rejected.
- [OrganizationRegistered](/5.7/portal/customization#new-organization-registered) when an API consumer organization is created.
- [OrganizationRequestCreated](/5.7/portal/customization#new-organization-registration-request-created) when a new API consumer organization registration request is created.
- [OrganizationRequestApproved](/5.7/portal/customization#organization-registration-request-is-approved) when an API consumer organization registration request is approved.
- [OrganizationRequestRejected](/5.7/portal/customization#organization-request-is-rejected) when an API consumer organization registration request is rejected.
...
This event is fired whenever a new consumer organization is created via the admin APIs, the live portal ([the become an organization flow](/5.7/portal/api-consumer#self-registration)) or the admin UI.
...
This event is fired whenever a new organization request is created via the live portal ([the become an organization flow](/5.7/portal/api-consumer#self-registration)) or the admin UI.
