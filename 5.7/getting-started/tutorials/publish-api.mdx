...
'og:description': "Publishing your API in the Tyk Developer Portal"
...
import CreatePortalEntryInclude from '/snippets/5.7/create-portal-entry-include.mdx';
...
This is for the closed source [Tyk Developer Portal](/5.7/tyk-developer-portal) only
