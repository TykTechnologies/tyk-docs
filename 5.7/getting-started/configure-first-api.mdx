...
- [A Tyk Cloud account](/5.7/getting-started/create-account).
...
Congratulations! You've successfully created, secured, and deployed your first API in Tyk Cloud. Next, explore more advanced features such as adding [rate limiting](/5.7/api-management/rate-limit#introduction) to protect your API from abuse.

Explore more features in your [dashboard](/5.7/getting-started/using-tyk-dashboard) to optimize and scale your API offerings.
