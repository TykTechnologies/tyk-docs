...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.7/#Changelog-v1.26.0) below.
...
Tyk Cloud allows users to enable or disable audit logging for their [Control Plane](/5.7/api-management/mdcb#data-plane) (CP) deployments, providing greater flexibility in managing compliance and storage costs. To enable this feature, please contact your account manager.
...
For more details, check out the [documentation on setting up Telemetry export](/5.7/tyk-cloud#enabling-telemetry-in-tyk-cloud).
