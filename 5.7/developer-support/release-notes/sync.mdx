...
Please refer to the [changelog](/5.7/#Changelog-v2.0.4) below for detailed explanation.
...
Please refer to the [changelog](/5.7/#Changelog-v2.0.1) below for detailed explanation.
...
Please refer to the [changelog](/5.7/#Changelog-v2.0.0) below for detailed explanation.
...
Please refer to the [changelog](/5.7/#Changelog-v1.5.0) below for detailed explanation.
...
Please refer to the [changelog](/5.7/#Changelog-v1.4.3) below for detailed explanation.
...
Recommended usage:
Tyk Dashboard setting: [allow-unsafe-oas](/5.7/tyk-dashboard/configuration#allow_unsafe_oas)
Tyk Sync: use the [--allow-unsafe-oas](/5.7/api-management/automations/sync) when invoking the CLI
...
#### Release Highlights
This release enhances compatibility as detailed in the [changelog](/5.7/#Changelog-v1.4.2) below.
