...
* [Client mTLS](/5.5/./client-mtls)
* [Upstream mTLS](/5.5/./upstream-mtls)
...
Before going into details about each of these areas, let's [describe the basic building blocks](/5.5/./concepts) used to make it work.