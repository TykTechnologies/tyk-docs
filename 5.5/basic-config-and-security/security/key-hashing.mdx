...
See the [Gateway Configuration Options](/5.5/tyk-oss-gateway/configuration) for more details.
...
See the Keys section of [Tyk Gateway API Swagger page](/5.5/tyk-gateway-api) for more details.