---
title: "Client mTLS"
'og:description': "How to set up client mTLS"
sidebarTitle: "Client mTLS"
...
Please consult the Tyk Operator supporting documentation for an example of how to [configure static mTLS](/5.5/product-stack/tyk-operator/advanced-configurations/client-authentication#client-mtls) with Tyk Operator.
...
3. During verification, Tyk gateway traverses the certificate chain for validation.
    ...
    <Note>
    Root CA certificates work only with [static mTLS](/5.5/#static-mtls) and are not compatible with dynamic  [dynamic mTLS](/5.5/#dynamic-client-mtls).
    </Note>
