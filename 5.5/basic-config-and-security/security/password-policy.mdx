...
There are other security options available from the Dashboard config file. See the [security section](/5.5/tyk-dashboard/configuration#security) for more details.
