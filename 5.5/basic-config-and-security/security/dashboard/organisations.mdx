---
title: "Organizations"
'og:description': "How organizations are created and used with the Tyk Dashboard"
...
Additional organizations can be created and managed using the [Dashboard Admin API](/5.5/dashboard-admin-api/organisations).
...
Self-Managed users should use [API tagging](/5.5/advanced-configuration/manage-multiple-environments/with-tyk-on-premises) and enforce a tagging standard across all organizations.
