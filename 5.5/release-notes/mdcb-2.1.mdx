...
### Added
- Added a new configuration option [enable_ownership](/5.5/tyk-multi-data-centre/mdcb-configuration-options#enable_ownership) that allows MDCB filter APIs by API Ownership. 
