...
You can configure [Tyk-Sync](/5.5/product-stack/tyk-sync/overview) to synchronise APIs and Policies with any version control system, like GitHub or GitLab and use it to perform roll back. Keys are not synchronised with Tyk Sync.
