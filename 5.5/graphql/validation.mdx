...
When using the [Dashboard API](/5.5/tyk-apis/tyk-dashboard-api/api-definitions.md) the response for a broken schema will be a *400 Bad Request* with a body containing the validation errors. For example:
