...
Follow the [Gateway installation instructions](/5.5/tyk-on-premises/debian-ubuntu/gateway) to connect to your Dashboard instance before you continue on to step 4.
