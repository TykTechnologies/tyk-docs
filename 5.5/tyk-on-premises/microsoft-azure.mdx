...
1. Via our [Ubuntu Setup](/5.5/tyk-on-premises/debian-ubuntu) on an installed Ubuntu Server on Azure.
2. Via our [Docker Installation](/5.5/tyk-on-premises/docker) using Azure's Docker support.
