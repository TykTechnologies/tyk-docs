...
We also have a [Docker Tyk Pro Demo](/5.5/tyk-on-premises/docker/docker-pro-demo), which installs our full Self-Managed solution, which includes our Gateway, Dashboard, and analytics processing pipeline. This demo will run Tyk Self-Managed on your machine.
