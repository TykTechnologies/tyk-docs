...
When selecting a Tyk Self-managed license [(see the pricing page to compare the licenses)](https://tyk.io/price-comparison), you can choose between three deployment models: [Launch](/5.5/licensing.md#launch---perfect-to-get-started), [Flex](/5.5/licensing.md#flex---for-multiple-teams-within-a-single-data-center-or-cloud) and [Global Multi-team](/5.5/licensing.md#global-multi-team---for-the-largest-global-enterprises-at-scale). Read below to learn which model fits best for your scenario. 
...
You might also need more depending on your average load or to handle seasonal peak traffic. See [Planning for Production](/5.5/planning-for-production.md) to learn more. 
...
✅ For larger organizations [with multiple teams](/5.5/tyk-multi-data-centre.md) and [data sovereignty](https://tyk.io/blog/strategies-for-dealing-with-data-sovereignty-at-scale/) requirements <br />
