...
<Warning>
`tyk-pro` chart is deprecated. Please use our [Tyk Stack helm chart](/5.5/product-stack/tyk-charts/tyk-stack-chart) instead. 

We recommend all users migrate to the `tyk-stack` Chart. Please review the [Configuration](/5.5/product-stack/tyk-charts/tyk-stack-chart) section of the new helm chart and cross-check with your existing configurations while planning for migration.
</Warning>
...
You can find supported MongoDB and SQL versions [here](/5.5/planning-for-production/database-settings).
...
<Note>
Please make sure you are installing Redis versions that are supported by Tyk. Please refer to Tyk docs to get list of [supported versions](/5.5/planning-for-production/redis).
</Note>
...
<Note>
Please make sure you are installing PostgreSQL versions that are supported by Tyk. Please refer to Tyk docs to get list of [supported versions](/5.5/tyk-dashboard/database-options).
</Note>
...
Check [Tyk Gateway Sharding](/5.5/content/advanced-configuration/manage-multiple-environments.md#api-sharding) for more details.


## Other Tyk Components

### Installing Tyk Enterprise Developer Portal
If you are deploying the **Tyk Enterprise Developer Portal**, set the appropriate values under the `enterprisePortal` section in your `values.yaml`. Please visit [Tyk Enterprise Developer Portal installation](/5.5/product-stack/tyk-enterprise-developer-portal/deploy/install-tyk-enterprise-portal/install-portal-using-helm) for a step by step guide.
...
Check [Tyk Control plane](/5.5/tyk-multi-data-centre) for more configuration details.
...
See [TIB](/5.5/tyk-identity-broker/getting-started) for more details.
...
1. [Add an API](/5.5/getting-started/create-api)
2. [Create a Security Policy](/5.5/getting-started/create-security-policy)
3. [Create an API Key](/5.5/getting-started/create-api-key)
