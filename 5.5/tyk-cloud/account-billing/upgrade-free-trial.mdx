...
If your free trial ends without you upgrading, your account enters what we call [retirement](/5.5/tyk-cloud/troubleshooting-&-support/glossary.md#retirement).

## What does upgrading a free trial account involve?

To upgrade your free trial, you (as a Billing Admin) need to:
* Add a [payment method](/5.5/tyk-cloud/account-billing/add-payment-method) to your organization
* Select a new [plan](/5.5/tyk-cloud/account-billing/plans) from our list
