...
'og:description': "How to manage your Tyk Cloud Environments"
...
Environments are used to group your [Control Plane](/5.5/tyk-cloud/troubleshooting-&-support/glossary.md#control-plane) and [Cloud Data Planes](/5.5/tyk-cloud/troubleshooting-&-support/glossary.md#cloud-data-plane) into logical groups. For example you may want to create environments that reflect different departments of your organization.


<Note>
The number of Environments you can create is determined by your [plan](/5.5/tyk-cloud/account-billing/plans)
</Note>


## Prerequisites

The following [user roles](/5.5/tyk-cloud/teams-&-users/user-roles) can perform Environment Admin tasks:
