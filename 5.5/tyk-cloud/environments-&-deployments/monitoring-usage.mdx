...
- **Storage** - This is the total amount of data stored as [analytics by Tyk Dashboard](/5.5/tyk-dashboard-analytics). An example is *per request* statistics containing information about each request, like path or status.
