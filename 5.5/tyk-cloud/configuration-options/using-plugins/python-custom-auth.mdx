...
1. Firstly you will need a local Tyk Gateway installation that allows you to create your Python plugin bundle. We recommend [installing our Self-Managed version on Ubuntu Bionic 18.04](/5.5/tyk-on-premises/debian-ubuntu).
...
Next you'll [set up a Control Plane](/5.5/tyk-cloud/configuration-options/using-plugins/setup-control-plane) to support plugins
