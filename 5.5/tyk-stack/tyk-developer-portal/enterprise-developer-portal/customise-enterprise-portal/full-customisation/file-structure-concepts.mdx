...
sidebarTitle: "File Structure and Concepts"
tags: ['']
order: 2
---
  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="text-container">
        ...
        <a href="/5.5/{{.blocks.HeaderButtonLink.Content}}" class="btn btn-primary">{{.blocks.HeaderButtonLabel.Content}}</a>
    </div>
….
```
