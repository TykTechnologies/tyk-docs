---
title: "Templates"
'og:description': "Comprehensive guide to customizing the Tyk Enterprise Developer Portal using templates. Covers template
...
[section](/5.5/tyk-stack/tyk-developer-portal/enterprise-developer-portal/customise-enterprise-portal/full-customisation/edit-manage-page-content)
...
- [Template Data](/5.5/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/5.5/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/5.5/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/5.5/#analytics)
- [Application Create](/5.5/#application-create)
- [Application Detail](/5.5/#application-detail)
- [Blogs](/5.5/#blogs)
- [Blog Detail](/5.5/#blog-detail)
- [Cart Checkout](/5.5/#cart-checkout)
- [Organisation User Detail](/5.5/#organisation-user-detail)
- [Organisation User Edit](/5.5/#organisation-user-edit)
- [Organisation Users List](/5.5/#organisation-users-list)
- [Product Detail](/5.5/#product-detail)
- [Product OAS Documentation](/5.5/#product-oas-documentation)
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/5.5/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/5.5/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/5.5/portal/private/users">Cancel</a>
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/5.5/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/5.5/#cancreateorganisation)
- [Clients](/5.5/#clients)
- [Current User](/5.5/#currentuser)
- [FeaturedProducts](/5.5/#featuredproducts)
- [FilterUserInvites](/5.5/#filteruserinvites)
- [FormatTime](/5.5/#formattime)
- [GetCart](/5.5/#getcart)
- [GetCatalogueList](/5.5/#getcataloguelist)
- [GetCataloguesForProduct](/5.5/#getcataloguesforproduct)
- [GetClientDescription](/5.5/#getclientdescription)
- [GetClientName](/5.5/#getclientname)
- [GetMenus](/5.5/#getmenus)
- [GetProducts](/5.5/#getproducts)
- [IsPortalDisabled](/5.5/#isportaldisabled)
- [IsPortalPrivate](/5.5/#isportalprivate)
- [ProductDocRenderer](/5.5/#productdocrenderer)
- [ProviderUpstreamURL](/5.5/#providerupstreamurl)
- [SplitStrings](/5.5/#splitstrings)
- [TruncateString](/5.5/#truncatestring)
- [TypeOfCredential](/5.5/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/5.5/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/5.5/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/5.5/tyk-stack/tyk-developer-portal/enterprise-developer-portal/customise-enterprise-portal/full-customisation/menus-customisation).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/5.5/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/5.5/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/5.5/tyk-stack/tyk-developer-portal/enterprise-developer-portal/customise-enterprise-portal/full-customisation/email-customization)
for additional detail on email notifications sent by the portal.


## Available Email Templates

- [Access Request Approve/Reject](/5.5/#access-request-approvereject)
- [Access Request Submitted](/5.5/#access-request-submitted)
- [Activate and Deactivate](/5.5/#activate-and-deactivate)
- [New User Request](/5.5/#new-user-request)
- [Organisation Approve](/5.5/#organisation-approve)
- [Organisation Reject](/5.5/#organisation-reject)
- [Organisation Request](/5.5/#organisation-request)
- [Reset Password](/5.5/#reset-password)
- [Targeted Invite](/5.5/#targeted-invite)
- [Welcome User](/5.5/#welcome-user)
