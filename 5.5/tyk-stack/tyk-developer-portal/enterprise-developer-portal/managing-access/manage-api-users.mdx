...
To customize the invite email, please refer to the [Email customization section](/5.5/tyk-stack/tyk-developer-portal/enterprise-developer-portal/customise-enterprise-portal/full-customisation/email-customization.md) for guidance.
