...
sidebarTitle: "Secure an API with Auth token"
order: 3
---
...
<Note>
Tyk Operator supported authentication types are listed in the [API Definition features](/5.5/product-stack/tyk-operator/reference/api-definition) page.
</Note>
