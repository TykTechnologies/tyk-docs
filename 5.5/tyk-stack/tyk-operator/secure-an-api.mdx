...
sidebarTitle: "Protect an API with Policy"
---
...
You can visit the [Security Policy features](/5.5/product-stack/tyk-operator/reference/security-policy) page to see all the latest Security Policies fields and features Tyk Operator supports.
