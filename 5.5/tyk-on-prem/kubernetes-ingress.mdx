...
**Tyk Operator** offers an [Ingress Controller](/5.5/product-stack/tyk-operator/tyk-ingress-controller), which dynamically manages Tyk ApiDefinition resources as per the ingress spec. 
