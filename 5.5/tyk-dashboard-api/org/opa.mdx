...
For more information on how to configure OPA see [Open Policy Agent](/5.5/tyk-dashboard/open-policy-agent).
### List OPA rules and settings

This endpoint returns by defaul the initial set of OPA rules defined in your Tyk Dashboard, which are located in [schema/dashboard.rego](/5.5/tyk-dashboard/opa-rules) (accessible in Self-Managed installations).
