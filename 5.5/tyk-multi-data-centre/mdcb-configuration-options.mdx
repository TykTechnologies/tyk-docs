...
'og:description': "Each of the config options that are available when deploying MDCB."
sidebarTitle: "MDCB Configuration options"
tags: ['MDCB', 'configuration options', 'MDCB configuration options']
order: 3
---

import MdcbConfig.md from '/snippets/mdcb-config.md.mdx';
...
<!-- Included file not found: mdcb-config.md -->
