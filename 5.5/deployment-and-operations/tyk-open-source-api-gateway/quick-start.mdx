---
title: "Quick Start"
'og:description': "Quick start guide for the Tyk Open Source API Gateway"
...
Next, [add your first API to Tyk ](/5.5/getting-started/create-api) and follow the *Open Source* instructions.

## Kubernetes

This pages has shown the fasted way to get up and running with Tyk Open Source. If you are interested in deploying Tyk stack on a Kubernetes cluster please use our [Helm Charts]/tyk-oss/ce-helm-chart-new