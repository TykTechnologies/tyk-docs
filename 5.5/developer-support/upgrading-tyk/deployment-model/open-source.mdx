...
'og:description': "Explain how to upgrade Open-Source"
sidebarTitle: "Open source upgrade guide"
...
the [pre-upgrade guidelines](/5.5/developer-support/upgrading-tyk/preparations/upgrade-guidelines). Once you
...
For full installation details, check the usual [installation page](/5.5/tyk-oss/ce-docker).
...
3. Review and complete the steps outlined in the [pre-upgrade guidelines](/5.5/developer-support/upgrading-tyk/preparations/upgrade-guidelines).
