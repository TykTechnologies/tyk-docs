...
Before executing the upgrade, ensure that you have consulted and performed all the necessary steps in the [pre upgrade checklist](/5.5/developer-support/upgrading-tyk/preparations/upgrade-guidelines).
