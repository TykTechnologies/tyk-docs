...
The following are required for a Tyk OSS installation:
 ...
 - MongoDB - Required only if you chose to use the MongoDB Tyk Pump with your Tyk OSS installation. Same goes with any [other pump data stores](/5.5/tyk-stack/tyk-pump/other-data-stores.md) you choose to use.
