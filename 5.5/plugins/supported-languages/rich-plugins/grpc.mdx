...
The [Protocol Buffers](https://github.com/TykTechnologies/tyk/tree/master/coprocess/proto ) and [bindings](https://github.com/TykTechnologies/tyk/tree/master/coprocess/bindings) provided by Tyk should be used in order for successful ommunication between Tyk Gateway and your gRPC plugin server. Documentation for the protobuf messages is available in the [Rich Plugins Data Structures](/5.5/plugins/supported-languages/rich-plugins/rich-plugins-data-structures) page.
...
See our [getting started](/5.5/plugins/supported-languages/rich-plugins/grpc/write-grpc-plugin) guide for an explanation of how to write and configure gRPC plugins.
