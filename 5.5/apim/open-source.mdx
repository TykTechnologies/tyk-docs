...
If you are new to Tyk API Gateway or just want to quickly take it for a spin in just 3 steps, head over to our [quick start guide](/5.5/deployment-and-operations/tyk-open-source-api-gateway/quick-start). If you want to deploy it in a specific platform check our [installation options](/5.5/apim/open-source/installation) page.
...
To Get started, simply install [Tyk Open Source](/5.5/apim/open-source/installation), and then create your first API!
