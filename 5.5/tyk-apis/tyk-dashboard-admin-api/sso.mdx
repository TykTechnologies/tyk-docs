...
The Dashboard Admin SSO API endpoint allows you to implement custom authentication schemes for the Dashboard and Portal. Our Tyk Identity Broker (TIB) internally also uses this API. See [Single Sign On](/5.5/tyk-apis/tyk-dashboard-admin-api/sso) for more details.
...
See [Single Sign On](/5.5/advanced-configuration/integrate/sso) documentation for how to use this token and more details.