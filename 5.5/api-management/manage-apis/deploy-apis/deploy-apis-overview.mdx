...
Learn more:
* [Tutorial: Create an API in File-based Mode](/5.5/getting-started/create-api#tutorial-create-an-api-in-file-based-mode)
...
Learn more:
* [Tutorial: Create an API with the Dashboard](/5.5/getting-started/create-api#tutorial-create-an-api-with-the-dashboard)
...
Learn more:
- [Dashboard API](/5.5/getting-started/key-concepts/dashboard-api)
- [Gateway API](/5.5/api-management/oss/gateway-api)
...
Learn more:
- [Tyk Sync](/5.5/product-stack/tyk-sync/overview)
...
Learn more:
- [Tyk Operator](/5.5/tyk-operator)
- [Using Tyk Operator to enable GitOps with Tyk](/5.5/getting-started/key-concepts/gitops-with-tyk)
