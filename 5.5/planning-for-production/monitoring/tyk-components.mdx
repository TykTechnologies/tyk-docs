...
For information about our health check endpoint, please visit our [Liveness Health Check](/5.5/planning-for-production/ensure-high-availability/health-check) documentation.
...
The Tyk Dashboard liveness health check endpoint can be configured [here](/5.5/tyk-dashboard/configuration#health_check_endpoint_name). 

The Tyk MDCB liveness health check endpoint can be configured [here](/5.5/tyk-multi-data-centre/setup-controller-data-centre#health-check). 
...
The Tyk Pump component offers a built-in Liveness Health Check endpoint [here](/5.5/tyk-pump/tyk-pump-configuration/tyk-pump-environment-variables#health-check). 
