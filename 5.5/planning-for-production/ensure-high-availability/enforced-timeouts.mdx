...
If you're using Tyk OAS APIs, then you can find details and examples of how to configure the enforced timeout middleware [here](/5.5/product-stack/tyk-gateway/middleware/enforced-timeout-tyk-oas).

If you're using Tyk Classic APIs, then you can find details and examples of how to configure the enforced timeout middleware [here](/5.5/product-stack/tyk-gateway/middleware/enforced-timeout-tyk-classic).
