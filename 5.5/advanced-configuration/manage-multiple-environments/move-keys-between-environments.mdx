...
sidebarTitle: "Move Keys Between Environments"
order: 5
---
...
To create a key with a custom identifier, ie Token, simply use the [Gateway (OSS)](/5.5/tyk-gateway-api) or [Dashboard (Pro)](/5.5/tyk-apis/tyk-dashboard-api/api-keys#create-a-custom-key) REST APIs to import a custom key.
