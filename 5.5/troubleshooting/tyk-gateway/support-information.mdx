...
You can provide various profile information for us in [pprof format](https://github.com/google/pprof/). See [Gateway Profiling](/5.5/troubleshooting/tyk-gateway/profiling) for more details.
