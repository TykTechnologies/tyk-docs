...
We offer 3 ways of importing an example into Tyk:
 - Using [tyk-sync](/5.5/product-stack/tyk-sync/overview)
 - Manually import via [Dashboard API Import](/5.5/getting-started/import-apis)
- Using Tyk Dashboard to browse and import the examples directly

## Import via tyk-sync

Please follow the [tyk-sync documentation](/5.5/product-stack/tyk-sync/commands/sync-examples#import-tyk-example-into-dashboard) to learn more about this approach.
...
You can find more detailed instructions in the [Dashboard API Import documentation section](/5.5/getting-started/import-apis).
