...
Global headers now have access to all [request context variables](/5.5/content/context-variables.md).
...
Data source headers now have access to all [request context variables](/5.5/content/context-variables.md).
