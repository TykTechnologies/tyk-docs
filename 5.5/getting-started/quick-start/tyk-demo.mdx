...
- [Deploying Tyk in Kubernetes](/5.5/getting-started/quick-start/tyk-k8s-demo)
...
- Exploring integrations, such as [Dynamic Client registration](/5.5/tyk-developer-portal/tyk-portal-classic/keycloak-dcr) in [Keycloak IdP](https://github.com/TykTechnologies/tyk-demo/tree/master/deployments/keycloak-dcr), [Open Telemetry](https://github.com/TykTechnologies/tyk-demo/tree/master/deployments/otel-new-relic) with [New Relic](https://newrelic.com/)
