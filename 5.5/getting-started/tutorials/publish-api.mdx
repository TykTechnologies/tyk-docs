...
import CreatePortalEntryInclude from '/snippets/5.5/create-portal-entry-include.mdx';

This is for the closed source [Tyk Developer Portal](/5.5/tyk-developer-portal) only
