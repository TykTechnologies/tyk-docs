...
The [Tyk Dashboard API](/5.5/tyk-dashboard-api) is a superset of the Tyk Gateway API, enabling (almost) all of the core features and adding many more. The Dashboard API is also more granular and supports [Role Based Access Control](/5.5/tyk-dashboard/rbac) (RBAC) on both a multi-tenant, and user basis.
