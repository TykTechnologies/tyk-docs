...
For global configurations of the gateway that are not related to specific user's API, use the [config file](/5.5/tyk-oss-gateway/configuration)
...
- [Tyk OAS API Definition Objects](/5.5/tyk-apis/tyk-gateway-api/oas/x-tyk-oas-doc)
- [Tyk Classic API Definition Objects](/5.5/tyk-gateway-api/api-definition-objects)
