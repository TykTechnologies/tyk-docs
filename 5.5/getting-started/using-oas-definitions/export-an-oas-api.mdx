...
Tyk Gateway API and Tyk Dashboard API both support exporting the entire [Tyk OAS API Definition](/5.5/getting-started/using-oas-definitions/oas-glossary#tyk-oas-api-definition) or just the [OpenAPI Document](/5.5/getting-started/using-oas-definitions/oas-glossary#openapi-document) part so that you can manage or work on them outside Tyk.
