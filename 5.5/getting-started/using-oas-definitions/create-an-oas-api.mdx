...
In this tutorial we show you how to create a minimal Tyk OAS API using the Tyk Gateway API, starting with a [Tyk OAS API Definition](/5.5/getting-started/using-oas-definitions/oas-glossary#tyk-oas-api-definition).
...
You can also create APIs using the Tyk Dashboard API, starting with a [Tyk OAS API Definition](/5.5/getting-started/using-oas-definitions/oas-glossary#tyk-oas-api-definition).
...
Using [this](https://bit.ly/39jUnuq) API definition it is possible to create a Tyk OAS API on your Tyk Gateway that forwards requests to the [Swagger Petstore](/5.5/https://petstore3.swagger.io) request/response service.
