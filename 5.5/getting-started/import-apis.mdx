...
import ImportApiInclude from '/snippets/5.5/import-api-include.mdx';
...
<Note>
See [note](/5.5/#api-blueprint-is-being-deprecated) above regarding deprecation of support for API Blueprint.
</Note>
...
See [Versioning](/5.5/getting-started/key-concepts/versioning) for more details.
