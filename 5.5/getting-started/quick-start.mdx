...
Head over to our **Tyk Demo** guides in [Kubernetes](/5.5/getting-started/quick-start/tyk-k8s-demo) or [Docker](/5.5/getting-started/quick-start/tyk-demo). These guides, with zero to none effort, will spin up the full Tyk infrastructure (Tyk stack) with examples of Tyk's capabilities and integrations out-of-the-box.
