...
import CreateSecurityPolicyInclude from '/snippets/5.5/create-security-policy-include.mdx';

A security policy encapsulates several options that can be applied to a key. It acts as a template that can override individual sections of an API key (or identity) in Tyk.

See [What is a Security Policy?](/5.5/getting-started/key-concepts/what-is-a-security-policy) for more details.
