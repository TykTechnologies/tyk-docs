...
Does Tyk support the version of Mongo that you’re using? Read more about that [here](/5.5/planning-for-production/database-settings/mongodb).
...
You can determine each collection's cap size by visiting our [MongoDB sizing calculator](/5.5/planning-for-production/database-settings/mongodb-sizing).
