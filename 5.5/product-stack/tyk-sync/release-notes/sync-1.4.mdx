...
'og:description': "Release notes documenting updates, enhancements, fixes and changes for Tyk Sync versions within the 1.4.X series."
sidebarTitle: "Tyk Sync v1.4"
---
...
Please refer to the [changelog](/5.5/#Changelog-v1.4.3) below for detailed explanation.
...
Recommended usage:
Tyk Dashboard setting: [allow-unsafe-oas](/5.5/tyk-dashboard/configuration#allow_unsafe_oas)
Tyk Sync: use the [--allow-unsafe-oas](/5.5/product-stack/tyk-sync/overview) when invoking the CLI
...
#### Release Highlights
This release enhances compatibility as detailed in the [changelog](/5.5/#Changelog-v1.4.2) below.
