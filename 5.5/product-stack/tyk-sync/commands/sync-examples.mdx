...
The examples command lists all examples from our official [Tyk examples](https://github.com/TykTechnologies/tyk-examples) repository. [See output in example usage](/5.5/{{< relref "#import-tyk-example-into-dashboard" >}})
```bash
Usage:
...
## Show Command
Shows more details about a specific example by using its location. [See output in example usage](/5.5/{{< relref "#import-tyk-example-into-dashboard" >}})
```bash
Usage:
