...
'og:description': "Version compatibility matrix with Tyk and Kubernetes version"
...
See [Release notes](/5.5/product-stack/tyk-operator/release-notes/overview.md) to check for each Tyk Operator release,
