...
sidebarTitle: "Operator Context"
tags: ['Tyk Operator', 'Organizations', 'Kubernetes']
---

## Multi-tenancy in Tyk

Tyk Dashboard is multi-tenant capable, which means you can use a single Tyk Dashboard instance to host separate [organizations](/5.5/basic-config-and-security/security/dashboard/organisations) for each team or department. Each organization is a completely isolated unit with its own:
