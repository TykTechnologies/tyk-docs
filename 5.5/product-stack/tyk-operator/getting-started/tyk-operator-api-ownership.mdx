...
sidebarTitle: "Manage API Ownership"
...
Please consult the [API Ownership](/5.5/product-stack/tyk-dashboard/advanced-configurations/user-management/api-ownership) documentation for the fundamental concepts of API Ownership in Tyk and [Operator Context](/5.5/product-stack/tyk-operator/key-concepts/operator-context) documentation for an overview of the use of OperatorContext to manage resources for different teams effectively.
