...
sidebarTitle: "Tyk Dashboard v2.9"
...
See our [TCP Proxy Docs](/5.5/key-concepts/tcp-proxy) for more details.
...
See our [JWT Scope docs](/5.5/basic-config-and-security/security/authentication-authorization/json-web-tokens#jwt-scope-to-policy-mapping-support) for more details.
...
See our [Golang plugin documentation](/5.5/plugins/supported-languages/golang) for more details.
...
See our [Distributed Tracing documentation](/5.5/product-stack/tyk-gateway/advanced-configurations/distributed-tracing/open-telemetry/open-telemetry-overview) for more details.
...
See our updated [Getting Started](/5.5/tyk-self-managed/install) section and [new CLI documentation](/5.5/tyk-on-premises).
...
See our [Dashboard SSO documentation](/5.5/tyk-apis/tyk-dashboard-api/sso) for more details.

### Importing WSDL APIs

WSDL now is a first class citizen at Tyk. You can take your WSDL definition and simply import to the Dashboard, creating a nice boilerplate for your service. See [Import APIs](/5.5/getting-started/import-apis) for more details.
