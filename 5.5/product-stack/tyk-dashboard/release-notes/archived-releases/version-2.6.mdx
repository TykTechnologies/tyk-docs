...
See the Keys section of the [Tyk Gateway REST API](/5.5/tyk-gateway-api) Swagger doc for more details.
...
See [List Key Requests](/5.5/tyk-apis/tyk-dashboard-api/manage-key-requests#list-key-requests) for more details.
...
See [Developer Profiles](/5.5/tyk-developer-portal/tyk-portal-classic/developer-profiles#reset-developer-password) for more details.
