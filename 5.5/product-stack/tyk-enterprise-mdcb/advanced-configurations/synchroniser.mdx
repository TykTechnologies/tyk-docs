...
Please see [Gateway configuration options](/5.5/tyk-oss-gateway/configuration#slave_optionssynchroniser_enabled) for reference.
...
Please see [Gateway configuration options](/5.5/tyk-oss-gateway/configuration#slave_optionskey_space_sync_interval) for reference.
...
Please see [Gateway configuration options](/5.5/tyk-oss-gateway/configuration##slave_optionsgroup_id) for reference
...
Please see [MDCB configuration options](/5.5/tyk-multi-data-centre/mdcb-configuration-options#sync_worker_config) for reference.
...
A: Synchronisation will be triggered once the Time To Live (TTL) of a worker Gateway has expired. The default expiry duration is 3 minutes. The Time To Live (TTL) value can be set via [sync_worker_config.group_key_ttl](/5.5/tyk-multi-data-centre/mdcb-configuration-options#sync_worker_configgroup_key_ttl)
