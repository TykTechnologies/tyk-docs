...
To effectively use Tyk Streams for managing async APIs, it's important to first understand the terminology and [key concepts](/5.5/product-stack/tyk-streaming/key-concepts)
