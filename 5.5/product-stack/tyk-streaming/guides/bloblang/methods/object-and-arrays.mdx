...
Explodes an array or object at a [field path](/5.5/product-stack/tyk-streaming/configuration/common-configuration/field-paths).

#### Parameters

**path** &lt;string&gt; A [dot path](/5.5/product-stack/tyk-streaming/configuration/common-configuration/field-paths) to a field to explode.  
...
Extract a field value, identified via a [dot path](/5.5/product-stack/tyk-streaming/configuration/common-configuration/field-paths), from an object.

#### Parameters

**`path`** &lt;string&gt; A [dot path](/5.5/product-stack/tyk-streaming/configuration/common-configuration/field-paths) identifying a field to obtain.  
...
Returns an object where all but one or more [field path](/5.5/product-stack/tyk-streaming/configuration/common-configuration/field-paths) arguments are removed. Each path specifies a specific field to be retained from the input object, allowing for nested fields.
...
Returns an object where one or more [field path](/5.5/product-stack/tyk-streaming/configuration/common-configuration/field-paths) arguments are removed. Each path specifies a specific field to be deleted from the input object, allowing for nested fields.
