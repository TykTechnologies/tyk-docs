---
title: "Nats"
'og:description': "Explains an overview of nats input"
sidebarTitle: "Nats"
...
You can access these metadata fields using [function interpolation](/5.5/product-stack/tyk-streaming/configuration/common-configuration/interpolation).
...
EXPERIMENTAL: A [Bloblang](/5.5/product-stack/tyk-streaming/guides/bloblang/overview) mapping that attempts to extract an object containing tracing propagation information, which will then be used as the root tracing span for the message. The specification of the extracted fields must match the format used by the service wide tracer.
