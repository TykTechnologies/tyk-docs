---
title: "Parse Log"
'og:description': "Explains an overview of parse_log processor"
sidebarTitle: "Parse Log"
tags: ['Tyk Streams', 'Stream Processors', 'Processors', 'parse_log', 'Logs', 'Log']
---

Parses common log [formats](/5.5/#formats) into [structured data](/5.5/#codecs).
...
A common log [format](/5.5/#formats) to parse.
