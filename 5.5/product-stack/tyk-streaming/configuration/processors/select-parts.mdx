---
title: "Select Parts"
'og:description': "Explains an overview of select parts processor"
sidebarTitle: "Select Parts"
...
This processor is only applicable to [batched messages](/5.5/product-stack/tyk-streaming/configuration/common-configuration/batching).
