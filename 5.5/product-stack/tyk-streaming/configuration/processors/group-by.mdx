---
title: "Group By"
'og:description': "Explains an overview of group by processor"
sidebarTitle: "Group By"
tags: ['Tyk Streams', 'Stream Processors', 'Processors', 'Group_By']
---

Splits a [batch of messages](/5.5/product-stack/tyk-streaming/configuration/common-configuration/batching) into N batches, where each resulting batch contains a group of messages determined by a [Bloblang query](/5.5/product-stack/tyk-streaming/guides/bloblang/overview).
...
The functionality of this processor depends on being applied across messages that are [batched](/5.5/product-stack/tyk-streaming/configuration/common-configuration/batching).

## Fields

### [].check

A [Bloblang query](/5.5/product-stack/tyk-streaming/guides/bloblang/overview) that should return a boolean value indicating whether a message belongs to a given group.
