---
title: "MQTT"
'og:description': "Explains an overview of configuring MQTT output"
sidebarTitle: "MQTT"
...
The `topic` field can be dynamically set using function [interpolations](/5.5/product-stack/tyk-streaming/configuration/common-configuration/interpolation#bloblang-queries). When sending batched messages these interpolations are performed per message part.
