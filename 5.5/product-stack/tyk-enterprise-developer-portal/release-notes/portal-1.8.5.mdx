...
If you are on 1.8.3 or older version please follow the [upgrade instructions](/5.5/product-stack/tyk-enterprise-developer-portal/upgrading/theme-upgrades) to upgrade the portal's themes.
