...
From that page you can also manage [OAuth2.0 settings](/5.5/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/dynamic-client-registration.md) and add [Get started guides](/5.5/tyk-stack/tyk-developer-portal/enterprise-developer-portal/getting-started-with-enterprise-portal/manage-get-started-guides-for-api-products) to your API Products, which is covered in the relevant sections.
...
- **Scope**: Scope for the [OAuth2.0 settings](/5.5/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/dynamic-client-registration.md). Please refer to the [OAuth2.0 documentation](/5.5/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/dynamic-client-registration) for further guidance.
- **Catalogs**: The catalogs in which this plan is available. Catalogs and organization are [covered](/5.5/product-stack/tyk-enterprise-developer-portal/getting-started/create-orgs-and-catalogs) later within this getting started guide.
...
Visit the [create API Consumer organizations and catalogs](/5.5/product-stack/tyk-enterprise-developer-portal/getting-started/create-orgs-and-catalogs) section to learn how to create API consumer organizations and catalogs.