...
'og:description': "Using the Request Header Transform middleware with Tyk OAS APIs"
...
If you're using the legacy Tyk Classic APIs, then check out the [Tyk Classic](/5.5/product-stack/tyk-gateway/middleware/request-header-tyk-classic) page.
