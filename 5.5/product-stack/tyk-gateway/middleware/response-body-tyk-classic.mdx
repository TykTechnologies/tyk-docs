...
The [response body transform](/5.5/advanced-configuration/transform-traffic/response-body) middleware provides a way to modify the payload of API responses before they are returned to the client.
...
If you're using the newer Tyk OAS APIs, then check out the [Tyk OAS](/5.5/product-stack/tyk-gateway/middleware/response-body-tyk-oas) page.
