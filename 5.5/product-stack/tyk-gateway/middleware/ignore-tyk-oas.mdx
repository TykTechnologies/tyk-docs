...
'og:description': "Using the Ignore Authentication middleware with Tyk OAS APIs"
...
If you're using the legacy Tyk Classic APIs, then check out the [Tyk Classic](/5.5/product-stack/tyk-gateway/middleware/ignore-tyk-classic) page.
