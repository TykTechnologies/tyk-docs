...
For development purposes, we are going to load the plugin from local file storage. For production, you can use [bundles](/5.5/#loading-a-tyk-golang-plugin-from-a-bundle) to deploy plugins to multiple gateways.
