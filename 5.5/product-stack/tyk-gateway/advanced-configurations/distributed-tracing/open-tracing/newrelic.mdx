...
OpenTracing is now deprecated. We have introduced support of [OpenTelemetry](/5.5/{{ref "product-stack/tyk-gateway/advanced-configurations/distributed-tracing/open-telemetry/open-telemetry-overview"}}) in v5.2. We recommend users to migrate to OpenTelemetry for better supports of your tracing needs.
</Note>
