...
- Familiarize yourself with URL matching in Tyk [here](/5.5/getting-started/key-concepts/url-matching).
- For production setup guidance, see [this guide](/5.5/planning-for-production#ensure-you-are-matching-only-the-url-paths-that-you-want-to-match).
...
Learn more about the settings in the [URL Path Matching](/5.5/getting-started/key-concepts/url-matching) documentation.
</Expandable>
</li>
