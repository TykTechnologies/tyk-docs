...
'og:description': "Release notes documenting updates, enhancements and changes for Tyk Charts versions within the 1.6 series."
sidebarTitle: "Tyk Charts 1.6"
...
MDCB v2.7.0 release introduces `/liveness` and `/readiness` probes which give more accurate and detail health check information. MDCB deployment has been updated to use the new endpoints. See [MDCB Health Check](/5.5/tyk-multi-data-centre/setup-controller-data-centre#health-check) section for information about the new probes.
...
For more details about new endpoints, check [MDCB Health check](/5.5/tyk-multi-data-centre/setup-controller-data-centre#health-check) section.
</Expandable>
</li>
</ul>
