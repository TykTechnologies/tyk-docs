...
To configure them, add an `event_options` section to an Organization when you are creating them. See [Creating an Organization via the Dashboard Admin API](/platform-management/dashboard-admin-api#create-an-organization) for more details.
