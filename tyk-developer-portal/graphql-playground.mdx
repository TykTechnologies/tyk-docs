...
- A [working Tyk environment](/getting-started/quick-start) with Tyk Gateway and Tyk Dashboard
- A [GraphQL API](/api-management/graphql) in Tyk Dashboard
...
2. Navigate to **Developer Portal > API Products** and [create a new API Product](/portal/api-products#creating-a-new-api-product).
...
9. You should now see the **GraphQL Playground**, ready for interactive query testing.
   ...
   <Note>
   To test authenticated APIs, set the required headers in the Playground. The Star Wars GQL API uses [Auth Token](/api-management/authentication/bearer-token) authentication.
