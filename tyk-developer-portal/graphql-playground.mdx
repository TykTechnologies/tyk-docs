...
6. Set the **GraphQL Server URL** to the endpoint of your GraphQL API on the Gateway (for example, `http://gateway.example.com/my-graphql-api/`).
   ...
   From v1.16.0, this field is auto-populated from your Provider's [Baseline URL](#graphql-server-url-and-baseline-url) and the API's listen path. You can edit the value at any time.
