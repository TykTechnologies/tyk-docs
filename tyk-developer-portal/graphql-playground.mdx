...
1. In the **Tyk Dashboard**, create a new **GraphQL API** by
    ...
    - Copy the **Key ID** from the pop-up and save it for later use. We will set the authorization header in the Playground using this Key ID.
...
The Tyk Getting Started Guide creates an API Catalog (`Public catalogue`) by default. If you don't have one, refer to this [guide](/tyk-developer-portal/developer-portal-setup/create-api-catalog/) to create an API Catalog in the Developer Portal.
