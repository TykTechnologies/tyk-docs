...
2. **Working Tyk Environment**: You need access to a running Tyk instance with the Developer Portal deployed. For setup instructions, please refer to the [Portal Deployment Guide](/product-stack/tyk-enterprise-developer-portal/deploy/install-tyk-enterprise-portal).
