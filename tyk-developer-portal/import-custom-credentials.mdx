...
1. Use the [Create Application API](https://tyk.io/docs/api-reference/portal/applications-and-credentials/create-a-new-developer-application) to create the application for the user.
...
2. Use the [Add Credential to Application API](https://tyk.io/docs/api-reference/portal/applications-and-credentials/create-a-custom-credential) to add the custom credential, specifying the token value, and associating the desired products and plan.
