...
<Note>
When you add a Tyk Managed Custom Credential, the Developer Portal automatically creates a corresponding API key in the Tyk Dashboard for that credential. You can find this key in the Dashboard under the relevant API Product and Plan, which allows you to manage and monitor its usage alongside other credentials.
...
The Tyk Developer Portal API can automate the exact same workflow you performed via the UI. 
