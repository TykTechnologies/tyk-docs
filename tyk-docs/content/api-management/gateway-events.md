...
Creating an event handler is very similar to [creating custom JS plugins]({{< ref "api-management/plugins/javascript#the-plugin-contract" >}}), simply invoke the correct constructors with a closure in the TykJS namespace:
