...
- Either a [Tyk Pro install]({{< ref "migration-to-tyk#configure-tyk-self-managed" >}}) or [Tyk OSS Gateway install]({{< ref "migration-to-tyk#configure-tyk-self-managed" >}}) along with a [Tyk Pump]({{< ref "tyk-pump.md" >}}) install.
