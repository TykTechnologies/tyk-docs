...
This section explains some advanced [Bloblang]({< ref "/product-stack/tyk-streaming/reference/bloblang/overview" >}) patterns
...
Tyk Streams has a few different ways of outputting a stream of CSV data. However, the best way to do it is by converting the documents into CSV rows with [Bloblang]({< ref "/product-stack/tyk-streaming/reference/bloblang/overview" >}) as this gives you full control over exactly how the schema is generated, erroneous data is handled, and escaping of column data is performed.
