...
A [Bloblang]({< ref "/product-stack/tyk-streaming/reference/bloblang/overview" >}) mapping which should evaluate to an array of values matching in size to the number of arguments required for the specified Redis command.
