...
MDCB v2.7.0 release introduces `/liveness` and `/readiness` probes which give more accurate and detail health check information. MDCB deployment has been updated to use the new endpoints. See [MDCB Health Check]({{<ref "migration-to-tyk#use-mdcb-for-health-checks">}}) section for information about the new probes.
...
For more details about new endpoints, check [MDCB Health check]({{<ref "migration-to-tyk#use-mdcb-for-health-checks">}}) section.
</details>
</li>
</ul>
