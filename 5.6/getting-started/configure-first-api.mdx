...
- [A Tyk Cloud account](/5.6/getting-started/create-account).
...
Congratulations! You've successfully created, secured, and deployed your first API in Tyk Cloud. Next, explore more advanced features like [rate-limiting](/5.6/getting-started/key-concepts/rate-limiting) or [OAuth2](/5.6/api-management/authentication-authorization#set-up-oauth-20-authorization).

Explore more features in your [dashboard](/5.6/getting-started/using-tyk-dashboard) to optimize and scale your API offerings.
