...
The [Tyk Gateway REST API](/5.6/tyk-gateway-api) is the primary means for integrating your application with the Tyk API Gateway system. This
...
<Note>
The Tyk Gateway API is subsumed by the [Tyk Dashboard API](/5.6/getting-started/key-concepts/dashboard-api) in all
