...
import ImportApiInclude from '/snippets/5.6/import-api-include.mdx';
...
<Note>
See [note](/5.6/#api-blueprint-is-being-deprecated) above regarding deprecation of support for API Blueprint.
</Note>
...
See [Versioning](/5.6/getting-started/key-concepts/versioning) for more details.
