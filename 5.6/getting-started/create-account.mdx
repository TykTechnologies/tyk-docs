...
Finally, you will be taken to the Tyk Dashboard. Select "Design From Scratch" and continue on to [our tutorial](/5.6/getting-started/configure-first-api) to learn how to setup and secure your APIs.
...
- **Create Your First API**: Follow our guide on [setting up and securing your first API](/5.6/getting-started/configure-first-api).
- **Explore the Dashboard**: Familiarize yourself with the [Tyk Cloud interface](/5.6/tyk-dashboard).
