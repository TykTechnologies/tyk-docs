...
import CreatePortalEntryInclude from '/snippets/5.6/create-portal-entry-include.mdx';

This is for the closed source [Tyk Developer Portal](/5.6/tyk-developer-portal) only
