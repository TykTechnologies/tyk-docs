...
'og:description': "Tyk OAS API feature status"
sidebarTitle: "Tyk OAS Maturity"
tags: ['Tyk Tutorials', 'Getting Started', 'First API', 'Tyk Cloud', 'Tyk Self-Managed', 'Tyk Open Source', 'OAS Reference']
order: 8
---

Tyk Gateway is extremely flexible with a great many features that you can use to configure and optimize the handling of requests to your APIs. During the [Early Access](/5.6/developer-support/special-releases-and-features/early-access-features) phase, we gradually rolled out support for the configuration that is available through Tyk Classic API definitions into the new Tyk OAS API Definition format.
