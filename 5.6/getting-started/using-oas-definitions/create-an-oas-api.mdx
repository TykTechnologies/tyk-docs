...
'og:description': "Creating a Tyk OAS API"
sidebarTitle: "Create a Tyk OAS API"
...
In this tutorial we show you how to create a minimal Tyk OAS API using the Tyk Gateway API, starting with a [Tyk OAS API Definition](/5.6/getting-started/using-oas-definitions/oas-glossary#tyk-oas-api-definition).
...
You can also create APIs using the Tyk Dashboard API, starting with a [Tyk OAS API Definition](/5.6/getting-started/using-oas-definitions/oas-glossary#tyk-oas-api-definition).
...
Using [this](https://bit.ly/39jUnuq) API definition it is possible to create a Tyk OAS API on your Tyk Gateway that forwards requests to the [Swagger Petstore](/5.6/https://petstore3.swagger.io) request/response service.
...
You can make use of Tyk Operator custom resources to configure [Tyk OAS API](/5.6/getting-started/using-oas-definitions/oas-glossary#tyk-oas-api-definition) in a Kubernetes environment.

In this [tutorial](/5.6/api-management/automations#set-up-oas-api) we guide you through the steps to create a new Tyk OAS API using Tyk Operator.