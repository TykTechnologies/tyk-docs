...
When you add a new user, they are created without a password being set. After adding a user, you need to use the [Set Password](/5.6/tyk-dashboard-api/users#set-user-password) call to set a password using the `user-id` created.
