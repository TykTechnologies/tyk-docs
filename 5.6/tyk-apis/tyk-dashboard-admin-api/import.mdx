...
The [Organization object](/5.6/basic-config-and-security/security/dashboard/organisations#concept-dashboard-organisations) is the most fundamental object in a Tyk setup, all other ownership properties hang off the relationship between an Organization and its APIs, Policies and API Tokens.
