...
Please consult the Tyk Operator supporting documentation for an example of how to [configure an IP block list](/5.6/api-management/automations#ip-blocklist) with Tyk Operator.