...
Please [click here](/5.6/content/planning-for-production/monitoring/tyk-components.md) to read more about Tyk component monitoring and how to set it up.
...
Infrastructure sizing, benchmarks, and scaling will be explained in [this section](/5.6/content/planning-for-production/benchmarks.md).
