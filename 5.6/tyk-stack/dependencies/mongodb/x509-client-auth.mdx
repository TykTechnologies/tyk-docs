...
'og:description': "Setting up MongoDB with X509 Client Authentication between Tyk Components"
sidebarTitle: "MongoDB X.509 Client Authentication"
tags: ['MongoDB', 'x509']
order: 2
---

You can use the *MongoDB X509 Certificate* flow to authenticate the *Tyk Dashboard*, *Tyk Pump*, and *Tyk MDCB* with your *MongoDB* install.  This is slightly different from [AWS DocumentDB setup instructions](/5.6/frequently-asked-questions/how-to-connect-to-documentdb).
