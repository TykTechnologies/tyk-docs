...
Head over to the [connect data source](/5.6/universal-data-graph/concepts/datasources) section to learn about the supported data sources and how to connect them to Tyk.