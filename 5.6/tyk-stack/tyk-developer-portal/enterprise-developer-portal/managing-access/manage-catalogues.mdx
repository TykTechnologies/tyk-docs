...
- Create one or more [policies with enforced rate limit and quotas](/5.6/product-stack/tyk-enterprise-developer-portal/getting-started/create-api-product-and-plan) (Plan in the Portal)
