...
We suggest you read the [portal concepts](/5.6/product-stack/tyk-enterprise-developer-portal/getting-started/enterprise-portal-concepts) first. If you've already done that, we will show you an example on how to:
...
<html lang="en">
 ...
 <head>
   ...
   <title>{{ if .page}} {{.page.Title}} {{else}} Developer Portal {{end}}</title>
    ...
    {/* Bootstrap core CSS */}
    <link href="/5.6/system/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="/5.6/assets/stylesheets/fonts.css" rel="stylesheet">
    <link href="/5.6/assets/stylesheets/main.css" rel="stylesheet">
