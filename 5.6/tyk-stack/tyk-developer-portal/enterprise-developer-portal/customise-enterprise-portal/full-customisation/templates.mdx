...
[section](/5.6/tyk-stack/tyk-developer-portal/enterprise-developer-portal/customise-enterprise-portal/full-customisation/edit-manage-page-content)
...
- [Template Data](/5.6/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/5.6/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/5.6/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/5.6/#analytics)
- [Application Create](/5.6/#application-create)
- [Application Detail](/5.6/#application-detail)
- [Blogs](/5.6/#blogs)
- [Blog Detail](/5.6/#blog-detail)
- [Cart Checkout](/5.6/#cart-checkout)
- [Organization User Detail](/5.6/#organization-user-detail)
- [Organization User Edit](/5.6/#organization-user-edit)
- [Organization Users List](/5.6/#organization-users-list)
- [Product Detail](/5.6/#product-detail)
- [Product OAS Documentation](/5.6/#product-oas-documentation)
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/5.6/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/5.6/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/5.6/portal/private/users">Cancel</a>
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/5.6/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/5.6/#cancreateorganisation)
- [Clients](/5.6/#clients)
- [Current User](/5.6/#currentuser)
- [FeaturedProducts](/5.6/#featuredproducts)
- [FilterUserInvites](/5.6/#filteruserinvites)
- [FormatTime](/5.6/#formattime)
- [GetCart](/5.6/#getcart)
- [GetCatalogueList](/5.6/#getcataloguelist)
- [GetCataloguesForProduct](/5.6/#getcataloguesforproduct)
- [GetClientDescription](/5.6/#getclientdescription)
- [GetClientName](/5.6/#getclientname)
- [GetMenus](/5.6/#getmenus)
- [GetProducts](/5.6/#getproducts)
- [IsPortalDisabled](/5.6/#isportaldisabled)
- [IsPortalPrivate](/5.6/#isportalprivate)
- [ProductDocRenderer](/5.6/#productdocrenderer)
- [ProviderUpstreamURL](/5.6/#providerupstreamurl)
- [SplitStrings](/5.6/#splitstrings)
- [TruncateString](/5.6/#truncatestring)
- [TypeOfCredential](/5.6/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/5.6/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/5.6/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/5.6/tyk-stack/tyk-developer-portal/enterprise-developer-portal/customise-enterprise-portal/full-customisation/menus-customisation).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/5.6/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/5.6/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/5.6/tyk-stack/tyk-developer-portal/enterprise-developer-portal/customise-enterprise-portal/full-customisation/email-customization)
for additional detail on email notifications sent by the portal.


## Available Email Templates

- [Access Request Approve/Reject](/5.6/#access-request-approvereject)
- [Access Request Submitted](/5.6/#access-request-submitted)
- [Activate and Deactivate](/5.6/#activate-and-deactivate)
- [New User Request](/5.6/#new-user-request)
- [Organization Approve](/5.6/#organization-approve)
- [Organization Reject](/5.6/#organization-reject)
- [Organization Request](/5.6/#organization-request)
- [Reset Password](/5.6/#reset-password)
- [Targeted Invite](/5.6/#targeted-invite)
- [Welcome User](/5.6/#welcome-user)
