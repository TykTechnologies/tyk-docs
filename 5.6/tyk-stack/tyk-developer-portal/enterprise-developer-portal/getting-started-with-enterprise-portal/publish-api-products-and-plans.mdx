...
sidebarTitle: "3. Publish API Products and Plans"
tags: ['']
order: 3
---
...
- [Created and imported API Products and Plans from Tyk](/5.6/product-stack/tyk-enterprise-developer-portal/getting-started/create-api-product-and-plan)
