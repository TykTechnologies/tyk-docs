...
'og:description': "How to manage the Get started guides with the Enterprise Developer portal"
sidebarTitle: "Create Get started guides for your API Products"
...
To start with, create and publish an API Product. Please refer to the [Publish API Products and Plans](/5.6/tyk-stack/tyk-developer-portal/enterprise-developer-portal/getting-started-with-enterprise-portal/publish-api-products-and-plans) page for further guidance.
