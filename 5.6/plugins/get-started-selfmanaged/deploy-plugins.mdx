...
<Note>
For added security, please consider signing your [bundles](/5.6/plugins/how-to-serve-plugins#global-parameters), especially if the connection between the Gateways and the Bundler server traverses the internet.
</Note>
...
<Note>
For seamless deployments, take a look at multi-version [plugin support](/5.6/plugins/supported-languages/golang#upgrading-tyk) to enable zero downtime deployments of your Tyk Gateway installs
</Note>
