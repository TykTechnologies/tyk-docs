...
sidebarTitle: "Tyk Dashboard Configuration Options"
order: 2
---

import DashboardConfig.md from '/snippets/dashboard-config.md.mdx';
...
To understand how the environment variables notation works, see [Environment Variables](/5.6/tyk-environment-variables).
...
<!-- Included file not found: dashboard-config.md -->
