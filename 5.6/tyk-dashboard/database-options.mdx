...
import MongodbVersionsInclude from '/snippets/5.6/mongodb-versions-include.mdx';
import SqlVersionsInclude from '/snippets/5.6/sql-versions-include.mdx';
...
Please check [here](/5.6/planning-for-production/database-settings/mongodb.md) for MongoDB driver and production configurations.
...
Please check [here](/5.6/planning-for-production/database-settings/postgresql.md) for production configurations.

See the following pages for configuring your SQL installation with Tyk:

* [Configuring Tyk Dashboard](/5.6/content/planning-for-production/database-settings/postgresql.md)
* [Configuring Tyk Pumps](/5.6/content/planning-for-production/database-settings/postgresql.md)
