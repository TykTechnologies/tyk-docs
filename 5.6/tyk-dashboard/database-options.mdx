...
Please check [here](/5.6/planning-for-production/database-settings/mongodb) for MongoDB driver and production configurations.
...
Please check [here](/5.6/planning-for-production/database-settings/postgresql) for production configurations.

See the following pages for configuring your SQL installation with Tyk:

* [Configuring Tyk Dashboard](/5.6/planning-for-production/database-settings/postgresql)
* [Configuring Tyk Pumps](/5.6/planning-for-production/database-settings/postgresql)
