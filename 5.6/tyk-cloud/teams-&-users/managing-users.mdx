...
The following [user roles](/5.6/tyk-cloud/teams-&-users/user-roles) can perform existing User Admin tasks:

* [Organization Admin](/5.6/tyk-cloud/teams-&-users/user-roles#user-roles-within-tyk-cloud) - Can manage all users in the organization they are a member of.
* [Team Admin](/5.6/tyk-cloud/teams-&-users/user-roles#user-roles-within-tyk-cloud) - Can only manage the users of the team they are a member of.
