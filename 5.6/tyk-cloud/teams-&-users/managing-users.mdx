...
The following [user roles](/5.6/tyk-cloud/teams-&-users/user-roles.md) can perform existing User Admin tasks:

* [Organization Admin](/5.6/tyk-cloud/teams-&-users/user-roles.md#user-roles-within-tyk-cloud) - Can manage all users in the organization they are a member of.
* [Team Admin](/5.6/tyk-cloud/teams-&-users/user-roles.md#user-roles-within-tyk-cloud) - Can only manage the users of the team they are a member of.
    ...
    You can also [add users to the Tyk Dashboard](/5.6/basic-config-and-security/security/dashboard/create-users) itself instead of inviting them as Tyk Cloud users. These users would likely be your API Developers and Engineers who manage the APIs.
    </Note>
