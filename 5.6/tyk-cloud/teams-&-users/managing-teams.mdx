...
The following [user roles](/5.6/tyk-cloud/teams-&-users/user-roles) can perform existing Team Admin tasks:
...
You need to be a [Organization Admin](/5.6/tyk-cloud/teams-&-users/user-roles#user-roles-within-tyk-cloud) to create a new team.
...
You need to be a [Organization Admin](/5.6/tyk-cloud/teams-&-users/user-roles#user-roles-within-tyk-cloud) to delete a team.
...
You can now invite users to your new team. See [Managing Users](/5.6/tyk-cloud/teams-&-users/managing-users) for more details.
