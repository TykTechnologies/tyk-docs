...
You can [add users to the Tyk Dashboard](/5.6/basic-config-and-security/security/dashboard/create-users) itself instead of inviting them as Tyk Cloud users. These users would likely be your API Developers and Engineers who manage the APIs.   
