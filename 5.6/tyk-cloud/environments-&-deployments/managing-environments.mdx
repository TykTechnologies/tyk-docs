...
Environments are used to group your [Control Plane](/5.6/tyk-cloud/troubleshooting-&-support/glossary#control-plane) and [Cloud Data Planes](/5.6/tyk-cloud/troubleshooting-&-support/glossary#cloud-data-plane) into logical groups. For example you may want to create environments that reflect different departments of your organization.
