...
See [Tyk Gateway configuration](/5.6/tyk-oss-gateway/configuration) and [Tyk Gateway API](/5.6/tyk-gateway-api/api-definition-objects) for further information regarding API definition settings.