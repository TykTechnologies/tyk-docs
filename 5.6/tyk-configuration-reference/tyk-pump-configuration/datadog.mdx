---
title: "Datadog Setup"
'og:description': "How configure the Tyk Pump with Datadog"
sidebarTitle: "Datadog Setup"
...
- Either a [Tyk Pro install](/5.6/tyk-on-premises.md) or [Tyk OSS Gateway install](/5.6/apim/open-source.md) along with a [Tyk Pump](/5.6/tyk-pump.md) install.
