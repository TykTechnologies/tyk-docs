...
'og:description': "Release notes documenting updates, enhancements and changes for Tyk Pump versions within the 1.10.X series."
sidebarTitle: "Pump v1.10"
...
Tyk Pump now offers [FIPS 140-2](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.140-2.pdf) compliance. For further details please consult [Tyk API Management FIPS support](/5.6/developer-support/special-releases-and-features/fips-release)
...
Added [FIPS compliance](/5.6/developer-support/special-releases-and-features/fips-release) for Tyk Pump.
</Expandable>
</li>
</ul>
