...
Executes a [Bloblang](/5.6/product-stack/tyk-streaming/guides/bloblang/overview) mapping and directly transforms the contents of messages, mutating (or deleting) them.
