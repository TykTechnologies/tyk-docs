...
You can access these metadata fields using [function interpolation](/5.6/product-stack/tyk-streaming/configuration/common-configuration/interpolation).
