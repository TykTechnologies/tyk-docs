...
Allows you to route messages to multiple child outputs using a range of brokering [patterns](/5.6/#patterns).
...
Sometimes it is useful to disable the back pressure or retries of certain fan out outputs and instead drop messages that have failed or were blocked. In this case you can wrap outputs with a [drop_on](/5.6/product-stack/tyk-streaming/configuration/outputs/drop_on) output.
