---
title: "amqp_0_9"
'og:description': "Explains an overview of amqp_0_9 output"
sidebarTitle: "Amqp_0_9"
...
The fields 'key', 'exchange' and 'type' can be dynamically set using function interpolations described [here](/5.6/product-stack/tyk-streaming/configuration/common-configuration/interpolation#bloblang-queries).
