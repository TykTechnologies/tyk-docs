...
Checks that a field, identified via a [dot path](/5.6/product-stack/tyk-streaming/configuration/common-configuration/field-paths), exists in an object.

#### Parameters

**path** &lt;string&gt; A [dot path](/5.6/product-stack/tyk-streaming/configuration/common-configuration/field-paths) to a field.  
