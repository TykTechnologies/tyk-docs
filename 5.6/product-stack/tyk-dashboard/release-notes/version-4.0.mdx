...
[Federation docs](/5.6/content/getting-started/key-concepts/graphql-federation.md)

[Subgraphs and Supergraphs docs](/5.6/content/getting-started/key-concepts/graphql-federation.md#subgraphs-and-supergraphs)
...
[Subscriptions docs](/5.6/content/getting-started/key-concepts/graphql-subscriptions.md)
...
While SQL support for Tyk products does not depend on specific database features, with this release, we will provide official support for [PostgreSQL DB for production purposes](/5.6/content/planning-for-production/database-settings.md), and SQLite for development and PoC environments. Note that SQL support is available for self-managed setups only.
...
[MongoDB to SQL migration docs](/5.6/content/planning-for-production/database-settings/postgresql.md#migrating-from-an-existing-mongodb-instance)
...
Follow the [standard upgrade guide](/5.6/content/upgrading-tyk.md), there are no breaking changes in this release.

If you want switch from MongoDB to SQL, you can [use our migration tool](/5.6/content/planning-for-production/database-settings/postgresql.md#migrating-from-an-existing-mongodb-instance), but keep in mind that it does not yet support the migration of your analytics data.
