...
'og:description': "Tyk Dashboard 4.1 release notes"
sidebarTitle: "Tyk Dashboard v4.1"
...
Tyk has always had a proprietary specification for defining APIs. From Tyk v4.1 we now support defining APIs using the Open API Specification (OAS) as well, which can offer significant time and complexity savings. [This is an early access capability](/5.6/developer-support/special-releases-and-features/early-access-features).
...
This capability is available in both the open source and paid versions of Tyk. See our [High Level Concepts](/5.6/getting-started/key-concepts/high-level-concepts) for more details, or jump to [OAS Getting Started documentation](/5.6/getting-started/using-oas-definitions/create-an-oas-api).
