...
See our [TCP Proxy Docs](/5.6/key-concepts/tcp-proxy) for more details.
...
See our [JWT Scope docs](/5.6/api-management/authentication-authorization#use-json-web-tokens-jwt) for more details.
...
See our [Golang plugin documentation](/5.6/plugins/supported-languages/golang) for more details.
...
See our [Distributed Tracing documentation](/5.6/product-stack/tyk-gateway/advanced-configurations/distributed-tracing/open-telemetry/open-telemetry-overview) for more details.
...
See our updated [Getting Started](/5.6/tyk-self-managed/install) section and [new CLI documentation](/5.6/tyk-on-premises).
...
See our [Dashboard SSO documentation](/5.6/tyk-apis/tyk-dashboard-api/sso) for more details.

### Importing WSDL APIs

WSDL now is a first class citizen at Tyk. You can take your WSDL definition and simply import to the Dashboard, creating a nice boilerplate for your service. See [Import APIs](/5.6/getting-started/import-apis) for more details.
