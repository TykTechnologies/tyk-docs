...
sidebarTitle: "Tyk Identity Broker 1.6"
...
<h3 id="Changelog-v1.6.1">Changelog</h3>
...
For more details, refer to the [OIDC SSO with JWE](/5.6/tyk-stack/tyk-identity-broker/about-profiles#social-profile-fields) documentation.
</Expandable>
</li>
