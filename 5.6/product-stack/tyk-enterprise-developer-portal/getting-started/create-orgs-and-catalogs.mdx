...
The default catalogs that are featured when the portal is [bootstrapped](/5.6/product-stack/tyk-enterprise-developer-portal/deploy/bootstrapping-portal) are:
