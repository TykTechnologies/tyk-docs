...
Visit the [connect to the Tyk Dashboard](/5.6/product-stack/tyk-enterprise-developer-portal/getting-started/with-tyk-self-managed-as-provider) guide to learn how to connect the portal with Tyk Dashboard.
