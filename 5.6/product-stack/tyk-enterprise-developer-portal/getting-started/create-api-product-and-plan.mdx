...
When integrating with Tyk, the Tyk policies will be imported into the Developer Portal. Depending on the configuration that’s been set in the policy section, the policy will either be imported as an API Product or a Plan. For further details check the [portal key concepts](/5.6/product-stack/tyk-enterprise-developer-portal/getting-started/enterprise-portal-concepts) document.

- A Tyk Self-Managed [installation](/5.6/tyk-self-managed/install)
- Tyk Self-Managed [added as a provider](/5.6/product-stack/tyk-enterprise-developer-portal/getting-started/with-tyk-self-managed-as-provider)
- Have APIs [created in your Tyk installation](/5.6/getting-started/create-api).
...
Visit [Customize visual appearance of API Products and Plans](/5.6/product-stack/tyk-enterprise-developer-portal/getting-started/customize-products-and-plans) to learn how to customize the visual appearance of API Products and plans.