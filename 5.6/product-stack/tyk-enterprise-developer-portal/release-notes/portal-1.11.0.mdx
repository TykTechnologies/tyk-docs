...
- [22 bugs fixed](/5.6/#fixed)
- [19 CVEs fixed](/5.6/#fixed)
...
- Added new TLS variables to set MinVersion ([PORTAL_TLSCONFIG_MINVERSION](/5.6/product-stack/tyk-enterprise-developer-portal/deploy/configuration#portal_tlsconfig_minversion), MaxVersion ([PORTAL_TLSCONFIG_MAXVERSION](/5.6/product-stack/tyk-enterprise-developer-portal/deploy/configuration#portal_tlsconfig_maxversion), and CipherSuites ([PORTAL_TLS_CIPHER_SUITES](/5.6/product-stack/tyk-enterprise-developer-portal/deploy/configuration#portal_tls_cipher_suites).
- Added a new configuration to manage the idle timeout of the portal's session ([PORTAL_SESSION_IDLE_TIMEOUT](/5.6/product-stack/tyk-enterprise-developer-portal/deploy/configuration#portal_session_idle_timeout).
...
- Changed the default value of [PORTAL_DATABASE_CONNECTION_MAX_LIFETIME](/5.6/product-stack/tyk-enterprise-developer-portal/deploy/configuration#portal_database_connection_max_lifetime) to 1800000 milliseconds.
