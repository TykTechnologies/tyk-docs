...
sidebarTitle: "Tyk Operator v1.0"
---
...
For details please refer to the [changelog](/5.6/#Changelog-v1.0.0) below.


### Breaking Changes
{/* Required. Use the following statement if there are no breaking changes, or explain if there are */}
{/* This release has no breaking changes. */}
**License Requirement:** Tyk Operator is now a closed-source product and requires a valid license key to operate. Please follow our [Installation and Upgrade Guide](/5.6/api-management/automations#install-and-configure-tyk-operator) to set your license key before installation or upgrade.
...
<h3 id="dependencies-1.1">Dependencies</h3>
...
Go to the [Upgrading Tyk Operator](/5.6/api-management/automations#upgrading-tyk-operator) section for detailed upgrade instructions.
...
- [Docker image v1.0.0](https://hub.docker.com/r/tykio/tyk-operator/tags?page=&page_size=&ordering=&name=v1.0.0)
  - ```bash
    ...
    ```
- Helm chart
  - [tyk-charts v2.1.0](/5.6/product-stack/tyk-charts/release-notes/version-2.1.md) {/* This is the link to the Helm charts links. Please be mindful that this URL is only available a few hours or day/s after we release the main release, so this link needs to be updated in a separate iteration */}
{/* source code tarball for oss projects */}

<h3 id="Changelog-v1.0.0">Changelog</h3>
...
Learn More: [Create Tyk OAS API](/5.6/api-management/automations#set-up-oas-api)
</Accordion>
...
Learn More: [Tyk Ingress Controller](/5.6/api-management/automations#control-kubernetes-ingress-resources)
</Accordion>
...
Learn More: [Key-Level Per-API Rate Limits and Quota](/5.6/api-management/automations#security-policy-example)
</Accordion>
...
Learn More: [Key-Level Per-Endpoint Rate Limits](/5.6/api-management/automations#security-policy-example)
</Accordion>
...
Learn More: [TykOasApiDefinition in Security Policy](/5.6/api-management/automations#add-a-security-policy-to-your-api)
</Accordion>
...
Learn More: [Event Webhook with Tyk Classic](/5.6/product-stack/tyk-gateway/basic-config-and-security/report-monitor-and-trigger-events/event-webhook-tyk-classic)
</Accordion>
