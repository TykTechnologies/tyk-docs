...
'og:description': "Release notes documenting updates, enhancements and changes for Tyk Charts versions within the 2.0 series."
sidebarTitle: "Tyk Charts 2.0"
...
- Familiarize yourself with URL matching in Tyk [here](/5.6/getting-started/key-concepts/url-matching).
- For production setup guidance, see [this guide](/5.6/planning-for-production#ensure-you-are-matching-only-the-url-paths-that-you-want-to-match).
...
Learn more about the settings in the [URL Path Matching](/5.6/getting-started/key-concepts/url-matching) documentation.
</Expandable>
</li>
