...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.6/#Changelog-v2.1.0) below.

### Breaking Changes
{/* Required. Use the following statement if there are no breaking changes, or explain if there are */}
This release has no breaking changes.

However, if you are upgrading to [Tyk Operator v1.0](/5.6/product-stack/tyk-operator/release-notes/operator-1.0) using the Helm Chart, please read the [license requirement](/5.6/product-stack/tyk-operator/release-notes/operator-1.0#breaking-changes) and Tyk Operator [installation and upgrade instructions](/5.6/api-management/automations#install-and-configure-tyk-operator) carefully.
...
<h3 id="dependencies-2.1">Dependencies</h3>
...
<h3 id="Changelog-v2.1.0">Changelog</h3>
#### Added
