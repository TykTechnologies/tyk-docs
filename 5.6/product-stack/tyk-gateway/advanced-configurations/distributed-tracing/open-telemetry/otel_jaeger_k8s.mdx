...
'og:description': "This guide explains how to integrate Tyk Gateway with OpenTelemetry and Jager on Kubernetes to enhance API Observability"
...
For Docker instructions, please refer to [How to integrate with Jaeger on Docker](/5.6/product-stack/tyk-gateway/advanced-configurations/distributed-tracing/open-telemetry/otel_jaeger).
