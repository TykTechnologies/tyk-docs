...
<Note>
[Tyk Gateway 5.2](/5.6/product-stack/tyk-gateway/release-notes/version-5.2.md) now includes OpenTelemetry Tracing. We recommend migrating to OpenTelemetry for better trace insights and more comprehensive support. This change will offer you significant advantages in managing your distributed tracing needs.

Subsequently, we recommend following this guide [Exporting OpenTelemetry Distributed Traces to Jaeger](/5.6/otel_jaeger).
</Note>
