...
Add this field within your [Gateway config file](/5.6/tyk-oss-gateway/configuration):
...
And this field within your [API definition](/5.6/getting-started/key-concepts/what-is-an-api-definition):
...
You can find more information about enabling OpenTelemetry [here](/5.6/product-stack/tyk-gateway/advanced-configurations/distributed-tracing/open-telemetry/open-telemetry-overview).
