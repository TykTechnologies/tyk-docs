...
This guide explains how to configure plugins for Tyk Classic APIs within the [Tyk Classic API definition](/5.6/#tyk-classic-apidef) or via the [API designer](/5.6/#tyk-classic-dashboard) in Tyk Dashboard.

If you’re using the newer Tyk OAS APIs, then check out the [Tyk OAS](/5.6/product-stack/tyk-gateway/advanced-configurations/plugins/api-config/oas) page.
...
The `driver` configuration parameter describes the plugin implementation language. Please refer to the [supported languages](/5.6/plugins/supported-languages#plugin-driver-names) section for list of supported plugin driver names.
...
Use the editor to edit the `custom_middleware` section of the [Tyk Classic API Definition](/5.6/product-stack/tyk-gateway/advanced-configurations/plugins/api-config/classic).
