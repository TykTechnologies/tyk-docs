...
If you’re using the newer Tyk OAS APIs, then check out the [Tyk OAS](/5.6/product-stack/tyk-gateway/advanced-configurations/plugins/bundles/oas) page.
...
Tyk Gateway should be configured for downloading plugin bundles from a secured web server. Please consult the [plugin bundles](/5.6/plugins/how-to-serve-plugins/plugin-bundles) documentation for further details.
