...
[v5.3.4](/5.6/product-stack/tyk-dashboard/release-notes/version-5.3)
...
For licensed deployments (Tyk Cloud, Self Managed including MDCB), please refer to the [release notes of Tyk Dashboard 5.3.0](/5.6/product-stack/tyk-dashboard/release-notes/version-5.3).
...
users - Please refer to the [release notes of Tyk Dashboard 5.3.0](/5.6/product-stack/tyk-dashboard/release-notes/version-5.3).
