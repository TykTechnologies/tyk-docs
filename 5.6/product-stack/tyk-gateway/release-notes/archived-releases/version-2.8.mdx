...
Visit the [looping section](/5.6/advanced-configuration/transform-traffic/looping) for more information.
...
[partitioned policies](/5.6/basic-config-and-security/security/security-policies/partitioned-policies).
