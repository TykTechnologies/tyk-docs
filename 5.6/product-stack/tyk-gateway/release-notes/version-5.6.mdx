...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.6/#Changelog-v5.6.1) below.
...
[changelog](/5.6/#Changelog-v5.6.0) below.

#### Per endpoint Rate Limiting for clients

Building on the [per-endpoint upstream rate
limits](/5.6/getting-started/key-concepts/rate-limiting#api-level-rate-limiting) introduced in Tyk 5.5.0 we have
now added [per-endpoint client
rate limits](/5.6/getting-started/key-concepts/rate-limiting#key-level-rate-limiting). This new feature allows
...
rate limits](/5.6/getting-started/key-concepts/rate-limiting#key-level-rate-limiting). This new feature
