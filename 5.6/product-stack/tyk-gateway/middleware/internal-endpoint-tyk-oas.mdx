...
If you're using the legacy Tyk Classic APIs, then check out the [Tyk Classic](/5.6/product-stack/tyk-gateway/middleware/internal-endpoint-tyk-classic) page.
...
- the [URL rewrite](/5.6/transform-traffic/url-rewriting) middleware has been configured for requests to the `GET /redirect` endpoint
