...
'og:description': "Using the Request Method Transform middleware with Tyk OAS APIs"
...
If you're using the legacy Tyk Classic APIs, then check out the [Tyk Classic](/5.6/product-stack/tyk-gateway/middleware/request-method-tyk-classic) page.
