...
*   Follow the steps provided in this link [Getting started on Red Hat (RHEL / CentOS)](/5.6/tyk-on-premises/redhat-rhel-centos) to install and configure Tyk dependencies.
