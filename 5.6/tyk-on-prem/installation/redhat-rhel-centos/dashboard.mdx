...
*   Follow the steps provided in this link [Getting started on Red Hat (RHEL / CentOS)](/5.6/tyk-on-premises/redhat-rhel-centos.md) to install and configure Tyk dependencies.
...
To set up your [Developer Portal](/5.6/content/tyk-developer-portal.md) follow our Self-Managed [tutorial on publishing an API to the Portal Catalog](/5.6/content/getting-started/tutorials/publish-api.md).
