...
- [Quick Start with PostgreSQL](/5.6/deployment-and-operations/tyk-self-managed/deployment-lifecycle/installations/kubernetes/tyk-helm-tyk-stack-postgresql)
- [Quick Start with MongoDB](/5.6/deployment-and-operations/tyk-self-managed/deployment-lifecycle/installations/kubernetes/tyk-helm-tyk-stack-mongodb)

Or go to [Tyk Stack helm chart](/5.6/product-stack/tyk-charts/tyk-stack-chart) for detailed installation instructions and configuration options.
...
To get started go to [Tyk Operator](/5.6/api-management/automations#automate-api-management-in-kubernetes-environments).
