...
See [SQL configuration](/5.6/content/planning-for-production/database-settings/postgresql.md) for details on installing SQL in a production environment.
</Tab>
</Tabs>
...
- [Dashboard](/5.6/tyk-on-premises/debian-ubuntu/dashboard)
- [Pump](/5.6/tyk-on-premises/debian-ubuntu/analytics-pump)
- [Gateway](/5.6/tyk-on-premises/debian-ubuntu/gateway)
</Tab>
</Tabs>


<Note>
For a production environment, we recommend that the Gateway, Dashboard and Pump are installed on separate machines. If installing multiple Gateways, you should install each on a separate machine. See [Planning for Production](/5.6/planning-for-production) For more details.
</Note>
