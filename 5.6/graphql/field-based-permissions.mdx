...
First, you need to learn [how to create a security policy with the API](/5.6/getting-started/create-security-policy) or [how to create an API Key with the API](/5.6/getting-started/create-security-policy).
