...
From v2.9.3 you can also specify a custom proxy and set the minimum TLS versions and any SSL ciphers within your API definitions. See [Internal Proxy Setup](/5.6/tyk-apis/tyk-gateway-api/api-definition-objects/proxy-settings#internal-proxy-setup) for more details.
