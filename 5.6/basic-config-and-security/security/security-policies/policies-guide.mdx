...
Here you can see the various fields as they are applied to Tyk keys, these are all described in the Keys section of the [Gateway API](/5.6/tyk-gateway-api).
...
[With the Dashboard API](/5.6/getting-started/create-security-policy#tutorial-create-a-security-policy-with-the-api)

[With the Gateway API - Open Source tab](/5.6/getting-started/create-security-policy)

[With the Dashboard](/5.6/getting-started/create-security-policy#tutorial-create-a-security-policy-with-the-dashboard)
