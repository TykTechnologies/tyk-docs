...
'og:description': "How to create user groups and add users to them"
sidebarTitle: "Managing User Groups"
...
Tyk has a flexible [user permissions](/5.6/basic-config-and-security/security/dashboard/user-roles) system that provides Role Based Access Control (RBAC) for your Tyk Dashboard.
...
You can also manage User Groups via our [Dashboard API](/5.6/tyk-apis/tyk-dashboard-api/user-groups). The following functions are available:

* [List all User Groups](/5.6/tyk-apis/tyk-dashboard-api/user-groups#list-user-groups)
* [Get a User Group via the User Group ID](/5.6/tyk-apis/tyk-dashboard-api/user-groups#get-user-group)
* [Add a User Group](/5.6/tyk-apis/tyk-dashboard-api/user-groups#add-user-group)
* [Update a User Group](/5.6/tyk-apis/tyk-dashboard-api/user-groups#update-user-group)
* [Delete a User Group](/5.6/tyk-apis/tyk-dashboard-api/user-groups#delete-user-group)
