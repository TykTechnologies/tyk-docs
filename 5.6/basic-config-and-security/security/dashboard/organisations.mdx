...
Additional organizations can be created and managed using the [Dashboard Admin API](/5.6/dashboard-admin-api/organisations).
...
Self-Managed users should use [API tagging](/5.6/advanced-configuration/manage-multiple-environments/with-tyk-on-premises) and enforce a tagging standard across all organizations.
