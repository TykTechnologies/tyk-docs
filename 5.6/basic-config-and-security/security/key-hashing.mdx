...
See the [Gateway Configuration Options](/5.6/tyk-oss-gateway/configuration) for more details.
...
See the Keys section of [Tyk Gateway API Swagger page](/5.6/tyk-gateway-api) for more details.