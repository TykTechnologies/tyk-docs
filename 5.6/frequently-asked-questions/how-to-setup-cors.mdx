...
To learn more, look for `CORS.options_passthrough` [here](/5.6/tyk-apis/tyk-gateway-api/api-definition-objects/cors).
...
The same can happen with Allowed Origins and Allowed Methods. Read more about it [here](/5.6/tyk-apis/tyk-gateway-api/api-definition-objects/cors).
