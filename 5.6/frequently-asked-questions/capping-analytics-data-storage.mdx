...
[Time Based Caps](/5.6/tyk-stack/tyk-manager/analytics/capping-analytics-data-storage#a-name-time-based-cap-a-time-based-cap)

[Size Based Caps](/5.6/tyk-stack/tyk-manager/analytics/capping-analytics-data-storage#a-name-size-based-cap-a-size-based-cap)
