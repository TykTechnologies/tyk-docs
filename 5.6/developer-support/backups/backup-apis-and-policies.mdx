...
'og:description': "How to backup APIs and Policies with Tyk Dashboard"
sidebarTitle: "Backup APIs and Policies"
...
If you are using Self Managed deployment then we recommend that you use [Tyk Sync](/5.6/api-management/automations#synchronize-tyk-environment-with-github-repository) to backup your Tyk APIs and policies. 
