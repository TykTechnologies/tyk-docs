...
*FIPS compliance* means that the *FIPS Tyk Product* only uses FIPS 140-2 approved cryptographic [algorithms](/5.6/#fips-compliant-cryptographic-operations)
