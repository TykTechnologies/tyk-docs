...
Which strategy do you intend to use?
  ...
  - If following the [Blue-Green upgrade](/5.6/developer-support/upgrading-tyk/preparations/upgrade-strategies#blue-green) strategy, has the green environment been configured and verified as production-ready?
  - If pursuing the [Rolling upgrade](/5.6/developer-support/upgrading-tyk/preparations/upgrade-strategies#rolling-upgrade) strategy, do all Tyk components have a second instance?
...
Have backups been performed?
  ...
  - Backup guide: Have you checke our [comprehensive guide for backing up Tyk](/5.6/frequently-asked-questions/how-to-backup-tyk)?

## Go plugins
Do you use custom go plugins with your APIs?

  - Go plugin must be [recompiled](/5.6/developer-support/upgrading-tyk/go-plugins) for the new version.
...
Use the [Upgrade Guides ToC](/5.6/upgrading-tyk#upgrade-guides-toc) to choose the appropriate upgrade guide for
your platform.