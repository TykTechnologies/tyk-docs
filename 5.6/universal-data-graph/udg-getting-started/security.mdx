...
For this tutorial we'll mitigate these risks using `Query Depth Limit` but you can also use common strategies like rate limiting and throttling, which you can read more about [here](/5.6/../../../getting-started/key-concepts/rate-limiting/)
...
Although we can directly create keys by selecting this API but we'll use policy as it will make it easier to update keys for this API in future. You can read more about policies [here](/5.6/../../../getting-started/key-concepts/what-is-a-security-policy/)
