...
Global headers now have access to all [request context variables](/5.6/context-variables).
...
Data source headers now have access to all [request context variables](/5.6/context-variables).
