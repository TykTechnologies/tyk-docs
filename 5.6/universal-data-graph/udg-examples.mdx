...
We offer 3 ways of importing an example into Tyk:
 - Using [tyk-sync](/5.6/api-management/automations#synchronize-api-configurations-with-github-actions)
 - Manually import via [Dashboard API Import](/5.6/getting-started/import-apis)
- Using Tyk Dashboard to browse and import the examples directly

## Import via tyk-sync

Please follow the [tyk-sync documentation](/5.6/api-management/automations#examples-publish-command) to learn more about this approach.
...
You can find more detailed instructions in the [Dashboard API Import documentation section](/5.6/getting-started/import-apis).
