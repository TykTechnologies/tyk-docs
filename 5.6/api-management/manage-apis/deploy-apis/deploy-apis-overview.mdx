...
Learn more:
* [Tutorial: Create an API in File-based Mode](/5.6/getting-started/create-api#tutorial-create-an-api-in-file-based-mode)
...
Learn more:
* [Tutorial: Create an API with the Dashboard](/5.6/getting-started/create-api#tutorial-create-an-api-with-the-dashboard)
...
Learn more:
- [Dashboard API](/5.6/getting-started/key-concepts/dashboard-api)
- [Gateway API](/5.6/api-management/oss/gateway-api)
...
- [Using Tyk Operator to enable GitOps with Tyk](/5.6/getting-started/key-concepts/gitops-with-tyk)
