...
If you've successfully completed the [Quick Start](/5.6/getting-started/quick-start), congratulations! This page is the **next step** in your Tyk journey and designed for users who are ready to play with Tyk, learn more about Tyk's capabilities, services, and integration options.
...
1. [tyk-demo](/5.6/getting-started/quick-start/tyk-demo) -  *Docker* based
2. [tyk-k8s-demo](/5.6/getting-started/quick-start/tyk-k8s-demo) - *Kubernetes* based. 