...
Depending on your configuration, these requests can be processed [automatically]() or require [manual approval](/5.14/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/approve-requests#manual-approval-workflow).
...
For more information, refer to this [guide](/5.14/tyk-developer-portal/direct-access-flow)
...
The manual approval workflow provides API Owners with oversight of all API access. When an API Consumer completes an [access request](/5.14/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/approve-requests#requesting-access-to-an-api-product), API Owners receive notification of pending request via [email](/5.14/product-stack/tyk-enterprise-developer-portal/getting-started/setup-email-notifications) and should then:
...
For trusted users or specific API Products, you can enable automatic approval in the [subscription Plan](/5.14/portal/api-plans#auto-approve-provisioning-requests).
...
If the [email service](/5.14/product-stack/tyk-enterprise-developer-portal/getting-started/setup-email-notifications) is configured, then:
...
For more information, refer to this [guide](/5.14/tyk-developer-portal/single-credentials-multiple-api-products)
