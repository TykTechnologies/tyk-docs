...
<ButtonLeft href="https://raw.githubusercontent.com/TykTechnologies/tyk-docs/refs/heads/production/swagger/5.14/dashboard-swagger.yml" color="green" content="Download Swagger" />
...
The [Tyk Dashboard API](/5.14/tyk-dashboard-api) is a superset of the Tyk Gateway API, enabling (almost) all of the core features and adding many more. The Dashboard API is also more granular and supports [Role Based Access Control](/5.14/platform-management/user-permissions) (RBAC) on both a multi-tenant, and user basis.
