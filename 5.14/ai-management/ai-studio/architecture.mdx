...
To know more about the AI Studio component, see the [AI Studio Documentation](/5.14/ai-management/ai-studio/ai-studio).
...
To know more about the Edge Gateway, see the [Edge Gateway Architecture](/5.14/ai-management/ai-studio/proxy) documentation.