...
This page is the end-to-end reference. For filter script syntax, see [Filters](/5.14/ai-management/ai-studio/filters#compliance-event-reporting).
...
See [Filters](/5.14/ai-management/ai-studio/filters#compliance-event-reporting) for conditional emission, response-filter examples, and metadata conventions.
...
In a hub-spoke deployment, filter scripts run on the [Edge Gateway](/5.14/ai-management/ai-studio/proxy), but compliance events live on the control plane. The propagation path is:
...
See [Analytics & Monitoring](/5.14/ai-management/ai-studio/analytics#prometheus-and-opentelemetry-metrics) for the full metric catalog.
...
- [Filters](/5.14/ai-management/ai-studio/filters#compliance-event-reporting): script-level syntax and examples.
- [Analytics & Monitoring](/5.14/ai-management/ai-studio/analytics): the surrounding analytics pipeline and the full metric catalog.
- [Edge Gateway](/5.14/ai-management/ai-studio/proxy): hub-spoke architecture and the analytics pulse that carries edge events to control.
- [Tyk AI Studio release notes](/5.14/developer-support/release-notes/ai-studio): the `AnalyticsHandler` context change and related v2.1.0 SDK updates.
