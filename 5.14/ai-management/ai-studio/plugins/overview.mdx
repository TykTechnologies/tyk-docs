...
[Learn more →](/5.14/ai-management/ai-studio/plugins/edge-gateway)
...
[Learn more →](/5.14/ai-management/ai-studio/plugins/studio-ui)
...
[Learn more →](/5.14/ai-management/ai-studio/plugins/studio-agent)
...
[Learn more →](/5.14/ai-management/ai-studio/plugins/object-hooks)
...
Plugins can also run as standalone gRPC services in a sidecar or elsewhere on the network, rather than as local sub-processes. See [Plugin Deployment](/5.14/ai-management/ai-studio/plugins/deployment) for details.
...
[Learn more about Service API →](/5.14/ai-management/ai-studio/plugins/service-api)
...
[Learn more about deployment →](/5.14/ai-management/ai-studio/plugins/deployment)
...
[Learn more about manifests →](/5.14/ai-management/ai-studio/plugins/manifests)
...
5. Build and test with `file://` deployment (see [Development Workflow Guide](/5.14/ai-management/ai-studio/plugins/development-workflow) for fast iteration)
6. Deploy with `grpc://` or `oci://` for production

**Pro tip**: Use the reload API (`POST /api/v1/plugins/{id}/reload`) to test changes instantly without reinstalling. See the [Development Workflow Guide](/5.14/ai-management/ai-studio/plugins/development-workflow) for the fastest iteration loop.
