...
Catalogs in Tyk AI Studio are collections of AI resources ([LLM providers](/5.14/ai-management/ai-studio/llm-management), [Data sources](/5.14/ai-management/ai-studio/datasources-rag), and [Tools](/5.14/ai-management/ai-studio/tools)) that you can assign to specific [Teams](/5.14/ai-management/ai-studio/teams) to easily manage access. They act as the bridge between the raw AI capabilities and the users who need to consume them.
...
Catalogs do not grant access on their own. To make the resources within a catalog available to [Users](/5.14/ai-management/ai-studio/users), the catalog must be assigned to a [Team](/5.14/ai-management/ai-studio/teams).
...
7. Once created, navigate to the [Teams](/5.14/ai-management/ai-studio/teams) section to assign this catalog to a Team.
...
9. Once created, navigate to the [Teams](/5.14/ai-management/ai-studio/teams) section to assign this catalog to a Team.
