...
Before creating an App, ensure that an LLM provider is already configured and activated in the proxy. If not, a Studio Administrator must first [create and enable an LLM provider](/5.14/ai-management/ai-studio/llm-management#how-to-create-a-llm-provider).
...
For more information on the approval process, see the [Admin App Management documentation](/5.14/ai-management/ai-studio/admin-apps).
</Note>
...
- **[Tutorial: Create an AI CLI App](/5.14/ai-management/ai-studio/ai-cli-app)**
