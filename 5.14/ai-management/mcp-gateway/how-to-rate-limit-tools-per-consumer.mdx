...
For the full picture of how rate limits compose across the middleware and policy layers, see [MCP proxy policies](/5.14/ai-management/mcp-gateway/policies).
