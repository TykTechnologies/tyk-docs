...
We are going to set up Tyk with a WebSocket proxy. Set up Tyk using our Docker [guide](/5.14/tyk-self-managed/install/docker).
...
See the [Access an API](/5.14/api-management/gateway-config-managing-classic#access-an-api) tutorial for details on adding an Authentication Token to your APIs.
