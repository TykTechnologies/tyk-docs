...
Get Tyk Open Source Gateway running locally with Docker in a few steps. For other deployment options, see the [installation options](/5.14/apim/open-source/installation) page.
...
- [Create your first API](/5.14/api-management/gateway-config-managing-oas#creating-an-api)
- [Explore installation options](/5.14/apim/open-source/installation)
