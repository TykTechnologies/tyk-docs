...
<ButtonLeft href="https://raw.githubusercontent.com/TykTechnologies/tyk-docs/refs/heads/production/swagger/5.14/dashboard-admin-swagger.yml" color="green" content="Download Swagger" />
...
Self-Managed users should use [API tagging](/5.14/api-management/api-sharding#api-tagging-with-on-premises) and enforce a tagging standard across all organizations.
