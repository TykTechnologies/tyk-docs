...
| Method           | Description                        |
| :---------------- | :---------------------------------- |
| **[Docker](/5.14/#install-on-docker)**       | Run Tyk Sync in a container |
| **[Packagecloud](/5.14/#install-via-package-manager-packagecloud)** | Hosts packages for linux distributions |
| **[Homebrew](/5.14/#install-on-macos-homebrew)** | Package manager for macOS |
...
<Note>
Homebrew installation is available from Tyk Sync **v2.2.0** onwards. For earlier versions, use [Docker](/5.14/#install-on-docker) instead.
</Note>
