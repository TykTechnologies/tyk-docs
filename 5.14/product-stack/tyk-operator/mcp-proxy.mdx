...
| :---- | :--- | :---------- |
| `contextRef` | object (optional) | Reference (`name`, `namespace`) to an [OperatorContext](/5.14/api-management/automations/operator#multi-tenancy-in-tyk) used when reconciling this resource. Use this for multi-tenant setups. |
...
For background on the underlying gateway feature, see the [MCP proxy policies documentation](/5.14/ai-management/mcp-gateway/policies).
