...
- [Enterprise Edition License](/5.14/apim#licensing)
...
Tyk Gateway has a [dependency](/5.14/planning-for-production/database-settings#redis) on Redis. Follow the steps provided by Red Hat to make the installation of Redis, conducting a [search](https://access.redhat.com/search/?q=redis) for the correct version and distribution.

#### Storage Database

Tyk Dashboard has a dependency on a storage database that can be [PostgreSQL](/5.14/planning-for-production/database-settings#postgresql) or [MongoDB](/5.14/planning-for-production/database-settings#mongodb-sizing-guidelines).

<Tabs>

<Tab title="PostgreSQL">

Check the PostgreSQL supported [versions](/5.14/planning-for-production/database-settings#postgresql). Follow the steps provided by [PostgreSQL](https://www.postgresql.org/download/linux/redhat/) to install it.
...
Check the MongoDB supported [versions](/5.14/planning-for-production/database-settings#mongodb-sizing-guidelines). Follow the steps provided by [MongoDB](https://www.mongodb.com/docs/manual/tutorial/install-mongodb-on-red-hat/) to install it.
...
*   Follow the steps provided in this link [Getting started on Red Hat (RHEL / CentOS)](/5.14/#install-tyk-on-redhat-rhel-centos) to install and configure Tyk dependencies.
...
10. **Login to the Dashboard**
    ...
    **Configure your Developer Portal**
    ...
    To set up your [Developer Portal](/5.14/portal/overview/intro) follow our Self-Managed [tutorial on publishing an API to the Portal Catalog](/5.14/getting-started/tutorials/publish-api).
...
See [SQL configuration](/5.14/planning-for-production/database-settings#postgresql) for details on installing SQL in a production environment.
</Tab>
</Tabs>
...
**Prerequisites**
- Have MongoDB/SQL and Redis installed - follow the guide for [installing databases on Debian/Ubuntu](/5.14/#install-tyk-on-debian-or-ubuntu).
...
Follow the [Gateway installation instructions](/5.14/#using-shell-7) to connect to your Dashboard instance before you continue on to step 4.
