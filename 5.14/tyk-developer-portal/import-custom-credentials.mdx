...
| :------------- | :---------------------- | :------------------------- |
| Developer Portal | Available since [v1.12.0](/5.14/developer-support/release-notes/portal#1-12-0-release-notes) | Enterprise |
...
2. **Working Tyk Environment:** You need access to a running Tyk instance. For setup instructions using Docker, please refer to the [Tyk Getting Started Guide](/5.14/getting-started/quick-start).
3. Developer Portal Setup with
    ...
    4. [API Products](/5.14/portal/api-products), [Plans](/5.14/portal/api-plans) and [Catalogue](/5.14/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/manage-catalogues) already created and published in the portal.
4. The custom token or credential value you want to import.

## What we will do

1. Create an [application](/5.14/portal/developer-app) in the Developer Portal for the user.
2. Add a custom credential to that app.
4. Select one or more [API Product](/5.14/portal/api-products) and the [Plan](/5.14/portal/api-plans) to associate with that credential.
