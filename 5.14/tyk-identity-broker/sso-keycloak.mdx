...
description: "Learn how to configure Single Sign-On (SSO) for Tyk Dashboard or Tyk Developer Portal using Keycloak via OpenID Connect (OIDC), with worked examples for Dashboard and Portal."
keywords: "Tyk Identity Broker, TIB, SSO, Single Sign-On, Keycloak, OIDC, OpenID Connect, Authentication"
sidebarTitle: "Keycloak"
canonical: "https://tyk.io/docs/tyk-identity-broker/sso-keycloak"
---
...
Before configuring your IdP and TIB profile, pick the guide for your use case: [Dashboard SSO](/5.14/tyk-identity-broker/dashboard-sso), [Portal SSO](/5.14/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/enable-sso), or [Issuing Tokens via TIB](/5.14/api-management/access-control/sessions-and-keys/issuing-tokens-via-tib). Each page explains the `ActionType`, `ReturnURL`, and `IdentityHandlerConfig` fields for that use case.
...
```
   ...
   <img src="/img/keycloak-sso/realm-discovery-endpoint.png" alt="Keycloak discovery endpoint" />
