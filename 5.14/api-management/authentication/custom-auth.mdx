...
To learn more about using Tyk Golang Plugins, go [here](/5.14/api-management/plugins/golang)
...
* See [Custom Authentication with a Python plugin](/5.14/api-management/plugins/rich-plugins#custom-authentication-plugin-tutorial) for a detailed example of a custom Python plugin.
* See [JavaScript Middleware](/5.14/api-management/plugins/javascript#) for more details on using JavaScript Middleware. 
