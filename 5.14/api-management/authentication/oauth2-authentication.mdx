...
- **Tyk OAuth 2.0**: Tyk Gateway acts as the authorization server, issuing and managing tokens itself. See [Tyk OAuth 2.0](/5.14/api-management/authentication/oauth-2).
...
Token exchange is Enterprise Edition only. For full configuration details, see [Token exchange](/5.14/api-management/authentication/token-exchange).
