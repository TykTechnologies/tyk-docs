...
<Note>
While you can configure `access_rights` directly on a Session object, it is highly recommended to manage these settings via [Policies](/5.14/api-management/access-control/policies/applying-policies) for easier management at scale.
</Note>
