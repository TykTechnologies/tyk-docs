...
See [Configuring Application and Access Logs](/5.14/api-management/logs#configuring-application-and-access-logs) for details of these and how to configure them.
...
[Event log handlers](/5.14/api-management/gateway-events#logging-api-events) can be registered against Gateway events to write a log entry each time a specific event fires, such as an authentication failure or rate limit being exceeded.
