...
**Learn more:**
* [Create an API in file-based mode](/5.14/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
**Learn more:**
* [Create an API with the Dashboard](/5.14/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
**Learn more:**
- [Dashboard API](/5.14/tyk-dashboard-api)
- [Gateway API](/5.14/tyk-gateway-api)
...
**Learn more:**
- [Tyk Sync](/5.14/api-management/automations/sync)
...
**Learn more:**
- [Tyk Operator](/5.14/api-management/automations/operator#what-is-tyk-operator)
- [Using Tyk Operator to enable GitOps](/5.14/api-management/automations)
