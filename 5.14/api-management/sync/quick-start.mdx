...
First, let's set up a Tyk Demo environment with some prebuilt APIs. Follow our Docker [guide](/5.14/tyk-self-managed/install/docker).
...
Follow this [guide](/5.14/product-stack/tyk-sync/installing-tyk-sync) to install Tyk Sync. You can either use the Docker image or download the binary directly. We will be using the Docker image for this quick start.
