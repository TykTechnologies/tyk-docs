...
order: 2
sidebarTitle: "Environment Variables and Config"
canonical: "https://tyk.io/docs/tyk-dashboard/configuration"
---

import DashboardConfig from '/snippets/5.14/dashboard-config.mdx';
...
To understand how the environment variables notation works, see [Environment Variables](/5.14/tyk-oss-gateway/configuration).
