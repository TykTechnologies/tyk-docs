...
This feature is built on Tyk Gateway's OpenTelemetry integration. See the [OpenTelemetry documentation](/5.14/api-management/traces) for configuration options and sampling strategies.
...
- [Datadog](/5.14/#configure-providers)
- [Dynatrace](/5.14/#configure-providers)
- [New Relic](/5.14/#configure-providers)
- [Elastic](/5.14/#configure-providers)
- [Custom](/5.14/#configure-providers)
...
2. In the telemetry export section, enable the types you want:
    ...
    - **Enable Metrics**: Enable gateway metrics export (requires Gateway v5.13.0 or later). See [Default Metrics Exported](/5.14/#default-metrics-exported) for what is included.
