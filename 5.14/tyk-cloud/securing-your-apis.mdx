...
* [Adding APIs](/5.14/api-management/gateway-config-managing-classic#create-an-api) to Tyk, including REST and GraphQL APIs
* Applying Quotas and Rate limits via [Security Policies](/5.14/api-management/gateway-config-managing-classic#secure-an-api) and [Keys](/5.14/api-management/gateway-config-managing-classic#access-an-api)
* [Securing](/5.14/api-management/security-best-practices#securing-apis-with-tyk) your APIs
* Viewing granular [Analytics](/5.14/api-management/dashboard-analytics#traffic-analytics) for your Tyk managed APIs
* [Transform traffic](/5.14/api-management/traffic-transformation) with the Tyk API Designer
* Add integration options such as [SSO](/5.14/tyk-identity-broker/dashboard-sso) and [3rd Party Identity Providers](/5.14/tyk-identity-broker/overview)
* [Adding Segment Tags](/5.14/tyk-cloud/troubleshooting-support)
