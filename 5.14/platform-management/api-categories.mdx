...
API categories can be added and removed from APIs within the [API Designer](/5.14/#api-designer), via the [Tyk Dashboard API](/5.14/#tyk-dashboard-api), or via [Tyk Operator](/5.14/api-management/automations/operator#what-is-tyk-operator).
...
### Tyk Dashboard API
The [Tyk Dashboard API](/5.14/tyk-dashboard-api) provides endpoints to manage categories directly, if you are not using the API Designer.
...
You can manage categories using Tyk Operator custom resources. Please refer to [Tyk Operator](/5.14/api-management/automations/operator#api-categories) documentation to see how to manage API categories for Tyk OAS APIs and Tyk Classic APIs.
