...
Tyk has a flexible [user permissions](/5.14/platform-management/user-permissions) system that provides Role Based Access Control (RBAC) for your Tyk Dashboard.
