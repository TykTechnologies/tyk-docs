...
**5.13.x is our current LTS release. Please refer to this [page](/5.14/developer-support/release-types/long-term-support) for exact timelines**
...
* The FIPS Products use Go 1.25's native FIPS implementation to provide FIPS 140-3 validated cryptographic operations. See [Go FIPS 140-3 documentation](/5.14/#) for more details.
...
No. Tyk’s products have not been submitted to a NIST testing laboratory. They are FIPS-compliant, by Tyk’s definition. See [What "FIPS-compliant" means](/5.14/#what-fips-compliant-means) for further information.
</Accordion>
