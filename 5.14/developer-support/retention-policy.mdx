...
<Note>
This is a snapshot at the time of this notice. Retention floors move as new releases ship. See [How Retention Windows Are Calculated](#how-retention-windows-are-calculated) for the ongoing formula.
</Note>
