...
[section](/5.14/portal/customization/pages#edit-page-content)
...
- [Template Data](/5.14/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/5.14/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/5.14/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/5.14/#analytics)
- [Application Create](/5.14/#application-create)
- [Application Detail](/5.14/#application-detail)
- [Blogs](/5.14/#blogs)
- [Blog Detail](/5.14/#blog-detail)
- [Cart Checkout](/5.14/#cart-checkout)
- [Organization User Detail](/5.14/#organization-user-detail)
- [Organization User Edit](/5.14/#organization-user-edit)
- [Organization Users List](/5.14/#organization-users-list)
- [Product Detail](/5.14/#product-detail)
- [Product OAS Documentation](/5.14/#product-oas-documentation)
...
| `{{ .MarkdownContent }}` | Markdown content (see [Markdown reference](/5.14/portal/customization/markdown)) |
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/5.14/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/5.14/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/5.14/portal/private/users">Cancel</a>
...
<div class="product-detail">
  ...
  <div class="related-post">
    <h3><a href="/5.14/{{ .Path }}">{{ .Title }}</a></h3>
    <img src="{{ .HeaderImage.URL }}" alt="{{ .Title }}">
    <p>{{ .Lede }}</p>
  </div>
  {{ end }}
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/5.14/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/5.14/#cancreateorganisation)
- [Clients](/5.14/#clients)
- [Current User](/5.14/#currentuser)
- [FeaturedProducts](/5.14/#featuredproducts)
- [FilterUserInvites](/5.14/#filteruserinvites)
- [FormatTime](/5.14/#formattime)
- [GetCart](/5.14/#getcart)
- [GetCatalogueList](/5.14/#getcataloguelist)
- [GetCataloguesForProduct](/5.14/#getcataloguesforproduct)
- [GetClientDescription](/5.14/#getclientdescription)
- [GetClientName](/5.14/#getclientname)
- [GetMenus](/5.14/#getmenus)
- [GetProducts](/5.14/#getproducts)
- [IsPortalDisabled](/5.14/#isportaldisabled)
- [IsPortalPrivate](/5.14/#isportalprivate)
- [ProductDocRenderer](/5.14/#productdocrenderer)
- [ProviderUpstreamURL](/5.14/#providerupstreamurl)
- [SplitStrings](/5.14/#splitstrings)
- [TruncateString](/5.14/#truncatestring)
- [TypeOfCredential](/5.14/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/5.14/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/5.14/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/5.14/portal/customization/menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/5.14/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/5.14/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/5.14/portal/customization/email-notifications)
for additional detail on email notifications sent by the portal.


### Available Email Templates

- [Access Request Approve/Reject](/5.14/#access-request-approvereject)
- [Access Request Submitted](/5.14/#access-request-submitted)
- [Activate and Deactivate](/5.14/#activate-and-deactivate)
- [Key Expiration Warning](/5.14/#key-expiration-warning)
- [Key Expired](/5.14/#key-expired)
- [New User Request](/5.14/#new-user-request)
- [Organization Approve](/5.14/#organization-approve)
- [Organization Reject](/5.14/#organization-reject)
- [Organization Request](/5.14/#organization-request)
- [Reset Password](/5.14/#reset-password)
- [Targeted Invite](/5.14/#targeted-invite)
- [Welcome User](/5.14/#welcome-user)
