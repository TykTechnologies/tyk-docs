...
sidebarTitle: "Themes"
canonical: "https://tyk.io/docs/portal/customization/themes"
---
  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="text-container">
        ...
        <a href="/5.14/{{.blocks.HeaderButtonLink.Content}}" class="btn btn-primary">{{.blocks.HeaderButtonLabel.Content}}</a>
    </div>
….
```
...
If the output of the above command is empty, proceed to step 4 to add the `portal-default-theme`.
...
2. Upload the theme package that is created in the previous step to the portal. You can use the portal's [Admin dashboard](/5.14/portal/customization/themes#create-a-theme) or the [admin API](/5.14/product-stack/tyk-enterprise-developer-portal/api-documentation/tyk-edp-api) to do it.

3. Finally, you need to [activate](/5.14/portal/customization/themes#activate-a-theme) the theme so that it will be applied to the portal.
