...
We suggest you read the [portal concepts](/5.14/portal/overview/concepts) first. If you've already done that, we will show you an example on how to:
...
<html lang="en">
 ...
 <head>
   ...
   <title>{{ if .page}} {{.page.Title}} {{else}} Developer Portal {{end}}</title>
    ...
    {/* Bootstrap core CSS */}
    <link href="/5.14/system/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="/5.14/assets/stylesheets/fonts.css" rel="stylesheet">
    <link href="/5.14/assets/stylesheets/main.css" rel="stylesheet">
...
3. Edit the page content within the existing content blocks. Each content block can be switched to Markdown individually. See the [Markdown reference](/5.14/portal/customization/markdown) for supported features and limitations.
