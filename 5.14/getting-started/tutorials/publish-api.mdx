...
import CreatePortalEntryInclude from '/snippets/5.14/create-portal-entry-include.mdx';
import LegacyClassicPortalApi from '/snippets/5.14/legacy-classic-portal-api.mdx';

<LegacyClassicPortalApi/>

This is for the closed source [Tyk Developer Portal](/5.14/portal/overview/intro) only
