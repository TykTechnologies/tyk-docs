...
1. **[TCP Proxy](/5.8/key-concepts/tcp-proxy)**

2. **[gRPC](/5.8/key-concepts/grpc-proxy)**

3. **[Server-Sent Events (SSE)](/5.8/advanced-configuration/sse-proxy)**

4. **[WebSockets](/5.8/advanced-configuration/websockets)**