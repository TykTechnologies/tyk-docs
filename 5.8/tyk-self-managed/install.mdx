...
Check [Tyk Control plane](/5.8/api-management/mdcb) for more configuration details.
...
10. **Login to the Dashboard**
    ...
    **Configure your Developer Portal**
    ...
    To set up your [Developer Portal](/5.8/portal/overview/intro) follow our Self-Managed [tutorial on publishing an API to the Portal Catalog](/5.8/getting-started/tutorials/publish-api).
