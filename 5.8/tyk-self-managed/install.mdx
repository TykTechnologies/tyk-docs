...
canonical: "https://tyk.io/docs/5.8/tyk-self-managed/install"
---
...
For those who need more deployment flexibility, Tyk Cloud also supports a [Hybrid Gateway](/5.8/tyk-cloud/environments-deployments/hybrid-gateways) option. In this setup, the control plane remains hosted and managed by Tyk on AWS, while the gateways can be deployed on your preferred cloud provider or on-premises environment—allowing you to meet data locality and compliance needs without sacrificing control.
