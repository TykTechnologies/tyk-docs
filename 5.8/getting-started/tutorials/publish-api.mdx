---
canonical: https://tyk.io/docs/getting-started/tutorials/publish-api
description: Publishing your API in the Tyk Developer Portal
keywords: Tyk Tutorials, Getting Started, Publish API, Tyk Cloud, Tyk Self-Managed,
  Developer Portal
...
import CreatePortalEntryInclude from '/snippets/5.8/create-portal-entry-include.mdx';
...
This is for the closed source [Tyk Developer Portal](/5.8/portal/overview/intro) only
