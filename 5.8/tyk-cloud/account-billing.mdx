...
* The available [Tyk Cloud Plans](/5.8/tyk-cloud/account-billing#select-a-payment-plan)
...
If your free trial ends without you upgrading, your account enters what we call [retirement](/5.8/tyk-cloud#glossary).
...
* Select a new [plan](/5.8/tyk-cloud/account-billing#select-a-payment-plan) from our list
...
Your plan will go into [retirement](/5.8/tyk-cloud#glossary) in the following scenarios:
