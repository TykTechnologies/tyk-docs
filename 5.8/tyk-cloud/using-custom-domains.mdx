---
canonical: https://tyk.io/docs/tyk-cloud/using-custom-domains
description: Learn how to set up custom domains for Tyk Cloud Control Planes and Cloud
  Data Planes.
keywords: Custom Domains, Tyk Cloud, Cloud Data Plane, Control Plane
