...
Environments are used to group your [Control Plane](/5.8/tyk-cloud#glossary) and [Cloud Data Planes](/5.8/tyk-cloud#glossary) into logical groups. For example you may want to create environments that reflect different departments of your organization.


<Note>
The number of Environments you can create is determined by your [plan](/5.8/tyk-cloud/account-billing#select-a-payment-plan)
</Note>


## Prerequisites

The following [user roles](/5.8/tyk-cloud/teams-users#assign-user-roles) can perform Environment Admin tasks:
