---
canonical: https://tyk.io/docs/tyk-apis/tyk-portal-api/portal-documentation
description: This page details the API endpoint used for publishing APIs to Tyk classic
  Dev Portal. API platform teams and API owners can use this endpoint to integrate
  their APIs, making them visible and accessible to developers.
...
This page describes the endpoints to create [catalog](/5.8/#catalog) and [Swagger documentation](/5.8/#documentation) for your API.
