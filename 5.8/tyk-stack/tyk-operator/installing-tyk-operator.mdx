...
Tyk Operator needs a [user credential](/5.8/api-management/automations/operator#operator-user) to connect with
...
You can configure [Tyk Operator as Ingress Controller](/5.8/product-stack/tyk-operator/tyk-ingress-controller) so
