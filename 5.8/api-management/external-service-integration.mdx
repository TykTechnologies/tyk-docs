...
1. [Login with 3rd party social providers](/5.8/api-management/single-sign-on-social-idp)
2. [Login with any IdP that supports OIDC](/5.8/api-management/single-sign-on-oidc)
3. [Login with any IdP that supports SAML](/5.8/api-management/single-sign-on-saml)
3. [Login with LDAP](/5.8/api-management/single-sign-on-ldap)
