...
We offer 3 ways of importing an example into Tyk:
 - Using [tyk-sync](/5.8/api-management/automations/sync#synchronize-api-configurations-with-github-actions)
...
Please follow the [tyk-sync documentation](/5.8/api-management/automations/sync#examples-publish-command) to learn more about this approach.
