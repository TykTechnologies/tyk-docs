...
<Note>
For seamless deployments, take a look at multi-version [plugin support](/5.8/tyk-cloud#configure-plugins) to enable zero downtime deployments of your Tyk Gateway installs
</Note>
