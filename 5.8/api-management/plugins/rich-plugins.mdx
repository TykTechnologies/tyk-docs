...
canonical: "https://tyk.io/docs/5.8/api-management/plugins/rich-plugins"
---
...
The `ResponseObject` exists within an [object](/5.8/#coprocess-object) for response hooks. The fields are populated with the upstream HTTP response data. All the field contents can be modified.
