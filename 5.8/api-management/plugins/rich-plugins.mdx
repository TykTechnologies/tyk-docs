...
Example tutorials are available that explain how to generate the protobuf bindings and implement a server for [Java](/5.8/api-management/plugins/rich-plugins#create-a-request-transformation-plugin-with-java), [.NET](/5.8/api-management/plugins/rich-plugins#create-custom-authentication-plugin-with-net) and [NodeJS](/5.8/api-management/plugins/rich-plugins#create-custom-authentication-plugin-with-net).
...
- Visit tutorial guides that explain how to implement a [Java](/5.8/api-management/plugins/rich-plugins#create-a-request-transformation-plugin-with-java), [.NET](/5.8/api-management/plugins/rich-plugins#create-custom-authentication-plugin-with-net) and [NodeJS](/5.8/api-management/plugins/rich-plugins#create-custom-authentication-plugin-with-net) gRPC server.
