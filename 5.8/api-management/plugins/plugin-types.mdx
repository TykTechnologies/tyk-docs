...
- [Go custom authentication plugin](/5.8/api-management/automations/operator#custom-plugin-auth-go)
- [gRPC custom authentication plugin](/5.8/api-management/automations/operator#custom-plugin-auth-grpc)
