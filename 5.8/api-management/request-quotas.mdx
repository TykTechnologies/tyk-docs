...
canonical: "https://tyk.io/docs/5.8/api-management/request-quotas"
---
...
<h4 className="policy-setup">Configure Policy and Quota</h4>
...
Refer to the [Tyk Gateway Configuration Reference](/5.8/tyk-oss-gateway/configuration#enforce_org_quotas) for more details on this setting.
...
Refer to the [Tyk OAS API Definition reference](/5.8/api-management/gateway-config-tyk-oas#global) for details.
...
Refer to the [Tyk Classic API Definition reference](/5.8/api-management/gateway-config-tyk-classic) for details.
...
Refer this [documentation](/5.8/#configuration-options).
</Accordion>
...
Refer this [documentation](/5.8/#api-level-configuration).
</Accordion>
