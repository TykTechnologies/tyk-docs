...
canonical: "https://tyk.io/docs/5.8/api-management/traffic-transformation/response-body"
---

<h2 className="response-body-overview">Overview</h2>
...
<h2 className="response-body-using-tyk-oas">Using Tyk OAS</h2>
...
<h2 className="response-body-using-classic">Using Classic</h2>
The [response body transform](/5.8/api-management/traffic-transformation/response-body) middleware provides a way to modify the payload of API responses before they are returned to the client.
...
<h4 className="gw-lt-5-3-example">Tyk Gateway < 5.3.0 Example</h4>
