...
canonical: "https://tyk.io/docs/5.8/api-management/traffic-transformation/internal-endpoint"
---

<h2 className="internal-endpoint-overview">Overview</h2>
...
<h2 className="internal-endpoint-using-tyk-oas">Using Tyk OAS</h2>
...
<h2 className="internal-endpoint-using-classic">Using Classic</h2>
The [Internal Endpoint](/5.8/#internal-endpoint-overview) middleware instructs Tyk Gateway not to process external requests to the endpoint (which is a combination of HTTP method and path). Internal requests from other APIs will be processed.
