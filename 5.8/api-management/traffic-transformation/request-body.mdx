...
canonical: "https://tyk.io/docs/5.8/api-management/traffic-transformation/request-body"
---

<h2 className="request-body-overview">Overview</h2>
...
<h2 className="request-body-using-tyk-oas">Using Tyk OAS</h2>
...
<h2 className="request-body-using-classic">Using Classic</h2>
The [request body transform](/5.8/api-management/traffic-transformation/request-body) middleware provides a way to modify the payload of API requests before they are proxied to the upstream.
