...
canonical: "https://tyk.io/docs/5.8/api-management/traffic-transformation/ignore-authentication"
---

<h2 className="ignore-authentication-overview">Overview</h2>
...
<h2 className="ignore-authentication-using-tyk-oas">Using Tyk OAS</h2>
...
<h2 className="ignore-authentication-using-classic">Using Classic</h2>
The [Ignore Authentication](/5.8/api-management/traffic-transformation/ignore-authentication) middleware instructs Tyk Gateway to skip the authentication step for calls to an endpoint, even if authentication is enabled for the API.
