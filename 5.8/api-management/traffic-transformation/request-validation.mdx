...
<h2 className="request-validation-overview">Overview</h2>
...
<h2 className="request-validation-using-tyk-oas">Using Tyk OAS</h2>
...
<h2 className="request-validation-using-classic">Using Classic</h2>
