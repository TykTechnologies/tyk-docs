...
Follow this [guide](/5.8/product-stack/tyk-sync/installing-tyk-sync) to install Tyk Sync. You can either use the Docker image or download the binary directly. We will be using the Docker image for this quick start.
