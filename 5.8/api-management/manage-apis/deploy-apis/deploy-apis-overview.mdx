...
Learn more:
* [Tutorial: Create an API in File-based Mode](/5.8/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
Learn more:
* [Tutorial: Create an API with the Dashboard](/5.8/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
- [Using Tyk Operator to enable GitOps with Tyk](/5.8/api-management/automations)
