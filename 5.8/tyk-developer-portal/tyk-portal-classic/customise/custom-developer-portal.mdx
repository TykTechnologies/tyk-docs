...
canonical: "https://tyk.io/docs/5.8/tyk-developer-portal/tyk-portal-classic/customise/custom-developer-portal"
---

import PortalDeveloperAnalytics from '/snippets/5.8/portal-developer-analytics.mdx';
...
<h2 className="building-portal"><a name="building-portal"></a> Building a Portal</h2>
