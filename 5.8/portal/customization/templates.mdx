...
[section](/5.8/portal/customization/pages#edit-page-content)
...
- [Template Data](/5.8/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/5.8/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/5.8/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/5.8/#analytics)
- [Application Create](/5.8/#application-create)
- [Application Detail](/5.8/#application-detail)
- [Blogs](/5.8/#blogs)
- [Blog Detail](/5.8/#blog-detail)
- [Cart Checkout](/5.8/#cart-checkout)
- [Organization User Detail](/5.8/#organization-user-detail)
- [Organization User Edit](/5.8/#organization-user-edit)
- [Organization Users List](/5.8/#organization-users-list)
- [Product Detail](/5.8/#product-detail)
- [Product OAS Documentation](/5.8/#product-oas-documentation)
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/5.8/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/5.8/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/5.8/portal/private/users">Cancel</a>
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/5.8/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/5.8/#cancreateorganisation)
- [Clients](/5.8/#clients)
- [Current User](/5.8/#currentuser)
- [FeaturedProducts](/5.8/#featuredproducts)
- [FilterUserInvites](/5.8/#filteruserinvites)
- [FormatTime](/5.8/#formattime)
- [GetCart](/5.8/#getcart)
- [GetCatalogueList](/5.8/#getcataloguelist)
- [GetCataloguesForProduct](/5.8/#getcataloguesforproduct)
- [GetClientDescription](/5.8/#getclientdescription)
- [GetClientName](/5.8/#getclientname)
- [GetMenus](/5.8/#getmenus)
- [GetProducts](/5.8/#getproducts)
- [IsPortalDisabled](/5.8/#isportaldisabled)
- [IsPortalPrivate](/5.8/#isportalprivate)
- [ProductDocRenderer](/5.8/#productdocrenderer)
- [ProviderUpstreamURL](/5.8/#providerupstreamurl)
- [SplitStrings](/5.8/#splitstrings)
- [TruncateString](/5.8/#truncatestring)
- [TypeOfCredential](/5.8/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/5.8/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/5.8/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/5.8/portal/customization/menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/5.8/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/5.8/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/5.8/portal/customization/email-notifications)
for additional detail on email notifications sent by the portal.


### Available Email Templates

- [Access Request Approve/Reject](/5.8/#access-request-approvereject)
- [Access Request Submitted](/5.8/#access-request-submitted)
- [Activate and Deactivate](/5.8/#activate-and-deactivate)
- [New User Request](/5.8/#new-user-request)
- [Organization Approve](/5.8/#organization-approve)
- [Organization Reject](/5.8/#organization-reject)
- [Organization Request](/5.8/#organization-request)
- [Reset Password](/5.8/#reset-password)
- [Targeted Invite](/5.8/#targeted-invite)
- [Welcome User](/5.8/#welcome-user)
