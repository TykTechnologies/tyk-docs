...
canonical: "https://tyk.io/docs/5.8/transform-traffic/url-rewriting"
---
...
For further examples check out the [internal looping](/5.8/product-stack/tyk-operator/advanced-configurations/internal-looping) page.
