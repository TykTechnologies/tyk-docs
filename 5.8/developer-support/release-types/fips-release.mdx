...
canonical: "https://tyk.io/docs/5.8/developer-support/release-types/fips-release"
---
...
*FIPS compliance* means that the *FIPS Tyk Product* only uses FIPS 140-2 approved cryptographic [algorithms](/5.8/#fips-compliant-cryptographic-operations)
