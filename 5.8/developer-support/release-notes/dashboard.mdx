...
<h4 id="dependencies-5.8.2">Dependencies</h4>
...
<h5 id="3rdPartyTools-v5.8.2">3rd Party Dependencies & Tools</h5>
...
<h4 id="upgrade-5.8.2">Upgrade instructions</h4>
...
<h4 id="Changelog-v5.8.2">Changelog</h4>
...
[Setup guide for JWE OIDC SSO](/5.8/api-management/external-service-integration#log-into-an-app-with-github-oauth)
</Accordion>
