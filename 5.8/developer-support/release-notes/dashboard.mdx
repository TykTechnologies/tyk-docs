...
canonical: "https://tyk.io/docs/5.8/developer-support/release-notes/dashboard"
---
...
<h4 className="dependencies-5.8.5">Dependencies</h4>
...
<h4 className="upgrade-5.8.5">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.8.5">Changelog</h4>
##### Fixed
...
<h4 className="dependencies-5.8.4">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.8.4">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
...
<h4 className="upgrade-5.8.4">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.8.4">Changelog</h4>
##### Fixed
...
<h4 className="dependencies-5.8.3">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.8.3">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)                               | 1.23       | 1.23       | [Go plugins](/5.8/api-management/plugins/golang) must be built using Go 1.23 | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | | 
...
<h4 className="upgrade-5.8.3">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.8.3">Changelog</h4>
##### Fixed
...
<h4 className="dependencies-5.8.2">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.8.2">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)                               | 1.23       | 1.23       | [Go plugins](/5.8/api-management/plugins/golang) must be built using Go 1.23 | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | | 
...
<h4 className="upgrade-5.8.2">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.8.2">Changelog</h4>
...
<h4 className="dependencies-5.8.1">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.8.1">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)                               | 1.23       | 1.23       | [Go plugins](/5.8/api-management/plugins/golang) must be built using Go 1.23 | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | | 
...
<h4 className="upgrade-5.8.1">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.8.1">Changelog</h4>
##### Fixed
...
<h4 className="dependencies-5.8.0">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.8.0">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)                               | 1.23       | 1.23       | [Go plugins](/5.8/api-management/plugins/golang) must be built using Go 1.23 | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | | 
...
<h4 className="upgrade-5.8.0">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.8.0">Changelog</h4>
##### Added
...
<h4 className="dependencies-5.7.3">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.7.3">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
...
<h4 className="upgrade-5.7.3">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.7.3">Changelog</h4>
No changes in this release.
...
<h4 className="dependencies-5.7.2">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.7.2">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)                               | 1.22       | 1.22       | [Go plugins](/5.8/api-management/plugins/golang) must be built using Go 1.22 | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | | 
...
<h4 className="upgrade-5.7.2">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.7.2">Changelog</h4>
...
<h4 className="dependencies-5.7.1">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.7.1">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)                               | 1.22       | 1.22       | [Go plugins](/5.8/api-management/plugins/golang#) must be built using Go 1.22 | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | | 
...
<h4 className="upgrade-5.7.1">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.7.1">Changelog</h4>
##### Fixed
...
<h4 className="dependencies-5.7.0">Dependencies</h4>
...
<h5 className="3rdPartyTools-v5.7.0">3rd Party Dependencies & Tools</h5>
...
<h4 className="upgrade-5.7.0">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.7.0">Changelog</h4>
##### Added
...
<h4 className="dependencies-5.6.1">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
{/* Required. Version compatibility with other components in the Tyk stack. This takes the form of a compatibility matrix and is only required for Gateway and Portal.
An illustrative example is shown below. */}
| Dashboard Version | Recommended Releases | Backwards Compatibility |
...
<h5 className="3rdPartyTools-v5.6.1">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
...
<h4 className="upgrade-5.6.1">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.6.1">Changelog</h4>
No changes in this release.
...
<h4 className="dependencies-5.6.0">Dependencies</h4>
{/* Required. Use this section to announce the following types of dependencies compatible with the release:
Version compatibility with other components in the Tyk stack. This takes the form of a compatibility matrix and is only required for Gateway and Portal.
3rd party dependencies and tools */}
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.6.0">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
...
{/* ###### Future deprecations */}
<h4 className="upgrade-5.6.0">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.6.0">Changelog</h4>
...
<h4 className="dependencies-5.5.2">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.5.2">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
...
<h4 className="upgrade-5.5.2">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.5.2">Changelog</h4>
No changes in this release.
...
<h4 className="dependencies-5.5.1">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.5.1">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)                               | 1.21       | 1.21       | [Go plugins](/5.8/api-management/plugins/golang#) must be built using Go 1.21 | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | | 
...
<h4 className="upgrade-5.5.1">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.5.1">Changelog</h4>
No changes in this release.
...
<h4 className="dependencies-5.5.0">Dependencies</h4>
{/* Required. Use this section to announce the following types of dependencies compatible with the release:
Version compatibility with other components in the Tyk stack. This takes the form of a compatibility matrix and is only required for Gateway and Portal.
3rd party dependencies and tools */}
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.5.0">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
...
Once you put an item in this section, we must keep this item listed in all the following releases till the deprecation happens. */}
{/* ###### Future deprecations */}
<h4 className="upgrade-5.5.0">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.5.0">Changelog</h4>
{/* Required. The change log should include the following ordered set of sections below that briefly summarise the features, updates and fixed issues of the release.
Here it is important to explain the benefit of each changelog item. As mentioned by James in a previous Slack message (https://tyktech.slack.com/archives/C044R3ZTN6L/p1686812207060839?thread_ts=1686762128.651249&cid=C044R3ZTN6L):
"...it is important to document the customer impact for the work delivered, so we can share it with prospects/install base. For example:
"New Chart delivers x and y benefit to a and b customer use cases. The business impact for them will be this and that" */}
...
<h4 className="dependencies-5.4.0">Dependencies</h4>
{/* Required. Use this section to announce the following types of dependencies compatible with the release:
Version compatibility with other components in the Tyk stack. This takes the form of a compatibility matrix and is only required for Gateway and Portal.
3rd party dependencies and tools */}
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.4.0">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
...
Once you put an item in this section, we must keep this item listed in all the following releases till the deprecation happens. */}
{/* ###### Future deprecations */}
<h4 className="upgrade-5.4.0">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.4.0">Changelog</h4>
{/* Required. The change log should include the following ordered set of sections below that briefly summarise the features, updates and fixed issues of the release.
Here it is important to explain the benefit of each changelog item. As mentioned by James in a previous Slack message (https://tyktech.slack.com/archives/C044R3ZTN6L/p1686812207060839?thread_ts=1686762128.651249&cid=C044R3ZTN6L):
"...it is important to document the customer impact for the work delivered, so we can share it with prospects/install base. For example:
"New Chart delivers x and y benefit to a and b customer use cases. The business impact for them will be this and that" */}
...
<h4 className="dependencies-5.3.12">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.3.12">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)                               | 1.23       | 1.23       | [Go plugins](/5.8/api-management/plugins/golang) must be built using Go 1.23 | 
...
<h4 className="upgrade-5.3.12">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.3.12">Changelog</h4>
No changes in this release.
...
<h4 className="dependencies-5.3.11">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h4 className="upgrade-5.3.11">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.3.11">Changelog</h4>
##### Fixed
...
<h4 className="dependencies-5.3.10">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 className="3rdPartyTools-v5.3.10">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments |
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- |
| [GoLang](https://go.dev/dl/)                               | 1.23       | 1.23       | [Go plugins](/5.8/api-management/plugins/golang) must be built using Go 1.23 |
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | | 
...
<h4 className="Changelog-v5.3.10">Changelog</h4>
##### Fixed
...
<h4 className="dependencies-5.3.9">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
{/* Required. Version compatibility with other components in the Tyk stack. This takes the form of a compatibility matrix and is only required for Gateway and Portal.
An illustrative example is shown below. */}
| Dashboard Version | Recommended Releases | Backwards Compatibility |
...
<h5 className="3rdPartyTools-v5.3.9">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
Additionally, a disclaimer statement was added below the table, for customers to check that the third-party dependency they decide to install remains in support.
An example is given below for illustrative purposes only. Tested Versions and Compatible Versions information will require discussion with relevant squads and QA. */}
...
<h4 className="Changelog-v5.3.9">Changelog</h4>
{/* Required. The change log should include the following ordered set of sections below that briefly summarise the features, updates and fixed issues of the release.
Here it is important to explain the benefit of each changelog item. As mentioned by James in a previous Slack message (https://tyktech.slack.com/archives/C044R3ZTN6L/p1686812207060839?thread_ts=1686762128.651249&cid=C044R3ZTN6L):
"...it is important to document the customer impact for the work delivered, so we can share it with prospects/install base. For example:
"New Chart delivers x and y benefit to a and b customer use cases. The business impact for them will be this and that" */}
...
<h4 className="dependencies-5.3.8">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
{/* Required. Version compatibility with other components in the Tyk stack. This takes the form of a compatibility matrix and is only required for Gateway and Portal.
An illustrative example is shown below. */}
| Dashboard Version | Recommended Releases | Backwards Compatibility |
...
<h5 className="3rdPartyTools-v5.3.8">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
Additionally, a disclaimer statement was added below the table, for customers to check that the third-party dependency they decide to install remains in support.
An example is given below for illustrative purposes only. Tested Versions and Compatible Versions information will require discussion with relevant squads and QA. */}
...
<h4 className="Changelog-v5.3.8">Changelog</h4>
{/* Required. The change log should include the following ordered set of sections below that briefly summarise the features, updates and fixed issues of the release.
Here it is important to explain the benefit of each changelog item. As mentioned by James in a previous Slack message (https://tyktech.slack.com/archives/C044R3ZTN6L/p1686812207060839?thread_ts=1686762128.651249&cid=C044R3ZTN6L):
"...it is important to document the customer impact for the work delivered, so we can share it with prospects/install base. For example:
"New Chart delivers x and y benefit to a and b customer use cases. The business impact for them will be this and that" */}
...
<h4 className="dependencies-5.3.7">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
{/* Required. Version compatibility with other components in the Tyk stack. This takes the form of a compatibility matrix and is only required for Gateway and Portal.
An illustrative example is shown below. */}
| Dashboard Version | Recommended Releases | Backwards Compatibility |
...
<h5 className="3rdPartyTools-v5.3.7">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
Additionally, a disclaimer statement was added below the table, for customers to check that the third-party dependency they decide to install remains in support.
An example is given below for illustrative purposes only. Tested Versions and Compatible Versions information will require discussion with relevant squads and QA. */}
...
<h4 className="upgrade-5.3.7">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.3.7">Changelog</h4>
No changes in this release.
...
<h4 className="dependencies-5.3.6">Dependencies</h4>
{/* Required. Use this section to announce the following types of dependencies compatible with the release:
Version compatibility with other components in the Tyk stack. This takes the form of a compatibility matrix and is only required for Gateway and Portal.
3rd party dependencies and tools */}
...
<h5 className="3rdPartyTools-v5.3.6">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
Additionally, a disclaimer statement was added below the table, for customers to check that the third-party dependency they decide to install remains in support.
An example is given below for illustrative purposes only. Tested Versions and Compatible Versions information will require discussion with relevant squads and QA. */}
...
<h4 className="Changelog-v5.3.6">Changelog</h4>
{/* Required. The change log should include the following ordered set of sections below that briefly summarise the features, updates and fixed issues of the release.
Here it is important to explain the benefit of each changelog item. As mentioned by James in a previous Slack message (https://tyktech.slack.com/archives/C044R3ZTN6L/p1686812207060839?thread_ts=1686762128.651249&cid=C044R3ZTN6L):
"...it is important to document the customer impact for the work delivered, so we can share it with prospects/install base. For example:
"New Chart delivers x and y benefit to a and b customer use cases. The business impact for them will be this and that" */}
...
<h4 className="dependencies-5.3.5">Dependencies</h4>
{/* Required. Use this section to announce the following types of dependencies compatible with the release:
Version compatibility with other components in the Tyk stack. This takes the form of a compatibility matrix and is only required for Gateway and Portal.
3rd party dependencies and tools */}
...
<h5 className="3rdPartyTools-v5.3.5">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
Additionally, a disclaimer statement was added below the table, for customers to check that the third-party dependency they decide to install remains in support.
An example is given below for illustrative purposes only. Tested Versions and Compatible Versions information will require discussion with relevant squads and QA. */}
...
<h4 className="Changelog-v5.3.5">Changelog</h4>
 No changes in this release.
...
<h4 className="dependencies-5.3.0">Dependencies</h4>
{/* Required. Use this section to announce the following types of dependencies compatible with the release:
Version compatibility with other components in the Tyk stack. This takes the form of a compatibility matrix and is only required for Gateway and Portal.
3rd party dependencies and tools */}
...
<h5 className="3rdPartyTools-v5.3.4">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
Additionally, a disclaimer statement was added below the table, for customers to check that the third-party dependency they decide to install remains in support.
An example is given below for illustrative purposes only. Tested Versions and Compatible Versions information will require discussion with relevant squads and QA. */}
...
<h4 className="Changelog-v5.3.4">Changelog</h4>
{/* Required. The change log should include the following ordered set of sections below that briefly summarise the features, updates and fixed issues of the release.
Here it is important to explain the benefit of each changelog item. As mentioned by James in a previous Slack message (https://tyktech.slack.com/archives/C044R3ZTN6L/p1686812207060839?thread_ts=1686762128.651249&cid=C044R3ZTN6L):
"...it is important to document the customer impact for the work delivered, so we can share it with prospects/install base. For example:
"New Chart delivers x and y benefit to a and b customer use cases. The business impact for them will be this and that" */}
...
<h5 className="3rdPartyTools-v5.3.3">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
Additionally, a disclaimer statement was added below the table, for customers to check that the third-party dependency they decide to install remains in support.
An example is given below for illustrative purposes only. Tested Versions and Compatible Versions information will require discussion with relevant squads and QA. */}
...
<h4 className="Changelog-v5.3.3">Changelog</h4>
{/* Required. The change log should include the following ordered set of sections below that briefly summarise the features, updates and fixed issues of the release.
Here it is important to explain the benefit of each changelog item. As mentioned by James in a previous Slack message (https://tyktech.slack.com/archives/C044R3ZTN6L/p1686812207060839?thread_ts=1686762128.651249&cid=C044R3ZTN6L):
"...it is important to document the customer impact for the work delivered, so we can share it with prospects/install base. For example:
"New Chart delivers x and y benefit to a and b customer use cases. The business impact for them will be this and that" */}
...
<h5 className="3rdPartyTools-v5.3.2">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
...
<h4 className="Changelog-v5.3.2">Changelog</h4>
{/* Required. The change log should include the following ordered set of sections below that briefly summarise the features, updates and fixed issues of the release.
Here it is important to explain the benefit of each changelog item. As mentioned by James in a previous Slack message (https://tyktech.slack.com/archives/C044R3ZTN6L/p1686812207060839?thread_ts=1686762128.651249&cid=C044R3ZTN6L):
"...it is important to document the customer impact for the work delivered, so we can share it with prospects/install base. For example:
"New Chart delivers x and y benefit to a and b customer use cases. The business impact for them will be this and that" */}
...
<h5 className="3rdPartyTools-v5.3.1">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
...
<h4 className="Changelog-v5.3.1">Changelog</h4>
##### Fixed
...
<h5 className="TykOAS-v5.3.0">Tyk OAS APIs Compatibility Caveats</h5>
...
<h5 className="3rdPartyTools-v5.3.0">3rd Party Dependencies & Tools</h5>
{/* Required. Third-party dependencies encompass tools (GoLang, Helm etc.), databases (PostgreSQL, MongoDB etc.) and external software libraries. This section should be a table that presents the third-party dependencies and tools compatible with the release. Compatible is used in the sense of those versions tested with the releases. Such information assists customers considering upgrading to a specific release.
...
<h4 className="upgrade-5.3.0">Upgrade Instructions</h4>
...
<h4 className="Changelog-v5.3.0">Changelog</h4>
{/* Required. The change log should include the following ordered set of sections below that briefly summarise the features, updates and fixed issues of the release.
...
<h4 className="Changelog-v5.2.5">Changelog</h4>
...
<h4 className="Changelog-v5.2.4">Changelog</h4>
##### Fixed
...
<h4 className="Changelog-v5.2.3">Changelog</h4>
##### Fixed
...
<h4 className="Changelog-v5.2.2">Changelog</h4>
##### Added
...
<h4 className="Changelog-v5.2.1">Changelog</h4>
##### Added
...
<h4 className="Changelog-v5.2.0">Changelog</h4>
##### Added
...
<h4 className="upgrade-5.0.15">Upgrade instructions</h4>
If you are upgrading to 5.0.15, please follow the detailed [upgrade instructions](/5.8/#upgrading-tyk). 

<h4 className="Changelog-v5.0.15">Changelog</h4>
No changes in this release.


---

<h3 className="rn-v5.0.14">5.0.14 Release Notes</h3>
...
<h4 className="Changelog-v5.0.14">Changelog</h4>
##### Fixed
...
<h5 className="Changelog-v5.0.2">Changelog</h5>
###### Fixed
...
<h5 className="Changelog-v5.0.1">Changelog</h5>
###### Added
...
<h4 className="Changelog-v5.0.0">Changelog</h4>
##### Added
