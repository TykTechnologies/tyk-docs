...
* Enable Tyk Identity Broker to apply LDAP filters to user search [Docs](/5.8/api-management/external-service-integration#advance-ldap-configuration)
...
* For those who love to build everything in-house, we have added new API for custom dashboard authentication integrations. [Docs](/5.8/api-management/external-service-integration#custom-proxy-identify-provider)
...
[Docs](/5.8/api-management/external-service-integration#custom-proxy-identify-provider)
...
Tyk Identity Broker now fully support LDAP search with complex filters! [Docs](/5.8/api-management/external-service-integration#advance-ldap-configuration)
