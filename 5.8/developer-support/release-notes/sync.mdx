...
sidebarTitle: "Sync"
canonical: "https://tyk.io/docs/5.8/developer-support/release-notes/sync"
---
...
Please refer to the [changelog](/5.8/#Changelog-v2.1.3) below for detailed explanation.
...
<h4 className="Changelog-v2.1.3">Changelog</h4>
##### Updated
<ul>
<li>
...
This patch release uplifts a dependent library for better interoperability with the rest of the Tyk stack. Please refer to the [changelog](/5.8/#Changelog-v2.1.2) below for detailed explanation.
...
<h4 className="Changelog-v2.1.2">Changelog</h4>
##### Updated
<ul>
<li>
...
This patch release contains a bug fix. Please refer to the [changelog](/5.8/#Changelog-v2.1.1) below for detailed explanation.
...
<h4 className="Changelog-v2.1.1">Changelog</h4>
##### Fixed
<ul>
<li>
...
Please refer to the [changelog](/5.8/#Changelog-v2.1.0) below for detailed explanation.
...
Please refer to the [changelog](/5.8/#Changelog-v2.0.4) below for detailed explanation.
...
<h4 className="Changelog-v2.0.4">Changelog</h4>
##### Fixed
...
Please refer to the [changelog](/5.8/#Changelog-v2.0.1) below for detailed explanation.
...
<h4 className="Changelog-v2.0.1">Changelog</h4>
###### Changed
...
Please refer to the [changelog](/5.8/#Changelog-v2.0.0) below for detailed explanation.
...
<h4 className="Changelog-v1.5.1">Changelog</h4>
##### Fixed
...
Please refer to the [changelog](/5.8/#Changelog-v1.5.0) below for detailed explanation.
...
Please refer to the [changelog](/5.8/#Changelog-v1.4.3) below for detailed explanation.
...
<h4 className="Changelog-v1.4.3">Changelog</h4>
##### Updated
...
Recommended usage:
Tyk Dashboard setting: [allow-unsafe-oas](/5.8/tyk-dashboard/configuration#allow_unsafe_oas)
Tyk Sync: use the [--allow-unsafe-oas](/5.8/api-management/automations/sync) when invoking the CLI
...
#### Release Highlights
This release enhances compatibility as detailed in the [changelog](/5.8/#Changelog-v1.4.2) below.
...
<h4 className="Changelog-v1.4.2">Changelog</h4>
##### Updated
