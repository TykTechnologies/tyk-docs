...
In this release, we have fixed some priority CVEs. For a comprehensive list of changes, please refer to the detailed [changelog](/5.8/#Changelog-v2.8.8). 
...
If you are upgrading to 2.8.8, please follow the detailed [upgrade instructions](/5.8/#upgrading-tyk).
...
In this patch release, we've resolved MongoDB connection leaks, and faster gateway recovery after Redis outages. For a comprehensive list of changes, please refer to the detailed [changelog](/5.8/#Changelog-v2.8.7).
...
#### Upgrade instructions
If you are upgrading to 2.8.7, please follow the detailed [upgrade instructions](/5.8/#upgrading-tyk).
...
In this patch release, we fixed high-priority CVEs. For a comprehensive list of changes, please refer to the detailed [changelog](/5.8/#Changelog-v2.8.6).
...
#### Upgrade instructions
If you are upgrading to 2.8.6, please follow the detailed [upgrade instructions](/5.8/#upgrading-tyk).
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.8/#Changelog-v2.8.5).
...
#### Upgrade instructions
If you are upgrading to 2.8.5, please follow the detailed [upgrade instructions](/5.8/#upgrading-tyk).
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.8/#Changelog-v2.8.4).
...
If you are upgrading to 2.8.4, please follow the detailed [upgrade instructions](/5.8/#upgrading-tyk).
...
Check the [Upgrade and Compatibility section](/5.8/#upgrade-instructions) for details on the recommended upgrade path.
</Expandable>
</li>
</ul>
...
This release updates MDCB to maintain compatibility with recent changes to the [URL Rewrite Middleware schema](/5.8/developer-support/release-notes/gateway#release-highlights-1), ensuring seamless interoperability with the latest Gateway and Dashboard versions.

For a comprehensive list of changes, please refer to the detailed [changelog](/5.8/#Changelog-v2.8.3).
...
#### Upgrade instructions
If you are upgrading to 2.8.3, please follow the detailed [upgrade instructions](/5.8/#upgrading-tyk).
...
We have updated MDCB to align with the recent [URL Rewrite Middleware schema](/5.8/developer-support/release-notes/gateway#release-highlights-1). This update ensures that MDCB remains fully compatible and behaves consistently with the latest Gateway and Dashboard releases.
</Expandable>
</li>
</ul>
...
#### Upgrade instructions
If you are upgrading to 2.8.2, please follow the detailed [upgrade instructions](/5.8/#upgrading-tyk).
...
#### Upgrade instructions
If you are upgrading to 2.8.1, please follow the detailed [upgrade instructions](/5.8/#upgrading-tyk).
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.8/#Changelog-v2.8.0) below.
...
- Migrate to new [health check](/5.8/api-management/mdcb#health-check) endpoints in order to get more detailed information. For Kubernetes users, use Helm Charts v1.6 to upgrade MDCB to set liveness and readiness probes of MDCB deployment to the new health check endpoints.
...
Two new [health check](/5.8/api-management/mdcb#health-check) endpoints have been added to improve monitoring and diagnostics:
...
Two new `/config` and `/env` [endpoints](/5.8/api-management/mdcb#check-mdcb-configurations) have been implemented, allowing developers to access the current configuration state of the MDCB instance in real-time. This feature provides:
...
Please refer to the [changelog](/5.8/#Changelog-v2.7.0) below.
...
Please refer to the [changelog](/5.8/#Changelog-v2.6.0) below.
...
#### Release Highlights
This release contains bug fixes as detailed in the [changelog](/5.8/#Changelog-v2.5.1) below.
...
Please refer to the [changelog](/5.8/#Changelog-v2.5.0) below.
...
[MongoDB supported versions](/5.8/planning-for-production/database-settings#supported-versions) 
...
#### Release Highlights
This release enhances compatibility as detailed in the [changelog](/5.8/#Changelog-v2.4.2) below.
...
#### Release Highlights
This release enhances compatibility as detailed in the [changelog](/5.8/#Changelog-v2.4.1) below.
...
#### Release Highlights
MDCB 2.4.0 is an update for compatibility for synchronisation with Tyk v5.2 API Definitions. It also enables gateway information visualisation on Tyk Dashboard v5.2+. Please refer to the [changelog](/5.8/#Changelog-v2.4.0) below.
...
#### Added
- Added a new configuration option [enable_ownership](/5.8/tyk-multi-data-centre/mdcb-configuration-options#enable_ownership) that allows MDCB filter APIs by API Ownership. 
