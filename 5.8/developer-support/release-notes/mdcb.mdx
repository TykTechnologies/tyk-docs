...
canonical: "https://tyk.io/docs/5.8/developer-support/release-notes/mdcb"
---
...
<h4 className="dependencies-2.8.4">Dependencies</h4>
...
- [Docker image v2.8.3](https://hub.docker.com/r/tykio/tyk-mdcb-docker/tags?page=&page_size=&ordering=&name=v2.8.4)
  - ```bash
    ...
    ```
<h4 className="Changelog-v2.8.4">Changelog</h4>
##### Fixed
...
<h4 className="dependencies-2.8.3">Dependencies</h4>
##### 3rd Party Dependencies & Tools
| Third Party Dependency          | Tested Versions | Compatible Versions | Comments | 
| :------------------------------- | :--------------- | :------------------- | :-------- | 
| [Redis](https://redis.io/download/)    | 6.2.x, 7.x, 7.4.x      | 6.2.x, 7.x, 7.4.x      | | 
...
- [Docker image v2.8.3](https://hub.docker.com/r/tykio/tyk-mdcb-docker/tags?page=&page_size=&ordering=&name=v2.8.3)
  - ```bash
    ...
    ```
<h4 className="Changelog-v2.8.3">Changelog</h4>
##### Changed
...
<h4 className="dependencies-2.8.2">Dependencies</h4>
##### 3rd Party Dependencies & Tools
| Third Party Dependency          | Tested Versions | Compatible Versions | Comments | 
| :------------------------------- | :--------------- | :------------------- | :-------- | 
| [Redis](https://redis.io/download/)    | 6.2.x, 7.x, 7.4.x      | 6.2.x, 7.x, 7.4.x      | | 
...
- [Docker image v2.8.2](https://hub.docker.com/r/tykio/tyk-mdcb-docker/tags?page=&page_size=&ordering=&name=v2.8.2)
  - ```bash
    ...
    ```
<h4 className="Changelog-v2.8.2">Changelog</h4>
##### Added
...
<h4 className="dependencies-2.8.1">Dependencies</h4>
##### 3rd Party Dependencies & Tools
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
...
- [Docker image v2.8.1](https://hub.docker.com/r/tykio/tyk-mdcb-docker/tags?page=&page_size=&ordering=&name=v2.8.1)
  - ```bash
    ...
    ```
<h4 className="Changelog-v2.8.1">Changelog</h4>
...
<h4 className="dependencies-2.8.0">Dependencies</h4>
##### 3rd Party Dependencies & Tools
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | Used by MDCB | 
...
- [Docker image v2.8.0](https://hub.docker.com/r/tykio/tyk-mdcb-docker/tags?page=&page_size=&ordering=&name=v2.8.0)
  - ```bash
    ...
    ```
<h4 className="Changelog-v2.8.0">Changelog</h4>
##### Changed
<ul>
...
<h4 className="dependencies-X.Y.Z">Dependencies</h4>
##### 3rd Party Dependencies & Tools
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | Used by MDCB | 
...
<h4 className="Changelog-v2.7.2">Changelog</h4>
##### Updated
<ul>
...
<h4 className="Changelog-v2.7.1">Changelog</h4>
##### Added
<ul>
   <li>
...
<h4 className="Changelog-v2.7.0">Changelog</h4>
##### Added
<ul>
   <li>
 <AccordionGroup>
...
<h4 className="Changelog-v2.6.0">Changelog</h4>
##### Security
...
<h4 className="Changelog-v2.5.1">Changelog</h4>
##### Fixed
<ul>
 <li>
 <AccordionGroup>
...
<h4 className="Changelog-v2.5.0">Changelog</h4>
##### Fixed
<ul>
 <li>
 <AccordionGroup>
...
<h4 className="Changelog-v2.4.3">Changelog</h4>
##### Fixed
<ul>
 <li>
...
<h4 className="Changelog-v2.4.2">Changelog</h4>
##### Fixed
<ul>
 <li>
...
<h4 className="Changelog-v2.4.1">Changelog</h4>
##### Changed
...
<h4 className="Changelog-v2.4.0">Changelog</h4>
##### Added
