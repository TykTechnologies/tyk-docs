...
canonical: "https://tyk.io/docs/5.8/developer-support/release-notes/gateway"
---
...
<h5 className="TykOAS-v5.3.0">Tyk OAS APIs Compatibility Caveats - Tyk OSS</h5>
...
<h3 className="rn-v5.0.15">5.0.15 Release Notes</h3>
...
<h4 className="Changelog-v5.0.13">Changelog</h4>
##### Fixed
...
<h4 className="Changelog-v5.0.2">Changelog</h4>
##### Updated
...
<h4 className="Changelog-v5.0.1">Changelog</h4>
##### Added
