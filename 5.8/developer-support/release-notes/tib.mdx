...
canonical: "https://tyk.io/docs/5.8/developer-support/release-notes/tib"
---
...
<h4 className="Changelog-v1.7.0">Changelog</h4>
##### Added
<ul>
<li>
<AccordionGroup>
...
<h4 className="Changelog-v1.6.1">Changelog</h4>
