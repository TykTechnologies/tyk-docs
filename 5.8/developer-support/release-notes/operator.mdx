...
'og:description': "Release notes documenting updates, enhancements, fixes and changes for Tyk Operator."
...
Go to the [Upgrading Tyk Operator](/5.8/api-management/automations/operator#install-and-configure-tyk-operator) section for detailed upgrade instructions.
...
[Learn More](/5.8/api-management/automations/operator#create-a-tykstreamsapidefinition-custom-resource)
</Expandable>
</li>
</ul>
...
{/* Required. Use the following statement if there are no breaking changes, or explain if there are */}
{/* This release has no breaking changes. */}
**License Requirement:** Tyk Operator is now a closed-source product and requires a valid license key to operate. Please follow our [Installation and Upgrade Guide](/5.8/api-management/automations/operator#install-and-configure-tyk-operator) to set your license key before installation or upgrade.
...
Go to the [Upgrading Tyk Operator](/5.8/api-management/automations/operator#upgrading-tyk-operator) section for detailed upgrade instructions.
...
Learn More: [Create Tyk OAS API](/5.8/api-management/automations/operator#set-up-tyk-oas-api)
</Accordion>
...
Learn More: [Tyk Ingress Controller](/5.8/api-management/automations/operator#control-kubernetes-ingress-resources)
</Accordion>
...
Learn More: [Key-Level Per-API Rate Limits and Quota](/5.8/api-management/automations/operator#security-policy-example)
</Accordion>
...
Learn More: [Key-Level Per-Endpoint Rate Limits](/5.8/api-management/automations/operator#security-policy-example)
</Accordion>
...
Learn More: [TykOasApiDefinition in Security Policy](/5.8/api-management/automations/operator#add-a-security-policy-to-your-api)
</Accordion>
