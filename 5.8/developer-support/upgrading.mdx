...
Follow our guide for [upgrading Cloud Control Planes](/5.8/tyk-cloud#upgrade-control-planes).
...
Follow our guide for [upgrading Cloud Data Planes](/5.8/tyk-cloud#managing-cloud-data-plane).
...
See Tyk Guide for how to [upgrade Control Planes](/5.8/tyk-cloud#upgrade-control-planes)
...
2. [Upload this bundle](/5.8/tyk-cloud#uploading-your-bundle) to your configured S3 bucket if using Cloud SaaS. If you're using Hybrid SaaS, upload this bundle to your bundle server.
