...
- `jwt_signing_method`: Specify the method used to sign the JWT. Refer to the documentation on [JWT Signatures](/api-management/authentication/jwt-signature-validation) for supported methods.
