...
* You already have authorized access to Tyk's Dashboard. If you haven't, [get the authorization key by following this doc](/basic-config-and-security/security/dashboard/create-users#a-name-with-api-a-create-a-dashboard-user-with-the-api).
