...
For the full reference, see [`PORTAL_SSOCUSTOMLOGINURL`](/product-stack/tyk-enterprise-developer-portal/deploy/configuration#portal_ssocustomloginurl) in the configuration reference.
