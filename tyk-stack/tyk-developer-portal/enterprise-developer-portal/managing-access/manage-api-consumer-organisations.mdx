...
- Remove users from it — move active users to purpose-built Teams so they can only see their own team members rather than all users in the Organisation
- Use it as a holding area for inactive users awaiting deactivation or reassignment

<Note>
As of v1.14, users can be removed from the Default Team. Keep the Default Team for inactive users only — Org Admins also cannot add users to other Organisations, reinforcing the Default Team as a holding area rather than an active working team.
</Note>
