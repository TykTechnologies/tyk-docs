...
To customize the invite email, please refer to the [Email customization section](/tyk-stack/tyk-developer-portal/enterprise-developer-portal/customise-enterprise-portal/full-customisation/email-customization) for guidance.
