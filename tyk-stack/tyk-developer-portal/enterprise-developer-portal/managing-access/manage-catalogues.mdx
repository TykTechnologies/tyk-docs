...
- Connect to a provider [Tyk Self-Managed](/product-stack/tyk-enterprise-developer-portal/getting-started/with-tyk-self-managed-as-provider)
- Create [policies with enforced access rights](/product-stack/tyk-enterprise-developer-portal/getting-started/create-api-product-and-plan) (API Product in the Portal)
- Create one or more [policies with enforced rate limit and quotas](/product-stack/tyk-enterprise-developer-portal/getting-started/create-api-product-and-plan.md) (Plan in the Portal)
