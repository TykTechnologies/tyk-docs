...
To enable this, Tyk introduced support for custom rate limit keys in [Tyk 5.3.0](/product-stack/tyk-dashboard/release-notes/version-5.3). This guide explains how to configure custom rate limit keys.

## Prerequisites for getting started
This capability works with [Tyk 5.3.0](/product-stack/tyk-dashboard/release-notes/version-5.3) or higher.
