...
Users can extend their existing credentials with additional API Products when compatibility requirements are met, avoiding the need to manage multiple credentials for the same application.
