...
The Enterprise Developer Portal supports two different access flows for API Products. Your portal administrator configures which flow is available:
...
Note: The access flow type is configured by your portal administrator and applies to all developers using the portal.
