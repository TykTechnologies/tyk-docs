...
**Direct Access Flow**: When requesting access to an API Product, developers can choose to:
 - **Generate new credentials**: Creates a separate credential set
 - **Use existing credentials**: Adds the product to compatible existing credentials
**Cart-Based Flow**: During checkout, the system identifies compatible credentials and allows developers to:
 - Extend existing credentials with new products
 - Create new credentials when no compatible options exist
