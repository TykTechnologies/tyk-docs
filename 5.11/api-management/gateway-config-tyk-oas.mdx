...
import XTykGateway from '/snippets/5.11/x-tyk-gateway.mdx';
...
The [Tyk Vendor Extension](/5.11/#tyk-vendor-extension) follows the same architectural style as the OpenAPI Specification and is encapsulated in a single object that is appended to the OpenAPI description, creating a *Tyk OAS API definition*.
