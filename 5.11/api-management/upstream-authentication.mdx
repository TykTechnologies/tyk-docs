...
- [Mutual TLS](/5.11/api-management/upstream-authentication/mtls)
- [Token-based authentication](/5.11/api-management/upstream-authentication/auth-token)
- [Request signing](/5.11/api-management/upstream-authentication/request-signing)
- [Basic Authentication](/5.11/api-management/upstream-authentication/basic-auth)
- [OAuth 2.0](/5.11/api-management/upstream-authentication/oauth)
    - [OAuth 2.0 Client Credentials](/5.11/api-management/upstream-authentication/oauth#oauth-client-credentials)
    - [OAuth 2.0 Password Grant](/5.11/api-management/upstream-authentication/oauth#oauth-resource-owner-password-credentials)
