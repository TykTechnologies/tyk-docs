...
- API Product Management
  - [Create and configure API Products](/5.11/portal/api-products)
  - [Define Plans with appropriate rate limits and quotas](/5.11/portal/api-plans)
  - [Organize Products into Catalogs](/5.11/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/manage-catalogues)
  - [Maintain API documentation and guides](/5.11/portal/api-products#documentation)
- User Administration
  - [Create and manage API Consumer accounts](/5.11/portal/api-consumer)
  - [Establish Organisations and Teams](/5.11/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/manage-api-consumer-organisations)
  - [Control access to Catalogs and API Products](/5.11/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/manage-catalogues#catalog-visibility)
  - [Approve API access requests](/5.11/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/approve-requests)
- Portal Configuration
  - [Customize the Live Portal experience](/5.11/portal/customization)
  - [Set up email notifications](/5.11/product-stack/tyk-enterprise-developer-portal/getting-started/setup-email-notifications)
  - [Integrate with OAuth 2.0 Identity Providers](/5.11/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/dynamic-client-registration)
  - [Integrate with Single Sign On providers](/5.11/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/enable-sso)


## Creating An API Owner User

When the Developer Portal is first started, you will go through a [bootstrapping](/5.11/portal/install#bootstrapping-enterprise-developer-portal) process during which an initial API Owner user will be created. When the bootstrapped user logs into the Portal, they will reach the Admin Portal. They can create additional API Owners from the **Settings > Admin Users** screen:
...
- You will be taken to the log in page (`/auth/password/login`) where you enter the email address and password registered for your account.
    ...
    <Note>
    If you are using Single Sign-On (SSO) then Tyk does not provide a log in page and you should [create one](/5.11/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/enable-sso#testing-sso).
    </Note>


After completing authentication, as an API Owner, you will be taken to the [Admin Portal](/5.11/portal/overview/concepts#developer-portal-views).
...
This status mechanism is also used when approving [self-registered users](/5.11/portal/api-consumer#self-registration), who remain inactive until approved by an administrator.
