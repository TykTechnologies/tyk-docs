...
<Note>
If you want to enable Tyk Developer Portal, please use [PostgreSQL](#install-tyk-stack-with-helm-chart-postgresql). MongoDB is not supported in Developer Portal.
</Note>
