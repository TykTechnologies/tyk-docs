...
import DashboardConfig from '/snippets/5.11/dashboard-config.mdx';
import EnvTypeMapping from '/snippets/5.11/env-type-mapping.mdx';
...
To understand how the environment variables notation works, see [Environment Variables](/5.11/tyk-oss-gateway/configuration).
