...
1. **Encapsulation of Resources**:
   ...
   - Users can subscribe to tools from the [AI Portal](/5.11/ai-management/ai-studio/ai-portal) tool catalogue, similar to how they access LLMs and data sources.
