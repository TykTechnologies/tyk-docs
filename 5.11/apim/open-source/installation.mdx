...
<Card href="/5.11/apim/open-source/installation#install-tyk-gateway-with-docker" img="/img/docker.png">
**Read time: 10 mins**

Install with Docker.
</Card>

<Card href="/5.11/apim/open-source/installation#install-tyk-gateway-with-kubernetes" img="/img/k8s.png">
**Read time: 10 mins**

Install with K8s.
</Card>

<Card href="/5.11/apim/open-source/installation#install-tyk-gateway-with-ansible" img="/img/ansible.png">
**Read time: 10 mins**

Install with Ansible.
</Card>

<Card href="/5.11/apim/open-source/installation#install-tyk-gateway-on-red-hat-rhel--centos" img="/img/redhat-logo2.png">
**Read time: 10 mins**

Install on RHEL / CentOS.
</Card>

<Card href="/5.11/apim/open-source/installation#install-tyk-gateway-with-ubuntu" img="/img/debian-nd-753.png">
**Read time: 10 mins**
...
The following are required for a Tyk OSS installation:
 ...
 - MongoDB - Required only if you chose to use the Tyk Pump with your Tyk OSS installation. Same goes with any [other pump data stores](/5.11/api-management/tyk-pump#external-data-stores) you choose to use.
...
Get started with our [Quick Start guide](/5.11/#quick-start-with-helm-chart) or go to [Tyk Open Source helm chart](/5.11/product-stack/tyk-charts/tyk-oss-chart) for detailed installation instructions and configuration options.
...
For the complete installation guide and configuration options, please see [Tyk OSS Helm Chart](/5.11/product-stack/tyk-charts/tyk-oss-chart).

### Configure Legacy Tyk Headless Helm Chart

<Warning>
`tyk-headless` chart is deprecated. Please use our Tyk Chart for Tyk Open Source at [tyk-oss](/5.11/#quick-start-with-helm-chart) instead. 

We recommend all users migrate to the `tyk-oss` Chart. Please review the [Configuration](/5.11/#quick-start-with-helm-chart) section of the new helm chart and cross-check with your existing configurations while planning for migration.
</Warning>
...
2. MongoDB/SQL - Required only if you choose to use the MongoDB/SQL Tyk pump with your Tyk OSS installation. The same goes for any
             [other pump](/5.11/api-management/tyk-pump#external-data-stores) you choose to use.
...
<Note>
Please make sure you are installing Redis versions that are supported by Tyk. Please refer to Tyk docs to get a list of [supported versions](/5.11/tyk-configuration-reference/redis-cluster-sentinel#supported-versions).
</Note>
...
*   The Tyk Gateway has a [dependency](/5.11/tyk-configuration-reference/redis-cluster-sentinel#supported-versions) on Redis. Follow the steps provided by Red Hat to make the installation of Redis, conducting a [search](https://access.redhat.com/search/?q=redis) for the correct version and distribution.
