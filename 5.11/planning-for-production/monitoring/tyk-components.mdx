...
For information about our health check endpoint, please visit our [Liveness Health Check](/5.11/#liveness-health-check) documentation.
...
The Tyk Dashboard liveness health check endpoint can be configured [here](/5.11/tyk-dashboard/configuration#health_check_endpoint_name). 

The Tyk MDCB liveness health check endpoint can be configured [here](/5.11/api-management/mdcb#health-check). 
...
The Tyk Pump component offers a built-in Liveness Health Check endpoint [here](/5.11/tyk-pump/tyk-pump-configuration/tyk-pump-environment-variables#health-check). 
...
* [Redis Sizing](/5.11/planning-for-production/database-settings#redis-sizing-guidelines)
* [PostgreSQL Sizing](/5.11/planning-for-production/database-settings#postgresql-sizing-guidelines)
* [MongoDB Sizing](/5.11/planning-for-production/database-settings#mongodb-sizing-guidelines)
