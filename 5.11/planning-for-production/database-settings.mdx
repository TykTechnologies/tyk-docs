...
import RedisCalculator from '/snippets/5.11/RedisCalculator.mdx';
import DatabaseCalculator from '/snippets/5.11/DatabaseCalculator.mdx';

Visit the following sections to see how to configure the Database for Production:
* [Redis](/5.11/planning-for-production/database-settings#redis)
* [MongoDB](/5.11/planning-for-production/database-settings#mongodb-sizing-guidelines)
* [PostgreSQL](/5.11/planning-for-production/database-settings#postgresql)

Please consult the [data storage configuration](/5.11/api-management/dashboard-configuration#data-storage-solutions) guide for further information relating to how to configure Tyk's data storage across different database engines.
...
**Capping Analytics**
Tyk Gateways can generate a lot of analytics data. Be sure to read about [capping your Dashboard analytics](/5.11/api-management/tyk-pump#tyk-pump-capping-analytics-data-storage)
...
* [Configure Dashboard MongoDB driver](/5.11/tyk-dashboard/configuration#mongo_driver)
* [Configure MDCB MongoDB driver](/5.11/tyk-multi-data-centre/mdcb-configuration-options#analyticsdriver)
...
<Note>
If you are using [DocumentDB](https://aws.amazon.com/documentdb/), [capped collections](/5.11/api-management/tyk-pump#tyk-pump-capping-analytics-data-storage) are not supported. See [here](https://docs.aws.amazon.com/documentdb/latest/developerguide/mongo-apis.html) for more details.
</Note>
...
More information on these configuration variables [here](/5.11/tyk-dashboard/configuration). 
