...
#### Release Highlights
Tyk Sync 2.1.5 is a version alignment release that ensures compatibility with the most recent Tyk LTS release [5.8.9](/5.11/developer-support/release-notes/dashboard#589-release-notes). It contains one bug fix.
...
#### Release Highlights
Tyk Sync 2.1.4 is a version alignment release that ensures compatibility with the most recent Tyk LTS release [5.8.6](/5.11/developer-support/release-notes/dashboard#586-release-notes). No functional changes have been implemented in this release.
...
Please refer to the [changelog](/5.11/#Changelog-v2.1.3) below for detailed explanation.
...
This patch release uplifts a dependent library for better interoperability with the rest of the Tyk stack. Please refer to the [changelog](/5.11/#Changelog-v2.1.2) below for detailed explanation.
...
This patch release contains a bug fix. Please refer to the [changelog](/5.11/#Changelog-v2.1.1) below for detailed explanation.
...
Please refer to the [changelog](/5.11/#Changelog-v2.1.0) below for detailed explanation.
...
Please refer to the [changelog](/5.11/#Changelog-v2.0.4) below for detailed explanation.
...
Please refer to the [changelog](/5.11/#Changelog-v2.0.1) below for detailed explanation.
...
Please refer to the [changelog](/5.11/#Changelog-v2.0.0) below for detailed explanation.
...
Please refer to the [changelog](/5.11/#Changelog-v1.5.0) below for detailed explanation.
...
Please refer to the [changelog](/5.11/#Changelog-v1.4.3) below for detailed explanation.
...
Recommended usage:
Tyk Dashboard setting: [allow-unsafe-oas](/5.11/tyk-dashboard/configuration#allow_unsafe_oas)
Tyk Sync: use the [--allow-unsafe-oas](/5.11/api-management/automations/sync) when invoking the CLI
...
#### Release Highlights
This release enhances compatibility as detailed in the [changelog](/5.11/#Changelog-v1.4.2) below.
