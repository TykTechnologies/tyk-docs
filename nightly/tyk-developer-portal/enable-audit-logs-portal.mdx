...
canonical: "https://tyk.io/docs/tyk-developer-portal/enable-audit-logs-portal"
---
...
| :-------- | :------ | :------- |
| Tyk Enterprise Developer Portal | Available since [v1.7.0](/nightly/developer-support/release-notes/portal#1-7-0-release-notes) | Enterprise |
...
For more information on configuration options, refer to the [Portal Configuration Reference](/nightly/product-stack/tyk-enterprise-developer-portal/deploy/configuration#audit-log-settings).
