...
description: Tyk Developer Portal API documentation. This page provides details on
  how to use the Tyk Developer Portal Management API for managing portal resources.
