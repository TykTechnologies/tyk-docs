---
canonical: https://tyk.io/docs/product-stack/tyk-enterprise-developer-portal/getting-started/setup-email-notifications
description: Learn how to set up email notifications in the Tyk Enterprise Developer
  Portal.
keywords: Tyk Developer Portal, Enterprise Portal, Email, Notifications
noindex: noindex, follow
sidebarTitle: Email Service
