...
canonical: "https://tyk.io/docs/product-stack/tyk-operator/advanced-configurations/custom-plugins"
---
...
<Note>
This page mounts plugin files directly onto the Gateway's file system. For guidance on when to use this approach instead of a remote plugin bundle, see [Choosing Between Local Plugins And Plugin Bundles](/nightly/api-management/plugins/overview#choosing-between-local-plugins-and-plugin-bundles).
</Note>
