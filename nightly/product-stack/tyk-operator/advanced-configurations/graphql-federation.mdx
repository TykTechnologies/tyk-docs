---
canonical: https://tyk.io/docs/product-stack/tyk-operator/advanced-configurations/graphql-federation
description: Learn how to implement GraphQL Federation using Tyk Operator in Kubernetes,
  enabling a unified API from multiple subgraphs.
