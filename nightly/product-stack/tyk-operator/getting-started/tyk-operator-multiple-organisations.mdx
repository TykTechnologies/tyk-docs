---
canonical: https://tyk.io/docs/product-stack/tyk-operator/getting-started/tyk-operator-multiple-organisations
description: Learn how to manage multiple organizations with Tyk Operator by defining
  OperatorContext and referencing it in API definitions.
...
An [OperatorContext](/nightly/api-management/automations/operator#multi-tenancy-in-tyk) specifies the parameters for connecting and authenticating with a Tyk Dashboard. Below is an example of how to define an `OperatorContext`:
