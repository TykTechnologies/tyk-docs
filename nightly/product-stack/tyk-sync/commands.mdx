---
canonical: https://tyk.io/docs/product-stack/tyk-sync/commands
description: Learn about the Tyk Sync commands for managing API configurations, examples,
  and deployments.
keywords: Commands, Tyk Sync, API Management, Automations
