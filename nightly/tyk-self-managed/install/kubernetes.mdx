...
description: "Installation guide for the Tyk Self-Managed on Kubernetes using Helm charts"
sidebarTitle: "Kubernetes"
canonical: "https://tyk.io/docs/tyk-self-managed/install/kubernetes"
---
...
- [Enterprise Edition License](/nightly/apim#licensing)
...
<Note>
If you want to enable Tyk Developer Portal, please use [PostgreSQL](/nightly/#install-tyk-stack-with-helm-chart-postgresql). MongoDB is not supported in Developer Portal.
</Note>
...
If you are deploying the **Tyk Developer Portal**, set the appropriate values under the `enterprisePortal` section in your `values.yaml`. Please visit [Tyk Developer Portal installation](/nightly/portal/install/kubernetes) for a step by step guide.
