...
- Install each [Data Plane](/nightly/api-management/mdcb#installing-in-a-kubernetes-cluster-with-our-helm-chart-1) using the connection details produced by the Control Plane installation.
...
<Note>
Please make sure you are installing Redis versions that are supported by Tyk. Please refer to Tyk docs to get list of [supported versions](/nightly/tyk-configuration-reference/redis-cluster-sentinel#supported-versions).
</Note>
...
<Note>
Please make sure you are installing PostgreSQL versions that are supported by Tyk. Please refer to Tyk docs to get list of [supported versions](/nightly/tyk-self-managed/install#requirements).
</Note>
...
Check [Tyk Gateway Sharding](/nightly/api-management/api-sharding#what-is-api-sharding-) for more details.
