...
<h2 id="install-tyk-on-redhat-rhel-centos">Install Tyk on Red Hat (RHEL / CentOS)</h2>
...
<h3 id="Debian-Ubuntu-install-dashboard">Install Dashboard</h3>
#### Using Shell
...
<h3 id="Debian-Ubuntu-install-pump">Install Pump</h3>
#### Using Shell
...
<h3 id="debian-ubuntu-install-gateway">Install Gateway</h3>
#### Using Shell
