...
Check [Tyk Control plane](/nightly/api-management/mdcb) for more configuration details.
...
10. **Login to the Dashboard**
    ...
    **Configure your Developer Portal**
    ...
    To set up your [Developer Portal](/nightly/portal/overview/intro) follow our Self-Managed [tutorial on publishing an API to the Portal Catalog](/nightly/getting-started/tutorials/publish-api).
