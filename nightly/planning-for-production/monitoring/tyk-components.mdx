...
The Tyk Dashboard liveness health check endpoint can be configured [here](/nightly/tyk-dashboard/configuration#health_check_endpoint_name). 

The Tyk MDCB liveness health check endpoint can be configured [here](/nightly/api-management/mdcb#health-check). 
...
The Tyk Pump component offers a built-in Liveness Health Check endpoint [here](/nightly/tyk-pump/tyk-pump-configuration/tyk-pump-environment-variables#health-check). 
...
* [Redis Sizing](/nightly/planning-for-production/database-settings#redis-sizing-guidelines)
* [PostgreSQL Sizing](/nightly/planning-for-production/database-settings#postgresql-sizing-guidelines)
* [MongoDB Sizing](/nightly/planning-for-production/database-settings#mongodb-sizing-guidelines)
