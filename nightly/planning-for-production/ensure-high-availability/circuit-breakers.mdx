---
canonical: https://tyk.io/docs/planning-for-production/ensure-high-availability/circuit-breakers
description: How to configure Tyk's circuit breaker middleware to protect your upstream
  services from repeated failures and overloading.
