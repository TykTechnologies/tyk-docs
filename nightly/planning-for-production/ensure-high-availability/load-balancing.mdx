...
description: How to set up round-robin load balancing in Tyk Gateway and Dashboard,
  including dynamic load balancing with service discovery.
...
See [Service Discovery](/nightly/planning-for-production/ensure-high-availability/service-discovery) to see how you can integrate a service discovery system such as Consul or etcd with Tyk and enable dynamic load balancing support.
...
You can also perform [gRPC Load balancing](/nightly/key-concepts/grpc-proxy#grpc-load-balancing).