...
| [`ConnectionString`](/nightly/product-stack/tyk-enterprise-developer-portal/deploy/configuration#portal_database_connectionstring) | The database [connection string](#connection-string). See [TLS](#tls) for encryption parameters. |
