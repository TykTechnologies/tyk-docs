...
Tyk supports Mutual Authentication in gRPC. See [Mutual TLS](/nightly/api-management/implement-tls#secure-hosted-apis-with-mtls) to configure Mutual Authentication in Tyk. 
