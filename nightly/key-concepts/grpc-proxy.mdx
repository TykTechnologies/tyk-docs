...
Tyk supports Token Based Authentication in gRPC. See [Bearer Tokens](/nightly/api-management/authentication/bearer-token) to configure Token Based Authentication in Tyk. 
