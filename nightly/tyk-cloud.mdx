---
title: "Tyk Cloud"
description: "An overview of Tyk Cloud, a fully managed API management platform"
keywords: "Tyk Cloud, Migration"
sidebarTitle: "Tyk Cloud"
canonical: "https://tyk.io/docs/tyk-cloud"
---
...
Tyk cloud is a fully managed service that makes it easy for API teams to create, secure, publish and maintain APIs at any scale, anywhere in the world. Tyk Cloud includes everything you need to manage your global API ecosystem: [Tyk Gateways](/nightly/tyk-oss-gateway), [Tyk Dashboard](/nightly/api-management/dashboard-configuration), [Tyk Developer Portal](/nightly/portal/overview/intro) and [Universal Data Graph](/nightly/api-management/data-graph#overview).
...
The Tyk Cloud trial does not include access to [Hybrid deployments](/nightly/tyk-cloud/environments-deployments/hybrid-gateways) or the [Developer Portal](/nightly/portal/overview/intro).
...
2. Creating your first [API](/nightly/api-management/gateway-config-introduction) using the [Tyk Dashboard](/nightly/api-management/dashboard-configuration).
3. Setting up a [Policy](/nightly/api-management/access-control/overview) and generating a Key to secure your APIs.
...
For further details, please refer to the [release notes](/nightly/developer-support/release-notes/gateway#5-3-0-release-notes) for Tyk Gateway v5.3.0.
</Warning>
...
* Adding [Plugins and Middleware](/nightly/tyk-cloud/using-plugins) to your Control Plane
...
Where an Organization has expired due to either a subscription failure or cancelation and is now within a "retirement" period of 30 days, during which an [Billing Admin](/nightly/tyk-cloud/teams-users#assign-user-roles) can reinstate full functionality by updating or creating a new subscription.
