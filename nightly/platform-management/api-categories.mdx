---
title: "Governance using API Categories"
description: "Learn how to use API categories in Tyk Dashboard to group and manage APIs by attributes such as environment, ownership or target consumer"
keywords: "API Categories, API Governance, Tyk Dashboard, API Management, Categorization"
sidebarTitle: "API Categories"
canonical: "https://tyk.io/docs/platform-management/api-categories"
---
...
Multi-tenant deployments with [role-based access control](/nightly/platform-management/user-permissions) enabled allows an admin user to give different users or groups access to a sub-set of the entire API portfolio. Categories can be aligned with the API ownership rules that you have deployed to allow filtering the list of APIs for those visible to each separate user group/team.
