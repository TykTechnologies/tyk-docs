...
canonical: "https://tyk.io/docs/platform-management/user-groups"
---

import { ButtonLeft } from '/snippets/nightly/ButtonLeft.mdx';


Tyk has a flexible [user permissions](/nightly/platform-management/user-permissions) system that provides Role Based Access Control (RBAC) for your Tyk Dashboard.
...
You can also manage User Groups via our [Dashboard API](https://tyk.io/docs/api-reference/usergroup/list-user-groups). The following functions are available:

* [List all User Groups](https://tyk.io/docs/api-reference/usergroup/list-user-groups)
* [Get a User Group via the User Group ID](https://tyk.io/docs/api-reference/usergroup/get-user-group-details)
* [Add a User Group](https://tyk.io/docs/api-reference/usergroup/create-user-group)
* [Update a User Group](https://tyk.io/docs/api-reference/usergroup/update-user-group)
* [Delete a User Group](https://tyk.io/docs/api-reference/usergroup/delete-user-group)
