...
canonical: "https://tyk.io/docs/docs/ai-management/ai-studio/quickstart"
---
...
Continue to the [First Steps guide](/nightly/docs/ai-management/ai-studio/configuration) for detailed configuration instructions.
