...
canonical: "https://tyk.io/docs/docs/ai-management/ai-studio/sso"
---
...
4.  **Group Mapping (Optional but Recommended):** Configure rules to automatically assign users to Tyk AI Studio [Groups](/nightly/docs/ai-management/ai-studio/user-management) based on group information received from the IdP.
