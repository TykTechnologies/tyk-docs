...
canonical: "https://tyk.io/docs/docs/ai-management/ai-studio/deployment-k8s"
---
...
Once deployed and you've registered your first user, proceed to the [First Steps guide](/nightly/docs/ai-management/ai-studio/configuration) to configure Tyk AI Studio.
