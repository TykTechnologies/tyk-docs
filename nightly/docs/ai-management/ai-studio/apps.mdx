...
canonical: "https://tyk.io/docs/docs/ai-management/ai-studio/apps"
---
...
1. **Encapsulation of Resources**:
   ...
   - Users can subscribe to tools from the [AI Portal](/nightly/docs/ai-management/ai-studio/ai-portal) tool catalogue, similar to how they access LLMs and data sources.
