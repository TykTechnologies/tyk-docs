...
canonical: "https://tyk.io/docs/docs/ai-management/ai-studio/notifications"
---
...
*   **[Budget Control](/nightly/docs/ai-management/ai-studio/llm-management):**
    *   Approaching spending limit threshold (e.g., 80% of budget).
    *   Reaching or exceeding spending limit.
*   **[User Management](/nightly/docs/ai-management/ai-studio/user-management):**
