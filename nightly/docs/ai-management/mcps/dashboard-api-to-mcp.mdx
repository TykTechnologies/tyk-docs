...
canonical: "https://tyk.io/docs/docs/ai-management/mcps/dashboard-api-to-mcp"
---
...
Explore the core functionality in the [API to MCP guide](/nightly/docs/ai-management/mcps/api-to-mcp).
