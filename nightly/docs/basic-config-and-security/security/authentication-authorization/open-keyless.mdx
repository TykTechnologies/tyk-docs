...
canonical: "https://tyk.io/docs/docs/basic-config-and-security/security/authentication-authorization/open-keyless"
---
...
Tyk OAS APIs are inherently "open" unless authentication is configured, however the older Tyk Classic API applies [auth token](/nightly/docs/api-management/authentication/bearer-token) protection by default.
