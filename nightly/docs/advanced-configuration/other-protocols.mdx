...
canonical: "https://tyk.io/docs/docs/advanced-configuration/other-protocols"
---
...
1. **[TCP Proxy](/nightly/docs/key-concepts/tcp-proxy)**

2. **[gRPC](/nightly/docs/key-concepts/grpc-proxy)**

3. **[Server-Sent Events (SSE)](/nightly/docs/advanced-configuration/sse-proxy)**

4. **[WebSockets](/nightly/docs/advanced-configuration/websockets)**