...
canonical: "https://tyk.io/docs/docs/advanced-configuration/websockets"
---
...
See the [Access an API](/nightly/docs/api-management/gateway-config-managing-classic#access-an-api) tutorial for details on adding an Authentication Token to your APIs.
