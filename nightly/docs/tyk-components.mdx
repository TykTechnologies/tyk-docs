...
canonical: "https://tyk.io/docs/docs/tyk-components"
---
...
<Card title="Tyk Gateway" href="/nightly/docs/tyk-components#tyk-gateway">
The open-source core of Tyk that handles request routing, rate-limiting, and caching.
</Card>

<Card title="Tyk Dashboard" href="/nightly/docs/tyk-components#tyk-dashboard">
A powerful interface for managing and monitoring APIs, users, and permissions.
</Card>

<Card title="Tyk Enterprise Developer Portal" href="/nightly/docs/tyk-components#tyk-enterprise-developer-portal">
A customizable portal for enabling API discovery and user self-service.
</Card>

<Card title="Tyk Multi Data Centre Bridge" href="/nightly/docs/tyk-components#tyk-multi-data-centre-bridge-mdcb">
Enables centralized API management across distributed data centers for global reach and compliance.
</Card>

<Card title="Tyk Pump" href="/nightly/docs/tyk-components#tyk-pump">
Aggregates and exports API analytics from Gateway to enable insights and advanced monitoring.
</Card>

<Card title="Tyk Operator" href="/nightly/docs/tyk-components#tyk-operator">
Integrates with Kubernetes for seamless API management within containerized environments.
</Card>

<Card title="Tyk Streams" href="/nightly/docs/tyk-components#tyk-streams">
Enables real-time event streaming for APIs, ideal for push notifications and live data.
</Card>

<Card title="Tyk Sync" href="/nightly/docs/tyk-components#tyk-sync">
Synchronizes API configurations across environments for consistency and streamlined deployments.
</Card>

<Card title="Tyk Identity Broker" href="/nightly/docs/tyk-components#tyk-identity-broker">
Facilitates single sign-on (SSO) and integrates external identity providers with APIs.
</Card>

<Card title="Tyk Helm Charts" href="/nightly/docs/tyk-components#tyk-helm-charts">
Provides templated configurations to simplify deploying Tyk in Kubernetes.
</Card>

<Card title="Universal Data Graph" href="/nightly/docs/tyk-components#universal-data-graph-udg">
...
The **[Tyk Gateway](/nightly/docs/tyk-oss-gateway)** is the core of Tyk’s API management platform. This open-source, high-performance API gateway handles crucial API tasks:
...
The **[Tyk Dashboard](/nightly/docs/tyk-dashboard)** is a GUI interface for managing, monitoring, and configuring APIs. It integrates with the Tyk Gateway and offers centralized control for all API operations:
...
The **[Tyk Developer Portal](/nightly/docs/tyk-developer-portal)** provides a self-service interface for developers to access and interact with APIs. Key functionalities include:
...
The **[Tyk Multi Data Centre Bridge (MDCB)](/nightly/docs/tyk-multi-data-centre)** enables centralized control over API configurations across distributed regions or data centers. It’s ideal for global API infrastructure, offering:
...
**[Tyk Pump](/nightly/docs/tyk-pump)** is a lightweight tool that aggregates API analytics from the Tyk Gateway and exports them to various storage systems for analysis:
...
The **[Tyk Operator](/nightly/docs/api-management/automations/operator#what-is-tyk-operator)** is a Kubernetes-native API management solution, allowing teams to deploy and manage APIs as Kubernetes resources:
...
**[Tyk Streams](/nightly/docs/api-management/event-driven-apis#)** is Tyk’s real-time data streaming tool for APIs, enabling applications to receive data as events happen:
...
**[Tyk Sync](/nightly/docs/api-management/automations/sync)** facilitates configuration synchronization, helping teams manage API configurations across different environments:
...
The **[Tyk Identity Broker](/nightly/docs/api-management/external-service-integration#what-is-tyk-identity-broker-tib)** simplifies authentication by connecting APIs with external identity providers (IDPs), supporting single sign-on (SSO) capabilities:
...
**[Tyk Helm Charts](/nightly/docs/product-stack/tyk-charts/overview)** provide templated configurations for deploying Tyk components in Kubernetes, enabling efficient setup and management:
...
The **[Universal Data Graph (UDG)](/nightly/docs/api-management/data-graph#overview)** provides a single API endpoint for accessing data from multiple sources using GraphQL, offering:
...
1. **[Getting Started with Tyk Gateway](/nightly/docs/tyk-oss-gateway)**  
...
2. **[Set Up and Configure the Tyk Dashboard](/nightly/docs/tyk-dashboard)**  
...
3. **[Explore API Security](/nightly/docs/api-management/client-authentication)**  
...
4. **[Implement Multi-Region Deployments with MDCB](/nightly/docs/tyk-multi-data-centre)**  
...
5. **[Use Tyk Sync for Consistent Configuration Management](/nightly/docs/api-management/automations/sync)**  
...
6. **[Explore Tyk Developer Portal for Enhanced Developer Experience](/nightly/docs/tyk-developer-portal)**  
