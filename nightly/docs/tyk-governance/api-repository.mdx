...
canonical: "https://tyk.io/docs/docs/tyk-governance/api-repository"
---
...
For detailed installation and configuration instructions, please refer to the [Installation and Setup](/nightly/docs/tyk-governance/installation) page.
