...
canonical: "https://tyk.io/docs/docs/tyk-governance/agent-management"
---
...
4. **Deploy the Agent**
    ...
    Run the agent using Docker or as a Kubernetes Deployment. See [Installation](/nightly/docs/tyk-governance/installation#deploy-the-agent) for details.
