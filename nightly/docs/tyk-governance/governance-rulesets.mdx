...
canonical: "https://tyk.io/docs/docs/tyk-governance/governance-rulesets"
---
...
- You can now use this ruleset to [evaluate APIs](/nightly/docs/tyk-governance/api-evaluation)
...
Once you've created rulesets, you can use them to validate APIs through the [API Evaluation](/nightly/docs/tyk-governance/api-evaluation) feature, which allows you to check API specifications against your governance standards.
</Accordion>
</AccordionGroup>
