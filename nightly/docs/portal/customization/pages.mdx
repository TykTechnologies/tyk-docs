...
sidebarTitle: "Pages"
canonical: "https://tyk.io/docs/docs/portal/customization/pages"
---

We suggest you read the [portal concepts](/nightly/docs/portal/overview/concepts) first. If you've already done that, we will show you an example on how to:
