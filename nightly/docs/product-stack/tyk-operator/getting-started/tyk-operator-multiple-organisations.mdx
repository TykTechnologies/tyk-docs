...
canonical: "https://tyk.io/docs/docs/product-stack/tyk-operator/getting-started/tyk-operator-multiple-organisations"
---
...
An [OperatorContext](/nightly/docs/api-management/automations/operator#multi-tenancy-in-tyk) specifies the parameters for connecting and authenticating with a Tyk Dashboard. Below is an example of how to define an `OperatorContext`:
