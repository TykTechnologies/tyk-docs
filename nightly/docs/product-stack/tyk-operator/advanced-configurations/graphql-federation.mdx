...
canonical: "https://tyk.io/docs/docs/product-stack/tyk-operator/advanced-configurations/graphql-federation"
---

## Introduction

Tyk, with release *v4.0* offers [GraphQL federation](/nightly/docs/api-management/graphql#federation-version-support) that allows you to divide GraphQL implementation across multiple back-end
