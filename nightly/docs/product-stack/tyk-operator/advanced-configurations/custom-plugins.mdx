...
canonical: "https://tyk.io/docs/docs/product-stack/tyk-operator/advanced-configurations/custom-plugins"
---

## Introduction

Using Tyk Classic APIs, developers can implement API-level custom plugins that can be optionally setup to execute for
each of the following [hooks](/nightly/docs/api-management/plugins/plugin-types#plugin-and-hook-types) in the API request
lifecycle: [Pre (Request)](/nightly/docs/api-management/plugins/plugin-types#request-plugins), [Authentication](/nightly/docs/api-management/plugins/plugin-types#authentication-plugins),
[Post (Request)](/nightly/docs/api-management/plugins/plugin-types#request-plugins), [Post
Authentication](/nightly/docs/api-management/plugins/plugin-types#request-plugins), [Response](/nightly/docs/api-management/plugins/plugin-types#response-plugins)
and [Analytics](/nightly/docs/api-management/plugins/plugin-types#analytics-plugins). Subsequently, users can execute, or “hook”, their
...
Please refer to [Analytics Plugins](/nightly/docs/api-management/plugins/plugin-types#analytics-plugins) to learn how to configure Analytics
...
languages](/nightly/docs/api-management/plugins/overview#plugin-driver-names) section for list of supported plugin driver names.
...
[per-endpoint](/nightly/docs/api-management/plugins/plugin-types#per-endpoint-custom-plugins) level plugins are not currently
...
2. **Create API Definition Resource**
    ...
    *http://httpbin.org*.
    ...
    - The `driver` configuration parameter is set to `otto` at line 15, since our plugin is a Javascript plugin. For other
      valid values please refer to the [plugins driver page](/nightly/docs/api-management/plugins/overview#plugin-driver-names).
...
request lifecycle](/nightly/docs/api-management/traffic-transformation#request-middleware-chain).
...
bundles](/nightly/docs/api-management/plugins/overview#plugin-bundles), load them into the Tyk Gateway, and configure an API
