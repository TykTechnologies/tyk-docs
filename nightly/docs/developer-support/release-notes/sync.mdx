...
sidebarTitle: "Sync"
canonical: "https://tyk.io/docs/docs/developer-support/release-notes/sync"
---
...
#### Release Highlights
Tyk Sync 2.1.4 is a version alignment release that ensures compatibility with the most recent Tyk LTS release [5.8.6](/nightly/docs/developer-support/release-notes/dashboard#586-release-notes). No functional changes have been implemented in this release.
...
Recommended usage:
Tyk Dashboard setting: [allow-unsafe-oas](/nightly/docs/tyk-dashboard/configuration#allow_unsafe_oas)
Tyk Sync: use the [--allow-unsafe-oas](/nightly/docs/api-management/automations/sync) when invoking the CLI
