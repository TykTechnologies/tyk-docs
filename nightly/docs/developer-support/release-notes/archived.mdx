...
canonical: "https://tyk.io/docs/docs/developer-support/release-notes/archived"
---
...
See our [TCP Proxy Docs](/nightly/docs/key-concepts/tcp-proxy) for more details.
...
See our [JWT Scope docs](/nightly/docs/basic-config-and-security/security/authentication-authorization/json-web-tokens) for more details.
...
See our [Golang plugin documentation](/nightly/docs/api-management/plugins/golang#) for more details.
...
See our [Distributed Tracing documentation](/nightly/docs/api-management/logs-metrics#opentelemetry) for more details.
...
See our updated [Getting Started](/nightly/docs/tyk-self-managed/install) section and [new CLI documentation](/nightly/docs/tyk-self-managed).
...
See our [Dashboard SSO documentation](/nightly/docs/api-management/dashboard-configuration#single-sign-on-api) for more details.

### Importing WSDL APIs

WSDL now is a first class citizen at Tyk. You can take your WSDL definition and simply import to the Dashboard, creating a nice boilerplate for your service. See [Import APIs](/nightly/docs/api-management/gateway-config-managing-classic#import-an-api) for more details.
...
See [Debugging Tab](/nightly/docs/api-management/dashboard-configuration#debugging) for more information.
...
There is a [new section](/nightly/docs/api-management/dashboard-configuration#dashboard-audit-logs) in the Tyk Dashboard config file where you can specify parameters for the audit log (containing audit records for all requests made to all endpoints under the `/api` route).
...
> **TLDR**
> To get benefit or performance improvements ensure that you have `close_connections` set to `false` and set `max_idle_connections_per_host` according to our [production perfomance guide](/nightly/docs/planning-for-production)
...
Instead of setting permissions per user, you can now [create a user group](/nightly/docs/api-management/user-management#manage-tyk-dashboard-user-groups), and assign it to multiple users. It works for Single Sign-On too, just specify group ID during [SSO API](/nightly/docs/api-management/dashboard-configuration#single-sign-on-api-1) flow.
...
From an API standpoint, user groups can be managed by [new Dashboard API](/nightly/docs/api-management/dashboard-configuration#user-groups-api). The User object now has a new `group_id` field, and if it is specified, all permissions will be inherited from the specified group. [SSO API](/nightly/docs/api-management/dashboard-configuration#single-sign-on-api-1) has been updated to include `group_id` field as well.

#### Added SMTP support
Now you can configure the Dashboard to send transactional emails using your SMTP provider. See [Outbound Email Configuration](/nightly/docs/configure/outbound-email-configuration) for details.

#### <a name="upgrade"></a>Upgrading all new Components

For details on upgrading all Tyk versions, see [Upgrading Tyk](/nightly/docs/developer-support/upgrading).
...
See the Keys section of the [Tyk Gateway REST API](/nightly/docs/tyk-gateway-api) Swagger doc for more details.
...
See [List Key Requests](/nightly/docs/tyk-apis/tyk-dashboard-api/manage-key-requests#list-key-requests) for more details.
...
See [Developer Profiles](/nightly/docs/tyk-developer-portal/tyk-portal-classic/developer-profiles#reset-developer-password) for more details.
...
[Docs](/nightly/docs/api-management/logs-metrics#statsd-instrumentation)
...
[Docs](/nightly/docs/api-management/gateway-config-tyk-classic#tyk-classic-api-versioning)
...
[Docs](/nightly/docs/tyk-oss-gateway/configuration#http_server_options)
...
[Docs](/nightly/docs/tyk-oss-gateway/configuration#enable_key_logging)
...
[Docs](/nightly/docs/api-management/certificates)
...
[JSVM Docs](/nightly/docs/api-management/plugins/javascript#using-javascript-with-tyk)
[Plugin Data Structure Docs](/nightly/docs/api-management/plugins/rich-plugins#rich-plugins-data-structures)
...
* [API Docs](/nightly/docs/api-management/dashboard-configuration#manage-apis-api-definition)
* [Policy Docs](/nightly/docs/tyk-apis/tyk-dashboard-api/portal-policies)
...
[Docs](/nightly/docs/transform-traffic/url-rewriting#url-rewrite-middleware)
...
[Docs](/nightly/docs/tyk-oss-gateway/configuration)
...
[Docs](/nightly/docs/api-management/policies#partitioned-policies)
...
[Docs](/nightly/docs/api-management/dashboard-configuration#activity-logs)
...
* Enable Tyk Identity Broker to apply LDAP filters to user search [Docs](/nightly/docs/api-management/single-sign-on-ldap)
* Set permissions for your users, logged via SSO, via `sso_permission_defaults` in Dashboard config file. [Docs](/nightly/docs/api-management/external-service-integration)
* Setup a login page redirect, using `sso_custom_login_url` and `sso_custom_portal_login_url` Dashboard config options to enable users login using a custom SSO login page. [Docs](/nightly/docs/api-management/external-service-integration)
* For those who love to build everything in-house, we have added new API for custom dashboard authentication integrations. [Docs](/nightly/docs/api-management/custom-auth-with-proxy-identity-provider)
...
#### Mutual TLS support
[Docs](/nightly/docs/basic-config-and-security/security/mutual-tls/client-mtls#why-use-mutual-tls)

#### Global API rate limits
[Docs](/nightly/docs/api-management/rate-limit#rate-limiting-layers)
...
[Docs](/nightly/docs/tyk-oss-gateway/configuration#control_api_port)
...
[Docs](/nightly/docs/tyk-oss-gateway/configuration#log_level)
...
[Docs](/nightly/docs/api-management/traffic-transformation/request-body)
...
[Docs](/nightly/docs/tyk-gateway-api)
...
```
[Docs](/nightly/docs/api-management/external-service-integration)
...
[Docs](/nightly/docs/api-management/custom-auth-with-proxy-identity-provider)
...
Added support for Mutual TLS, mentioned by Gateway and Dashboard above. See [Docs](/nightly/docs/basic-config-and-security/security/mutual-tls/client-mtls#why-use-mutual-tls)
...
Tyk Identity Broker now fully support LDAP search with complex filters! [Docs](/nightly/docs/api-management/single-sign-on-ldap)
...
Hybrid users should follow the upgrade instructions [here](/nightly/docs/developer-support/upgrading#tyk-upgrade-guides-for-different-deployment-models).
