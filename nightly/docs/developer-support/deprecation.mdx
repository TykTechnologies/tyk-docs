...
canonical: "https://tyk.io/docs/docs/developer-support/deprecation"
---
...
*   **Upgrade Guides:** Please consult the official [Tyk Upgrade Documentation](/nightly/docs/developer-support/upgrading) for detailed instructions.
*   **Release Notes:** Review the [Tyk Release Notes](/nightly/docs/developer-support/release-notes/overview) for information on new features and changes in recent versions.
