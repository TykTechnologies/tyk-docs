...
canonical: "https://tyk.io/docs/docs/developer-support/upgrading"
---
...
- **Long Term Support:** Refer to our [versioning and long-term support policies](/nightly/docs/developer-support/release-types/long-term-support) for details on major and minor releases, patches, and support dates.
...
- **Backups:** Follow our [comprehensive backup guide](/nightly/docs/developer-support/faq#tyk-configuration) before starting the upgrade.
...
Use our [migration tool](/nightly/docs/planning-for-production/database-settings#migrating-from-an-existing-mongodb-instance) to manage the switch from MongoDB to SQL.

##### Backup APIs Script

Utilize our bash [backup script](/nightly/docs/developer-support/upgrading#backup-apis-and-policies) to export and restore all Tyk API Definitions and Policies.
...
Have backups been performed?
  ...
  - Backup guide: Have you checke our [comprehensive guide for backing up Tyk](/nightly/docs/developer-support/faq#tyk-configuration)?
...
3. **Upgrade Process:**
   ...
   - If using a new deployment process, follow the [deployment instructions](/nightly/docs/tyk-self-managed) appropriate for your platform.
...
Follow our guide for [upgrading Cloud Control Planes](/nightly/docs/tyk-cloud/environments-deployments/managing-control-planes#upgrade-cloud-control-planes).
...
2. Update the [custom_middleware_bundle](/nightly/docs/api-management/plugins/overview#plugin-bundles) field in the API Definitions of all APIs that use your plugin. The field should be updated to use the new bundle file containing your upgrade plugin.
3. Validate that your plugin is working per your expectations.

**Gateway Versions >= 4.1.0**

1. Update the [custom_middleware_bundle](/nightly/docs/api-management/plugins/overview#plugin-bundles) field in the API Definitions of all APIs that use your plugin. The field should be updated to use the new bundle file containing your upgraded plugin.
...
Follow our guide for [upgrading Cloud Data Planes](/nightly/docs/tyk-cloud/environments-deployments/managing-gateways).
...
See Tyk Guide for how to [upgrade Control Planes](/nightly/docs/tyk-cloud/environments-deployments/managing-control-planes#upgrade-cloud-control-planes)
...
2. Update the [custom_middleware_bundle](/nightly/docs/api-management/plugins/overview#plugin-bundles)
...
1. Update the [custom_middleware_bundle](/nightly/docs/api-management/plugins/overview#plugin-bundles)
field in the API Definitions of all APIs that use your plugin. The field should be updated to use the new bundle file
...
1. [Create a plugin bundle](/nightly/docs/api-management/plugins/overview#plugin-bundles) that includes the newly compiled version
...
2. [Upload this bundle](/nightly/docs/tyk-cloud/using-plugins#uploading-your-bundle) to your configured S3 bucket if using Cloud SaaS. If you're using Hybrid SaaS, upload this bundle to your bundle server.


**Path 2 - Current `Version >= 4`.1.0 and Target `Version >= 4`.2.0**

1. [Create a plugin bundle](/nightly/docs/api-management/plugins/overview#plugin-bundles) that includes both your current version’s plugin along with the newly compiled version
...
the addition of the [Multi Data Center Bridge](/nightly/docs/tyk-multi-data-centre) (MDCB).
...
For full installation details, check the usual [installation page](/nightly/docs/apim/open-source/installation#install-tyk-gateway-with-docker).
...
If you are using Self Managed deployment then we recommend that you use [Tyk Sync](/nightly/docs/api-management/automations/sync) to backup your Tyk APIs and policies. 
