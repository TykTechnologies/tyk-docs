...
canonical: "https://tyk.io/docs/docs/planning-for-production/monitoring/tyk-components"
---
...
For information about our health check endpoint, please visit our [Liveness Health Check](/nightly/#liveness-health-check) documentation.
...
The Tyk Dashboard liveness health check endpoint can be configured [here](/nightly/docs/tyk-dashboard/configuration#health_check_endpoint_name). 

The Tyk MDCB liveness health check endpoint can be configured [here](/nightly/docs/api-management/mdcb#health-check). 
...
The Tyk Pump component offers a built-in Liveness Health Check endpoint [here](/nightly/docs/tyk-pump/tyk-pump-configuration/tyk-pump-environment-variables#health-check). 
...
* [Redis Sizing](/nightly/docs/planning-for-production/database-settings#redis-sizing-guidelines)
* [PostgreSQL Sizing](/nightly/docs/planning-for-production/database-settings#postgresql-sizing-guidelines)
* [MongoDB Sizing](/nightly/docs/planning-for-production/database-settings#mongodb-sizing-guidelines)
