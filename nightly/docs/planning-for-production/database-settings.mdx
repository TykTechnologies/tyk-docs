...
canonical: "https://tyk.io/docs/docs/planning-for-production/database-settings"
---
...
* [Redis](/nightly/docs/planning-for-production/database-settings#redis)
* [MongoDB](/nightly/docs/planning-for-production/database-settings#mongodb-sizing-guidelines)
* [PostgreSQL](/nightly/docs/planning-for-production/database-settings#postgresql)

Please consult the [data storage configuration](/nightly/docs/api-management/dashboard-configuration#data-storage-solutions) guide for further information relating to how to configure Tyk's data storage across different database engines.
...
**Capping Analytics**
Tyk Gateways can generate a lot of analytics data. Be sure to read about [capping your Dashboard analytics](/nightly/docs/api-management/tyk-pump#tyk-pump-capping-analytics-data-storage)
...
* [Configure Dashboard MongoDB driver](/nightly/docs/tyk-dashboard/configuration#mongo_driver)
* [Configure MDCB MongoDB driver](/nightly/docs/tyk-multi-data-centre/mdcb-configuration-options#analyticsdriver)
...
<Note>
If you are using [DocumentDB](https://aws.amazon.com/documentdb/), [capped collections](/nightly/docs/api-management/tyk-pump#tyk-pump-capping-analytics-data-storage) are not supported. See [here](https://docs.aws.amazon.com/documentdb/latest/developerguide/mongo-apis.html) for more details.
</Note>
...
More information on these configuration variables [here](/nightly/docs/tyk-dashboard/configuration). 
