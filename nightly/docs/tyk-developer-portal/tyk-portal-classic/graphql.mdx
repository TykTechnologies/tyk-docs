...
canonical: "https://tyk.io/docs/docs/tyk-developer-portal/tyk-portal-classic/graphql"
---
...
As of Tyk v3.0.0, you can now publish GraphQL APIs, including [Universal Data Graph](/nightly/docs/api-management/data-graph#overview) APIs(UDG) to the Tyk Developer Portal.
