...
canonical: "https://tyk.io/docs/docs/tyk-developer-portal/tyk-portal-classic/curity-dcr"
---
...
- A [Tyk Self-Managed installation](/nightly/docs/tyk-self-managed/install) (Gateway + Dashboard).
