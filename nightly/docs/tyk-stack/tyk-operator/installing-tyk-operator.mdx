...
canonical: "https://tyk.io/docs/docs/tyk-stack/tyk-operator/installing-tyk-operator"
---

## Introduction

We assume you have already installed Tyk. If you don’t have it, check out [Tyk
Cloud](/nightly/docs/tyk-cloud#quick-start-tyk-cloud) or [Tyk Self
Managed](/nightly/docs/tyk-self-managed) page. [Tyk Helm
Chart](/nightly/docs/product-stack/tyk-charts/overview) is the preferred (and easiest) way to install Tyk on Kubernetes.
...
Tyk Operator needs a [user credential](/nightly/docs/api-management/automations/operator#operator-user) to connect with
...
[Using Tyk Operator to enable GitOps with Tyk](/nightly/docs/api-management/automations) about
...
If you are using [Tyk Stack](/nightly/docs/product-stack/tyk-charts/tyk-stack-chart), [Tyk Control
Plane](/nightly/docs/product-stack/tyk-charts/tyk-control-plane-chart), or [Tyk Open
Source Chart](/nightly/docs/product-stack/tyk-charts/tyk-oss-chart), you can install Tyk Operator alongside other Tyk
...
You can configure [Tyk Operator as Ingress Controller](/nightly/docs/product-stack/tyk-operator/tyk-ingress-controller) so
