...
canonical: "https://tyk.io/docs/docs/troubleshooting/tyk-dashboard/not-found-error-developer-portal"
---
...
You should also look at the [portal tutorial](/nightly/docs/getting-started/tutorials/publish-api) for creating an API and publishing it to your Portal.
