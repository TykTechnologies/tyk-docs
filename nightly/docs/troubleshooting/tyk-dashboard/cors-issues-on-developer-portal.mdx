...
canonical: "https://tyk.io/docs/docs/troubleshooting/tyk-dashboard/cors-issues-on-developer-portal"
---
...
Make sure that your CORS in the `Advanced Options` of the API is enabled and the settings are correct. This means:
 ...
 - [CORS in API Definition](/nightly/docs/api-management/gateway-config-tyk-classic#cross-origin-resource-sharing-cors)
 - [How to setup CORS](/nightly/docs/api-management/troubleshooting-debugging#how-to-setup-cors) 
