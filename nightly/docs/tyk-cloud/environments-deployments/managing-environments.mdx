...
canonical: "https://tyk.io/docs/docs/tyk-cloud/environments-deployments/managing-environments"
---

## Introduction

Environments are used to group your [Control Plane](/nightly/docs/tyk-cloud#glossary) and [Cloud Data Planes](/nightly/docs/tyk-cloud#glossary) into logical groups. For example you may want to create environments that reflect different departments of your organization.


<Note>
The number of Environments you can create is determined by your [plan](/nightly/docs/tyk-cloud/account-billing#select-a-payment-plan)
</Note>


## Prerequisites

The following [user roles](/nightly/docs/tyk-cloud/teams-users#assign-user-roles) can perform Environment Admin tasks:
