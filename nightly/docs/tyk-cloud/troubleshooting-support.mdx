...
canonical: "https://tyk.io/docs/docs/tyk-cloud/troubleshooting-support"
---
...
To add either of the tags, see [Adding an API](/nightly/docs/tyk-cloud#steps-to-add-an-api-in-tyk-cloud) in the Getting Started section.
