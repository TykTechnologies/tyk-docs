...
canonical: "https://tyk.io/docs/docs/tyk-cloud/securing-your-apis"
---
...
* [Adding APIs](/nightly/docs/api-management/gateway-config-managing-classic#create-an-api) to Tyk, including REST and GraphQL APIs
* Applying Quotas and Rate limits via [Security Policies](/nightly/docs/api-management/gateway-config-managing-classic#secure-an-api) and [Keys](/nightly/docs/api-management/gateway-config-managing-classic#access-an-api)
* [Securing](/nightly/docs/api-management/security-best-practices#securing-apis-with-tyk) your APIs
* Viewing granular [Analytics](/nightly/docs/api-management/dashboard-configuration#traffic-analytics) for your Tyk managed APIs
* [Transform traffic](/nightly/docs/api-management/traffic-transformation) with the Tyk API Designer
* Add integration options such as [SSO](/nightly/docs/api-management/external-service-integration#single-sign-on-sso) and [3rd Party IdentityProviders](/nightly/docs/api-management/external-service-integration)
* [Adding Segment Tags](/nightly/docs/tyk-cloud/troubleshooting-support)
