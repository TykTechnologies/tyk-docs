...
canonical: "https://tyk.io/docs/docs/tyk-cloud/account-billing"
---
...
* The available [Tyk Cloud Plans](/nightly/docs/tyk-cloud/account-billing#select-a-payment-plan)
...
If your free trial ends without you upgrading, your account enters what we call [retirement](/nightly/docs/tyk-cloud#glossary).
...
* Select a new [plan](/nightly/docs/tyk-cloud/account-billing#select-a-payment-plan) from our list
...
Your plan will go into [retirement](/nightly/docs/tyk-cloud#glossary) in the following scenarios:
