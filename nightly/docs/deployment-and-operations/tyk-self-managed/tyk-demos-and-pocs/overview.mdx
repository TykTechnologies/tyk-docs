...
sidebarTitle: "Demos"
canonical: "https://tyk.io/docs/docs/deployment-and-operations/tyk-self-managed/tyk-demos-and-pocs/overview"
---
...
- [portal](https://github.com/TykTechnologies/tyk-k8s-demo/tree/main/src/deployments/portal): deploys the [Tyk Enterprise Developer Portal](/nightly/docs/portal/overview/intro) as well as its dependency PostgreSQL.
