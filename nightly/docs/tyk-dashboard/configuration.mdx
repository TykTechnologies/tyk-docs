...
canonical: "https://tyk.io/docs/docs/tyk-dashboard/configuration"
---
...
To understand how the environment variables notation works, see [Environment Variables](/nightly/docs/tyk-oss-gateway/configuration).
