...
canonical: "https://tyk.io/docs/docs/api-management/manage-apis/deploy-apis/deploy-apis-overview"
---
...
**Learn more:**
* [Create an API in file-based mode](/nightly/docs/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
**Learn more:**
* [Create an API with the Dashboard](/nightly/docs/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
**Learn more:**
- [Dashboard API](/nightly/docs/api-management/dashboard-configuration#exploring-the-dashboard-api)
- [Gateway API](/nightly/docs/tyk-gateway-api)
...
**Learn more:**
- [Tyk Sync](/nightly/docs/api-management/automations/sync)
...
**Learn more:**
- [Tyk Operator](/nightly/docs/api-management/automations/operator#what-is-tyk-operator)
- [Using Tyk Operator to enable GitOps](/nightly/docs/api-management/automations)
