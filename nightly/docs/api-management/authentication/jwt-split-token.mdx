...
canonical: "https://tyk.io/docs/docs/api-management/authentication/jwt-split-token"
---
...
1. **Token Issuance**:
    ...
    - Tyk intercepts this response through a [Virtual Endpoint](/nightly/docs/api-management/traffic-transformation/virtual-endpoints)
