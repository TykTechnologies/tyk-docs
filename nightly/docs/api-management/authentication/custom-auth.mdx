...
canonical: "https://tyk.io/docs/docs/api-management/authentication/custom-auth"
---
...
To learn more about using Tyk Golang Plugins, go [here](/nightly/docs/api-management/plugins/golang)
...
* See [Custom Authentication with a Python plugin](/nightly/docs/api-management/plugins/rich-plugins#custom-authentication-plugin-tutorial) for a detailed example of a custom Python plugin.
* See [JavaScript Middleware](/nightly/docs/api-management/plugins/javascript#) for more details on using JavaScript Middleware. 
