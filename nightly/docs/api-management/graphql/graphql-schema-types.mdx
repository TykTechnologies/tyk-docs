...
canonical: "https://tyk.io/docs/docs/api-management/graphql/graphql-schema-types"
---
...
Tyk supports [GraphQL Federation v1](/nightly/docs/api-management/graphql#graphql-federation) for building unified APIs across multiple services.
