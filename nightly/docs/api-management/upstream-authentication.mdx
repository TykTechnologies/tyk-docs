...
- [Mutual TLS](/nightly/docs/api-management/upstream-authentication/mtls)
- [Token-based authentication](/nightly/docs/api-management/upstream-authentication/auth-token)
- [Request signing](/nightly/docs/api-management/upstream-authentication/request-signing)
- [Basic Authentication](/nightly/docs/api-management/upstream-authentication/basic-auth)
- [OAuth 2.0](/nightly/docs/api-management/upstream-authentication/oauth)
    - [OAuth 2.0 Client Credentials](/nightly/docs/api-management/upstream-authentication/oauth#oauth-client-credentials)
    - [OAuth 2.0 Password Grant](/nightly/docs/api-management/upstream-authentication/oauth#oauth-resource-owner-password-credentials)
