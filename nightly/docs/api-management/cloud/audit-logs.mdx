...
canonical: "https://tyk.io/docs/docs/api-management/cloud/audit-logs"
---
...
For details on the API endpoints and usage, see [Retrieving Audit Logs via API](/nightly/docs/api-management/dashboard-configuration#retrieving-audit-logs-via-api).
