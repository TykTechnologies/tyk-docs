...
canonical: "https://tyk.io/docs/docs/api-management/upstream-authentication/request-signing"
---
...
For Request Signing, you must configure [upstream.authentication.upstreamRequestSigning](/nightly/docs/api-management/gateway-config-tyk-oas#upstreamrequestsigning), providing the following settings:
...
The Tyk Classic equivalent is [request_signing](/nightly/docs/api-management/gateway-config-tyk-classic#upstream-authentication).
