...
canonical: "https://tyk.io/docs/docs/api-management/external-service-integration"
---
...
This page introduces general features of Tyk Identity Broker (TIB) and how to configure them. If you are looking for global configurations of the TIB deployment refer this [config file](/nightly/docs/tyk-configuration-reference/tyk-identity-broker-configuration).
...
Refer to this [document](/nightly/docs/tyk-identity-broker/tib-rest-api)
...
1. [Login with 3rd party social providers](/nightly/docs/api-management/single-sign-on-social-idp)
2. [Login with any IdP that supports OIDC](/nightly/docs/api-management/single-sign-on-oidc)
3. [Login with any IdP that supports SAML](/nightly/docs/api-management/single-sign-on-saml)
3. [Login with LDAP](/nightly/docs/api-management/single-sign-on-ldap)
...
- `/admin/sso` - See [Dashboard Admin API SSO](/nightly/docs/api-management/dashboard-configuration#single-sign-on-api-1) for more details.
- `/api/sso` -  See [Dashboard API SSO](/nightly/docs/api-management/dashboard-configuration#single-sign-on-api) for more details.
