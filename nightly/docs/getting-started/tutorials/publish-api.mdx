...
canonical: "https://tyk.io/docs/docs/getting-started/tutorials/publish-api"
---
...
This is for the closed source [Tyk Developer Portal](/nightly/docs/tyk-developer-portal) only
