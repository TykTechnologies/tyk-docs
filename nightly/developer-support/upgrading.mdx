...
Follow our guide for [upgrading Cloud Control Planes](/nightly/tyk-cloud#upgrade-control-planes).
...
Follow our guide for [upgrading Cloud Data Planes](/nightly/tyk-cloud#managing-cloud-data-plane).
...
See Tyk Guide for how to [upgrade Control Planes](/nightly/tyk-cloud#upgrade-control-planes)
...
2. [Upload this bundle](/nightly/tyk-cloud#uploading-your-bundle) to your configured S3 bucket if using Cloud SaaS. If you're using Hybrid SaaS, upload this bundle to your bundle server.
