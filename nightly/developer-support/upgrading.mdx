...
canonical: "https://tyk.io/docs/nightly/developer-support/upgrading"
---
...
| **Tyk MDCB Self Managed** | [MDCB](/nightly/#upgrade-mdcb) | Guide for upgrading Mutli Data Center Bridge (MDCB) |
...
Have backups been performed?
  ...
  - Backup guide: Have you checke our [comprehensive guide for backing up Tyk](/nightly/developer-support/faq#tyk-configuration)?
...
<h4 className="next-steps">Next Steps</h4>
...
<h6 className="upgrading-cloud-data-planes">Step 3. Upgrade Cloud Data Plane</h6>
...
<h6 className="upgrading-data-plane-hybrid-gateways">Step 3. Upgrade your Tyk Data Plane Hybrid Gateway(s)</h6>
...
<h6 className="upgrade-mdcb">Upgrade order with Multi Data Center Bridge (MDCB)</h6>
For Enterprise customers, the Tyk control plane contains all the standard components of a Self-Managed installation with
the addition of the [Multi Data Center Bridge](/nightly/tyk-multi-data-centre) (MDCB).
...
<h4 className="upgrade-linux-debian">Linux - Debian</h4>
...
<h4 className="upgrade-linux-redhat-centos">Linux - RedHat (CentOS)</h4>
...
<h4 className="path-1">Path 1 - Current Version < 4.1.0 and Target Version < 4.1.0</h4>
...
<h4 className="path-2">Path 2 - Current Version < 4.1.0 and Target Version >= 4.1.0</h4>
1. Open a terminal/command prompt in the directory of your plugin source file(s)  
...
<h4 className="path-3">Path 3 - Current `Version >= 4`.1.0 and Target `Version >= 5`.1.0</h4>
1. Open a terminal/command prompt in the directory of your plugin source file(s)  
