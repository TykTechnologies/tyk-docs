...
For production environments, it is recommended to use [Helm charts](/nightly/#helm) or the [Tyk Operator](/nightly/tyk-stack/tyk-operator/installing-tyk-operator/#upgrading-tyk-operator) to manage upgrades with zero downtime.
