...
Follow our guide for [upgrading Cloud Control Planes](/nightly/tyk-cloud/environments-deployments/managing-control-planes#upgrade-control-planes).
...
See Tyk Guide for how to [upgrade Control Planes](/nightly/tyk-cloud/environments-deployments/managing-control-planes#upgrade-control-planes)
