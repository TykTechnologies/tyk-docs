...
3. **Does the portal support SQL databases for storing the portal's CMS assets ?**
    ...
    <Note>
    Tyk no longer supports SQLite as of Tyk 5.7.0. To avoid disruption, please transition to [PostgreSQL](/nightly/tyk-configuration-reference/sql), [MongoDB](/nightly/tyk-configuration-reference/mongodb), or one of the listed compatible alternatives.
    </Note>
