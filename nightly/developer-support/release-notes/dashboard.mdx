...
<h4 className="dependencies-5.9.2">Dependencies</h4>
...
<h5 className="3rdPartyTools-v5.9.1">3rd Party Dependencies & Tools</h5>
...
<h4 className="upgrade-5.9.2">Upgrade instructions</h4>
...
- [Docker Image to pull](https://hub.docker.com/r/tykio/tyk-dashboard/tags?page=&page_size=&ordering=&name=v5.9.2)
  - ```bash
    ...
    ```
- Helm charts
  - [tyk-charts v3.0.0](/nightly/developer-support/release-notes/helm-chart#300-release-notes)
...
<h4 className="Changelog-v5.9.2">Changelog</h4>
##### Fixed
...
<h4 className="dependencies-5.9.1">Dependencies</h4>
| Dashboard Version | Recommended Releases | Backwards Compatibility |
| :-------- | :------------------- | :------------- |
...
<h4 className="upgrade-5.9.1">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.9.1">Changelog</h4>
##### Fixed
...
This release builds on the recent release of [Tyk 5.8.3](/nightly/developer-support/release-notes/dashboard#583-release-notes), adding a collection of new capabilities. For a comprehensive list of changes, please refer to the detailed [changelog](/nightly/#Changelog-v5.9.0).
...
<h4 className="dependencies-5.9.0">Dependencies</h4>
| Dashboard Version | Recommended Releases | Backwards Compatibility |
| :-------- | :------------------- | :------------- |
...
<h5 className="3rdPartyTools-v5.9.0">3rd Party Dependencies & Tools</h5>
| Third Party Dependency | Tested Versions | Compatible Versions | Comments | 
| :---------------------- | :--------------- | :------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)          | 1.23 | 1.23 | [Go plugins](/nightly/api-management/plugins/golang) must be built using Go 1.23 | 
| [Redis](https://redis.io/download/)   | 5.x, 6.x, 7.x    |  5.x, 6.x, 7.x    | | 
...
<h4 className="upgrade-5.9.0">Upgrade instructions</h4>
...
<h4 className="Changelog-v5.9.0">Changelog</h4>
##### Added
...
<h5 className="Fixed-v5.9.0">Fixed</h5>
<ul>
<li>
...
- [Docker Image to pull](https://hub.docker.com/r/tykio/tyk-dashboard/tags?page=&page_size=&ordering=&name=v5.7.3)
  - ```bash
    ...
    ```
- Helm charts
  - [tyk-charts v2.2.0](/nightly/developer-support/release-notes/helm-chart#220-release-notes)
...
- ```bash
  ...
  ```
- Helm charts
  - [Tyk Charts v2.0.0](/nightly/developer-support/release-notes/helm-chart#200-release-notes)
...
- ```bash
  ...
  ```
- Helm charts
  - [tyk-charts v2.1.0](/nightly/developer-support/release-notes/helm-chart#210-release-notes)
...
- ```bash
  ...
  ```
- Helm charts
  - [tyk-charts v1.6](/nightly/developer-support/release-notes/helm-chart#160-release-notes)
...
- ```bash
  ...
  ```
- Helm charts
  - [tyk-charts v1.5](/nightly/developer-support/release-notes/helm-chart#150-release-notes)
...
- [Docker Image to pull](https://hub.docker.com/r/tykio/tyk-dashboard/tags?page=&page_size=&ordering=&name=v5.3.6)
 - ```bash
   ...
   ```
- Helm charts
 - [tyk-charts v2.0](/nightly/developer-support/release-notes/helm-chart#200-release-notes)
...
- [Docker Image to pull](https://hub.docker.com/r/tykio/tyk-dashboard/tags?page=&page_size=&ordering=&name=v5.3.4)
 - ```bash
   ...
   ```
- Helm charts
 - [tyk-charts v1.4](/nightly/developer-support/release-notes/helm-chart#140-release-notes)
...
- ```bash
  ...
  ```
- Helm charts
  - [tyk-charts v1.3](/nightly/developer-support/release-notes/helm-chart#130-release-notes)
...
size using [slave_options.rpc_pool_size](/nightly/tyk-oss-gateway/configuration#slave_optionsrpc_pool_size)
...
- Added option to configure certificates for Tyk Dashboard using [environment variables](/nightly/tyk-dashboard/configuration#http_server_optionscertificates).
...
#### Upgrade process
If you already have GraphQL or UDG APIs you need to follow this [upgrade guide](/nightly/api-management/graphql#migrating-to-32).
...
If you are upgrading from version 2.8, please [read this guide](/nightly/developer-support/release-notes/archived#upgrading-from-version-28)
