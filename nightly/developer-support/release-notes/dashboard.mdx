...
[Setup guide for JWE OIDC SSO](/nightly/api-management/single-sign-on-social-idp#log-into-an-app-with-github-oauth)
</Accordion>
...
To learn more [see the documentation](/nightly/api-management/external-service-integration)
...
See [updated flow details](/nightly/api-management/external-service-integration#what-is-tyk-identity-broker-tib-)
