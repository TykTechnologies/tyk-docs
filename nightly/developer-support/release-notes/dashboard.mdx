...
<h4 id="dependencies-5.9.1">Dependencies</h4>
...
<h5 id="3rdPartyTools-v5.9.1">3rd Party Dependencies & Tools</h5>
...
<h4 id="upgrade-5.9.1">Upgrade instructions</h4>
...
<h4 id="Changelog-v5.9.1">Changelog</h4>
##### Fixed
...
We have implemented a [change](/nightly/developer-support/release-notes/dashboard#Fixed-v5.9.0) to the behaviour of the `GET /api/streams/{apiID}` endpoint, which now expects an `Accept` header, not `Content-Type`.

<h4 id="dependencies-5.9.0">Dependencies</h4>
| Dashboard Version | Recommended Releases | Backwards Compatibility |
| :-------- | :------------------- | :------------- |
...
<h5 id="3rdPartyTools-v5.9.0">3rd Party Dependencies & Tools</h5>
| Third Party Dependency | Tested Versions | Compatible Versions | Comments | 
| :---------------------- | :--------------- | :------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)          | 1.23 | 1.23 | [Go plugins](/nightly/api-management/plugins/golang) must be built using Go 1.23 | 
| [Redis](https://redis.io/download/)   | 5.x, 6.x, 7.x    |  5.x, 6.x, 7.x    | | 
...
<h4 id="upgrade-5.9.0">Upgrade instructions</h4>
...
<h4 id="Changelog-v5.9.0">Changelog</h4>
##### Added
...
<h4 id="dependencies-5.8.5">Dependencies</h4>
...
<h4 id="upgrade-5.8.5">Upgrade instructions</h4>
...
<h4 id="Changelog-v5.8.5">Changelog</h4>
##### Fixed

<ul>
<li>
<Expandable title={'Consistent Handling of Escaped Dots in OAS Paths'}>
...
Check the [Upgrade and Compatibility section](/nightly/#upgrade-instructions) for details on the recommended upgrade path.
</Expandable>
</li>
</ul>
...
<h4 id="dependencies-5.8.4">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 id="3rdPartyTools-v5.8.4">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)                               | 1.23       | 1.23       | [Go plugins](/nightly/api-management/plugins/golang) must be built using Go 1.23 | 
...
<h4 id="upgrade-5.8.4">Upgrade instructions</h4>
...
<h4 id="Changelog-v5.8.4">Changelog</h4>
##### Fixed
...
<h4 id="dependencies-5.8.3">Dependencies</h4>
##### Compatibility Matrix For Tyk Components
...
<h5 id="3rdPartyTools-v5.8.3">3rd Party Dependencies & Tools</h5>
| Third Party Dependency                                     | Tested Versions        | Compatible Versions    | Comments | 
| :---------------------------------------------------------- | :---------------------- | :---------------------- | :-------- | 
| [GoLang](https://go.dev/dl/)                               | 1.23       | 1.23       | [Go plugins](/nightly/api-management/plugins/golang) must be built using Go 1.23 | 
| [Redis](https://redis.io/download/)  | 6.2.x, 7.x  | 6.2.x, 7.x  | Used by Tyk Dashboard | 
...
<h4 id="upgrade-5.8.3">Upgrade instructions</h4>
...
<h4 id="Changelog-v5.8.3">Changelog</h4>
##### Fixed
