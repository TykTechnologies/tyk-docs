...
- Familiarize yourself with URL matching in Tyk [here](/nightly/getting-started/key-concepts/url-matching).
...
Learn more about the settings in the [URL Path Matching](/nightly/getting-started/key-concepts/url-matching) documentation.
</Expandable>
