...
Tyk Charts 1.3 adds a field to enable Internal [Tyk Identity Broker (TIB)](/nightly/api-management/external-service-integration#what-is-tyk-identity-broker-tib-) in Tyk Dashboard by field `tyk-dashboard.tib.enabled` to `true`.
...
You can enable Internal [Tyk Identity Broker (TIB)](/nightly/api-management/external-service-integration#what-is-tyk-identity-broker-tib-) in Tyk Dashboard by field `tyk-dashboard.tib.enabled` to `true`.
</Accordion>
