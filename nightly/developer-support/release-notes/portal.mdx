...
'og:description': "Release notes documenting updates, enhancements and changes for Tyk Enterprise Developer Portal v1.13.0"
...
<h4 className="breaking-changes-v1.14.1">Breaking Changes</h4>
...
<h4 className="Changelog-v1.14.1">Changelog</h4>
##### Fixed
...
<h4 className="breaking-changes-v1.14.0">Breaking Changes</h4>
There are no breaking changes in this release.
...
<h4 className="Changelog-v1.14.0">Changelog</h4>
##### Added
<ul>
<li>
<AccordionGroup>
...
<h4 className="Changelog-v1.13.2">Changelog</h4>
#### Fixed 
...
<h4 className="Changelog-v1.13.1">Changelog</h4>
#### Fixed 
...
<h4 className="breaking-changes-v1.13.0">Breaking Changes</h4>
...
<h4 className="Changelog-v1.13.0">Changelog</h4>
##### Added
<ul>
<li>
<AccordionGroup>
...
<h4 className="Changelog-v1.12.0">Changelog</h4>
...
You can read more about the supported SSO providers [here](/nightly/tyk-identity-broker).
</Accordion>
...
##### Get started guides
API Providers can add [Get started guides](/nightly/tyk-stack/tyk-developer-portal/enterprise-developer-portal/getting-started-with-enterprise-portal/manage-get-started-guides-for-api-products) to API Products for better developer experiences:
...
- Added the [Get started guides](/nightly/tyk-stack/tyk-developer-portal/enterprise-developer-portal/getting-started-with-enterprise-portal/manage-get-started-guides-for-api-products) for API Products so that admins can explain to their consumers how use their API Products.
...
- Added [tags](/nightly/tyk-stack/tyk-developer-portal/enterprise-developer-portal/getting-started-with-enterprise-portal/manage-get-started-guides-for-api-products) for API Products and blog posts so that API Providers have greater control over which blog posts to display on their API Product page.
