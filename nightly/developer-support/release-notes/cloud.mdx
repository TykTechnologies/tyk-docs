...
keywords: "Tyk Cloud, Release notes, v1.23, 1.23.0, v1.24, 1.24.0, v1.25, 1.25.0, v1.26, 1.26.0, 1.27.0, 1.28.0, 1.28.1, 1.29.0, 1.30.0, 1.31.0, 1.31.1, 1.31.2, 1.32.0, 1.33.0 changelog"
sidebarTitle: "Tyk Cloud"
canonical: "https://tyk.io/docs/developer-support/release-notes/cloud"
noindex: true
...
This release fixes CVEs and updates the Go toolchain to Go 1.26.
For a comprehensive list of changes, please refer to the detailed [changelog](#Changelog-v1.33.1) below.
...
#### Changelog 
<a id="Changelog-v1.33.1" data-scroll-offset></a>
...
{/* TT-17868 */}
Ara has been updated to build with Go 1.26, keeping the toolchain current with upstream Go security and performance updates.
</Accordion>
...
#### Release Highlights
Addressed several CVEs within dependencies; no functional changes have been implemented.
...
#### Changelog 
<a id="Changelog-v1.33.0" data-scroll-offset></a>
...
#### Changelog 
<a id="Changelog-v1.31.2" data-scroll-offset></a>
...
#### Changelog 
<a id="Changelog-v1.31.1" data-scroll-offset></a>
...
#### Changelog 
<a id="Changelog-v1.31.0" data-scroll-offset></a>

There are no changes in this release

## 1.30 Release Notes

### 1.30.3 Release Notes
...
#### Changelog 
<a id="Changelog-v1.30.2" data-scroll-offset></a>
...
#### Changelog
<a id="Changelog-v1.30.1" data-scroll-offset></a>
...
#### Changelog
<a id="Changelog-v1.30.0" data-scroll-offset></a>
...
Introduced automated email notifications to inform organisations and team admins when a Control Plane [auto-upgrade](/nightly/tyk-cloud/environments-deployments/managing-control-planes#auto-upgrade) begins. Notifications include key details such as deployment name and version changes, helping teams track upgrade activity more effectively.
</Expandable>
...
### Changelog
<a id="Changelog-v1.29.0" data-scroll-offset></a>
...
### Changelog
<a id="Changelog-v1.28.1" data-scroll-offset></a>
...
### Changelog
<a id="Changelog-v1.28.0" data-scroll-offset></a>
...
### Changelog
<a id="Changelog-v1.27.0" data-scroll-offset></a>
...
### Changelog
<a id="Changelog-v1.26.0" data-scroll-offset></a>

#### Added

<AccordionGroup>
<Accordion title='Enable/Disable Audit Logging for Control Plane Deployments'>
Tyk Cloud allows users to enable or disable audit logging for their [Control Plane](/nightly/api-management/mdcb#data-plane) (CP) deployments, providing greater flexibility in managing compliance and storage costs. To enable this feature, please contact your account manager.
...
For more details, check out the [documentation on Gateway versioning and auto-upgrades](/nightly/developer-support/release-types/long-term-support)
...
#### Changelog
<a id="Changelog-v1.23.0" data-scroll-offset></a>
...
For more details, check out the [documentation on setting up Telemetry export](/nightly/tyk-cloud/telemetry).
