...
description: "Release notes for Tyk Cloud covering new features, enhancements, bug fixes, and control plane changes across recent versions of the managed platform."
...
For a comprehensive list of changes, please refer to the detailed [changelog](/nightly/#Changelog-v1.32.0) below.
...
This release upgrades Tyk Cloud to Golang 1.25 for enhanced security and transitions to Enterprise Edition Gateway images by default, ensuring full feature support and consistency between Dashboard and Gateway components. For a comprehensive list of changes, please refer to the detailed [changelog](/nightly/#Changelog-v1.30.3). 
...
For a complete list of changes, see the detailed [changelog](/nightly/#Changelog-v1.30.0) below.
...
For a complete list of changes, see the detailed [changelog](/nightly/#Changelog-v1.29.0) below.
...
For a full list of changes, see the detailed [changelog](/nightly/#Changelog-v1.28.1) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/nightly/#Changelog-v1.28.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/nightly/#Changelog-v1.27.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/nightly/#Changelog-v1.26.0) below.
...
For a comprehensive list of improvements and fixes, please check the detailed [changelog](/nightly/#Changelog-v1.23.0) below.
