...
For a comprehensive list of changes, please refer to the detailed [changelog](/nightly/#Changelog-v1.4.2) below.
...
- [Docker image v1.4.2](https://hub.docker.com/r/tykio/tyk-operator/tags?page=&page_size=&ordering=&name=v1.4.2)
  - ```bash
    ...
    ```
- Helm chart
  - [tyk-charts v5.2.1](/nightly/developer-support/release-notes/helm-chart#5-2-release-notes)
