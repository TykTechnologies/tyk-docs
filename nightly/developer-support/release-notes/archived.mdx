...
See our [Distributed Tracing documentation](/nightly/api-management/traces#opentelemetry) for more details.
...
[Docs](/nightly/transform-traffic/url-rewriting#url-rewrite-middleware)
...
#### Mutual TLS support
[Docs](/nightly/basic-config-and-security/security/mutual-tls/client-mtls#why-use-mutual-tls)
...
Added support for Mutual TLS, mentioned by Gateway and Dashboard above. See [Docs](/nightly/basic-config-and-security/security/mutual-tls/client-mtls#why-use-mutual-tls)
