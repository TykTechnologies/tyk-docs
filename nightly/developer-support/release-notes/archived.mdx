...
'og:description': "Tyk Old releases"
...
* Enable Tyk Identity Broker to apply LDAP filters to user search [Docs](/nightly/api-management/external-service-integration#advance-ldap-configuration)
...
* For those who love to build everything in-house, we have added new API for custom dashboard authentication integrations. [Docs](/nightly/api-management/external-service-integration#custom-proxy-identify-provider)
...
[Docs](/nightly/api-management/external-service-integration#custom-proxy-identify-provider)
...
Tyk Identity Broker now fully support LDAP search with complex filters! [Docs](/nightly/api-management/external-service-integration#advance-ldap-configuration)
