...
See our [Distributed Tracing documentation](/nightly/api-management/logs-metrics#opentelemetry) for more details.
...
[Docs](/nightly/api-management/policies#partitioned-policies)
