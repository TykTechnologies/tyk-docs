...
When this option is enabled, MDCB does not [automatically create indexes](/nightly/api-management/tyk-pump#omitting-indexes), eliminating database contention issues, while maintaining full analytics functionality.
