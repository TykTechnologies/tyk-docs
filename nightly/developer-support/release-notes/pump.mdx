...
For a comprehensive list of changes, please refer to the detailed [changelog](/nightly/#Changelog-v1.17.0).
...
For a comprehensive list of changes, please refer to the detailed [changelog](/nightly/#Changelog-v1.16.0).

#### Breaking Changes

**Changes to Tyk Pump application logs**

This release makes [changes](/nightly/#Changelog-v1.16.0) to the format of Tyk Pump application logs so that output is consistent with other Tyk components and aligned with industry observability standards.
