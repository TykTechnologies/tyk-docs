...
keywords: "Guides, Contribution to Tyk, Open source contribution guide"
sidebarTitle: "Content Guide"
canonical: "https://tyk.io/docs/developer-support/contribution-guides"
---
...
- You’ve set up the Tyk Docs local environment as described in the [Getting Started](/nightly/#getting-started---running-mintlify-locally) section.
...
**Note:** The above components is a list of mostly used components in Tyk documentation. To see the complete list of components, refer to the [Mintlify documentation](https://mintlify.com/docs/components).
