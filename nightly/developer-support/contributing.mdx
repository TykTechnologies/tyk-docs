...
canonical: "https://tyk.io/docs/nightly/developer-support/contributing"
---
...
- **UI component examples** - Documentation and examples for using shortcodes in our documentation system:
  - **[Pill label shortcode](/nightly/ui-examples/test-pill-label)** - For labeling content with edition indicators (Enterprise, Cloud, Lab Release, etc.)
  - **[Feature cards shortcode](/nightly/ui-examples/feature-cards)** - For creating responsive feature highlight grids
  - **[YouTube video embed shortcode](/nightly/ui-examples/youtube-video-embed)** - For embedding videos with proper styling and SEO
