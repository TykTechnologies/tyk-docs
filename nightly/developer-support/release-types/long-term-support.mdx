...
keywords: "Long Term Support, LTS, Special Release"
sidebarTitle: "Long Term Support Release"
canonical: "https://tyk.io/docs/developer-support/release-types/long-term-support"
---
...
4. **Continuation of Service**: We will patch the LTS version every 8 weeks for the period it remains in full support.

In summary, LTS releases are stable minor or patch releases that are suitable for production use.


<Note>
Our current long term support release is 5.13 LTS. This is in full support from June 2026 to July 2027. This release will enter maintenance support from July 2027 to June 2028. Our next long term support release will be announced end of June 2027.
</Note>
...
We provide [full support](/nightly/#full-support) for the first 12 months, including regular maintenance intervals every eight weeks. Following this period, we transition to [maintenance support](/nightly/#maintenance-support) for an additional 12 months, focusing on critical fixes and essential security patching as needed.
...
| 5.8 Maintenance LTS | May 2025 - June 2026  | July 2026 - June 2027 | July 2027 |
| 5.13 LTS            | July 2026 - June 2027 | July 2027 - June 2028 | July 2028 |
| LTS+1 (version TBC) | July 2027 - June 2028 | July 2028 - June 2029 | July 2029 |
...
For users who require a longer support window and predictable patching, we strongly recommend using our [LTS releases](/nightly/#current-lts-releases-timeline).
...
Our next LTS version will be announced in June 2027.
...
The compatibility matrix table shown above will be part of upcoming [Gateway release notes](/nightly/developer-support/release-notes/gateway) for versions x.x and beyond. Additionally, these release notes will list tested third-party dependencies like *PostgreSQL, MongoDB, Redis* and more. */}
...
When selecting the "Latest" option, users can only choose the latest feature branch ([Gateway Release Notes](/nightly/developer-support/release-notes/gateway)).

When selecting the "LTS" option, users will be able to choose from the following:
- Current LTS version (e.g., 5.13.x): Full support provided, with the latest patch marked as `Recommended`.
- Extended Support (e.g., 5.8.x): Maintenance support only.

Older versions (e.g., 5.7.x and below) are marked as "Unsupported" and will be greyed out. 

**Implications for Unsupported Versions**
Users with deployments on unsupported versions (e.g., 5.7.x) will see a notice informing them that their version is "Unsupported".
...
Users running deployments on a supported but non-latest version within a branch (e.g., 5.13.0) will see a notice encouraging an upgrade to the "Recommended" version (e.g., 5.13.1).
...
We have step-by-step install guides for various architectures and installation types. Refer to [upgrading tyk](/nightly/developer-support/upgrading) for further details.
