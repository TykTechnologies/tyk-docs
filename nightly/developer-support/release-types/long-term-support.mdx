...
canonical: "https://tyk.io/docs/nightly/developer-support/release-types/long-term-support"
---
...
<h5 className="full-support">Full Support</h5>
...
<h5 className="maintenance-support">Maintenance Support</h5>
