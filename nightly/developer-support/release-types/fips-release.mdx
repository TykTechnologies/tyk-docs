...
canonical: "https://tyk.io/docs/nightly/developer-support/release-types/fips-release"
---
...
*FIPS compliance* means that the *FIPS Tyk Product* only uses FIPS 140-2 approved cryptographic [algorithms](/nightly/#fips-compliant-cryptographic-operations)
