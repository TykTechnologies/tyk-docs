...
**5.13.X will become our next LTS version in the summer of 2026. Please refer to this [page](/nightly/developer-support/release-types/long-term-support) for exact timelines**
...
* The FIPS Products use Go 1.25's native FIPS implementation to provide FIPS 140-3 validated cryptographic operations. See [Go FIPS 140-3 documentation](/nightly/#) for more details.
...
No. Tyk’s products have not been submitted to a NIST testing laboratory. They are FIPS-compliant, by Tyk’s definition. See [What "FIPS-compliant" means](/nightly/#what-fips-compliant-means) for further information.
</Accordion>
