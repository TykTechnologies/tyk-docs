---
canonical: https://tyk.io/docs/developer-support/deprecation
description: Official schedule and information regarding Tyk component deprecation
  and End-of-Life (EOL).
keywords: Deprecation policy, EOL Policy, End of Life Policy
noindex: noindex, follow
sidebarTitle: Deprecation and EOL Policy
...
*   **Upgrade Guides:** Please consult the official [Tyk Upgrade Documentation](/nightly/developer-support/upgrading) for detailed instructions.
*   **Release Notes:** Review the [Tyk Release Notes](/nightly/developer-support/release-notes/overview) for information on new features and changes in recent versions.
