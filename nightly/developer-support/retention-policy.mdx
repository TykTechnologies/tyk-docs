...
<Note>
This is a snapshot at the time of this notice. Retention floors move as new releases ship. See [How Retention Windows Are Calculated](/nightly/#how-retention-windows-are-calculated) for the ongoing formula.
</Note>
...
*\* Direct email is sent to customers who have opted in to ongoing advance notices. See [Staying Informed](/nightly/#staying-informed) below. Everyone sees the Forum and Release Notes updates regardless of opt-in status.*
