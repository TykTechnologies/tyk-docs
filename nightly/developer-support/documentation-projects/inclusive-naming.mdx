...
- [analytics_storage.master_name](/nightly/tyk-oss-gateway/configuration#analytics_storage-master_name)
- [cache_storage.master_name](/nightly/tyk-oss-gateway/configuration#cache_storage-master_name)
- [storage.master_name](/nightly/tyk-oss-gateway/configuration#storage-master_name)
...
The Tyk Gateway OpenAPI Document (Tyk Gateway swagger), includes references to the following Tyk Classic API Definition parameters:
...
The Tyk Dashboard OpenAPI Document (Tyk Dashboard swagger), contains references to [the parameters from the above Tyk Classic API Definition list](/nightly/#gw-classic-api-definition).
...
- [analytics_storage.master_name](/nightly/tyk-multi-data-centre/mdcb-configuration-options#analytics_storage-master_name)
- [storage.master_name](/nightly/tyk-multi-data-centre/mdcb-configuration-options#storage-master_name)

##### Tyk Pump

The following Tyk Pump configuration parameters contain tier 1 word occurrences:
- [analytics_storage_config.master_name](/nightly/tyk-pump/tyk-pump-configuration/tyk-pump-environment-variables#analytics_storage_config-master_name)
