...
The Tyk Dashboard OpenAPI Document (Tyk Dashboard swagger), contains references to [the parameters from the above Tyk Classic API Definition list](#gw-classic-api-definition).
