...
import CreatePortalEntryInclude from '/snippets/nightly/create-portal-entry-include.mdx';
import LegacyClassicPortalApi from '/snippets/nightly/legacy-classic-portal-api.mdx';

<LegacyClassicPortalApi/>

This is for the closed source [Tyk Developer Portal](/nightly/portal/overview/intro) only
