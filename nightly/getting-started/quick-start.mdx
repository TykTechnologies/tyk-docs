...
* **API Security**: In API Security, you can manage [keys](/nightly/api-management/policies#access-keys), [policies](/nightly/api-management/policies), and [certificates](/nightly/api-management/certificates) to customize your security settings. 
...
1. **Make a Request to the XML Endpoint:**
   - Using your API key from the [previous section](/nightly/getting-started/quick-start#exploring-authentication-methods), make a request to the XML endpoint (on the Tyk Gateway):
     ```
