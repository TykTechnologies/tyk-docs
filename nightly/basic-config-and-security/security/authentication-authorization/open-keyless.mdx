...
keywords: Authentication, Authorization, Tyk Authentication, Tyk Authorization, Open
  Authentication, Keyless Authentication
...
Tyk OAS APIs are inherently "open" unless authentication is configured, however the older Tyk Classic API applies [auth token](/nightly/api-management/authentication/bearer-token) protection by default.
