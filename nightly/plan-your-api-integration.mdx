...
- **Develop the Backend**: Write the code to implement your [API’s endpoints](/nightly/api-management/endpoint-designer) and integrate with your [database](/nightly/tyk-self-managed/install#requirements) or service layer.
...
- **Advanced Security Options**: Easily configure [authentication methods](/nightly/api-management/client-authentication) and [permissions](/nightly/platform-management/user-permissions) to protect data and control access.
...
- **Plugin Support for Customization**: Use [Tyk’s plugin system](/nightly/tyk-cloud/using-plugins) to add custom functionality, such as [custom authentication](/nightly/tyk-cloud/using-plugins#create-a-python-code-bundle), or [traffic transformations](/nightly/api-management/traffic-transformation).
