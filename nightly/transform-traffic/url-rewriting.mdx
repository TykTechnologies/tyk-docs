...
canonical: "https://tyk.io/docs/transform-traffic/url-rewriting"
---

## Overview
<a id="url-rewriting-overview"></a>
...
## URL Rewrite middleware summary
 ...
 - URL Rewrite can access both [session metadata](/nightly/api-management/access-control/sessions-and-keys/understanding-sessions#metadata-and-context) and [request context variables](/nightly/api-management/traffic-transformation/request-context-variables). */}
...
- [session metadata](/nightly/api-management/access-control/sessions-and-keys/understanding-sessions#metadata-and-context), from the Tyk Session Object linked to the request, can be injected into the pattern regex using the `$tyk_meta.METADATA_KEY` namespace 
...
## Using Tyk OAS
<a id="url-rewriting-using-tyk-oas"></a>
...
## Using Classic
<a id="url-rewriting-using-classic"></a>
