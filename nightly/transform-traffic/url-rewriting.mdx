...
canonical: "https://tyk.io/docs/nightly/transform-traffic/url-rewriting"
---

<h2 className="url-rewriting-overview">Overview</h2>
...
<h2 className="url-rewriting-using-tyk-oas">Using Tyk OAS</h2>
...
<h2 className="url-rewriting-using-classic">Using Classic</h2>
Tyk's [URL rewriter](/nightly/transform-traffic/url-rewriting#url-rewrite-middleware) uses the concepts of triggers and rules to determine if the request (target) URL should be modified. These can be combined in flexible ways to create sophisticated logic to direct requests made to a single endpoint to various upstream services (or other APIs internally exposed within Tyk).
