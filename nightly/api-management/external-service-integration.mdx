---
canonical: https://tyk.io/docs/api-management/external-service-integration
description: Learn how to integrate external services with Tyk API Gateway. Discover
  how to use middleware plugins, webhooks, and service discovery to extend your API
  functionality and connect with third-party systems.
keywords: Tyk Identity Broker, TIB, Identity Provider, Identity Handler, SSO, Custom
  Authentication, Custom Proxy Provder, SAML, OIDC, OpenID Connect, Profies, IDPs,
  Social Provider, LDAP
noindex: noindex, follow
sidebarTitle: Tyk Identity Broker (TIB)
...
1. [Login with 3rd party social providers](/nightly/api-management/single-sign-on-social-idp)
2. [Login with any IdP that supports OIDC](/nightly/api-management/single-sign-on-oidc)
3. [Login with any IdP that supports SAML](/nightly/api-management/single-sign-on-saml)
3. [Login with LDAP](/nightly/api-management/single-sign-on-ldap)
