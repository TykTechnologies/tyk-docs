---
title: "Tyk Identity Broker (TIB) Overview"
description: "Learn about Tyk Identity Broker (TIB), a bridge that connects external Identity Management Systems such as LDAP, Social OAuth, and Okta to your Tyk Dashboard, Developer Portal, or Gateway."
keywords: "Tyk Identity Broker, TIB, Identity Provider, SSO, Authentication, IDP, LDAP, Social Login, Okta"
