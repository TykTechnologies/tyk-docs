...
From Tyk 5.10, you can pre-configure the [versioning metadata](#how-api-versioning-works-with-tyk) for an API before you've created the first [child API](/nightly/api-management/api-versioning#base-and-child-apis).
