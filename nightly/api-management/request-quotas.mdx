...
The Tyk Dashboard provides a straightforward interface to set request quota parameters on [Security Policies](/nightly/api-management/policies) and [Access Keys](/nightly/api-management/policies#access-key).
