...
* Redis (check [supported versions](/nightly/tyk-self-managed#redis))
* Tyk Dashboard
...
<Note>
Ensure that you are installing Redis versions that are supported by Tyk. Please consult the list of [supported versions](/nightly/tyk-self-managed#redis) that are compatible with Tyk.
</Note>
