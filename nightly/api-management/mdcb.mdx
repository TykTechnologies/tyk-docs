...
| `hash_keys`      | Set to `true` if [key hashing](/nightly/api-management/policies#access-key-hashing) is also enabled in your Tyk Dashboard and Gateway configurations. This ensures that the Synchroniser correctly handles hashed API keys. |
