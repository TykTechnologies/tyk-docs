...
| [**Aggregate Analytics**](#aggregate-analytics) | Summarized traffic statistics powering [Traffic Analytics](/nightly/api-management/dashboard-analytics#traffic-analytics) | [Tyk Pump](/nightly/api-management/dashboard-analytics/control-plane-pumps); Tyk MDCB (from [Data Plane Hybrid Pumps](/nightly/api-management/dashboard-analytics/data-plane-pump)) | Tyk Dashboard |
| [**Traffic Logs**](#traffic-logs) | [Traffic Logs](/nightly/api-management/logs/traffic-logs) - one record per tracked request | Tyk Pump; Tyk MDCB (from Data Plane Hybrid Pumps) | Tyk Dashboard |
| [**Uptime Test Results**](#uptime-test-results) | [Uptime test](/nightly/planning-for-production/ensure-high-availability/uptime-tests) results | Tyk Pump | Tyk Dashboard |
