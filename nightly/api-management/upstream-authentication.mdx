...
- [Mutual TLS](/nightly/api-management/upstream-authentication/mtls)
- [Token-based authentication](/nightly/api-management/upstream-authentication/auth-token)
- [Request signing](/nightly/api-management/upstream-authentication/request-signing)
- [Basic Authentication](/nightly/api-management/upstream-authentication/basic-auth)
- [OAuth 2.0](/nightly/api-management/upstream-authentication/oauth)
    - [OAuth 2.0 Client Credentials](/nightly/api-management/upstream-authentication/oauth#oauth-client-credentials)
    - [OAuth 2.0 Password Grant](/nightly/api-management/upstream-authentication/oauth#oauth-resource-owner-password-credentials)
