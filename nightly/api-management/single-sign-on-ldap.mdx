...
description: "Enable Single Sign-On (SSO) for the Tyk Dashboard and Developer Portal using LDAP-powered identity providers such as Active Directory."
keywords: "SSO, Single Sign-On, LDAP, Active Directory, Identity Broker, TIB, Authentication, Identity Provider"
