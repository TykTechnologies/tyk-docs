...
Explore our guides for [Datadog](/nightly/api-management/traces/datadog), [Dynatrace](/nightly/api-management/traces/dynatrace), [Jaeger](/nightly/api-management/traces/jaeger) and [New Relic](/nightly/api-management/traces#new-relic) for further info on how to integrate with 3rd party observability vendors.
