...
Learn more:
* [Tutorial: Create an API in File-based Mode](/nightly/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
Learn more:
* [Tutorial: Create an API with the Dashboard](/nightly/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
- [Using Tyk Operator to enable GitOps with Tyk](/nightly/api-management/automations)
