...
<h2 className="file-based-configuration">File-based configuration</h2>
...
**Learn more:**
* [Create an API in file-based mode](/nightly/api-management/gateway-config-managing-classic#create-an-api-in-file-based-mode)
...
**Learn more:**
* [Create an API with the Dashboard](/nightly/api-management/gateway-config-managing-classic#create-an-api-with-the-dashboard)
...
**Learn more:**
- [Dashboard API](/nightly/api-management/dashboard-configuration#exploring-the-dashboard-api)
- [Gateway API](/nightly/tyk-gateway-api)
...
- [Using Tyk Operator to enable GitOps](/nightly/api-management/automations)
