...
canonical: "https://tyk.io/docs/api-management/collecting-gateway-logs-otel-kubernetes"
---
...
For installing Tyk on Kubernetes, follow the [Tyk Helm Charts installation guide](/nightly/tyk-self-managed/install/kubernetes#tyk-stack-postgresql).
