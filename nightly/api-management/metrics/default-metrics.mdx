...
4. [Token exchange metrics](#token-exchange-metrics): Volume, latency, and cache hit-rate for [token exchange](/nightly/api-management/authentication/token-exchange) (Enterprise only)
