...
| `tyk.gw.tags` | No | `["region:eu", "env:prod"]` | Present only when the Gateway has [segment tags](/nightly/api-management/multiple-environments#what-is-api-sharding-) configured. |
