...
canonical: "https://tyk.io/docs/nightly/api-management/request-throttling"
---
...
<h4 className="policy-setup">Configure Policy and Rate Limit</h4>
...
Request Throttling is configured within Tyk [Security Policies](/nightly/api-management/policies) or directly on individual [Access Keys](/nightly/api-management/authentication/bearer-token).
