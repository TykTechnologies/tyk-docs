...
You can register user credentials using the `POST /api/apis/keys/basic/{username}` endpoint in the [Tyk Dashboard API](/nightly/tyk-dashboard-api). The request payload is a [Session Object](/nightly/api-management/access-control/sessions-and-keys/understanding-sessions).
...
You can register user credentials using the `POST /tyk/keys/{username}` endpoint in the [Tyk Dashboard API](/nightly/tyk-dashboard-api). The request payload is a [Session Object](/nightly/api-management/access-control/sessions-and-keys/understanding-sessions).
