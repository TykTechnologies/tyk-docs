...
description: Learn how to implement JWT Split Token flow in Tyk to enhance security
  by separating JWT components and storing sensitive data server-side.
keywords:
- Authentication
- JWT
- JSON Web Tokens
...
1. **Token Issuance**:
    ...
    - Tyk intercepts this response through a [Virtual Endpoint](/nightly/api-management/traffic-transformation/virtual-endpoints)
