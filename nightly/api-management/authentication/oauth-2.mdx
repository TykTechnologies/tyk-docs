...
| :--- | :--- | :--- |
| Register a new client app | `POST /api/apis/oauth/{{api-id}}` | [link](/nightly/api-management/dashboard-configuration#create-a-new-oauth2-0-client) |
| Get a list of registered client apps | `GET /api/apis/oauth/{{api-id}}` | [link](/nightly/api-management/dashboard-configuration#list-oauth-clients) |
| Get the details of a client app | `GET /api/apis/oauth/{{api-id}}/{{client_id}}` | [link](/nightly/api-management/dashboard-configuration#get-an-oauth2-0-client) |
| Delete a client app | `DELETE /api/apis/oauth/{{api-id}}/{{client_id}}` | [link](/nightly/api-management/dashboard-configuration#delete-oauth-client) |
...
The identity server will need access to the Tyk Dashboard API to [obtain an Authorization Code](/nightly/api-management/dashboard-configuration#oauth2-0-authorization-code).
...
- [retrieve a list of all tokens for a client app](/nightly/api-management/dashboard-configuration#retrieve-all-current-tokens-for-specified-oauth2-0-client)
- [revoke a single token](/nightly/api-management/dashboard-configuration#revoke-a-single-oauth-client-token)
- [revoke all tokens for a client app](/nightly/api-management/dashboard-configuration#revoke-all-oauth-client-tokens)
