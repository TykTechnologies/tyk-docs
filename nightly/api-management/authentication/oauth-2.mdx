...
- [optional] [metadata](/nightly/api-management/policies#what-is-a-session-metadata) to be added to the access tokens
...
| :--- | :--- | :--- |
| Register a new client app | `POST /api/apis/oauth/{{api-id}}` | [link](/nightly/api-management/dashboard-configuration#create-a-new-oauth20-client) |
...
| Get the details of a client app | `GET /api/apis/oauth/{{api-id}}/{{client_id}}` | [link](/nightly/api-management/dashboard-configuration#get-an-oauth20-client) |
...
The identity server will need access to the Tyk Dashboard API to [obtain an Authorization Code](/nightly/api-management/dashboard-configuration#oauth20-authorization-code).
...
- [retrieve a list of all tokens for a client app](/nightly/api-management/dashboard-configuration#retrieve-all-current-tokens-for-specified-oauth20-client)
