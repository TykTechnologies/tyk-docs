...
canonical: "https://tyk.io/docs/api-management/logs/application-logs"
---
...
See [Configuring Application and Access Logs](/nightly/api-management/logs#configuring-application-and-access-logs) for details of these and how to configure them.
