---
canonical: https://tyk.io/docs/api-management/cloud/audit-logs
description: Learn how to set up and manage audit logs in Tyk Cloud Control Plane
  deployments.
keywords: Audit Logs, Tyk Cloud, Control Plane, Data Plane
