...
<Card href="/nightly/plugins/tutorials/quick-starts/go/dashboard" img="/img/logos/tyk-logo-selfmanaged.svg">
**Read time: 15 mins**

Dashboard Tutorial
</Card>

<Card href="/nightly/plugins/tutorials/quick-starts/go/open-source" img="/img/logos/tyk-logo-selfmanaged.svg">
**Read time: 15 mins**
...
<h4 className="tyk-oas-apidef">Using API Definition</h4>
...
<h4 className="tyk-oas-dashboard">Using API Designer</h4>
...
<h4 className="tyk-classic-apidef">Using API Definition</h4>
...
<h4 className="tyk-classic-dashboard">Using API Designer</h4>
...
<h4 className="manifest">The manifest file</h4>
...
* Used to stop the request and return a [custom response](/nightly/api-management/plugins/plugin-types#return-overrides--returnoverrides)
