...
<Note>
For seamless deployments, take a look at multi-version [plugin support](/nightly/tyk-cloud#configure-plugins) to enable zero downtime deployments of your Tyk Gateway installs
</Note>
