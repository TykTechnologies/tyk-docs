...
- [Go custom authentication plugin](/nightly/api-management/automations/operator#custom-plugin-auth-go)
- [gRPC custom authentication plugin](/nightly/api-management/automations/operator#custom-plugin-auth-grpc)
