...
<Note>
If you don't need a full OTel pipeline, [Tyk Pump](/nightly/api-management/tyk-pump) provides built-in API traffic analytics out of the box, with no external collector required.
</Note>
