...
To enable this, Tyk introduced support for custom rate limit keys in [Tyk 5.3.0](/nightly/developer-support/release-notes/dashboard#530-release-notes). This feature allows you to define custom patterns for rate limiting that go beyond the default credential-based approach.
