...
4. **Set up the Authentication for your API**
    ...
    - **Enable client certificate**: Select this to use Mutual TLS. See [Mutual TLS](/nightly/api-management/implement-tls#secure-hosted-apis-with-mtls) for details on implementing mutual TLS.
