...
keywords: Tyk OAS API, Tyk Classic API, Migrate, Convert, Migration, Tyk Classic,
...
2. **Location of Mock Response Middleware**
    ...
    The position of mock response middleware in the request processing chain [differs between Tyk Classic and Tyk OAS](/nightly/api-management/traffic-transformation/mock-response#middleware-execution-order-during-request-processing):
