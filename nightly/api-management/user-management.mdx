...
1. **[Managing Users](/nightly/platform-management/dashboard-users)**: 
...
2. **[Managing User Permissions](/nightly/platform-management/user-permissions)**: 
    Configuring and enforcing role-based access control for users within the Tyk Dashboard, using both the API and UI.  
3. **[Managing User Groups/Teams](/nightly/platform-management/user-groups)**: 
...
4. **[Configuring API Ownership](/nightly/platform-management/api-ownership)**: 
    Applying role-based access control to APIs to govern visibility and manageability for specific teams or users.
5. **[Managing Users across Multiple Tyk Organizations](/nightly/#manage-tyk-dashboard-users-in-multiple-organizations)**: 
...
6. **[Single Sign-On](/nightly/#single-sign-on-integration)**: 
...
If you have deployed multiple [Tyk Organizations](/nightly/dashboard-admin-api#organizations), you may have users that need access to more than one Organization (known as a "multi-org user"). **This functionality requires a specific Tyk license.**
