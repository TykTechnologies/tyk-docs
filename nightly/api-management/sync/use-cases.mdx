---
canonical: https://tyk.io/docs/api-management/sync/use-cases
description: Learn how to automate API configuration management using Tyk Sync and
  GitHub Actions.
keywords: Tyk Sync, GitHub Actions, API Management, Automations
