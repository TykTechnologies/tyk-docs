...
keywords: "Quick Start, Tyk Sync, API Management, Automations"
sidebarTitle: "Quick Start"
canonical: "https://tyk.io/docs/api-management/sync/quick-start"
---
...
First, let's set up a Tyk Demo environment with some prebuilt APIs. Follow our Docker [guide](/nightly/tyk-self-managed/install/docker).
...
Follow this [guide](/nightly/product-stack/tyk-sync/installing-tyk-sync) to install Tyk Sync. You can either use the Docker image or download the binary directly. We will be using the Docker image for this quick start.
