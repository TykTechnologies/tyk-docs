...
| [Tyk MDCB](/nightly/tyk-multi-data-centre/mdcb-configuration-options#log_level)      | `log_level`   | `TYK_MDCB_LOGLEVEL`  | `info`                   |
...
You can enable this feature by setting the [track_404_logs](/nightly/tyk-oss-gateway/configuration#track-404-logs) option to `true` in your `tyk.conf` file or by setting the [TYK_GW_TRACK404LOGS](/nightly/tyk-oss-gateway/configuration#track-404-logs) environment variable to `true`.
