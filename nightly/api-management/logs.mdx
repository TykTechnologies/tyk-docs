...
description: Learn different types of logs in Tyk, how to configure them and how to
  integrate with third-party log management tools for effective API observability.
keywords: Metrics, Traces, Logs, Application Logs, API Traffic, Opentelemetry, Datadog,
