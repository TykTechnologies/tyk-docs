...
description: "Learn how to configure response caching in Tyk Gateway to reduce upstream load and improve API response times"
keywords: "Caching, Request Optimization, Optimization, Endpoint Caching, Configuration, Cache"
sidebarTitle: "Response Caching"
canonical: "https://tyk.io/docs/api-management/response-caching"
---
