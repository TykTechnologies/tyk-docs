...
13. ##### How to disable an API
    ...
    See [Dashboard API - API Definitions](https://tyk.io/docs/api-reference/apis/get-list-of-apis) for more details on how to GET and PUT an API definition.
...
1. ##### Capturing detailed logs
    ...
    If you've seen the documentation for Tyk Dashboard's [log browser](/nightly/api-management/dashboard-analytics#activity-logs), then you'll also be wondering how to set up your Tyk configuration to enable detailed request logging.
