...
If you're using Tyk OAS APIs, then you can find details and examples of how to configure the virtual endpoint middleware [here](/nightly/#virtual-endpoints-using-tyk-oas).

If you're using Tyk Classic APIs, then you can find details and examples of how to configure the virtual endpoint middleware [here](/nightly/#virtual-endpoints-using-classic).
...
If you're using the legacy Tyk Classic APIs, then check out the [Tyk Classic](/nightly/#virtual-endpoints-using-classic) page.
...
If you're using the newer Tyk OAS APIs, then check out the [Tyk OAS](/nightly/#virtual-endpoints-using-tyk-oas) page.
