...
- values from [key-value (KV) storage](/nightly/tyk-configuration-reference/kv-store#how-it-works) can be injected into added headers using the notation appropriate to the location of the KV store
