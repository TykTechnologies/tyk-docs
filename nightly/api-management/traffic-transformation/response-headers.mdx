...
description: "Learn how to modify API response headers"
keywords: "Traffic Transformation, Response Headers"
sidebarTitle: "Response Headers"
canonical: "https://tyk.io/docs/api-management/traffic-transformation/response-headers"
---
...
- [session metadata](/nightly/api-management/access-control/sessions-and-keys/understanding-sessions#metadata-and-context), from the Tyk Session Object linked to the request, can be injected into added headers using the `$tyk_meta.` namespace
...
## Using Tyk OAS
<a id="response-headers-using-tyk-oas"></a>
...
- `X-User-ID` with a dynamic value taken from the `uid` field in the [session metadata](/nightly/api-management/access-control/sessions-and-keys/understanding-sessions#metadata-and-context)
...
## Using Classic
<a id="response-headers-using-classic"></a>
