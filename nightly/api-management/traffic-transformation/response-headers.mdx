...
canonical: "https://tyk.io/docs/nightly/api-management/traffic-transformation/response-headers"
---

<h2 className="response-headers-overview">Overview</h2>
...
<h2 className="response-headers-using-tyk-oas">Using Tyk OAS</h2>
...
<h2 className="response-headers-using-classic">Using Classic</h2>
Tyk's [response header transform](/nightly/api-management/traffic-transformation/response-headers) middleware enables you to append or delete headers on responses received from the upstream service before sending them to the client.
...
<h4 className="tyk-classic-api">API-level transform</h4>
...
<h4 className="tyk-classic-endpoint">Endpoint-level transform</h4>
...
<h4 className="tyk-operator-api">API-level transform</h4>
...
<h4 className="tyk-operator-endpoint">Endpoint-level transform</h4>
