...
canonical: "https://tyk.io/docs/api-management/traffic-transformation/request-headers"
---
...
## Using Tyk OAS
<a id="request-headers-using-tyk-oas"></a>
...
## Using Classic
<a id="request-headers-using-classic"></a>
