...
When using the ignore authentication middleware, we recommend that you familiarize yourself with [Request Matching](/nightly/getting-started/key-concepts/url-matching) options.
