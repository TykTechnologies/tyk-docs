---
canonical: https://tyk.io/docs/api-management/traffic-transformation/request-method
description: How to configure Request Method traffic transformation middleware in
  Tyk
...
## Using Tyk OAS
<a id="request-method-using-tyk-oas"></a>
...
## Using Classic
<a id="request-method-using-classic"></a>
