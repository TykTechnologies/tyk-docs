...
canonical: "https://tyk.io/docs/nightly/api-management/traffic-transformation/request-method"
---

<h2 className="request-method-overview">Overview</h2>
...
<h2 className="request-method-using-tyk-oas">Using Tyk OAS</h2>
...
<h2 className="request-method-using-classic">Using Classic</h2>
Tyk's [request method transform](/nightly/api-management/traffic-transformation/request-method) middleware is configured at the endpoint level, where it modifies the HTTP method used in the request to a configured value.
