---
title: "Block List"
description: "Learn how to configure an endpoint Block List for your API"
keywords: "Traffic Transformation, Block List"
sidebarTitle: "Block List"
canonical: "https://tyk.io/docs/api-management/traffic-transformation/block-list"
---
...
When using the block list middleware, we recommend that you familiarize yourself with [Request Matching](/nightly/getting-started/key-concepts/url-matching) options.

<br />

<Note>
Tyk recommends that you use [exact matching](/nightly/getting-started/key-concepts/url-matching#matching-modes) for maximum security, though prefix and wildcard strategies might also apply for your particular deployment or use case.
</Note>
...
## Using Tyk OAS
<a id="block-list-using-tyk-oas"></a>
...
## Using Classic
<a id="block-list-using-classic"></a>
...
- `method_actions`: a shared object used to configure the [mock response](/nightly/api-management/traffic-transformation/mock-response#tyk-classic) middleware for Tyk Classic APIs
