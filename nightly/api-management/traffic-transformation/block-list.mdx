...
canonical: "https://tyk.io/docs/nightly/api-management/traffic-transformation/block-list"
---

<h2 className="block-list-overview">Overview</h2>
...
<h2 className="block-list-using-tyk-oas">Using Tyk OAS</h2>
...
<h2 className="block-list-using-classic">Using Classic</h2>
The [block list](/nightly/api-management/traffic-transformation/block-list) is a feature designed to block access to specific API endpoints. Tyk Gateway rejects all requests made to endpoints with the block list enabled, returning `HTTP 403 Forbidden`. 
