...
'og:description': "How to Configure data graph"
...
We offer 3 ways of importing an example into Tyk:
 - Using [tyk-sync](/nightly/api-management/automations/sync#synchronize-api-configurations-with-github-actions)
...
Please follow the [tyk-sync documentation](/nightly/api-management/automations/sync#examples-publish-command) to learn more about this approach.
