...
description: Learn how to configure distributed tracing in Tyk for enhanced API observability,
  including integration with OpenTelemetry and third-party tracing tools.
keywords: Metrics, Traces, Logs, System Logs, API Traffic, Opentelemetry, Datadog,
  Dynatrace, New Relic, Elastic Search, Jaeger, Monitoring, Observability
