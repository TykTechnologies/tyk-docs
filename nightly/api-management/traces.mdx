...
| [opentelemetry.traces.sampling.parent_based](/nightly/tyk-oss-gateway/configuration#opentelemetry-traces-sampling-parentbased) | Inherit the parent span's sampling decision | `false` |
...
Enable parent based sampling by setting [opentelemetry.traces.sampling.parent_based](/nightly/tyk-oss-gateway/configuration#opentelemetry-traces-sampling-parentbased) or the equivalent environment variable. The default value is `false`.
