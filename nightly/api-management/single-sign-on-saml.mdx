...
description: "Configure SAML-based Single Sign-On (SSO) for the Tyk Dashboard and Developer Portal to authenticate users via third-party identity providers."
keywords: "SSO, Single Sign-On, SAML, Identity Broker, TIB, Authentication, Identity Provider, IDP"
