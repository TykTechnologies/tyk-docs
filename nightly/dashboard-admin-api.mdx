...
Self-Managed users should use [API tagging](/nightly/api-management/api-sharding#api-tagging-with-on-premises) and enforce a tagging standard across all organizations.
