...
canonical: "https://tyk.io/docs/ai-management/ai-studio/branding"
---
...
Tyk AI Studio lets administrators white-label the admin UI and the [AI Portal](/nightly/ai-management/ai-studio/ai-portal). You can replace the logo and favicon, set brand colors, change the application title, and add custom CSS. Changes apply system-wide, to every user.
...
See [Environment Variables](/nightly/ai-management/ai-studio/ai-studio-env) for other Tyk AI Studio configuration options.
