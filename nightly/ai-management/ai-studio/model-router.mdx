...
- References an existing [LLM configuration](/nightly/ai-management/ai-studio/llm-management)
...
The Model Router entity is closely related to [LLM Management](/nightly/ai-management/ai-studio/llm-management), as the vendors within a pool reference the configured LLMs.
