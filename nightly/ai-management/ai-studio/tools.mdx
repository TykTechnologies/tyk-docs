...
3. **MCP Interface**: An MCP-compliant shim wraps the OpenAPI-generated tools, so MCP clients can call them. It works with tools that require authentication, and you don't need a separate MCP server.
## How it Works
