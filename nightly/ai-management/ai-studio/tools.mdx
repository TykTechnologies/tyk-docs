...
Tools become available within the [Chat Interface](/nightly/ai-management/ai-studio/chat-interface) if:
...
The [AI Portal](/nightly/ai-management/ai-studio/ai-portal) provides a dedicated **Tool Catalogue** where users can:
...
*   **Application Integration:** Include tools in [Apps](/nightly/ai-management/ai-studio/apps) for streamlined API access.
