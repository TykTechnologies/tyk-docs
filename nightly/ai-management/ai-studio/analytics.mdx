...
3.  **Cost Calculation:** Using data from the [Model Pricing System](/nightly/ai-management/ai-studio/llm-management#model-pricing), the cost of the interaction is calculated based on token counts.
...
*   **[Model Pricing](/nightly/ai-management/ai-studio/llm-management#model-pricing):** The pricing definitions are crucial for calculating the cost metric within the analytics system.
