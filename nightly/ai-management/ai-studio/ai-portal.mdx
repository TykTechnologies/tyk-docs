...
*   **Chat Interface:** Access to all [Chat Experiences](/nightly/ai-management/ai-studio/chat-interface) the user has permission to use, with a clean, intuitive UI for conversational interactions.
*   **Resource Catalogues:** Browse and subscribe to available LLMs, Data Sources, and [Tools](/nightly/ai-management/ai-studio/tools) through dedicated catalogue interfaces.
*   **Application Management:** Create and manage [Apps](/nightly/ai-management/ai-studio/admin-apps) that integrate LLMs, tools, and data sources for API access.
...
*   **Portal Branding:** Customize logos, colors, and themes to match organizational branding. See [Branding](/nightly/ai-management/ai-studio/branding).
