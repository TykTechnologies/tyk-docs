...
For more details on the data plane architecture and request processing, see the [Edge Gateway (Data Plane) Component](/nightly/ai-management/ai-studio/proxy) documentation.
