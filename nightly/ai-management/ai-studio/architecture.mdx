...
To know more about the AI Studio component, see the [AI Studio Documentation](/nightly/ai-management/ai-studio/ai-studio).
...
To know more about the Edge Gateway, see the [Edge Gateway Architecture](/nightly/ai-management/ai-studio/proxy) documentation.