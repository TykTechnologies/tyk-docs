...
description: "Learn how to build conversational AI experiences in the Chat Interface using Agent plugins, which can wrap LLMs, add custom logic, and integrate external services."
keywords: "AI Studio, AI Management, Plugin SDK"
sidebarTitle: "AI Studio Agent"
canonical: "https://tyk.io/docs/ai-management/ai-studio/plugins/studio-agent"
---
## Availability
...
This page covers the plugin code itself. To bind a built plugin to an App and make it available to users through the admin UI, see [Manage Agents](/nightly/ai-management/ai-studio/agents).
...
Create an Agent Object that binds the plugin to an App. You can do this via the API, as shown below, or from the admin UI. See [Manage Agents](/nightly/ai-management/ai-studio/agents) for the UI walkthrough.
