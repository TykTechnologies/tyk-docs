...
See [Resource Provider Plugins](/nightly/ai-management/ai-studio/plugins/resource-types) for the full guide.
...
See [plugins-studio-ui.md](/nightly/ai-management/ai-studio/plugins/studio-ui) for complete rate-limiting-ui example.
