...
> **Experimental**: Agent plugins are currently experimental. See [Agent Plugins Guide](/nightly/ai-management/ai-studio/plugins/studio-agent) for full documentation.
