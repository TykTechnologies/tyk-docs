...
canonical: "https://tyk.io/docs/ai-management/ai-studio/privacy-levels"
---
...
* [Tools](/nightly/ai-management/ai-studio/tools) used with an LLM Configuration.
* [Data Sources](/nightly/ai-management/ai-studio/datasources-rag) used with an LLM Configuration in a RAG-enabled Chat.
* [Apps](/nightly/ai-management/ai-studio/admin-apps), when an admin approves or edits the App's associated resources.
...
* An LLM Configuration, under [LLM Management](/nightly/ai-management/ai-studio/llm-management).
* A Tool, under [Tools](/nightly/ai-management/ai-studio/tools).
* A Data Source, under [Data Sources](/nightly/ai-management/ai-studio/datasources-rag).

Community submissions to the [AI Portal](/nightly/ai-management/ai-studio/ai-portal) also carry a suggested privacy score from the submitter, which an admin can change before approving the submission.
