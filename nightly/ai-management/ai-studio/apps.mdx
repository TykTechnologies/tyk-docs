...
canonical: "https://tyk.io/docs/ai-management/ai-studio/apps"
---
...
1. **Encapsulation of Resources**:
   ...
   - Users can subscribe to tools from the [AI Portal](/nightly/ai-management/ai-studio/ai-portal) tool catalogue, similar to how they access LLMs and data sources.
...
3. **Integration with Upstream LLMs and Tools**:
   ...
   - Tools can be accessed through multiple protocols:
     ...
     - **[MCP (Model Context Protocol)](/nightly/ai-management/mcps/overview)**: Standardized tool interaction protocol for enhanced compatibility.
