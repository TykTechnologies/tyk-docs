...
canonical: "https://tyk.io/docs/ai-management/ai-studio/deployment-k8s"
---
...
For further setup (additional LLMs, users, applications), see the **[Initial Configuration](/nightly/ai-management/ai-studio/configuration)** guide.
