...
Once deployed and you've registered your first user, proceed to the [First Steps guide](/nightly/ai-management/ai-studio/configuration) to configure Tyk AI Studio.
