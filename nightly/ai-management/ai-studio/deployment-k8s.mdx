...
'og:description': "Install Tyk AI Studio"
sidebarTitle: "Installation (Kubernetes)"
...
Once deployed, proceed to the [Initial Configuration](/nightly/ai-management/ai-studio/configuration) guide to set up Tyk AI Studio.
