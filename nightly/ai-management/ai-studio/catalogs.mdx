...
Catalogs in Tyk AI Studio are collections of AI resources (LLM providers, Data sources, and Tools) that you can assign to specific [Teams](/nightly/ai-management/ai-studio/teams) to easily manage access. They act as the bridge between the raw AI capabilities and the users who need to consume them.
