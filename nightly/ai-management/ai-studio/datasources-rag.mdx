---
title: "Manage Data Sources in Tyk AI Studio"
description: "Learn how to configure and manage Data Sources in Tyk AI Studio to enable Retrieval-Augmented Generation (RAG), connecting LLMs to external knowledge bases and vector stores."
