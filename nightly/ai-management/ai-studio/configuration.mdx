...
'og:description': "Configuration of Tyk AI Studio"
sidebarTitle: "Initial Configuration"
tags: ['AI Studio', 'AI Management']
---

This guide covers the essential first steps to take within the Tyk AI Studio UI after successfully deploying the platform using the [Installation Guide](/nightly/ai-management/ai-studio/deployment-k8s).
