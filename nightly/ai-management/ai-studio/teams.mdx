...
Teams in Tyk AI Studio help you organize [Users](/nightly/ai-management/ai-studio/users) and easily manage their access to [LLM providers](/nightly/ai-management/ai-studio/llm-management), [data sources](/nightly/ai-management/ai-studio/datasources-rag), and [tools](/nightly/ai-management/ai-studio/tools). By linking Teams to specific [Catalogs](/nightly/ai-management/ai-studio/catalogs), you ensure users access only the AI resources relevant to their role.
...
- **Resource Isolation**: Ensure that sensitive data sources (like HR documents) are only accessible to the "HR" Team by linking the specific data [Catalog](/nightly/ai-management/ai-studio/catalogs) only to that Team.
...
A Team acts as the central access control mechanism in Tyk AI Studio. Instead of assigning permissions to individual [Users](/nightly/ai-management/ai-studio/users), administrators assign [Catalogs](/nightly/ai-management/ai-studio/catalogs) (LLM providers, Data sources, and Tools) to a Team. Users are then added as members of the Team.
...
1. Navigate to **Governance > Teams** in the admin UI sidebar.
2. Click on the **Create team** button.
3. Enter a descriptive **Team name**.
4. In the **Manage team members** section, search for existing [Users](/nightly/ai-management/ai-studio/users) and add them to the Team.
5. In the **Add catalogs** section, select one or more [Catalogs](/nightly/ai-management/ai-studio/catalogs) (LLM providers, Data sources, or Tools) to make them available to this Team.
