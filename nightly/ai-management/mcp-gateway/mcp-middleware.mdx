...
description: "Middleware for individual MCP tools, resources, and prompts: access control, rate limits, transforms, circuit breakers, timeouts, and custom plugins."
