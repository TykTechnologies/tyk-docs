...
description: "Structure of a Tyk MCP proxy definition: the OpenAPI document, MCP primitives and JSON-RPC methods, and the x-tyk-api-gateway and x-tyk-mcp-server extensions."
