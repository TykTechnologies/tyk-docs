...
| **Protected Resource Metadata (PRM)** | 2025-03-26 | ✅ Full | Tyk serves `/.well-known/oauth-protected-resource` automatically. See [OAuth 2.1 authentication](/nightly/ai-management/mcp-gateway/oauth-2-1). |
