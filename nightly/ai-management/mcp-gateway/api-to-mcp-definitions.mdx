...
description: "Field reference for the x-tyk-mcp-server extension: source selection, tool and parameter overrides, behavioral hints, the allow-list rule, and examples."
