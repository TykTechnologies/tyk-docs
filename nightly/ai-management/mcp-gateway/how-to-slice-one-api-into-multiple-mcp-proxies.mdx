...
description: "Generate several MCP proxies from one Tyk-managed REST API, each with its own tool set and governance, such as a read-only and a write-enabled proxy."
