...
description: "How Tyk MCP Gateway fits in the MCP protocol flow: the session lifecycle, the proxy definition, the three middleware levels, and the policy model."
