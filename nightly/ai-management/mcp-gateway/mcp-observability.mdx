...
canonical: "https://tyk.io/docs/ai-management/mcp-gateway/mcp-observability"
---
...
OpenTelemetry must be enabled on your Tyk Gateway. See [OpenTelemetry configuration](/nightly/api-management/traces) for setup instructions.
...
|---|---|---|
| **Metrics** | Custom OTel metric instruments with MCP dimensions for counters and histograms | [MCP metrics](/nightly/ai-management/mcp-gateway/mcp-metrics) |
| **Access logs** | Structured per-request log records with MCP fields included when non-empty | [MCP access logs](/nightly/ai-management/mcp-gateway/mcp-access-logs) |
