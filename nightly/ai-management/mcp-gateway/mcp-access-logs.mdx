...
canonical: "https://tyk.io/docs/ai-management/mcp-gateway/mcp-access-logs"
---
...
When an MCP proxy is [generated directly from a Tyk-managed REST API](/nightly/ai-management/mcps/api-to-mcp) rather than fronting a remote MCP server, a single `tools/call` request produces two separate access log entries, provided access logging is enabled for both APIs.
