...
description: "Reference for the MCP proxy endpoints in the Tyk Gateway API and Tyk Dashboard API: CRUD operations, versioning, response shapes, and validation."
