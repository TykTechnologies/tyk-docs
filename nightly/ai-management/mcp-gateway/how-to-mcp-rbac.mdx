...
After [securing your MCP proxy](/nightly/ai-management/mcp-gateway/how-to-proxy-remote-mcp), the next step is controlling what each consumer can do. With role-based access control (RBAC), a policy bound to a key determines which tools that agent can invoke.
