...
description: "Create, edit, and delete MCP proxies in Tyk Dashboard: the proxy list, the creation wizard, the Settings and Primitives tabs, middleware, and permissions."
