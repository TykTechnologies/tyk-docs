...
<Note>
MCP OAS definitions use the Tyk OAS format. They are not available as Tyk Classic API definitions. For the full definition structure, see [MCP OAS definition](/nightly/ai-management/mcp-gateway/mcp-proxy-definitions).
</Note>
...
For a complete explanation of every field in the definition, see [MCP OAS definition](/nightly/ai-management/mcp-gateway/mcp-proxy-definitions).
