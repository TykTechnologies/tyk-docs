---
canonical: https://tyk.io/docs/ai-management/mcps/tyk-docs-mcp
description: Talk to Tyk documentation like a person using AI tools. Use Docs MCP
  to enable AI assistants to search and retrieve information from Tyk documentation.
...
**Step 2.**
Once connected, ask the AI to perform an operation as suggested in the [use cases above](/nightly/#use-cases)
