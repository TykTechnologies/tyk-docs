...
description: Enable AI assistants to safely and dynamically interact with your existing
  APIs using Tyk's API to MCP tooling.
keywords: AI MCP, API-to-MCP, Tyk AI MCP
...
If you're looking for quick setup, [jump to Quick Start](/nightly/#quick-start). For deeper understanding, see [How It Works](/nightly/#how-it-works) and [Use Cases](/nightly/#use-cases).
