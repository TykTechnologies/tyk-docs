...
Get Tyk Open Source Gateway running locally with Docker in a few steps. For other deployment options, see the [installation options](/nightly/apim/open-source/installation) page.
...
- [Create your first API](/nightly/api-management/gateway-config-managing-oas#creating-an-api)
- [Explore installation options](/nightly/apim/open-source/installation)
