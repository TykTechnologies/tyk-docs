...
description: Learn how to enable single sign on for admin users and developers in
...
If you use [the Tyk helm chart](/nightly/tyk-self-managed/install#install-more-tyk-components), it is required to add the `PORTAL_API_SECRET` to extraEnvs:
```.yaml
extraEnvs:
