...
The system automatically creates a pre-configured "Default Organisation" during the [bootstrap](/nightly/portal/install#bootstrapping-developer-portal) process that serves as the initial home for:
