...
'og:description': "How to manage organizations in Tyk developer portal"
...
Please refer to the [email notification section](/nightly/product-stack/tyk-enterprise-developer-portal/getting-started/setup-email-notifications) for further instructions for setting up the email server.
...
2. **Approve or reject organization registration requests**
    ...
    <br/><br/>Both emails are customizable. Refer to [the email customization documentation](/nightly/portal/customization/email-notifications) for further information on the email customization.
