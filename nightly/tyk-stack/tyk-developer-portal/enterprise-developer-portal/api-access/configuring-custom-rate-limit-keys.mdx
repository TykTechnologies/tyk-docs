...
canonical: "https://tyk.io/docs/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/configuring-custom-rate-limit-keys"
---
...
This capability works with [Tyk 5.3.0](/nightly/developer-support/release-notes/dashboard#5-3-0-release-notes) or higher.
