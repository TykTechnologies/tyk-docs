...
<h3 id="security-policy-example">Security policy example</h3>
<h4 id="key-level-per-api-rate-limits-and-quotas">Key-level per-API rate limits and quota</h4>
...
<h4 id="per-endpoint-rate-limit">Key-level per-endpoint rate limits</h4>
...
<h4 id="path-based-permissions">Path based permissions</h4>
...
<h4 id="partitioned-policies">Partitioned policies</h4>
