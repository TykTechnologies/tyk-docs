---
canonical: https://tyk.io/docs/tyk-stack/tyk-operator/publish-an-api
description: Learn how to publish an API to the Tyk Developer Portal using Tyk Operator
  in Kubernetes, enabling third-party developers to access your APIs.
keywords: Tyk Operator, Developer Portal, API Management, Kubernetes
