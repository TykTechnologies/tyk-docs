---
canonical: https://tyk.io/docs/tyk-stack/tyk-gateway/important-prerequisites
description: Important prerequisites and configurations needed before proceeding with
  Tyk tutorials.
noindex: noindex, follow
sidebarTitle: Useful Configurations
