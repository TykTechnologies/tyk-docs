...
canonical: "https://tyk.io/docs/portal/troubleshooting/kubernetes-bootstrap-failures"
---

This page covers common failures when deploying the Tyk Developer Portal on Kubernetes. For installation steps and configuration, see [Install Developer Portal on Kubernetes](/nightly/portal/install/kubernetes).
