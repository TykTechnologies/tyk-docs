...
description: Install Tyk Developer Portal using Docker, Kubernetes, or Linux packages.
  This page explains the architecture, requirements, and how to install and bootstrap
  the portal.
keywords: Developer Portal, Tyk, Install Tyk Developer Portal, Bootstrap Tyk Developer
  Portal
