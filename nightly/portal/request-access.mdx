...
- [Created](/nightly/portal/overview/getting-started#step-3-create-a-consumer-admin-user) an API Consumer Admin user
...
3. Enter the email address and password for the API consumer admin user you created [previously](/nightly/portal/overview/getting-started#step-3-create-a-consumer-admin-user)
4. Select **Log In**
