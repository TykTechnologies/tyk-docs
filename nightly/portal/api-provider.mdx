...
The endpoint URL for the Tyk Dashboard. This is where the Developer Portal will interact with the [Tyk Dashboard API](/nightly/tyk-dashboard-api) using its allocated [access credentials](/nightly/portal/api-provider#tyk-dashboard-api-access-credentials).
