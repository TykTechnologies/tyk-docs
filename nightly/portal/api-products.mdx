...
2. On the **APIs** tab, do not select any APIs from the [list](/nightly/portal/api-products#api-list)
3. On the **Documentation** tab, add API documentation as needed:
    - [OpenAPI documentation](/nightly/portal/api-products#api-reference-documentation): Upload OpenAPI Description files in JSON or YAML format.
    - [GraphQL SDL](/nightly/portal/api-products#api-reference-documentation): Upload GraphQL Schema Definition Language (SDL) files (.graphql, .graphqls, .gql, or JSON format)
4. Configure the usual Product descriptions, imagery and and [usage guides](/nightly/portal/api-products#getting-started-guide) you wish to display in the Live Portal
