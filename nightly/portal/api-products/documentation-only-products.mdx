...
<Note>
For an overview of API Products, see [API Products](/nightly/portal/api-products). For steps to create a standard API Product with live access, see the API Products page.
</Note>
...
2. **Skip API selection**
    ...
    ![APIs tab on the Add API Product page, showing the default empty state with no APIs selected and the inline note to skip this tab for documentation-only products](/nightly/img/portal/portal-doc-only-apis-tab.png)
...
3. **Add documentation**
    ...
    ![Documentation tab showing an uploaded OpenAPI specification with the Specification Alias field filled in](/nightly/img/portal/portal-doc-only-documentation-tab.png)
...
6. **Save and verify**
    ...
    ![The API specification tab showing a rendered OpenAPI specification in Redoc, with endpoint navigation on the left and schema details on the right](/nightly/img/portal/portal-doc-only-openapi-docs.png)
...
![Live Portal page for a documentation-only Product, showing the Overview, API specification, and Get Started tabs with no Request Access button](/nightly/img/portal/portal-doc-only-live-portal.png)
