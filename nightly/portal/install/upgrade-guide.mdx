...
canonical: "https://tyk.io/docs/portal/install/upgrade-guide"
---
...
{/* 1. **Check the [Compatibility Matrix](/nightly/portal/overview/compatibility-matrix)** to confirm the new Portal version is compatible with your Tyk Dashboard version. */}

2. **Review the release notes** for every version between your current version and the target version. Pay particular attention to the "Breaking Changes" section. See [Portal Release Notes](/nightly/developer-support/release-notes/portal).
...
4. **Back up your theme files.** If you have a custom theme, export it from the Admin Portal or copy the theme directory before upgrading. See [Upgrade Your Theme](/nightly/#upgrade-your-theme).
...
3. **Apply the update.**
    ...
    After the upgrade completes, proceed to [Post-Upgrade Verification](/nightly/#post-upgrade-verification).
...
See [Upgrading Themes](/nightly/portal/customization/themes#upgrading-themes) for the full procedure.
...
For detailed troubleshooting steps for common upgrade failure scenarios, including Admin Portal inaccessible after upgrade, broken Product and Plan sync, and user login failures, see [Troubleshooting > Upgrade Failures](/nightly/portal/troubleshooting/upgrade-failures).
