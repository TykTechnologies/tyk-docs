...
The Developer Portal leverages Tyk's [partitioned policies](/nightly/api-management/access-control/policies/applying-policies#partitioned-policies) in two distinct ways:
