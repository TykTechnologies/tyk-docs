---
canonical: https://tyk.io/docs/portal/resource-migration
description: Learn how to migrate resources between environments in the Tyk Enterprise
  Developer Portal.
keywords: Tyk Developer Portal, Enterprise Portal, Email, Notifications
noindex: noindex, follow
sidebarTitle: Resource Migration
...
This capability was made possible with introduction of [Custom IDs](/nightly/#custom-ids-in-developer-portal) (more on this later) in v1.13.
