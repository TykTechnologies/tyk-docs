...
canonical: "https://tyk.io/docs/portal/customization/blog/overview"
---
...
The blog is a top-level content area within the Live Portal. When enabled, the portal automatically registers a `/blog` route and adds a **Blog** link to the Primary navigation menu during initial setup. Portal Admins can later modify or remove this link from the [Menus](/nightly/portal/customization/menus) section.
...
Posts support both a rich text editor and a Markdown editor. See the [Markdown reference](/nightly/portal/customization/markdown) for supported syntax and known limitations.
