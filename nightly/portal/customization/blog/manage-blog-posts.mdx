...
canonical: "https://tyk.io/docs/portal/customization/blog/manage-blog-posts"
---
...
- The blog is enabled in your portal configuration (`Blog.Enable: true` / `PORTAL_BLOG_ENABLE=true`). See [Blog Posts Overview](/nightly/portal/customization/blog/overview) for configuration details.
...
5. **Choose your editor.** Toggle **Display Markdown version** to switch between the rich text editor and the Markdown editor.
   ...
   See [Markdown in Developer Portal](/nightly/portal/customization/markdown) for supported Markdown syntax and limitations.
...
9. **Assign categories.** Select one or more categories from the **Categories** field. Categories group your posts by topic and appear as filters in the Live Portal. To create categories first, see [Create and Manage Blog Categories and Tags](/nightly/portal/customization/blog/manage-categories-and-tags).

10. **Assign tags.** Select one or more tags from the **Tags** field. Tags control which blog posts appear in the **Related blog content** section on API Product pages in the Live Portal. To create tags first, see [Create and Manage Blog Categories and Tags](/nightly/portal/customization/blog/manage-categories-and-tags).
