...
2. Upload the theme package that is created in the previous step to the portal. You can use the portal's [Admin dashboard](/nightly/portal/customization/themes#create-a-theme) or the [admin API](/nightly/product-stack/tyk-enterprise-developer-portal/api-documentation/tyk-edp-api) to do it.

3. Finally, you need to [activate](/nightly/portal/customization/themes#activate-a-theme) the theme so that it will be applied to the portal.
