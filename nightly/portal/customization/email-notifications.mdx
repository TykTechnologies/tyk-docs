...
canonical: "https://tyk.io/docs/portal/customization/email-notifications"
---
...
| :-------------------------------------------------------- | :------------------------------- | :------------------------------------------------------ | :-------------------------------- | :-------------------------------- | :--------------------------- |
| Password reset                                         | User who reset their password | Reset password email - subject                       | auth/reset_password.text.tmpl  | auth/reset_password.html.tmpl  | auth/reset_password.tmpl  |
...
| An admin user is invited to register in the portal     | Admin                         | Developer registration approval request - subject    | auth/targeted_invite.text.tmpl | auth/targeted_invite.html.tmpl | auth/targeted_invite.tmpl |
...
| A credential is about to expire                        | Credential owner (developer)  | Your Credential is about to expire (not configurable) | keytoexpire.text.tmpl          | keytoexpire.html.tmpl          | keytoexpire.tmpl          |
| A credential has expired                               | Credential owner (developer)  | Your Credential has expired (not configurable)       | keyexpired.text.tmpl           | keyexpired.html.tmpl           | keyexpired.tmpl           |


## Behavior of Welcome and Activation Emails

When creating a user account from the admin UI or via [the admin APIs](/nightly/product-stack/tyk-enterprise-developer-portal/api-documentation/tyk-edp-api), an admin user can create the user account as active or inactive.
