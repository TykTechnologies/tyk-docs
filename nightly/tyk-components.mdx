...
The **[Tyk Identity Broker](/nightly/tyk-identity-broker/overview)** simplifies authentication by connecting APIs with external identity providers (IDPs), supporting single sign-on (SSO) capabilities:
