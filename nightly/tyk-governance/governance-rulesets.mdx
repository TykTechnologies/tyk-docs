---
canonical: https://tyk.io/docs/tyk-governance/governance-rulesets
description: Define, manage, and enforce API standards across your organization through
  customizable rules that act as executable policies for API governance requirements.
