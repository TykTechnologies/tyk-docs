---
canonical: https://tyk.io/docs/tyk-governance/agent-management
description: Deploy, configure, and monitor Tyk Governance agents that discover and
  synchronize APIs from various providers to create a federated API inventory.
keywords: Tyk Governance, Agent Management, API Provider, API Discovery, API Synchronization
noindex: noindex, follow
sidebarTitle: Agent and API Provider Management
...
1. **Create a New Agent**
    ...
    - From the Agents page, click the **New agent** button in the top-right corner.
        ...
        <img src="/img/governance/agents-list.png" alt="" />
    ...
    - In the New agent form, enter:
       ...
       - **Description**: Details about the agent's purpose or location (required)
        ...
        <img src="/img/governance/agents-new-1.png" alt="" />

    - Click **Create agent** to save the new agent.

        <img src="/img/governance/agents-new-2.png" alt="" />
...
2. **Generate an Agent Token**
   ...
   - For existing tokens:
        ...
        <img src="/img/governance/agents-new-3.png" alt="" />

        <img src="/img/governance/agents-new-4.png" alt="" />
...
4. **Deploy the Agent**
    ...
    Run the agent using Docker or as a Kubernetes Deployment. See [Installation](/nightly/tyk-governance/installation#deploy-the-agent) for details.

5. **Monitor Agent Status**

    - Check the agent status in the Governance Hub. A healthy agent will appear as "Healthy":

        <img src="/img/governance/agents-list-2.png" alt="" />
...
6. **Trigger Initial Synchronization**
    ...
    Trigger a [synchronization](/nightly/#synchronization-process) to verify the agent is working correctly.
...
2. **Scheduled Sync**: At regular intervals configured in the agent. See [Understanding Scheduled Synchronization](/nightly/#understanding-scheduled-synchronization).
