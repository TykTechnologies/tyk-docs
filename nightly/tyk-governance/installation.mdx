---
canonical: https://tyk.io/docs/tyk-governance/installation
description: Step-by-step instructions for installing and configuring Tyk Governance,
  including cloud-hosted options and deploying agents in your environment.
keywords: Tyk Governance, Installation, Configuration, Agent Setup, Deployment
...
2. Enable the Governance feature in Tyk Cloud Control Plane as described in [Enabling Governance Feature for Cloud Control Planes](/nightly/#enabling-governance-feature-for-cloud-control-planes)
...
1. Requesting Access to Tyk Governance
2. Generate agent tokens for each provider as described in [Installing a Local Agent](/nightly/#installing-a-local-agent)
3. Create configuration files for each agent
4. Deploy each agent using Docker or Kubernetes as described in [Installing a Local Agent](/nightly/#installing-a-local-agent)
