...
description: Tyk MDCB API documentation. This page provides details on how to use
  the Tyk Multi Data Center Bridge (MDCB) API for monitoring connected Data Planes
  and accessing diagnostic data.
