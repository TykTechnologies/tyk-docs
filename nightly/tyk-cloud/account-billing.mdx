...
'og:description': "Learn how to manage your Tyk Cloud account, including payment plans, billing methods, and account retirement."
...
* The available [Tyk Cloud Plans](/nightly/tyk-cloud/account-billing#select-a-payment-plan)
...
| Starter <p>[Standard Support SLA](/nightly/developer-support/support)</p> | For single teams with low traffic, mostly small businesses that manage few APIs. | This plan includes all of the features of the Tyk Stack. You can have **[custom domains](/nightly/tyk-cloud/using-custom-domains)** and **[plugins](/nightly/tyk-cloud/using-plugins)**, along with management of upto 5 APIs. Standard support is provided.|
| Launch <p>[Standard Support SLA](/nightly/developer-support/support)</p> | For single teams with low traffic, mostly small businesses. | This plan includes all of the features of the Tyk Stack. You can have **[custom domains](/nightly/tyk-cloud/using-custom-domains)** and **[plugins](/nightly/tyk-cloud/using-plugins)** along with management of unlimited APIs. Standard support is provided. |
| Grow <p>[Standard Support SLA](/nightly/developer-support/support)</p> | For single teams with high traffic. | This plan includes all of the features of the Tyk Stack. In this plan, you have **[Hybrid Gateways](/nightly/tyk-cloud/environments-deployments/hybrid-gateways)** as an add on, along with standard support. |
...
If your free trial ends without you upgrading, your account enters what we call [retirement](/nightly/tyk-cloud#glossary).
...
* Select a new [plan](/nightly/tyk-cloud/account-billing#select-a-payment-plan) from our list
...
Your plan will go into [retirement](/nightly/tyk-cloud#glossary) in the following scenarios:
