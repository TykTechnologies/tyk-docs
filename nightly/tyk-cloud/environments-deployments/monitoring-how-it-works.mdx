---
canonical: https://tyk.io/docs/tyk-cloud/environments-deployments/monitoring-how-it-works
description: Learn how Tyk Cloud monitors throughput and storage metrics for your
  deployments.
keywords: Monitoring, Tyk Cloud, Control Plane, Data Plane
noindex: noindex, follow
sidebarTitle: Monitor Metrics
