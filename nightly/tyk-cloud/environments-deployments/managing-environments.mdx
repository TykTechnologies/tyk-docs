...
Environments are used to group your [Control Plane](/nightly/tyk-cloud#glossary) and [Cloud Data Planes](/nightly/tyk-cloud#glossary) into logical groups. For example you may want to create environments that reflect different departments of your organization.


<Note>
The number of Environments you can create is determined by your [plan](/nightly/tyk-cloud/account-billing#select-a-payment-plan)
</Note>


## Prerequisites

The following [user roles](/nightly/tyk-cloud/teams-users#assign-user-roles) can perform Environment Admin tasks:
