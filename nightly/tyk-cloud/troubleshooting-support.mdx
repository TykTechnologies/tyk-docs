---
canonical: https://tyk.io/docs/tyk-cloud/troubleshooting-support
description: Learn how to troubleshoot common issues in Tyk Cloud, including FAQs
  and support resources.
keywords: Troubleshooting, Tyk Cloud, FAQs, Support
...
To add either of the tags, see [Adding an API](/nightly/tyk-cloud#steps-to-add-an-api-in-tyk-cloud) in the Getting Started section.
