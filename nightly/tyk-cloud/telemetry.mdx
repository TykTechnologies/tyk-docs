...
description: Learn how to set up and manage telemetry in Tyk Cloud for distributed
  tracing of your APIs.
keywords: Telemetry, Tyk Cloud, Control Plane, Data Plane, Distributed Tracing
