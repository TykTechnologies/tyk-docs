...
This feature is built on Tyk Gateway's OpenTelemetry integration. See the [OpenTelemetry documentation](/nightly/api-management/traces) for configuration options and sampling strategies.
