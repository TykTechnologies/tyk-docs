---
canonical: https://tyk.io/docs/tyk-cloud/teams-users
description: Learn how to manage teams and users in Tyk Cloud, including user roles,
  team management, and single sign-on (SSO) configuration.
keywords: Teams, Users, Tyk Cloud, User Management, User Roles
...
- [Managing Users](/nightly/tyk-cloud/teams-users)
- Available Tyk Cloud [User Roles](/nightly/tyk-cloud/teams-users#user-roles-within-tyk-cloud)
- [Tyk Cloud Single Sign-On (SSO)](/nightly/tyk-cloud/teams-users/single-sign-on)

## Managing Teams 

The following [user roles](/nightly/tyk-cloud/teams-users#user-roles-within-tyk-cloud) can perform existing Team Admin tasks:
...
You need to be a [Organization Admin](/nightly/tyk-cloud/teams-users#assign-user-roles) to create a new team.
...
You need to be a [Organization Admin](/nightly/tyk-cloud/teams-users#assign-user-roles) to delete a team.
...
You can now invite users to your new team. See [Managing Users](/nightly/tyk-cloud/teams-users) for more details.


## Managing Users

The following [user roles](/nightly/tyk-cloud/teams-users#user-roles-within-tyk-cloud) can perform existing User Admin tasks:

* [Organization Admin](/nightly/tyk-cloud/teams-users#assign-user-roles) - Can manage all users in the organization they are a member of.
* [Team Admin](/nightly/tyk-cloud/teams-users#assign-user-roles) - Can only manage the users of the team they are a member of.
