---
canonical: https://tyk.io/docs/tyk-cloud/initial-portal-config
description: Learn how to set up and configure the Developer Portal in Tyk Cloud Control
  Plane deployments.
keywords: Developer Portal, Tyk Cloud, Control Plane, Configuration
