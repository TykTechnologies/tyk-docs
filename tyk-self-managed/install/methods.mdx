...
1. Via our [Ubuntu Setup](/tyk-self-managed/install) on an installed Ubuntu Server on Azure.
2. Via our [Docker Installation](/deployment-and-operations/tyk-self-managed/tyk-demos-and-pocs/overview#docker-demo) using Azure's Docker support.
...
1. Via our [Ubuntu Setup](/tyk-self-managed/install) on an installed Ubuntu Server within Google Cloud.
2. Via our [Docker Installation](/deployment-and-operations/tyk-self-managed/tyk-demos-and-pocs/overview#docker-demo) using Google Cloud's Docker support.
