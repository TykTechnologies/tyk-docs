...
<Warning>
This deployment is NOT designed for production use or performance testing. The Tyk PoCs is our full, [Self-Managed](/tyk-self-managed/install) solution, which includes our Gateway, Dashboard and analytics processing pipeline. 
...
- Our Pro Demo Docker [GitHub repo](https://github.com/TykTechnologies/tyk-pocs)
