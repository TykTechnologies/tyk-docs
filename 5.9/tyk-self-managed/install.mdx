...
Check [Tyk Control plane](/5.9/tyk-multi-data-centre) for more configuration details.
...
10. **Login to the Dashboard**
    ...
    **Configure your Developer Portal**
    ...
    To set up your [Developer Portal](/5.9/tyk-developer-portal) follow our Self-Managed [tutorial on publishing an API to the Portal Catalog](/5.9/getting-started/tutorials/publish-api).
