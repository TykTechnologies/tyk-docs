...
For a complete list of changes, see the detailed [changelog](/5.9/#Changelog-v1.30.0) below.
...
Introduced automated email notifications to inform organisations and team admins when a Control Plane [auto-upgrade](/5.9/tyk-cloud/environments-deployments/managing-control-planes#auto-upgrade) begins. Notifications include key details such as deployment name and version changes, helping teams track upgrade activity more effectively.
</Expandable>
</li>
...
For a complete list of changes, see the detailed [changelog](/5.9/#Changelog-v1.29.0) below.
...
For a full list of changes, see the detailed [changelog](/5.9/#Changelog-v1.28.1) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.9/#Changelog-v1.28.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.9/#Changelog-v1.27.0) below.
...
For a comprehensive list of changes, please refer to the detailed [changelog](/5.9/#Changelog-v1.26.0) below.
...
Tyk Cloud allows users to enable or disable audit logging for their [Control Plane](/5.9/api-management/mdcb#data-plane) (CP) deployments, providing greater flexibility in managing compliance and storage costs. To enable this feature, please contact your account manager.
...
For more details, check out the [documentation on Gateway versioning and auto-upgrades](/5.9/developer-support/release-types/long-term-support)
...
For more details, check out the [documentation on setting up Telemetry export](/5.9/tyk-cloud/telemetry).
