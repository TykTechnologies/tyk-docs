...
Refer to the [Tyk Gateway Configuration Reference](/5.9/tyk-oss-gateway/configuration#enforce_org_quotas) for more details on this setting.
...
Refer to the [Tyk OAS API Definition reference](/5.9/api-management/gateway-config-tyk-oas#global) for details.
...
Refer to the [Tyk Classic API Definition reference](/5.9/api-management/gateway-config-tyk-classic) for details.
...
Refer this [documentation](/5.9/#configuration-options).
</Accordion>
...
Refer this [documentation](/5.9/#api-level-configuration).
</Accordion>
