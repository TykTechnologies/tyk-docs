...
The following custom resources can be used to configure APIs and policies at [Tyk Gateway](/5.9/tyk-oss-gateway) or [Tyk Dashboard](/5.9/tyk-dashboard).
