...
[section](/5.9/portal/customization/pages#edit-page-content)
...
- [Template Data](/5.9/#template-data): Detailed explanation of the data structures available in different templates.
- [Global Helper Functions](/5.9/#global-helper-functions): A list of global functions that can be used across templates to
manipulate and display data.
- [Email Templates](/5.9/#email-templates): Information about email-specific templates and their available data.
...
- [Analytics](/5.9/#analytics)
- [Application Create](/5.9/#application-create)
- [Application Detail](/5.9/#application-detail)
- [Blogs](/5.9/#blogs)
- [Blog Detail](/5.9/#blog-detail)
- [Cart Checkout](/5.9/#cart-checkout)
- [Organization User Detail](/5.9/#organization-user-detail)
- [Organization User Edit](/5.9/#organization-user-edit)
- [Organization Users List](/5.9/#organization-users-list)
- [Product Detail](/5.9/#product-detail)
- [Product OAS Documentation](/5.9/#product-oas-documentation)
...
{{ .post.Content }}
{{ end }}
<p>Read more at: <a href="/5.9/{{ .post.URL }}">{{ .post.URL }}</a></p>
<h2>Latest Posts</h2>
{{ range .latest_posts }}
<div>
  <h3><a href="/5.9/{{ .URL }}">{{ .Title }}</a></h3>
  <p>{{ .Lede }}</p>
</div>
{{ end }}
```
...
<form action="edit" method="post" id="user-edit">
  ...
  {{ end }}
  <div>
    <a href="/5.9/portal/private/users">Cancel</a>
...
<div class="docs-container">
  <div class="card mt-4">
    <div class="card-body">
      <h3 class="card-title">
        <a href="/5.9/portal/catalogue-products/{{ .Path }}">{{ .Name }}</a>
      </h3>
      <p class="card-text">
        {{ .Description }}
      </p>
...
- [CanCreateOrganisation](/5.9/#cancreateorganisation)
- [Clients](/5.9/#clients)
- [Current User](/5.9/#currentuser)
- [FeaturedProducts](/5.9/#featuredproducts)
- [FilterUserInvites](/5.9/#filteruserinvites)
- [FormatTime](/5.9/#formattime)
- [GetCart](/5.9/#getcart)
- [GetCatalogueList](/5.9/#getcataloguelist)
- [GetCataloguesForProduct](/5.9/#getcataloguesforproduct)
- [GetClientDescription](/5.9/#getclientdescription)
- [GetClientName](/5.9/#getclientname)
- [GetMenus](/5.9/#getmenus)
- [GetProducts](/5.9/#getproducts)
- [IsPortalDisabled](/5.9/#isportaldisabled)
- [IsPortalPrivate](/5.9/#isportalprivate)
- [ProductDocRenderer](/5.9/#productdocrenderer)
- [ProviderUpstreamURL](/5.9/#providerupstreamurl)
- [SplitStrings](/5.9/#splitstrings)
- [TruncateString](/5.9/#truncatestring)
- [TypeOfCredential](/5.9/#typeofcredential)
...
<div class="featured-products-container">
  ...
  <div class="product-card">
    ...
    <div class="product-actions">
      <a href="/5.9/portal/catalogue-products/{{ .Path }}" class="btn">More Info</a>
      <div class="dropdown-content">
        {{ range .APIDetails }}
        {{ if or (gt (.OASDocument.Base.Url | trim | length) 0) (gt (.OASUrl | trim | length) 0) }}
        <a href="/5.9/portal/catalogue-products/{{ $.Path }}/{{ .APIID }}/docs" target="blank">
          {{ .Name }}
        </a>
        {{ end }}
        {{ end }}
...
Returns a map of all [menus](/5.9/portal/customization/menus).
...
{{ if GetMenus.Primary }}
  {{ range GetMenus.Primary.Children }}
    {{ range .Children }}
    <li class="nav-item">
      <a class="dropdown-item" href="/5.9/{{ .Path }}">{{ .Tag }}</a>
    </li>
    {{ end }}
  {{ end }}
{{ end }}
...
<div class="col-lg-12 card-container">
  <div class="card d-flex flex-row {{ if .Logo.URL }}has-logo{{ end }}">
    ...
    <div class="card-cta d-flex flex-column align-self-center justify-content-between align-items-baseline w-100">
      <div>
        <a href="/5.9/portal/catalogue-products/{{ .Path }}" class="btn btn-secondary">More Info</a>
      </div>
    </div>
  </div>
</div>
...
Please refer to [email workflow](/5.9/portal/customization/email-notifications)
for additional detail on email notifications sent by the portal.


### Available Email Templates

- [Access Request Approve/Reject](/5.9/#access-request-approvereject)
- [Access Request Submitted](/5.9/#access-request-submitted)
- [Activate and Deactivate](/5.9/#activate-and-deactivate)
- [New User Request](/5.9/#new-user-request)
- [Organization Approve](/5.9/#organization-approve)
- [Organization Reject](/5.9/#organization-reject)
- [Organization Request](/5.9/#organization-request)
- [Reset Password](/5.9/#reset-password)
- [Targeted Invite](/5.9/#targeted-invite)
- [Welcome User](/5.9/#welcome-user)
