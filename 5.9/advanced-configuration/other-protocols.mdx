...
1. **[TCP Proxy](/5.9/key-concepts/tcp-proxy)**

2. **[gRPC](/5.9/key-concepts/grpc-proxy)**

3. **[Server-Sent Events (SSE)](/5.9/advanced-configuration/sse-proxy)**

4. **[WebSockets](/5.9/advanced-configuration/websockets)**