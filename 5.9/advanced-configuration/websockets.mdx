...
See the [Access an API](/5.9/api-management/gateway-config-managing-classic#access-an-api) tutorial for details on adding an Authentication Token to your APIs.
