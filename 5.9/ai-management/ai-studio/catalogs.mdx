...
Catalogs in Tyk AI Studio are collections of AI resources ([LLM providers](/5.9/ai-management/ai-studio/llm-management), [Data sources](/5.9/ai-management/ai-studio/datasources-rag), and [Tools](/5.9/ai-management/ai-studio/tools)) that you can assign to specific [Teams](/5.9/ai-management/ai-studio/teams) to easily manage access. They act as the bridge between the raw AI capabilities and the users who need to consume them.
