...
The [user owned analytics](/platform-management/api-ownership#owned-analytics) feature allows you to prevent users from seeing the traffic to (and existence of) APIs for which they are not responsible. This reduces the opportunity for data leakage within your business.
...
To implement this structure, you would create three user groups and assign [permissions](/platform-management/user-permissions) as indicated:
