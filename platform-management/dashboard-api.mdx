...
For more information on how to configure OPA see [Open Policy Agent](/platform-management/open-policy-agent#extend-permissions-using-open-policy-agent-opa).
