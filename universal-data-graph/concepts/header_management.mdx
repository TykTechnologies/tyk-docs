...
Global headers now have access to all [request context variables](/content/context-variables.md).
...
Data source headers now have access to all [request context variables](/content/context-variables.md).
