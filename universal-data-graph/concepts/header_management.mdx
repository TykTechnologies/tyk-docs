...
Global headers now have access to all [request context variables](/context-variables).
...
Data source headers now have access to all [request context variables](/context-variables).
