...
We offer 3 ways of importing an example into Tyk:
 - Using [tyk-sync](/product-stack/tyk-sync/overview)
...
Please follow the [tyk-sync documentation](/product-stack/tyk-sync/commands/sync-examples#import-tyk-example-into-dashboard) to learn more about this approach.
