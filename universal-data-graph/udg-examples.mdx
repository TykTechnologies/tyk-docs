...
We offer 3 ways of importing an example into Tyk:
 - Using [tyk-sync](/api-management/automations#synchronize-api-configurations-with-github-actions)
 - Manually import via [Dashboard API Import](/getting-started/import-apis)
- Using Tyk Dashboard to browse and import the examples directly

## Import via tyk-sync

Please follow the [tyk-sync documentation](/api-management/automations#examples-publish-command) to learn more about this approach.
...
You can find more detailed instructions in the [Dashboard API Import documentation section](/getting-started/import-apis).
