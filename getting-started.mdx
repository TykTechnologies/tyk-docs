...
### [Create an API](/getting-started/create-api)

How to add a basic API to Tyk

### [Create a Security Policy](/getting-started/create-security-policy)

Create a Security Policy that can be applied to multiple keys

### [Create an API Key](/getting-started/create-api-key)
