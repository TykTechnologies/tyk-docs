---
title: "Send Tyk Traces to Datadog"
description: "Step-by-step guide to connect Tyk Gateway distributed traces to Datadog using the OpenTelemetry Collector."
keywords: "Distributed Tracing, Datadog, OpenTelemetry, OTLP, OTel Collector, Tyk Gateway, APM, Observability"
