...
6. **[Configuring Internal Proxy Setup](#internal-proxy-setup)**: 
    Set up internal proxies with TLS to ensure secure communication within your architecture.
7. **[Configuring Certificate Pinning](#certificate-pinning)**: 
...
From v2.9.3 you can also specify a custom proxy and set the minimum TLS versions and any SSL ciphers within your API definitions. See [Internal Proxy Setup](/api-management/gateway-config-tyk-classic#internal-proxy-setup) for more details.
