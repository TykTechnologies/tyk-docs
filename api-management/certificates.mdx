...
Wherever Tyk accepts a certificate, the value is a **certificate reference**: a certificate ID from the Tyk Certificate Store, a local file path, or inline PEM content. The three forms are:
