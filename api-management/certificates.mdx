...
<Note>
    Several different algorithms can be used to sign certificates. The choice of signature can affect performance, as some are easier than others for Tyk to verify. Elliptic curve approaches seem to perform better on average, though this can vary for different CPU architectures. We recommend testing to determine the most appropriate trade-off between security and performance for your needs.
</Note>
