...
2. **Policy Resolution**: Tyk determines which [Policy](/api-management/access-control/policies/understanding-policies) to apply to the request:
...
The following [session attributes](/api-management/access-control/sessions-and-keys/understanding-sessions#configuration-options) are modified based on the Policies:
