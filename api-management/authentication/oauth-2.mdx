...
The *access tokens* issued to clients by *Tyk Authorization Server* are lookup keys to [Sessions](/api-management/access-control/sessions-and-keys/understanding-sessions) and are usually associated with [Policies](/api-management/access-control/policies/understanding-policies) at the point of creation. These allow the application of quotas, rate limits and access rights in the normal manner.
