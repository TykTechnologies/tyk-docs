...
| :--- | :--- | :--- |
| Register a new client app | `POST /api/apis/oauth/{{api-id}}` | [link](/platform-management/dashboard-api#create-a-new-oauth2-0-client) |
| Get a list of registered client apps | `GET /api/apis/oauth/{{api-id}}` | [link](/platform-management/dashboard-api#list-oauth-clients) |
| Get the details of a client app | `GET /api/apis/oauth/{{api-id}}/{{client_id}}` | [link](/platform-management/dashboard-api#get-an-oauth2-0-client) |
| Delete a client app | `DELETE /api/apis/oauth/{{api-id}}/{{client_id}}` | [link](/platform-management/dashboard-api#delete-oauth-client) |
...
The identity server will need access to the Tyk Dashboard API to [obtain an Authorization Code](/platform-management/dashboard-api#oauth2-0-authorization-code).
...
- [retrieve a list of all tokens for a client app](/platform-management/dashboard-api#retrieve-all-current-tokens-for-specified-oauth2-0-client)
- [revoke a single token](/platform-management/dashboard-api#revoke-a-single-oauth-client-token)
- [revoke all tokens for a client app](/platform-management/dashboard-api#revoke-all-oauth-client-tokens)
