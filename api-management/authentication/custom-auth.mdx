...
* See [Custom Authentication with a Python plugin](/api-management/plugins/rich-plugins-python#custom-authentication-plugin-tutorial) for a detailed example of a custom Python plugin.
