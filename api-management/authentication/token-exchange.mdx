...
By default, a provider sends an RFC 8693 token exchange request. Some authorization servers (Microsoft Entra ID) reject that grant outright and instead implement delegation using the [RFC 7523](https://www.rfc-editor.org/rfc/rfc7523) JWT bearer grant.
