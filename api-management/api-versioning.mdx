...
We also added a new optional `purge` parameter to the [delete API](https://tyk.io/docs/api-reference/dashboard/oas-apis/delete-oas-api) endpoint in the Tyk Dashboard API which will delete all child APIs linked to the API being deleted, allowing you to remove all versions of an API with one command.
