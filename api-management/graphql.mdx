...
It is possible to create GQL APIs using [Tyk Dashboard APIs](/platform-management/dashboard-api#manage-apis-api-definition). To make things easier you can use our [Postman collection](https://www.postman.com/tyk-technologies/workspace/tyk-public-workspace/overview).
...
When using the [Dashboard API](/platform-management/dashboard-api#manage-apis-api-definition) the response for a broken schema will be a *400 Bad Request* with a body containing the validation errors. For example:
