...
First, you need to [create an API Key](/api-management/gateway-config-managing-classic#tyk-open-source-2). If you prefer, you can follow [these instructions](/api-management/gateway-config-managing-classic#secure-an-api) to learn how to do this using a [Policy](/api-management/access-control/policies/understanding-policies).
