...
Request Throttling is configured using [Policies](/api-management/access-control/policies/understanding-policies) or directly on individual [Sessions](/api-management/access-control/sessions-and-keys/understanding-sessions).
