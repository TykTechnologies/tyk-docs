...
<<<<<<< HEAD
The [Internal Endpoint](/advanced-configuration/transform-traffic/looping) middleware instructs Tyk Gateway not to expose the endpoint externally. Tyk Gateway will then ignore external requests to that endpoint while continuing to process internal requests from other APIs; this is used for [internal routing](/advanced-configuration/transform-traffic/looping).
=======
The [Internal Endpoint](/advanced-configuration/transform-traffic/looping#internal-only-apis) middleware instructs Tyk Gateway not to expose the endpoint externally. Tyk Gateway will then ignore external requests to that endpoint while continuing to process internal requests from other APIs; this is used for [internal routing](/advanced-configuration/transform-traffic/looping).
