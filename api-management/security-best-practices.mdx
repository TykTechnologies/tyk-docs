...
Use [Policies](/api-management/access-control/policies/understanding-policies) to specify which paths, methods and schemas are accessible, whilst blocking all others.
