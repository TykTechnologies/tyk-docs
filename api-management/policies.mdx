...
[With the Dashboard API](/api-management/gateway-config-managing-classic#secure-an-api)

[With the Gateway API - Open Source tab](/api-management/gateway-config-managing-classic#secure-an-api)

[With the Dashboard](/api-management/gateway-config-managing-classic#secure-an-api)
