...
To effectively use Tyk Streams for managing async APIs, it's important to first understand the terminology and [key concepts](/api-management/event-driven-apis#key-concepts)
...
With [Tyk Streams](/api-management/event-driven-apis#), you can easily monetize your async APIs, provide a seamless developer experience, and manage the entire lifecycle of your event-driven architecture.
...
capabilities. Please consult the [glossary](/api-management/event-driven-apis#glossary) for explanations of key
terminology.
