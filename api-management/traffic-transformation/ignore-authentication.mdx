...
If you're using Tyk OAS APIs, then you can find details and examples of how to configure the ignore authentication middleware [here](#ignore-authentication-using-tyk-oas).

If you're using Tyk Classic APIs, then you can find details and examples of how to configure the ignore authentication middleware [here](#ignore-authentication-using-classic).
...
For example:
```json {hl_lines=["65-69"],linenos=true, linenostart=1} expandable
{
    "info": {
...
```yaml {linenos=true, linenostart=1, hl_lines=["27-35"]} expandable
