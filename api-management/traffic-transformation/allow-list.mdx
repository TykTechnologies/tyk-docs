...
If you're using Tyk OAS APIs, then you can find details and examples of how to configure the allow list middleware [here](#allow-list-using-tyk-oas).

If you're using Tyk Classic APIs, then you can find details and examples of how to configure the allow list middleware [here](#allow-list-using-classic).
...
```json {hl_lines=["47-50", "53-56"],linenos=true, linenostart=1} expandable
{
    "components": {},
    "info": {
