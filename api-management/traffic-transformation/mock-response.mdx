...
```json {hl_lines=["9-11"],linenos=true, linenostart=1} expandable
{
  "paths": {
    "/get": {
      "get": {
...
``` json {hl_lines=["9-18"],linenos=true, linenostart=1} expandable
{  
  "paths": {
    "/get": {
      "get": {
...
```json {hl_lines=["10-13", "18-33"],linenos=true, linenostart=1} expandable
{
    "paths": {
        "/get": {
            "get": {
...
```json {hl_lines=["39-49"],linenos=true, linenostart=1} expandable
{
  "components": {},
  "info": {
...
```json {hl_lines=["15-24", "29-33", "59-67"],linenos=true, linenostart=1} expandable
{  
    "components": {},
    "info": {
...
```json {hl_lines=["15-19", "22-39", "45-50", "53-55", "82-89"],linenos=true, linenostart=1} expandable
{  
    "components": {},
    "info": {
...
```yaml {linenos=true, linenostart=1, hl_lines=["26-34"]} expandable
