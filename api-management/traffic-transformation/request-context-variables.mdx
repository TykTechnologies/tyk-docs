...
|------------|-------------|
| URL Rewriter | Syntax is `$tyk_context.CONTEXTVARIABLES`. See [Path Modification](/transform-traffic/url-rewriting) for more details. |
| Request Header Transform | Syntax is `$tyk_context.CONTEXTVARIABLES`. See [Request Headers](/api-management/traffic-transformation/request-headers) for more details. |
| Response Header Transform | Syntax is `$tyk_context.CONTEXTVARIABLES`. See [Response Headers](/api-management/traffic-transformation/response-headers) for more details. |
| Request Body Transform | Syntax is `{{ ._tyk_context.CONTEXTVARIABLES }}`. See [Request Body](/api-management/traffic-transformation/request-body) for more details. |
| Response Body Transform | Syntax is `{{ ._tyk_context.CONTEXTVARIABLES }}`. See [Response Body](/api-management/traffic-transformation/response-body) for more details. |
