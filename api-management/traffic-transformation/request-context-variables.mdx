...
| Middleware | Syntax |
|------------|-------------|
| [URL Rewriter](/transform-traffic/url-rewriting) | `$tyk_context.CONTEXTVARIABLES` |
| [Request Header Transform](/api-management/traffic-transformation/request-headers) | `$tyk_context.CONTEXTVARIABLES` |
| [Response Header Transform](/api-management/traffic-transformation/response-headers) | `$tyk_context.CONTEXTVARIABLES` |
| [Request Body Transform](/api-management/traffic-transformation/request-body) | `{{ ._tyk_context.CONTEXTVARIABLES }}` |
| [Response Body Transform](/api-management/traffic-transformation/response-body) | `{{ ._tyk_context.CONTEXTVARIABLES }}` |
