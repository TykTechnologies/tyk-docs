...
<ParamField path="mcp_error_code">
  JSON-RPC error code when the MCP request fails (for example, `-32001` for Resource not found, `-32002` for Permission denied). Only present when an MCP error occurs.
</ParamField>
