...
<ParamField path="api_id">
  ID of the API that handled the request.
</ParamField>
...
<ParamField path="api_name">
  Name of the API that handled the request.
</ParamField>
...
<ParamField path="error_source">
  Source of an error (for example, ReverseProxy).
</ParamField>

<ParamField path="error_target">
  Target that caused an error.
</ParamField>
...
<ParamField path="latency_gateway">
  Gateway processing latency excluding upstream round-trip time.
</ParamField>
...
<ParamField path="original_path">
  Original request path before URL rewrites.
</ParamField>
...
<ParamField path="response_code_details">
  Detailed error description for 5XX responses.
</ParamField>

<ParamField path="response_flag">
  Error classification flag (for example, URT, UCF, TLE).
</ParamField>
...
<ParamField path="tls_cert_expiry">
  TLS certificate expiry date when applicable.
</ParamField>

<ParamField path="tls_cert_subject">
  TLS certificate subject when applicable.
</ParamField>
...
<ParamField path="upstream_status">
  Upstream response status code for 5XX responses.
</ParamField>
