...
- **[API Traffic Log](/api-management/dashboard-analytics#how-traffic-logging-works):** <Badge color="orange">Gateway</Badge> A record of every API request, written into Redis and processed by Tyk Pump for analytics and reporting. Not written to `stderr`.
