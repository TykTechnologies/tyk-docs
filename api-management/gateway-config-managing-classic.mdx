...
import CreateApiInclude from '/snippets/5.15/create-api-include.mdx';
import CreateApiKeyInclude from '/snippets/5.15/create-api-key-include.mdx';
import CreateSecurityPolicyInclude from '/snippets/5.15/create-security-policy-include.mdx';
import ImportApiInclude from '/snippets/5.15/import-api-include.mdx';
...
See [What is a Security Policy?](/api-management/policies) for more details.
...
4. **Click "Generate API"**
    ...
    Your API will appear in your APIs list. If you select **EDIT** from the **ACTIONS** drop-down list, you can see the endpoints (from the [Endpoint Designer](/api-management/endpoint-designer)) that have been created as part of the import process.
