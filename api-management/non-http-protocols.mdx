...
Tyk supports Basic Authentication in gRPC. See [Basic Authentication](/api-management/client-authentication#use-basic-authentication) to configure Basic Authentication in Tyk. 
...
Tyk supports Token Based Authentication in gRPC. See [Bearer Tokens](/api-management/client-authentication#use-auth-tokens) to configure Token Based Authentication in Tyk. 
