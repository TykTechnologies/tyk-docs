...
- API Settings including
   - Listen path
   - [API Categories](/platform-management/api-categories)
...
- [API Ownership](/platform-management/api-ownership)
...
- Manage *segment tags* if you are working with [sharded gateways](/api-management/api-sharding#gateway-sharding)
