...
<img src="/img/observability/tyk-sequence-traces.png" alt="Sequence diagram showing which headers Tyk Gateway reads from the client and writes to the upstream for tracecontext, custom, and composite propagation modes" />
...
<img src="/img/observability/tyk-sampling-diagram.png" alt="Decision tree showing how Tyk Gateway determines whether a trace is sampled based on opentelemetry.sampling.type, parent_based, and sampling.rate settings" />
