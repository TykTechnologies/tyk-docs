...
| [opentelemetry.traces.sampling.parent_based](/tyk-oss-gateway/configuration#opentelemetry-traces-sampling-parent_based) | Inherit the parent span's sampling decision | `false` |
...
Enable parent based sampling by setting [opentelemetry.traces.sampling.parent_based](/tyk-oss-gateway/configuration#opentelemetry-traces-sampling-parent_based) or the equivalent environment variable. The default value is `false`.
