...
| [New Relic Instrumentation](#new-relic-instrumentation) | Tyk Gateway | Deprecated | Legacy New Relic agent integration available since Gateway v2.5. |
| [StatsD Instrumentation](#statsd-instrumentation) | Tyk Gateway, Pump, Dashboard | Deprecated | Legacy StatsD protocol export for Gateway, Pump, and Dashboard. |
