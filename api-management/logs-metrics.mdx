...
<Note>
OpenTelemetry metrics do not populate the Tyk Dashboard. If you need Dashboard analytics alongside OTel metrics, see [Tyk Pump vs OpenTelemetry](/api-management/observability/pump-vs-opentelemetry).
</Note>
