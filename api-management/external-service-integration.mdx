...
- `/admin/sso` - See [Dashboard Admin API SSO](/platform-management/dashboard-admin-api#single-sign-on-api) for more details.
- `/api/sso` -  See [Dashboard API SSO](/platform-management/dashboard-api#single-sign-on-api) for more details.
