...
3. [Login with LDAP](/api-management/single-sign-on-ldap)
...
- `/admin/sso` - See [Dashboard Admin API SSO](https://tyk.io/docs/api-reference/single-sign-on/generate-authentication-token) for more details.
- `/api/sso` -  See [Dashboard API SSO](https://tyk.io/docs/api-reference/single-sign-on/generate-authentication-token) for more details.
