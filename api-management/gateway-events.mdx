...
- an [event log](/api-management/gateway-events#logging-api-events-1) that will write to the configured [log output](/api-management/logs#application-logs)
...
<li>
<Expandable title='RatelimitExceeded'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `path` (string): the path of the API endpoint request that led to the event being fired
- `origin` (string): origin data for the source of the request
- `key` (string): the key that was used in the request
- `originating_request` (string): a Base64-encoded raw inbound request
</Expandable>
</li>

<li>
<Expandable title='OrgRateLimitExceeded'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `path` (string): the path of the API endpoint request that led to the event being fired
- `origin` (string): origin data for the source of the request
- `key` (string): the key that was used in the request
...
<li>
<Expandable title='RateLimitSmoothingUp'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `path` (string): the path of the API endpoint request that led to the event being fired
- `origin` (string): origin data for the source of the request
- `key` (string): the key that was used in the request
...
<li>
<Expandable title='RateLimitSmoothingDown'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `path` (string): the path of the API endpoint request that led to the event being fired
- `origin` (string): origin data for the source of the request
- `key` (string): the key that was used in the request
...
<li>
<Expandable title='QuotaExceeded'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `path` (string): the path of the API endpoint request that led to the event being fired
- `origin` (string): origin data for the source of the request
- `key` (string): the key that was used in the request
...
<li>
<Expandable title='OrgQuotaExceeded'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `path` (string): the path of the API endpoint request that led to the event being fired
- `origin` (string): origin data for the source of the request
- `key` (string): the key that was used in the request
...
<li>
<Expandable title='UpstreamOAuthError'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `path` (string): the path of the API endpoint request that led to the event being fired
- `origin` (string): origin data for the source of the request
- `key` (string): the key that was used in the request
...
<li>
<Expandable title='VersionFailure'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `path` (string): the path of the API endpoint request that led to the event being fired
- `origin` (string): origin data for the source of the request
- `key` (string): the key that was used in the request
- `reason` (string): the reason for the version access failure
- `originating_request` (string): a Base64-encoded raw inbound request
</Expandable>
</li>

<li>
<Expandable title='BreakerTripped'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `path` (string): the path that triggered the circuit breaker
- `api_id` (string): the ID of the API that triggered the event
- `circuit_event` (string): the circuit breaker event status
- `originating_request` (string): a Base64-encoded raw inbound request
</Expandable>
</li>

<li>
<Expandable title='BreakerReset'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `path` (string): the path that triggered the circuit breaker reset
- `api_id` (string): the ID of the API that triggered the event
- `circuit_event` (string): the circuit breaker event status
- `originating_request` (string): a Base64-encoded raw inbound request
</Expandable>
...
<li>
<Expandable title='BreakerTriggered'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `path` (string): the path that triggered the circuit breaker state change
- `api_id` (string): the ID of the API that triggered the event
- `circuit_event` (string): the circuit breaker event status indicating whether the breaker tripped or reset
- `originating_request` (string): a Base64-encoded raw inbound request
</Expandable>
</li>

<li>
<Expandable title='HostDown'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `host_info` (object): contains information about the host that is down, including:
  - `check_url` (string): the URL being checked
  - `protocol` (string): the protocol used for the health check
  - `response_code` (integer): the HTTP response code received
  - `latency` (number): the response latency in milliseconds
  - `is_tcp_error` (boolean): whether the failure was a TCP-level error
- `originating_request` (string): a Base64-encoded raw inbound request
</Expandable>
</li>

<li>
<Expandable title='HostUp'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `host_info` (object): contains information about the host that is back up, including:
  - `check_url` (string): the URL being checked
  - `protocol` (string): the protocol used for the health check
  - `response_code` (integer): the HTTP response code received
  - `latency` (number): the response latency in milliseconds
  - `is_tcp_error` (boolean): whether there was a TCP-level error
- `originating_request` (string): a Base64-encoded raw inbound request
</Expandable>
</li>

<li>
<Expandable title='TokenCreated'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `org` (string): the organization ID associated with the token
- `key` (string): the key/token that was created
- `originating_request` (string): a Base64-encoded raw inbound request
</Expandable>
</li>

<li>
<Expandable title='TokenUpdated'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `org` (string): the organization ID associated with the token
- `key` (string): the key/token that was updated
- `originating_request` (string): a Base64-encoded raw inbound request
</Expandable>
</li>

<li>
<Expandable title='TokenDeleted'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `org` (string): the organization ID associated with the token
- `key` (string): the key/token that was deleted
- `originating_request` (string): a Base64-encoded raw inbound request
</Expandable>
</li>
...
<li>
<Expandable title='TriggerExceeded'>
- `message` (string): a human readable message from Tyk Gateway that adds detail about the event
- `org_id` (string): the organization ID that triggered the quota monitor
- `key` (string): the raw API key (only provided if triggered by a user quota, empty for organization quotas)
- `trigger_limit` (integer): the quota threshold percentage that was exceeded
- `usage_percentage` (integer): the current usage percentage
- `originating_request` (string): a Base64-encoded raw inbound request
</Expandable>
</li>
...
The Tyk platform can be configured to log at various verbosity levels (info, debug, warn, error) and can be integrated with third-party log aggregation tools like Sentry, Logstash, Graylog, and Syslog. For full details on configuring the Tyk logger, see [this section](/api-management/logs#application-logs).
