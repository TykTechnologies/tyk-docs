...
To create a key with a custom identifier, ie Token, simply use the [Gateway (OSS)](/tyk-gateway-api) or [Dashboard (Pro)](/platform-management/dashboard-api#create-a-custom-key) REST APIs to import a custom key.
