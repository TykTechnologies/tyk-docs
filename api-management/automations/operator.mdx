...
| API Ownership                  | ✅      | v0.12          | Define ownership of APIs within teams or organizations. Available for Tyk Classic APIs from v0.12, and for Tyk OAS APIs from v1.5.0. |
...
| API Ownership via OperatorContext | ✅      | v1.5.0 | - | [API Ownership](/api-management/user-management#when-to-use-api-ownership) |
...
<Note>
API ownership for Tyk OAS and Tyk Streams APIs is available starting from Tyk Operator v1.5.0.
</Note>
