...
| Custom domain certificates | ✅ [TLS and SSL](/api-management/certificates) | ✅ [TLS and SSL](/api-management/certificates) | Certificate ID can be set in the API Definition but configuring certificates from Secrets in CRD is not supported. |
