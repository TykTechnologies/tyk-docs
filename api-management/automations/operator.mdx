...
| SecurityPolicy     | tyk.tyk.io  | v1alpha1  | Defines configuration of [security policies](/api-management/access-control/policies/understanding-policies). Operator supports linking ApiDefinition custom resources in SecurityPolicy's access list so that API IDs do not need to be hardcoded in the resource manifest.        |
...
### Security Policy CRD
The SecurityPolicy custom resource defines configuration of [Tyk Policies](/api-management/access-control/policies/understanding-policies).
