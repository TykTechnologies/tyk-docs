...
```json {hl_lines=["9-25"],linenos=true} expandable
{
  "info": {
    "title": "Petstore",
    "version": "1.0.0"
...
```yaml{hl_lines=["7-7", "41-44"],linenos=true} expandable
apiVersion: v1
kind: ConfigMap
metadata:
  name: cm
...
```json {hl_lines=["8-14","16-20","33-40"],linenos=true} expandable
{
  "info": {
...
This configuration allows [keyless (open)](/basic-config-and-security/security/authentication-authorization/open-keyless) access to the API without any authentication.

```yaml {hl_lines=["7-7"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
...
```yaml {hl_lines=["13-35"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
...
```yaml {hl_lines=["13-22"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: httpbin-jwt1
...
```yaml {hl_lines=["13-13"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
...
```yaml {hl_lines=["7-7", "14-21"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
...
```yaml {hl_lines=["9-9", "14-26"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
...
This setup allows for [multiple authentication](/basic-config-and-security/security/authentication-authorization/multiple-auth) methods to be chained together, requiring clients to pass through each specified authentication provider.

To enable multiple (chained) auth, you should set `base_identity_provided_by` field to one of the supported chained enums. Consult the [Multi (Chained) Authentication](/basic-config-and-security/security/authentication-authorization/multiple-auth) section for the supported auths.
...
```yaml {hl_lines=["19-21"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
...
```yaml {hl_lines=["10-12"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: httpbin
...
```yaml {hl_lines=["15-17", "18-92"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: trevorblades
...
```yaml {hl_lines=["10-13"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: httpbin
...
```yaml {hl_lines=["10-10"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: httpbin
...
```yaml {hl_lines=["35-38"],linenos=false} expandable
...
```yaml {hl_lines=["8-11"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: redis-tcp
...
```yaml {hl_lines=["20-39", "46-80"],linenos=false} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: udg
...
```json {hl_lines=["17-54"],linenos=true} expandable
{
  "info": {
...
```yaml {linenos=true, linenostart=1, hl_lines=["21-35"]} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: basic-auth-internal
...
```yaml {linenos=true, linenostart=1, hl_lines=["10-13"]} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: proxy-api
...
```yaml {linenos=true, linenostart=1, hl_lines=["6-6"]} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
...
```yaml {linenos=true, linenostart=1, hl_lines=["9-9"]} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: inactive-api
...
```yaml {linenos=true, linenostart=1, hl_lines=["10-10"]} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: inactive-api
...
```yaml  {linenos=true, linenostart=1, hl_lines=["8-8"]} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: ApiDefinition
metadata:
  name: existing-api
...
```yaml  {linenos=true, linenostart=1, hl_lines=["7-9"]} expandable
apiVersion: tyk.tyk.io/v1alpha1
kind: TykOasApiDefinition
metadata:
...
```yaml {hl_lines=["40-43"],linenos=true} expandable
apiVersion: v1
data:
  test_oas.json: |-
    {
