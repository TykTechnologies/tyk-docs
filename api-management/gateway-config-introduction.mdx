...
**For global configurations of the Gateway deployment refer this [config file](/tyk-oss-gateway/configuration).**
...
- [Tyk OAS API Definition Objects](/api-management/gateway-config-tyk-oas#tyk-oas-api-definition-object)
- [Tyk Classic API Definition Objects](/api-management/gateway-config-tyk-classic)
...
<Note>
The Tyk Gateway API is subsumed by the [Tyk Dashboard API](/api-management/dashboard-configuration#overview) in all
