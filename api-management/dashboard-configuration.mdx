...
The **Activity by Graph** dashboard provides analytics specifically tailored for your GraphQL APIs (Universal Data Graph / UDG). It allows you to monitor and analyze GraphQL-specific traffic, including query performance, field usage, and resolver execution times. This helps you optimize your GraphQL schema and resolve performance bottlenecks.

<!-- TODO: Add screenshot of Activity by Graph dashboard -->
<Note>
**TODO:** Add screenshot of the Activity by Graph dashboard here.
</Note>

### Activity by MCP

The **Activity by MCP** dashboard provides analytics for your Model Context Protocol (MCP) proxies and primitives. It allows you to track and monitor MCP-specific traffic, including request volumes, latency, and error rates across your MCP tools, servers, and primitives. This helps you ensure the reliability and performance of your AI-powered integrations.

<!-- TODO: Add screenshot of Activity by MCP dashboard -->
<Note>
**TODO:** Add screenshot of the Activity by MCP dashboard here.
</Note>
