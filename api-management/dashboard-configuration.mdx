...
The **Activity by Graph** page provides analytics for your GraphQL APIs (Universal Data Graph / UDG). It allows you to monitor and analyze GraphQL-specific traffic, including query performance, field usage, and resolver execution times. This helps you optimize your GraphQL schema and resolve performance bottlenecks.
