...
The **Activity by MCP** page provides analytics for your Model Context Protocol (MCP) [proxies and primitives](/ai-management/mcp-gateway/managing-proxies). It allows you to track and monitor MCP-specific traffic, including request volumes, latency, and error rates across your MCP tools, servers, and primitives. This helps you ensure the reliability and performance of your AI-powered integrations.
