...
- **[Dashboard API](/tyk-dashboard-api)**: The Dashboard API reference, covering operational management of APIs, policies, keys and users.
- **[Dashboard Admin API](/dashboard-admin-api)**: The Dashboard Admin API reference, covering system administration, organization management and Tyk asset export/import.
...
Please consult [Control Plane Pumps](/api-management/dashboard-analytics/control-plane-pumps) for an explanation of how to configure Tyk Pump to write logs and analytics to different storage layers, or [Uptime Tests](/planning-for-production/ensure-high-availability/uptime-tests#monitoring-uptime-tests-in-tyk-dashboard) for the uptime storage layer specifically.
