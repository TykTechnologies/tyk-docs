...
The **Activity by Graph** page provides analytics for your GraphQL APIs (Universal Data Graph / UDG). It allows you to monitor and analyze GraphQL-specific traffic through the following charts and tables:
...
TODO: Add screenshots of the Activity by MCP dashboard
