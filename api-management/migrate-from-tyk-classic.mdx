...
2. **Location of Mock Response Middleware**
    ...
    The position of mock response middleware in the request processing chain [differs between Tyk Classic and Tyk OAS](/api-management/traffic-transformation/mock-response#how-it-works):
...
4. **Listen Path Variable Naming**
    ...
    Recommended action: Rename any hyphenated listen path variables before migrating. See [Dynamic Listen Paths](/getting-started/key-concepts/url-matching#dynamic-listen-paths) for the full naming constraint.
