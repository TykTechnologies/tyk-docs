...
1. Enable [audit logs in Tyk Dashboard](/dashboard-admin-api#dashboard-audit-logs) using the [database storage](/dashboard-admin-api#database-storage-support) option
2. View the audit logs through the Dashboard UI
3. Learn how to [access audit logs via the API](/dashboard-admin-api#retrieving-audit-logs-via-api)
