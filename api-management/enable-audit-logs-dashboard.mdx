...
1. Enable [audit logs in Tyk Dashboard](/api-management/enable-audit-logs-dashboard#dashboard-audit-logs) using the [database storage](/api-management/enable-audit-logs-dashboard#database-storage-support) option
2. View the audit logs through the Dashboard UI
3. Learn how to [access audit logs via the API](/api-management/enable-audit-logs-dashboard#retrieving-audit-logs-via-api)
