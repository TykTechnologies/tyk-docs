...
1. Enable [audit logs in Tyk Dashboard](/api-management/logs/audit-logs) using the [database storage](/api-management/logs/audit-logs#audit-log-storage) option
2. View the audit logs through the Dashboard UI
3. Learn how to [access audit logs via the API](/api-management/logs/audit-logs#viewing-and-retrieving-audit-logs)
