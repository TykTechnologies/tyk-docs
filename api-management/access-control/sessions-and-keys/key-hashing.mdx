...
By default, if key hashing is in use, then requests to the [Gateway API](https://tyk.io/docs/api-reference/gateway/keys/list-keys) or [Dashboard API](https://tyk.io/docs/api-reference/dashboard/keys/list-all-the-keys) to retrieve a list of keys will be rejected - this functionality is disabled for security reasons.
