...
- **Dashboard API:** You can create a Policy by sending a request to the [`POST /api/portal/policies/`](https://tyk.io/docs/api-reference/dashboard/policies/create-policy-definition) endpoint with the Policy object as the payload.
...
- **Gateway API (Open Source):** If you are using Tyk Open Source, you can create policies by sending a request to the Gateway's [`POST /tyk/policies/`](https://tyk.io/docs/api-reference/gateway/policies/create-a-policy) endpoint, or by adding the Policy to the [Policies file](/api-management/access-control/policies/managing-policies#configuring-tyk-open-source-to-use-file-based-policies).
