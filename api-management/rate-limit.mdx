...
The following assumptions are made:
 ...
 - If [path-based permissions](/api-management/policies#secure-your-apis-by-method-and-path) are configured, they must grant access to these endpoints for keys generated from the policies.
</Note>
