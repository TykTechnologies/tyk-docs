...
<Note>
It is assumed that the APIs being protected with a rate limit are using the [auth token](/api-management/client-authentication#use-auth-tokens) client authentication method and policies have already been created.
</Note>
