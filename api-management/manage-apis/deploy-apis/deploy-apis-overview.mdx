...
Learn more:
* [Tutorial: Create an API in File-based Mode](/getting-started/create-api#tutorial-create-an-api-in-file-based-mode)
...
Learn more:
* [Tutorial: Create an API with the Dashboard](/getting-started/create-api#tutorial-create-an-api-with-the-dashboard)
...
Learn more:
- [Dashboard API](/getting-started/key-concepts/dashboard-api)
- [Gateway API](/api-management/oss/gateway-api)
...
- [Using Tyk Operator to enable GitOps with Tyk](/getting-started/key-concepts/gitops-with-tyk)
