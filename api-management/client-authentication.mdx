...
<Card title="Tyk OAuth 2.0" href="/api-management/authentication/oauth-2">
Use Tyk Gateway as a built-in OAuth 2.0 authorization server to issue and manage access tokens.
</Card>

<Card title="OAuth 2.0 (External IdP)" href="/api-management/authentication/oauth2-authentication">
...
<Card title="mTLS" href="/api-management/implement-tls#secure-hosted-apis-with-mtls">
