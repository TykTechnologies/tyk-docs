...
|----------------------|--------------|
| `TYK_GW_OPENTELEMETRY_TRACES_ENABLED` | `traces.enabled` |
| `TYK_GW_OPENTELEMETRY_TRACES_EXPORTER` | `traces.exporter` |
| `TYK_GW_OPENTELEMETRY_TRACES_ENDPOINT` | `traces.endpoint` |
...
<Note>
Root-level env vars such as `TYK_GW_OPENTELEMETRY_ENABLED` and `TYK_GW_OPENTELEMETRY_ENDPOINT` still work for traces but are deprecated. Use `TYK_GW_OPENTELEMETRY_TRACES_*` for new deployments.
</Note>
