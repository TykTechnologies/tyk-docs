---
title: "Java Plugins"
description: "Write a custom Tyk Gateway request transformation plugin in Java, implemented as a gRPC server using Tyk's coprocess dispatcher protocol."
sidebarTitle: "Java Plugins"
---
