...
<Note>
If your Gateway is a Hybrid Data Plane connected to a Tyk Cloud Control Plane, you can point `bundle_base_url` directly at your Control Plane's File Server instead of hosting your own. See [Serving Plugin Bundles To Hybrid Gateways](/tyk-cloud/using-plugins#serving-plugin-bundles-to-hybrid-gateways).
</Note>
