---
title: "gRPC: Build a Dispatcher from Scratch (Python)"
description: "Step-by-step tutorial for implementing a Tyk coprocess dispatcher service and gRPC server from scratch in Python."
sidebarTitle: "gRPC: Dispatcher from Scratch"
---
