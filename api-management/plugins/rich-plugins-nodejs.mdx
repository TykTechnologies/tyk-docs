...
description: "Write a custom Tyk Gateway authentication plugin in Node.js, implemented as a gRPC server using Tyk's coprocess dispatcher protocol."
sidebarTitle: "Node.js Plugins"
---
