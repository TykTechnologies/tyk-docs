---
title: "Python: HMAC Auth Tutorial"
description: "Build a custom HMAC-signed authentication plugin for Tyk Gateway using a Python gRPC dispatcher server."
sidebarTitle: "Python: HMAC Auth Tutorial"
---
...
While Tyk Gateway offers built-in support for HMAC-signed authentication, this tutorial serves as a practical guide for developers looking to extend Tyk's capabilities through custom authentication plugins. It extends the gRPC server that we developed in our [getting started guide](/api-management/plugins/rich-plugins-grpc-dispatcher-from-scratch).
