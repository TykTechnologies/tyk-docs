---
title: "Plugin Caching & ID Extractor"
description: "Configure the ID Extractor caching mechanism used by custom authentication plugins to avoid running expensive extraction logic on every request."
sidebarTitle: "Plugin Caching & ID Extractor"
---
