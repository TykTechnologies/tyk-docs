---
title: ".NET Plugins"
description: "Write a custom Tyk Gateway authentication plugin in .NET, implemented as a gRPC server using Tyk's coprocess dispatcher protocol."
sidebarTitle: ".NET Plugins"
---
