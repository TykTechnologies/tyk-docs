...
2. **Dynamic event handlers**: components that fire on API events. They run asynchronously and are documented in [Gateway events](/api-management/gateway-events#set-up-a-webhook-event-handler-in-the-tyk-oas-api-definition).
