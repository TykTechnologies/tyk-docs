---
title: "gRPC Plugins"
description: "Write custom middleware for Tyk Gateway as a gRPC server, in any gRPC-supported language, using Tyk's coprocess dispatcher protocol."
sidebarTitle: "gRPC Plugins"
---
...
Example tutorials are available that explain how to generate the protobuf bindings and implement a server for [Java](/api-management/plugins/rich-plugins-java), [.NET](/api-management/plugins/rich-plugins-dotnet) and [NodeJS](/api-management/plugins/rich-plugins-nodejs).
...
- Visit tutorial guides that explain how to implement a [Java](/api-management/plugins/rich-plugins-java), [.NET](/api-management/plugins/rich-plugins-dotnet) and [NodeJS](/api-management/plugins/rich-plugins-nodejs) gRPC server.
