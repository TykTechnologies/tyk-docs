...
```yaml {linenos=table,hl_lines=["15-18"],linenostart=1} expandable
...
```json {hl_lines=["39-45"],linenos=true, linenostart=1} expandable
{
    "components": {},
    "info": {
...
For example:
```json  {linenos=true, linenostart=1} expandable
{
    "extended_paths": {
        "go_plugin": [
            {
