---
title: "CI/CD for Plugin Builds"
description: "Automate compiling, bundling, and deploying custom plugins as part of a CI/CD pipeline."
sidebarTitle: "CI/CD for Plugin Builds"
---
