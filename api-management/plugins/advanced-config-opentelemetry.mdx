...
description: "Instrument custom plugins with OpenTelemetry to create spans, set attributes, and propagate trace context from the request."
...
You can find more information about enabling OpenTelemetry [here](/api-management/traces).
