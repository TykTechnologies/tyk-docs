...
13. ##### How to disable an API
    ...
    See [Dashboard API - API Definitions](/platform-management/dashboard-api#manage-apis-api-definition) for more details on how to GET and PUT an API definition.
