...
Before configuring your TIB profile, read [Dashboard SSO](/tyk-identity-broker/dashboard-sso) or [Portal SSO](/tyk-stack/tyk-developer-portal/enterprise-developer-portal/managing-access/enable-sso) to understand the `ActionType`, `ReturnURL`, and `IdentityHandlerConfig` fields required for your use case.
...
```
http://portal.example.com:3001/auth/github-portal/github/callback
```
...
```
http://portal.example.com:3001/auth/github-portal/github
```
...
```
http://portal.example.com:3001/auth/google-portal-oidc/openid-connect/callback
```
...
```
http://portal.example.com:3001/auth/google-portal-oidc/openid-connect
```
