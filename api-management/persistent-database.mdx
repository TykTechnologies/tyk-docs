...
See [Database Management](/planning-for-production/database-settings) for how this fits alongside Redis, used for other data such as rate limits and response caching.
