...
The above configuration sends logs to the `k8s-logs` index in Elasticsearch. Before installing the collector, ensure the `k8s-log` index is created in your Elasticsearch cluster.
