...
<Card title="OAuth 2.0" href="/api-management/authentication-authorization/#set-up-oauth-20-authorization">
Delegate authentication using a widely adopted framework.
</Card>

<Card title="Bearer Tokens" href="/api-management/authentication-authorization/#use-bearer-tokens">
Implement token-based authentication for API access.
</Card>

<Card title="External OAuth" href="/api-management/authentication-authorization/#integrate-external-oauth-middleware">
Integrate with external providers for centralized authentication.
</Card>

<Card title="HMAC" href="/api-management/authentication-authorization/#sign-requests-with-hmac">
Verify message integrity using shared secret keys.
</Card>

<Card title="JWT" href="/api-management/authentication-authorization/#use-json-web-tokens-jwt">
Securely transmit information between parties.
</Card>

<Card title="mTLS" href="/api-management/authentication-authorization/#enable-mutual-tls">
Establish secure channels with two-way certificate verification.
</Card>

<Card title="Open Access" href="/api-management/authentication-authorization/#use-open-keyless-authentication">
Allow unrestricted access for public APIs.
</Card>


<Card title="Basic Auth" href="/api-management/authentication-authorization/#use-basic-authentication">
...
Please consult the Tyk Operator supporting documentation for an example of how to [enable a bearer token](/api-management/automations#auth-token-bearer-token) with Tyk Operator.
...
* Via a Portal Developer API call - [Revoke a token](/tyk-apis/tyk-portal-api/portal-developers#revoke-a-single-oauth-client-token) and [revoke all tokens](/tyk-apis/tyk-portal-api/portal-developers#revoke-all-oauth-client-tokens)
...
Please consult the Tyk Operator supporting documentation for an example of how to [enable basic authentication](/api-management/automations#basic-authentication) with Tyk Operator.
...
```
We have full tutorials to guide you to [create an API Key](/getting-started/create-api-key) via the Dashboard. 
...
If Tyk cannot find a `pol` claim, it will apply this Default Policy. Select a policy that gives access to this API we are protecting, or [go create one first](/getting-started/create-security-policy) if it doesn't exist.
...
If you are looking to POC this functionality in Kubernetes, you can run a fully worked-out example using our tyk-k8s-demo library. You can read more [here](/getting-started/quick-start/tyk-k8s-demo).
...
<Note>
Keyless APIs cannot be selected for [Access Rights](/getting-started/create-security-policy) in a security policy.
</Note>
...
Please consult the [Tyk Operator](/api-management/automations#multiple-chained-auth) supporting documentation for an example of how to enable multi chained authentication with Tyk Operator.
...
* See [Custom Authentication with a Python plugin](/plugins/supported-languages/rich-plugins/python/custom-auth-python-tutorial) for a detailed example of a custom Python plugin.
* See [JavaScript Middleware](/plugins/supported-languages/javascript-middleware) for more details on using JavaScript Middleware. 
