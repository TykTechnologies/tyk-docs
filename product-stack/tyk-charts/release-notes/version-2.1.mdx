...
However, if you are upgrading to [Tyk Operator v1.0](/product-stack/tyk-operator/release-notes/operator-1.0) using the Helm Chart, please read the [license requirement](/product-stack/tyk-operator/release-notes/operator-1.0#breaking-changes) and Tyk Operator [installation and upgrade instructions](/api-management/automations#install-and-configure-tyk-operator) carefully.
