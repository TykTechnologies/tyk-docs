...
A major feature of this release is the implementation of Mutual TLS. Now you can protect your APIs by allow listing certificates, idenitfy users based on them, and increase security between Tyk and upstream API. For details, see [Mutual TLS](/api-management/authentication-authorization#enable-mutual-tls).
...
[Docs](/tyk-stack/tyk-manager/analytics/log-browser)
...
#### Mutual TLS support
[Docs](/api-management/authentication-authorization#enable-mutual-tls)
...
[Docs](/tyk-oss-gateway/configuration#a-name-log-level-a-log-level)
...
[Docs](/transform-traffic/request-body)
...
Added support for Mutual TLS, mentioned by Gateway and Dashboard above. See [Docs](/api-management/authentication-authorization#enable-mutual-tls)
