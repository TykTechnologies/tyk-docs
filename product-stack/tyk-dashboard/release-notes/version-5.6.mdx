...
Now you can configure rate limits at the [endpoint level per client](/getting-started/key-concepts/rate-limiting#key-level-rate-limiting), using new configuration options in the access key. Use Tyk's powerful [security policies](/getting-started/key-concepts/what-is-a-security-policy) to create templates to set appropriate rate limits for your different categories of user.
...
- ```bash
  ...
  ```
- Helm charts
  - [tyk-charts v2.1.0](/product-stack/tyk-charts/release-notes/version-2.1.md)
