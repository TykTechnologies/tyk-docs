...
If you are upgrading from version 2.8, pls [read this guide](/product-stack/tyk-gateway/release-notes/archived-releases/version-2.9#upgrading-from-version-28)
