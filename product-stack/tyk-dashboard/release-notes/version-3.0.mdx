...
See updated tutorials on how to [create a policy](/getting-started/create-security-policy) and [keys](/getting-started/create-api-key)
...
See [updated flow details](/tyk-identity-broker)
...
At the moment the Response hook is supported for [Python and gRPC plugins](/plugins/supported-languages/rich-plugins/rich-plugins-work#overriding-response).
...
[Read More](/tyk-stack/tyk-pump/useful-debug-modes#enabling-detailed-logging)
...
[Read More](/tyk-pump/configuration)
...
If you are upgrading from version 2.8, pls [read this guide](/product-stack/tyk-gateway/release-notes/archived-releases/version-2.9.md#upgrading-from-version-28)
