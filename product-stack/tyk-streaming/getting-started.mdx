...
[Lab Release](/developer-support/special-releases-and-features/lab-releases) phase. Your feedback is crucial
...
- In case you used this repo before, ensure all Docker images are as defined in the [example env](#post-download) above.
...
Since *Tyk Streams* is currently released as a [Lab Release](/developer-support/special-releases-and-features/lab-releases),
...
- You can now start exploring [Tyk Stream capabilities](/api-management/async-apis/use-cases) and
[use cases](/api-management/async-apis/advanced-use-cases)
