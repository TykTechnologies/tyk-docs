...
Tyk Streams allows you to dynamically set config fields using [Bloblang](/product-stack/tyk-streaming/guides/bloblang/overview) queries.
...
[Bloblang](/product-stack/tyk-streaming/guides/bloblang/overview) supports arithmetic, boolean operators, coalesce and mapping expressions. 
