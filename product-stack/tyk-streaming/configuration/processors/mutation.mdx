...
Executes a [Bloblang](/product-stack/tyk-streaming/guides/bloblang/overview) mapping and directly transforms the contents of messages, mutating (or deleting) them.
