...
Checks that a field, identified via a [dot path](/product-stack/tyk-streaming/configuration/common-configuration/field-paths), exists in an object.

#### Parameters

**path** &lt;string&gt; A [dot path](/product-stack/tyk-streaming/configuration/common-configuration/field-paths) to a field.  
