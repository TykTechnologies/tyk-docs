...
Tyk Pump now offers [FIPS 140-2](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.140-2.pdf) compliance. For further details please consult [Tyk API Management FIPS support](/developer-support/special-releases-and-features/fips-release)
...
Added [FIPS compliance](/developer-support/special-releases-and-features/fips-release) for Tyk Pump.
</Expandable>
</li>
</ul>
