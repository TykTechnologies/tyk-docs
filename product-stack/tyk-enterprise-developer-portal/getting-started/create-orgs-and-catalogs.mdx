...
The default catalogs that are featured when the portal is [bootstrapped](/product-stack/tyk-enterprise-developer-portal/deploy/bootstrapping-portal.md) are:
...
Visit [Customize the sign-up form](/product-stack/tyk-enterprise-developer-portal/getting-started/customize-sign-up-form) for the user sign-up form customization guide.