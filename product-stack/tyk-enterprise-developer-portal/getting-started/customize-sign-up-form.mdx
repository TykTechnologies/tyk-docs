...
Visit [Setup email notifications](/product-stack/tyk-enterprise-developer-portal/getting-started/setup-email-notifications) to learn how to setup email notifications guide, which completes this tutorial.