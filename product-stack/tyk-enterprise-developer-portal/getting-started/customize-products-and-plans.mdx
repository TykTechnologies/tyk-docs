...
- **Scope**: Scope for the [OAuth2.0 settings](/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/dynamic-client-registration.md). Please refer to the [OAuth2.0 documentation](/tyk-stack/tyk-developer-portal/enterprise-developer-portal/api-access/dynamic-client-registration) for further guidance.
- **Catalogs**: The catalogs in which this plan is available. Catalogs and organization are [covered](/product-stack/tyk-enterprise-developer-portal/getting-started/create-orgs-and-catalogs) later within this getting started guide.
...
Visit the [create API Consumer organizations and catalogs](/product-stack/tyk-enterprise-developer-portal/getting-started/create-orgs-and-catalogs) section to learn how to create API consumer organizations and catalogs.