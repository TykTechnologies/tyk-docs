...
keywords: "Configure Tyk Enterprise Developer Portal, Tyk Enterprise Developer Portal"
...
However, if you have  already created [a theme](/portal/customization#) and want the portal to use when it starts for the first time, then you can use this setting to achieve that.
...
### PORTAL_CONF
**Config file:** PortalConfig
**Type:** `string`
**Description**: Defines the path to the portal configuration file.

### PORTAL_JWTSIGNINGKEY
**Config file:** JWTSigningKey
**Type:** `string`
**Description**: Sets the JWT signing key.

### PORTAL_THEMELISTCHECKFREQUENCY
**Config file:** ThemeListCheckFrequency
**Type:** `int`
**Description**: Specifies the frequency (in minutes) for checking the theme list.

### PORTAL_PORTALALPHAPOLICYSERVICEENABLED
**Config file:** PortalAlphaPolicyServiceEnabled
**Type:** `bool`
**Description**: Enables or disables the portal alpha policy service.

### PORTAL_FULLSTORYENABLED
**Config file:** FullStoryEnabled
**Type:** `bool`
**Description**: Enables or disables FullStory integration.

### PORTAL_ENABLEPROMETHEUS
**Config file:** EnablePrometheus
**Type:** `bool`
**Description**: Enables or disables Prometheus metrics.

### PORTAL_MENUCACHETTL
**Config file:** MenuCacheTTL
**Type:** `int`
**Description**: Sets the time-to-live (in seconds) for the menu cache.

### PORTAL_DIRECTCHECKOUTTOKENDURATION
**Config file:** DirectCheckoutTokenDuration
**Type:** `int`
**Description**: Sets the duration (in seconds) for direct checkout tokens.

### PORTAL_STORESESSIONNAME
**Config file:** StoreSessionName
**Type:** `string`
**Description**: Defines the name of the store session.

### PORTAL_DATABASE_MIGRATIONBATCHSIZE
**Config file:** Database.MigrationBatchSize
**Type:** `int`
**Description**: Sets the batch size for database migrations.

### PORTAL_BLOG_ENABLE
**Config file:** Blog.Enable
**Type:** `bool`
**Description**: Enables or disables the blog feature.

### PORTAL_BLOG_ALLOWFORMSUBMISSION
**Config file:** Blog.AllowFormSubmission
**Type:** `bool`
**Description**: Allows or disallows form submissions in the blog.

### PORTAL_FORMS_ENABLE
**Config file:** Forms.Enable
**Type:** `bool`
**Description**: Enables or disables forms.

### PORTAL_SITE_ENABLE
**Config file:** Site.Enable
**Type:** `bool`
**Description**: Enables or disables the site.

### PORTAL_TLS_PREFERSERVERCIPHERSUITES
**Config file:** TLSConfig.PreferServerCipherSuites
**Type:** `bool`
**Description**: Specifies whether to prefer server cipher suites.

### PORTAL_SESSION_PERSIST
**Config file:** Session.Persist
**Type:** `bool`
**Description**: Enables or disables session persistence.

### PORTAL_CORS_DEBUG
**Config file:** CORS.Debug
**Type:** `bool`
**Description**: Enables or disables CORS debugging.

### PORTAL_WEBHOOKS_PROVIDER
**Config file:** Webhooks.Provider
**Type:** `string`
**Description**: Defines the webhooks provider.

### PORTAL_WEBHOOKS_SECRET
**Config file:** Webhooks.Secret
**Type:** `string`
**Description**: Sets the webhooks secret.

### PORTAL_WEBHOOKS_PAUSE_DURATION
**Config file:** Webhooks.PauseDuration
**Type:** `int`
**Description**: Sets the pause duration (in seconds) for webhooks.

### PORTAL_WEBHOOKS_CACHE_EXPIRATION
**Config file:** Webhooks.CacheExpiration
**Type:** `int`
**Description**: Sets the cache expiration (in seconds) for webhooks.

### PORTAL_WEBHOOKS_CACHE_CLEANUP_INTERVAL
**Config file:** Webhooks.CacheCleanupInterval
**Type:** `int`
**Description**: Sets the cache cleanup interval (in seconds) for webhooks.

### PORTAL_WEBHOOKS_DISPATCH_TIMEOUT
**Config file:** Webhooks.DispatchTimeout
**Type:** `int`
**Description**: Sets the dispatch timeout (in seconds) for webhooks.

### PORTAL_WEBHOOKS_TOTAL_WORKERS
**Config file:** Webhooks.TotalWorkers
**Type:** `int`
**Description**: Sets the total number of webhook workers.

### PORTAL_WEBHOOKS_HTTP_TIMEOUT
**Config file:** Webhooks.HTTPTimeout
**Type:** `int`
**Description**: Sets the HTTP timeout (in seconds) for webhooks.

### PORTAL_WEBHOOKS_QUEUE_SIZE
**Config file:** Webhooks.QueueSize
**Type:** `int`
**Description**: Sets the queue size for webhooks.

### PORTAL_WEBHOOKS_DISABLE
**Config file:** Webhooks.Disable
**Type:** `bool`
**Description**: Disables webhooks.
