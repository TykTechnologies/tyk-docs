...
**Type:** `int` <br/>
**Description**: The duration (in seconds) to pause a webhook after a failed delivery attempt before retrying.
...
**Type:** `int` <br/>
**Description**: The interval (in seconds) at which the webhook cache is cleaned up.
...
**Type:** `int` <br/>
**Description**: The number of worker goroutines used to process webhooks concurrently.
