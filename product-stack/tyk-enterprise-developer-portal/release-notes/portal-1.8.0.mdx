...
All settings are available via the [admin API](/product-stack/tyk-enterprise-developer-portal/api-documentation/tyk-edp-api.md) and the UI.
...
- Fixed the bug where the [Forgot Password page](/tyk-developer-portal/tyk-enterprise-developer-portal/api-consumer-portal/reset-password.md#introduction) did not reflect the current theme.
