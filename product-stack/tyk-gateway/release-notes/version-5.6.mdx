...
limits](/getting-started/key-concepts/rate-limiting#api-level-rate-limiting) introduced in Tyk 5.5.0 we have
now added [per-endpoint client
rate limits](/getting-started/key-concepts/rate-limiting#key-level-rate-limiting). This new feature allows
...
rate limits](/getting-started/key-concepts/rate-limiting#key-level-rate-limiting). This new feature
