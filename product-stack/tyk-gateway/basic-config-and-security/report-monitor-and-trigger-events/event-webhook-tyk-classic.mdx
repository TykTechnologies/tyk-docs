...
[Webhooks](/basic-config-and-security/report-monitor-trigger-events/webhooks) are event handlers that can
...
OAS](/product-stack/tyk-gateway/basic-config-and-security/report-monitor-and-trigger-events/event-webhook-tyk-oas)
page.
...
API definition for the appropriate [API event](/basic-config-and-security/report-monitor-trigger-events/event-types).
...
- `template_path`: this is the path to the [webhook
  template](/basic-config-and-security/report-monitor-trigger-events/webhooks#webhook-payload) that will be
...
- `event_timeout`: the [webhook
  cooldown](/basic-config-and-security/report-monitor-trigger-events/webhooks#webhook-cooldown) for duplicate
...
[global
webhook](/basic-config-and-security/report-monitor-trigger-events/webhooks#using-webhooks-with-tyk-dashboard).
</Note>
...
[here](/basic-config-and-security/report-monitor-trigger-events/webhooks#creating-a-global-webhook-definition-using-tyk-dashboard).
...
API events](/basic-config-and-security/report-monitor-trigger-events/event-types).
