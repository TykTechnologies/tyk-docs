...
The bundler tool is a CLI service, provided by *Tyk Gateway* as part of its binary since v2.8. This lets you generate [plugin bundles](/plugins/how-to-serve-plugins/plugin-bundles). Please note that the generated plugin bundles must be served using your own web server.
