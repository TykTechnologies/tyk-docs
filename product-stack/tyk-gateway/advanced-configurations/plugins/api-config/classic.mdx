...
If you’re using the newer Tyk OAS APIs, then check out the [Tyk OAS](/product-stack/tyk-gateway/advanced-configurations/plugins/api-config/oas) page.
...
Use the editor to edit the `custom_middleware` section of the [Tyk Classic API Definition](/product-stack/tyk-gateway/advanced-configurations/plugins/api-config/classic).
