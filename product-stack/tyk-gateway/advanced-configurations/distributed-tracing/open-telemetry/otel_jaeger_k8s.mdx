...
For Docker instructions, please refer to [How to integrate with Jaeger on Docker](/product-stack/tyk-gateway/advanced-configurations/distributed-tracing/open-telemetry/otel_jaeger).
