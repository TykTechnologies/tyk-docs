...
Note that this is not the same as Tyk's [IP allow list](/tyk-apis/tyk-gateway-api/api-definition-objects/ip-whitelisting) feature, which is used to restrict access to APIs based upon the IP of the requestor.
...
If you're using Tyk OAS APIs, then you can find details and examples of how to configure the allow list middleware [here](/product-stack/tyk-gateway/middleware/allow-list-tyk-oas).

If you're using Tyk Classic APIs, then you can find details and examples of how to configure the allow list middleware [here](/product-stack/tyk-gateway/middleware/allow-list-tyk-classic).
