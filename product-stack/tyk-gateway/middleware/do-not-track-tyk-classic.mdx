...
The [Do-Not-Track](/product-stack/tyk-gateway/middleware/do-not-track-middleware) middleware provides the facility to disable generation of transaction records (which are used to track requests) at the API or endpoint level.
...
If you're using the newer Tyk OAS APIs, then check out the [Tyk OAS](/product-stack/tyk-gateway/middleware/do-not-track-tyk-oas) page.
