...
This page provides sample manifest for creating [Universal Data Graph (UDG)](/universal-data-graph/getting-started-with-udg) APIs. Follow the example to learn how to configure your APIs.
