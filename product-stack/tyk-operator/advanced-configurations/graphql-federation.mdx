...
Tyk, with release *v4.0* offers [GraphQL federation](/getting-started/key-concepts/graphql-federation#federation-version-support) that allows you to divide GraphQL implementation across multiple back-end
