...
To configure API ownership, ensure Tyk Operator is also an owner of the API. This can be done using Operator Context. For details, refer to Tyk [Operator API Ownership](/product-stack/tyk-operator/getting-started/tyk-operator-api-ownership).

## API Versioning

For details on how to configure API versions, refer to [configuring API versioning in Tyk Operator](/getting-started/key-concepts/versioning#tyk-operator)